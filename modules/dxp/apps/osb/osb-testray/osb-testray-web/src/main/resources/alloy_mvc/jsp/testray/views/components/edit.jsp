...
<liferay-util:include page="/alloy_mvc/jsp/testray/views/header.jsp" servletContext="<%= application %>">
	<liferay-util:param name="title" value="${testrayComponent.name}" />
...
<portlet:actionURL var="updateTestrayComponentURL">
	<portlet:param name="controller" value="components" />
	<portlet:param name="action" value="update" />
</portlet:actionURL>

<aui:form action="${updateTestrayComponentURL}" method="post">
	...
	<aui:input name="id" type="hidden" value="${testrayComponent.testrayComponentId}" />
