 ...
 * @see com.liferay.osb.testray.service.TestrayIssueLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TestrayIssueLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TestrayIssueLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.testray.service.TestrayIssueLocalServiceUtil} to access the testray issue local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TestrayIssue.class,
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(testrayIssueLocalService);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return testrayIssueLocalService.deleteTestrayIssue((TestrayIssue)persistedModel);
	}
	...
	public void addTestrayCaseResultTestrayIssue(long testrayCaseResultId,
		long testrayIssueId) {
		testrayCaseResultPersistence.addTestrayIssue(testrayCaseResultId,
			testrayIssueId);
	}
	...
	public void addTestrayCaseResultTestrayIssues(long testrayCaseResultId,
		...
		testrayCaseResultPersistence.addTestrayIssues(testrayCaseResultId,
			testrayIssueIds);
	}
	...
	public void deleteTestrayCaseResultTestrayIssue(long testrayCaseResultId,
		long testrayIssueId) {
		testrayCaseResultPersistence.removeTestrayIssue(testrayCaseResultId,
			testrayIssueId);
	}
	...
	public void deleteTestrayCaseResultTestrayIssues(long testrayCaseResultId,
		long[] testrayIssueIds) {
		testrayCaseResultPersistence.removeTestrayIssues(testrayCaseResultId,
			testrayIssueIds);
	}
	...
	public long[] getTestrayCaseResultPrimaryKeys(long testrayIssueId) {
		return testrayIssuePersistence.getTestrayCaseResultPrimaryKeys(testrayIssueId);
	}
	...
	public List<TestrayIssue> getTestrayCaseResultTestrayIssues(
		...
		return testrayCaseResultPersistence.getTestrayIssues(testrayCaseResultId);
	}
	...
	public int getTestrayCaseResultTestrayIssuesCount(long testrayCaseResultId) {
		return testrayCaseResultPersistence.getTestrayIssuesSize(testrayCaseResultId);
	}
	...
	public boolean hasTestrayCaseResultTestrayIssue(long testrayCaseResultId,
		long testrayIssueId) {
		return testrayCaseResultPersistence.containsTestrayIssue(testrayCaseResultId,
			testrayIssueId);
	}
	...
	public boolean hasTestrayCaseResultTestrayIssues(long testrayCaseResultId) {
		return testrayCaseResultPersistence.containsTestrayIssues(testrayCaseResultId);
	}
	...
	public void setTestrayCaseResultTestrayIssues(long testrayCaseResultId,
		long[] testrayIssueIds) {
		testrayCaseResultPersistence.setTestrayIssues(testrayCaseResultId,
			testrayIssueIds);
	}
	...
	public void addTestraySubtaskTestrayIssue(long testraySubtaskId,
		long testrayIssueId) {
		testraySubtaskPersistence.addTestrayIssue(testraySubtaskId,
			testrayIssueId);
	}
	...
	public void addTestraySubtaskTestrayIssue(long testraySubtaskId,
		TestrayIssue testrayIssue) {
		testraySubtaskPersistence.addTestrayIssue(testraySubtaskId, testrayIssue);
	}
	...
	public void addTestraySubtaskTestrayIssues(long testraySubtaskId,
		long[] testrayIssueIds) {
		testraySubtaskPersistence.addTestrayIssues(testraySubtaskId,
			testrayIssueIds);
	}
	...
	public void deleteTestraySubtaskTestrayIssue(long testraySubtaskId,
		long testrayIssueId) {
		testraySubtaskPersistence.removeTestrayIssue(testraySubtaskId,
			testrayIssueId);
	}
	...
	public void deleteTestraySubtaskTestrayIssues(long testraySubtaskId,
		long[] testrayIssueIds) {
		testraySubtaskPersistence.removeTestrayIssues(testraySubtaskId,
			testrayIssueIds);
	}
	...
	public long[] getTestraySubtaskPrimaryKeys(long testrayIssueId) {
		return testrayIssuePersistence.getTestraySubtaskPrimaryKeys(testrayIssueId);
	}
	...
	public boolean hasTestraySubtaskTestrayIssue(long testraySubtaskId,
		long testrayIssueId) {
		return testraySubtaskPersistence.containsTestrayIssue(testraySubtaskId,
			testrayIssueId);
	}
	...
	public boolean hasTestraySubtaskTestrayIssues(long testraySubtaskId) {
		return testraySubtaskPersistence.containsTestrayIssues(testraySubtaskId);
	}
	...
	public void setTestraySubtaskTestrayIssues(long testraySubtaskId,
		long[] testrayIssueIds) {
		testraySubtaskPersistence.setTestrayIssues(testraySubtaskId,
			testrayIssueIds);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.osb.testray.model.TestrayIssue",
