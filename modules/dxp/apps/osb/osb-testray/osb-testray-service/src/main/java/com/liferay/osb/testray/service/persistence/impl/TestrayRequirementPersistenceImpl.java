 ...
 * @see com.liferay.osb.testray.service.persistence.TestrayRequirementUtil
 * @generated
 */
@ProviderType
public class TestrayRequirementPersistenceImpl extends BasePersistenceImpl<TestrayRequirement>
	implements TestrayRequirementPersistence {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link TestrayRequirementUtil} to access the testray requirement persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY = TestrayRequirementImpl.class.getName();
	public static final String FINDER_CLASS_NAME_LIST_WITH_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List1";
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(TestrayRequirementModelImpl.ENTITY_CACHE_ENABLED,
			TestrayRequirementModelImpl.FINDER_CACHE_ENABLED,
			TestrayRequirementImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(TestrayRequirementModelImpl.ENTITY_CACHE_ENABLED,
			TestrayRequirementModelImpl.FINDER_CACHE_ENABLED,
			TestrayRequirementImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(TestrayRequirementModelImpl.ENTITY_CACHE_ENABLED,
			TestrayRequirementModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll", new String[0]);
	public static final FinderPath FINDER_PATH_FETCH_BY_TPI_K = new FinderPath(TestrayRequirementModelImpl.ENTITY_CACHE_ENABLED,
			TestrayRequirementModelImpl.FINDER_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_TPI_K = new FinderPath(TestrayRequirementModelImpl.ENTITY_CACHE_ENABLED,
			TestrayRequirementModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByTPI_K",
			new String[] { Long.class.getName(), String.class.getName() });

	/**
	 * Returns the testray requirement where testrayProjectId = &#63; and key = &#63; or throws a {@link NoSuchTestrayRequirementException} if it could not be found.
	 *
	...
	public TestrayRequirement findByTPI_K(long testrayProjectId, String key)
		...
		TestrayRequirement testrayRequirement = fetchByTPI_K(testrayProjectId,
				key);
	...
	public TestrayRequirement fetchByTPI_K(long testrayProjectId, String key,
		...
		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_TPI_K,
					finderArgs, this);
		}
		...
		if (result instanceof TestrayRequirement) {
			...
			if ((testrayProjectId != testrayRequirement.getTestrayProjectId()) ||
		...
		if (result == null) {
			...
			if (key == null) {
				query.append(_FINDER_COLUMN_TPI_K_KEY_1);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_TPI_K,
						finderArgs, list);
				}
				else {
					...
					if ((testrayRequirement.getTestrayProjectId() != testrayProjectId) ||
							(testrayRequirement.getKey() == null) ||
							!testrayRequirement.getKey().equals(key)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_TPI_K,
							finderArgs, testrayRequirement);
					}
				}
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_FETCH_BY_TPI_K, finderArgs);
	...
	public TestrayRequirement removeByTPI_K(long testrayProjectId, String key)
		throws NoSuchTestrayRequirementException {
		TestrayRequirement testrayRequirement = findByTPI_K(testrayProjectId,
				key);
	...
	public int countByTPI_K(long testrayProjectId, String key) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_TPI_K;
	...
	private static final String _FINDER_COLUMN_TPI_K_TESTRAYPROJECTID_2 = "testrayRequirement.testrayProjectId = ? AND ";
	private static final String _FINDER_COLUMN_TPI_K_KEY_1 = "testrayRequirement.key IS NULL";
	private static final String _FINDER_COLUMN_TPI_K_KEY_2 = "testrayRequirement.key = ?";
	private static final String _FINDER_COLUMN_TPI_K_KEY_3 = "(testrayRequirement.key IS NULL OR testrayRequirement.key = '')";
	...
	public void cacheResult(TestrayRequirement testrayRequirement) {
		entityCache.putResult(TestrayRequirementModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache(TestrayRequirement testrayRequirement) {
		entityCache.removeResult(TestrayRequirementModelImpl.ENTITY_CACHE_ENABLED,
			TestrayRequirementImpl.class, testrayRequirement.getPrimaryKey());

		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITH_PAGINATION);
		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);

		clearUniqueFindersCache((TestrayRequirementModelImpl)testrayRequirement,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(FINDER_PATH_COUNT_BY_TPI_K, args,
			Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_TPI_K, args,
			testrayRequirementModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_TPI_K, args);
			finderCache.removeResult(FINDER_PATH_FETCH_BY_TPI_K, args);
		}

		if ((testrayRequirementModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_TPI_K.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
	...
	public TestrayRequirement remove(Serializable primaryKey)
		...
		try {
			...
			TestrayRequirement testrayRequirement = (TestrayRequirement)session.get(TestrayRequirementImpl.class,
					primaryKey);
			...
			if (testrayRequirement == null) {
				...
				throw new NoSuchTestrayRequirementException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}
	...
	protected TestrayRequirement removeImpl(
		...
		testrayRequirement = toUnwrappedModel(testrayRequirement);

		testrayRequirementToTestrayCaseTableMapper.deleteLeftPrimaryKeyTableMappings(testrayRequirement.getPrimaryKey());
		...
		try {
			...
			if (!session.contains(testrayRequirement)) {
				testrayRequirement = (TestrayRequirement)session.get(TestrayRequirementImpl.class,
	...
	public TestrayRequirement updateImpl(TestrayRequirement testrayRequirement) {
		...
		TestrayRequirementModelImpl testrayRequirementModelImpl = (TestrayRequirementModelImpl)testrayRequirement;
		...
		if (isNew && (testrayRequirement.getCreateDate() == null)) {
			if (serviceContext == null) {
				...
				testrayRequirement.setCreateDate(serviceContext.getCreateDate(
						now));
			}
		}
		...
		if (!testrayRequirementModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				...
				testrayRequirement.setModifiedDate(serviceContext.getModifiedDate(
						now));
			}
		}
		...
		try {
			...
			if (testrayRequirement.isNew()) {
				...
				testrayRequirement = (TestrayRequirement)session.merge(testrayRequirement);
			}
		}
		catch (Exception e) {
			throw processException(e);
	...
	protected TestrayRequirement toUnwrappedModel(
		TestrayRequirement testrayRequirement) {
		if (testrayRequirement instanceof TestrayRequirementImpl) {
			return testrayRequirement;
		}

		TestrayRequirementImpl testrayRequirementImpl = new TestrayRequirementImpl();

		testrayRequirementImpl.setNew(testrayRequirement.isNew());
		testrayRequirementImpl.setPrimaryKey(testrayRequirement.getPrimaryKey());

		testrayRequirementImpl.setTestrayRequirementId(testrayRequirement.getTestrayRequirementId());
		testrayRequirementImpl.setGroupId(testrayRequirement.getGroupId());
		testrayRequirementImpl.setCompanyId(testrayRequirement.getCompanyId());
		testrayRequirementImpl.setUserId(testrayRequirement.getUserId());
		testrayRequirementImpl.setUserName(testrayRequirement.getUserName());
		testrayRequirementImpl.setCreateDate(testrayRequirement.getCreateDate());
		testrayRequirementImpl.setModifiedDate(testrayRequirement.getModifiedDate());
		testrayRequirementImpl.setTestrayComponentId(testrayRequirement.getTestrayComponentId());
		testrayRequirementImpl.setTestrayProjectId(testrayRequirement.getTestrayProjectId());
		testrayRequirementImpl.setKey(testrayRequirement.getKey());
		testrayRequirementImpl.setSummary(testrayRequirement.getSummary());
		testrayRequirementImpl.setComponents(testrayRequirement.getComponents());
		testrayRequirementImpl.setLinkTitle(testrayRequirement.getLinkTitle());
		testrayRequirementImpl.setLinkURL(testrayRequirement.getLinkURL());
		testrayRequirementImpl.setDescription(testrayRequirement.getDescription());
		testrayRequirementImpl.setDescriptionType(testrayRequirement.getDescriptionType());
		testrayRequirementImpl.setGoals(testrayRequirement.getGoals());
		testrayRequirementImpl.setGoalsType(testrayRequirement.getGoalsType());
		testrayRequirementImpl.setVariations(testrayRequirement.getVariations());
		testrayRequirementImpl.setVariationsType(testrayRequirement.getVariationsType());

		return testrayRequirementImpl;
	}

	/**
	 * Returns the testray requirement with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the testray requirement
	...
	/**
	 * Returns the testray requirement with the primary key or throws a {@link NoSuchTestrayRequirementException} if it could not be found.
	 *
	 * @param testrayRequirementId the primary key of the testray requirement
	 * @return the testray requirement
	 * @throws NoSuchTestrayRequirementException if a testray requirement with the primary key could not be found
	...
	public TestrayRequirement fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(TestrayRequirementModelImpl.ENTITY_CACHE_ENABLED,
		...
		TestrayRequirement testrayRequirement = (TestrayRequirement)serializable;
	...
	public Map<Serializable, TestrayRequirement> fetchByPrimaryKeys(
		...
		Map<Serializable, TestrayRequirement> map = new HashMap<Serializable, TestrayRequirement>();
		...
		try {
			...
			for (TestrayRequirement testrayRequirement : (List<TestrayRequirement>)q.list()) {
				map.put(testrayRequirement.getPrimaryKeyObj(),
					testrayRequirement);

				cacheResult(testrayRequirement);

				uncachedPrimaryKeys.remove(testrayRequirement.getPrimaryKeyObj());
			}
	...
	public List<TestrayRequirement> findAll(int start, int end,
		...
		if (retrieveFromCache) {
			list = (List<TestrayRequirement>)finderCache.getResult(finderPath,
					finderArgs, this);
		}
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					list = (List<TestrayRequirement>)QueryUtil.list(q,
	...
	public long[] getTestrayCasePrimaryKeys(long pk) {
		long[] pks = testrayRequirementToTestrayCaseTableMapper.getRightPrimaryKeys(pk);
	...
	public List<com.liferay.osb.testray.model.TestrayCase> getTestrayCases(
		...
		return testrayRequirementToTestrayCaseTableMapper.getRightBaseModels(pk,
	...
	public boolean containsTestrayCase(long pk, long testrayCasePK) {
		return testrayRequirementToTestrayCaseTableMapper.containsTableMapping(pk,
			testrayCasePK);
	}
	...
	public void addTestrayCase(long pk, long testrayCasePK) {
		...
		if (testrayRequirement == null) {
			testrayRequirementToTestrayCaseTableMapper.addTableMapping(companyProvider.getCompanyId(),
				pk, testrayCasePK);
		}
		else {
			testrayRequirementToTestrayCaseTableMapper.addTableMapping(testrayRequirement.getCompanyId(),
				pk, testrayCasePK);
		}
	}
	...
	public void addTestrayCases(long pk, long[] testrayCasePKs) {
		...
		testrayRequirementToTestrayCaseTableMapper.addTableMappings(companyId,
			pk, testrayCasePKs);
	}
	...
	public void addTestrayCases(long pk,
		...
		addTestrayCases(pk,
			ListUtil.toLongArray(testrayCases,
				com.liferay.osb.testray.model.TestrayCase.TESTRAY_CASE_ID_ACCESSOR));
	}
	...
	public void clearTestrayCases(long pk) {
		testrayRequirementToTestrayCaseTableMapper.deleteLeftPrimaryKeyTableMappings(pk);
	}
	...
	public void removeTestrayCase(long pk, long testrayCasePK) {
		testrayRequirementToTestrayCaseTableMapper.deleteTableMapping(pk,
			testrayCasePK);
	}
	...
	public void removeTestrayCases(long pk, long[] testrayCasePKs) {
		testrayRequirementToTestrayCaseTableMapper.deleteTableMappings(pk,
			testrayCasePKs);
	}
	...
	public void setTestrayCases(long pk, long[] testrayCasePKs) {
		...
		Set<Long> oldTestrayCasePKsSet = SetUtil.fromArray(testrayRequirementToTestrayCaseTableMapper.getRightPrimaryKeys(
					pk));

		Set<Long> removeTestrayCasePKsSet = new HashSet<Long>(oldTestrayCasePKsSet);

		removeTestrayCasePKsSet.removeAll(newTestrayCasePKsSet);

		testrayRequirementToTestrayCaseTableMapper.deleteTableMappings(pk,
			ArrayUtil.toLongArray(removeTestrayCasePKsSet));
		...
		testrayRequirementToTestrayCaseTableMapper.addTableMappings(companyId,
			pk, ArrayUtil.toLongArray(newTestrayCasePKsSet));
	}
	...
	public void setTestrayCases(long pk,
		...
		try {
			...
			for (int i = 0; i < testrayCases.size(); i++) {
				com.liferay.osb.testray.model.TestrayCase testrayCase = testrayCases.get(i);
	...
	public void afterPropertiesSet() {
		testrayRequirementToTestrayCaseTableMapper = TableMapperFactory.getTableMapper("OSB_TestrayRequirements_TestrayCases",
				"companyId", "testrayRequirementId", "testrayCaseId", this,
	...
	protected TableMapper<TestrayRequirement, com.liferay.osb.testray.model.TestrayCase> testrayRequirementToTestrayCaseTableMapper;
	private static final String _SQL_SELECT_TESTRAYREQUIREMENT = "SELECT testrayRequirement FROM TestrayRequirement testrayRequirement";
	private static final String _SQL_SELECT_TESTRAYREQUIREMENT_WHERE_PKS_IN = "SELECT testrayRequirement FROM TestrayRequirement testrayRequirement WHERE testrayRequirementId IN (";
	private static final String _SQL_SELECT_TESTRAYREQUIREMENT_WHERE = "SELECT testrayRequirement FROM TestrayRequirement testrayRequirement WHERE ";
	private static final String _SQL_COUNT_TESTRAYREQUIREMENT = "SELECT COUNT(testrayRequirement) FROM TestrayRequirement testrayRequirement";
	private static final String _SQL_COUNT_TESTRAYREQUIREMENT_WHERE = "SELECT COUNT(testrayRequirement) FROM TestrayRequirement testrayRequirement WHERE ";
	private static final String _ORDER_BY_ENTITY_ALIAS = "testrayRequirement.";
	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY = "No TestrayRequirement exists with the primary key ";
	private static final String _NO_SUCH_ENTITY_WITH_KEY = "No TestrayRequirement exists with the key {";
	private static final Log _log = LogFactoryUtil.getLog(TestrayRequirementPersistenceImpl.class);
