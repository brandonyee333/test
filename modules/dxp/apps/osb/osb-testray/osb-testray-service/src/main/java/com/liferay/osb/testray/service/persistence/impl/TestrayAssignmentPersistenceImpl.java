...
public class TestrayAssignmentPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setTestrayAssignmentUtilPersistence(this);
	}

	public void destroy() {
		_setTestrayAssignmentUtilPersistence(null);
	...
	private void _setTestrayAssignmentUtilPersistence(
		TestrayAssignmentPersistence testrayAssignmentPersistence) {

		try {
			Field field = TestrayAssignmentUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, testrayAssignmentPersistence);
		}
