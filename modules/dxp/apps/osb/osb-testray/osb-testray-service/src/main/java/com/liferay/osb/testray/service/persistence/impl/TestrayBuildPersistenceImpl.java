...
public class TestrayBuildPersistenceImpl
	...
	public TestrayBuild fetchByTRI_N(
		long testrayRoutineId, String name, boolean retrieveFromCache) {
		...
		if (result == null) {
			...
			try {
				...
				finderCache.removeResult(_finderPathFetchByTRI_N, finderArgs);
