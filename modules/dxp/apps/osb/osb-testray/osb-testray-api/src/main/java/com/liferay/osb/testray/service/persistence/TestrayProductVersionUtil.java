...
/**
 * The persistence utility for the testray product version service. This utility wraps {@link com.liferay.osb.testray.service.persistence.impl.TestrayProductVersionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TestrayProductVersionUtil {
	...
	*/
	public static TestrayProductVersion findByT_N(long testrayProjectId,
		java.lang.String name)
		throws com.liferay.osb.testray.exception.NoSuchTestrayProductVersionException {
	...
	*/
	public static TestrayProductVersion fetchByT_N(long testrayProjectId,
		java.lang.String name) {
	...
	*/
	public static TestrayProductVersion fetchByT_N(long testrayProjectId,
		...
		return getPersistence()
				   .fetchByT_N(testrayProjectId, name, retrieveFromCache);
	}
	...
	*/
	public static TestrayProductVersion removeByT_N(long testrayProjectId,
		java.lang.String name)
		throws com.liferay.osb.testray.exception.NoSuchTestrayProductVersionException {
	...
	*/
	public static int countByT_N(long testrayProjectId, java.lang.String name) {
	...
	*/
	public static void cacheResult(TestrayProductVersion testrayProductVersion) {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, TestrayProductVersion> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<TestrayProductVersionPersistence, TestrayProductVersionPersistence> _serviceTracker =
		ServiceTrackerFactory.open(TestrayProductVersionPersistence.class);
}