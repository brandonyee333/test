...
public class TestrayRunUtil {
	...
	private static ServiceTracker<TestrayRunPersistence, TestrayRunPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(TestrayRunPersistence.class);

		ServiceTracker<TestrayRunPersistence, TestrayRunPersistence>
			serviceTracker =
				new ServiceTracker
					<TestrayRunPersistence, TestrayRunPersistence>(
						bundle.getBundleContext(), TestrayRunPersistence.class,
						null);
