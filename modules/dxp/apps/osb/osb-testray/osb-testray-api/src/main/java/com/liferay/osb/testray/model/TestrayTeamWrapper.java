 ...
 */
@ProviderType
public class TestrayTeamWrapper implements TestrayTeam,
	ModelWrapper<TestrayTeam> {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<TestrayTeam> toCacheModel() {
