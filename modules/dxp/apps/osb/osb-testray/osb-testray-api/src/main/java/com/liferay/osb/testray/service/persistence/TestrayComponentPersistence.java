 ...
 */
@ProviderType
public interface TestrayComponentPersistence extends BasePersistence<TestrayComponent> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public TestrayComponent findByTPI_N(long testrayProjectId,
		java.lang.String name) throws NoSuchTestrayComponentException;
	...
	*/
	public TestrayComponent fetchByTPI_N(long testrayProjectId,
	...
	*/
	public TestrayComponent removeByTPI_N(long testrayProjectId,
		java.lang.String name) throws NoSuchTestrayComponentException;
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TestrayComponent> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<TestrayComponent> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TestrayComponent> orderByComparator);
