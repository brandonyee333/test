...
/**
 * The persistence utility for the testray case service. This utility wraps {@link com.liferay.osb.testray.service.persistence.impl.TestrayCasePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.liferay.osb.testray.service.persistence.impl.TestrayCasePersistenceImpl
 * @generated
 */
@ProviderType
public class TestrayCaseUtil {
	...
	*/
	public static TestrayCase findByTPI_N(long testrayProjectId,
	...
	*/
	public static TestrayCase fetchByTPI_N(long testrayProjectId,
		java.lang.String name) {
	...
	*/
	public static TestrayCase removeByTPI_N(long testrayProjectId,
		java.lang.String name)
		throws com.liferay.osb.testray.exception.NoSuchTestrayCaseException {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, TestrayCase> fetchByPrimaryKeys(
	...
	*/
	public static List<com.liferay.osb.testray.model.TestrayBuild> getTestrayBuilds(
		long pk) {
	...
	*/
	public static List<com.liferay.osb.testray.model.TestrayBuild> getTestrayBuilds(
		...
		return getPersistence()
				   .getTestrayBuilds(pk, start, end, orderByComparator);
	}
	...
	*/
	public static void addTestrayBuild(long pk,
	...
	*/
	public static void addTestrayBuilds(long pk,
	...
	* @param testrayBuild the testray build
	*/
	public static void removeTestrayBuild(long pk,
		com.liferay.osb.testray.model.TestrayBuild testrayBuild) {
	...
	* @param testrayBuilds the testray builds
	*/
	public static void removeTestrayBuilds(long pk,
		List<com.liferay.osb.testray.model.TestrayBuild> testrayBuilds) {
	...
	*/
	public static void setTestrayBuilds(long pk,
		List<com.liferay.osb.testray.model.TestrayBuild> testrayBuilds) {
	...
	*/
	public static List<com.liferay.osb.testray.model.TestrayComponent> getTestrayComponents(
		long pk) {
	...
	*/
	public static List<com.liferay.osb.testray.model.TestrayComponent> getTestrayComponents(
		...
		return getPersistence()
				   .getTestrayComponents(pk, start, end, orderByComparator);
	}
	...
	*/
	public static boolean containsTestrayComponent(long pk,
		long testrayComponentPK) {
		return getPersistence().containsTestrayComponent(pk, testrayComponentPK);
	}
	...
	*/
	public static void addTestrayComponent(long pk,
	...
	*/
	public static void addTestrayComponents(long pk, long[] testrayComponentPKs) {
	...
	*/
	public static void addTestrayComponents(long pk,
	...
	* @param testrayComponentPK the primary key of the testray component
	*/
	public static void removeTestrayComponent(long pk, long testrayComponentPK) {
	...
	* @param testrayComponent the testray component
	*/
	public static void removeTestrayComponent(long pk,
		com.liferay.osb.testray.model.TestrayComponent testrayComponent) {
	...
	* @param testrayComponentPKs the primary keys of the testray components
	*/
	public static void removeTestrayComponents(long pk,
		long[] testrayComponentPKs) {
	...
	*/
	public static void setTestrayComponents(long pk, long[] testrayComponentPKs) {
	...
	*/
	public static void setTestrayComponents(long pk,
		List<com.liferay.osb.testray.model.TestrayComponent> testrayComponents) {
	...
	*/
	public static List<com.liferay.osb.testray.model.TestrayRequirement> getTestrayRequirements(
		long pk) {
	...
	*/
	public static List<com.liferay.osb.testray.model.TestrayRequirement> getTestrayRequirements(
		...
		return getPersistence()
				   .getTestrayRequirements(pk, start, end, orderByComparator);
	}
	...
	*/
	public static boolean containsTestrayRequirement(long pk,
		long testrayRequirementPK) {
		return getPersistence()
				   .containsTestrayRequirement(pk, testrayRequirementPK);
	}
	...
	* @param testrayRequirementPK the primary key of the testray requirement
	*/
	public static void addTestrayRequirement(long pk, long testrayRequirementPK) {
	...
	*/
	public static void addTestrayRequirement(long pk,
	...
	*/
	public static void addTestrayRequirements(long pk,
		long[] testrayRequirementPKs) {
	...
	* @param testrayRequirementPK the primary key of the testray requirement
	*/
	public static void removeTestrayRequirement(long pk,
		long testrayRequirementPK) {
	...
	* @param testrayRequirementPKs the primary keys of the testray requirements
	*/
	public static void removeTestrayRequirements(long pk,
		long[] testrayRequirementPKs) {
	...
	*/
	public static void setTestrayRequirements(long pk,
		long[] testrayRequirementPKs) {
	...
	*/
	public static List<com.liferay.osb.testray.model.TestraySuite> getTestraySuites(
		long pk) {
	...
	*/
	public static List<com.liferay.osb.testray.model.TestraySuite> getTestraySuites(
		...
		return getPersistence()
				   .getTestraySuites(pk, start, end, orderByComparator);
	}
	...
	*/
	public static void addTestraySuite(long pk,
	...
	*/
	public static void addTestraySuites(long pk,
	...
	* @param testraySuite the testray suite
	*/
	public static void removeTestraySuite(long pk,
		com.liferay.osb.testray.model.TestraySuite testraySuite) {
	...
	* @param testraySuites the testray suites
	*/
	public static void removeTestraySuites(long pk,
		List<com.liferay.osb.testray.model.TestraySuite> testraySuites) {
	...
	*/
	public static void setTestraySuites(long pk,
		List<com.liferay.osb.testray.model.TestraySuite> testraySuites) {
	...
	private static ServiceTracker<TestrayCasePersistence, TestrayCasePersistence> _serviceTracker =
		ServiceTrackerFactory.open(TestrayCasePersistence.class);
}