 ...
 * {@link com.liferay.osb.testray.service.impl.TestrayRequirementLocalServiceImpl} and is the
 ...
 * @see com.liferay.osb.testray.service.base.TestrayRequirementLocalServiceBaseImpl
...
public class TestrayRequirementLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.testray.service.impl.TestrayRequirementLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static boolean hasTestrayCaseTestrayRequirement(long testrayCaseId,
		long testrayRequirementId) {
		return getService()
				   .hasTestrayCaseTestrayRequirement(testrayCaseId,
			testrayRequirementId);
	}

	public static boolean hasTestrayCaseTestrayRequirements(long testrayCaseId) {
	...
	*/
	public static com.liferay.osb.testray.model.TestrayRequirement addTestrayRequirement(
	...
	*/
	public static com.liferay.osb.testray.model.TestrayRequirement createTestrayRequirement(
		long testrayRequirementId) {
	...
	*/
	public static com.liferay.osb.testray.model.TestrayRequirement deleteTestrayRequirement(
		com.liferay.osb.testray.model.TestrayRequirement testrayRequirement) {
	...
	*/
	...
	public static com.liferay.osb.testray.model.TestrayRequirement fetchTestrayRequirement(
		long testrayRequirementId) {
	...
	* @throws PortalException if a testray requirement with the primary key could not be found
	*/
	public static com.liferay.osb.testray.model.TestrayRequirement getTestrayRequirement(
		long testrayRequirementId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.liferay.osb.testray.model.TestrayRequirement updateTestrayRequirement(
		com.liferay.osb.testray.model.TestrayRequirement testrayRequirement) {
	...
	*/
	...
	public static int getTestrayCaseTestrayRequirementsCount(long testrayCaseId) {
		return getService().getTestrayCaseTestrayRequirementsCount(testrayCaseId);
	}
	...
	*/
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayRequirement> getTestrayCaseTestrayRequirements(
		long testrayCaseId) {
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayRequirement> getTestrayCaseTestrayRequirements(
		...
		return getService()
				   .getTestrayCaseTestrayRequirements(testrayCaseId, start,
	...
	*/
	public static java.util.List<com.liferay.osb.testray.model.TestrayRequirement> getTestrayRequirements(
		int start, int end) {
	...
	*/
	...
	public static void addTestrayCaseTestrayRequirement(long testrayCaseId,
		com.liferay.osb.testray.model.TestrayRequirement testrayRequirement) {
		getService()
			.addTestrayCaseTestrayRequirement(testrayCaseId, testrayRequirement);
	}

	public static void addTestrayCaseTestrayRequirement(long testrayCaseId,
		long testrayRequirementId) {
		getService()
			.addTestrayCaseTestrayRequirement(testrayCaseId,
			testrayRequirementId);
	}

	public static void addTestrayCaseTestrayRequirements(long testrayCaseId,
		java.util.List<com.liferay.osb.testray.model.TestrayRequirement> testrayRequirements) {
		getService()
			.addTestrayCaseTestrayRequirements(testrayCaseId,
			testrayRequirements);
	}
	...
	public static void deleteTestrayCaseTestrayRequirement(long testrayCaseId,
		com.liferay.osb.testray.model.TestrayRequirement testrayRequirement) {
		getService()
			.deleteTestrayCaseTestrayRequirement(testrayCaseId,
			testrayRequirement);
	}
	...
	public static void deleteTestrayCaseTestrayRequirements(
		...
		java.util.List<com.liferay.osb.testray.model.TestrayRequirement> testrayRequirements) {
		getService()
			.deleteTestrayCaseTestrayRequirements(testrayCaseId,
			testrayRequirements);
	}
	...
	public static void setTestrayCaseTestrayRequirements(long testrayCaseId,
		long[] testrayRequirementIds) {
		getService()
			.setTestrayCaseTestrayRequirements(testrayCaseId,
			testrayRequirementIds);
	}
	...
	private static ServiceTracker<TestrayRequirementLocalService, TestrayRequirementLocalService> _serviceTracker =
		ServiceTrackerFactory.open(TestrayRequirementLocalService.class);
}