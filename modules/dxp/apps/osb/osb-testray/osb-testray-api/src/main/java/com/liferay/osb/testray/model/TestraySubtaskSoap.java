...
public class TestraySubtaskSoap implements Serializable {
	public static TestraySubtaskSoap toSoapModel(TestraySubtask model) {
		...
		soapModel.setMergedToTestraySubtaskId(model.getMergedToTestraySubtaskId());
		soapModel.setSplitFromTestraySubtaskId(model.getSplitFromTestraySubtaskId());
	...
	public static TestraySubtaskSoap[][] toSoapModels(TestraySubtask[][] models) {
		...
		if (models.length > 0) {
			soapModels = new TestraySubtaskSoap[models.length][models[0].length];
		}
		else {
	...
	public static TestraySubtaskSoap[] toSoapModels(List<TestraySubtask> models) {
		List<TestraySubtaskSoap> soapModels = new ArrayList<TestraySubtaskSoap>(models.size());
