 ...
 * @generated
 */
public class TestrayBuildLocalServiceWrapper
	implements ServiceWrapper<TestrayBuildLocalService>,
	...
	public void addTestrayCaseTestrayBuild(
		...
		_testrayBuildLocalService.addTestrayCaseTestrayBuild(
	...
	public void addTestrayCaseTestrayBuilds(
		...
		_testrayBuildLocalService.addTestrayCaseTestrayBuilds(
	...
	public void deleteTestrayCaseTestrayBuild(
		...
		_testrayBuildLocalService.deleteTestrayCaseTestrayBuild(
			testrayCaseId, testrayBuildId);
	}
	...
	public void deleteTestrayCaseTestrayBuilds(
		...
		_testrayBuildLocalService.deleteTestrayCaseTestrayBuilds(
			testrayCaseId, testrayBuilds);
	}
	...
	public long dynamicQueryCount(
		...
		return _testrayBuildLocalService.dynamicQueryCount(
	...
	public long[] getTestrayCasePrimaryKeys(long testrayBuildId) {
		return _testrayBuildLocalService.getTestrayCasePrimaryKeys(
			testrayBuildId);
	}
	...
	public java.util.List<com.liferay.osb.testray.model.TestrayBuild>
		...
		return _testrayBuildLocalService.getTestrayCaseTestrayBuilds(
			testrayCaseId);
	}
	...
	public int getTestrayCaseTestrayBuildsCount(long testrayCaseId) {
		return _testrayBuildLocalService.getTestrayCaseTestrayBuildsCount(
			testrayCaseId);
	}
	...
	public boolean hasTestrayCaseTestrayBuild(
		...
		return _testrayBuildLocalService.hasTestrayCaseTestrayBuild(
			testrayCaseId, testrayBuildId);
	}

	@Override
	public boolean hasTestrayCaseTestrayBuilds(long testrayCaseId) {
		return _testrayBuildLocalService.hasTestrayCaseTestrayBuilds(
			testrayCaseId);
	}
	...
	public void setTestrayCaseTestrayBuilds(
		...
		_testrayBuildLocalService.setTestrayCaseTestrayBuilds(
			testrayCaseId, testrayBuildIds);
	}
