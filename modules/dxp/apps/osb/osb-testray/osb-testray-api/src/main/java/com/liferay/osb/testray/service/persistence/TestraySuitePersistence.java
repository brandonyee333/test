...
public interface TestraySuitePersistence extends BasePersistence<TestraySuite> {
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TestraySuite> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<TestraySuite> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TestraySuite> orderByComparator);
