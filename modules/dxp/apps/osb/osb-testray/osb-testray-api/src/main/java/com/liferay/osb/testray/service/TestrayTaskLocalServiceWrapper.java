 ...
 */
@ProviderType
public class TestrayTaskLocalServiceWrapper implements TestrayTaskLocalService,
	ServiceWrapper<TestrayTaskLocalService> {
	...
	@Override
	public boolean hasTestrayCaseTypeTestrayTask(long testrayCaseTypeId,
		long testrayTaskId) {
		return _testrayTaskLocalService.hasTestrayCaseTypeTestrayTask(testrayCaseTypeId,
			testrayTaskId);
	}

	@Override
	public boolean hasTestrayCaseTypeTestrayTasks(long testrayCaseTypeId) {
		return _testrayTaskLocalService.hasTestrayCaseTypeTestrayTasks(testrayCaseTypeId);
	}
	...
	*/
	...
	public int getTestrayCaseTypeTestrayTasksCount(long testrayCaseTypeId) {
		return _testrayTaskLocalService.getTestrayCaseTypeTestrayTasksCount(testrayCaseTypeId);
	}
	...
	*/
	...
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayTask> getTestrayCaseTypeTestrayTasks(
		long testrayCaseTypeId) {
		return _testrayTaskLocalService.getTestrayCaseTypeTestrayTasks(testrayCaseTypeId);
	}
	...
	*/
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayTask> getTestrayTasks(
		int start, int end) {
	...
	*/
	...
	public long[] getTestrayCaseTypePrimaryKeys(long testrayTaskId) {
		return _testrayTaskLocalService.getTestrayCaseTypePrimaryKeys(testrayTaskId);
	}

	@Override
	public void addTestrayCaseTypeTestrayTask(long testrayCaseTypeId,
		com.liferay.osb.testray.model.TestrayTask testrayTask) {
		_testrayTaskLocalService.addTestrayCaseTypeTestrayTask(testrayCaseTypeId,
			testrayTask);
	}
	...
	@Override
	public void addTestrayCaseTypeTestrayTasks(long testrayCaseTypeId,
		java.util.List<com.liferay.osb.testray.model.TestrayTask> testrayTasks) {
		_testrayTaskLocalService.addTestrayCaseTypeTestrayTasks(testrayCaseTypeId,
			testrayTasks);
	}
	...
	public void clearTestrayCaseTypeTestrayTasks(long testrayCaseTypeId) {
		_testrayTaskLocalService.clearTestrayCaseTypeTestrayTasks(testrayCaseTypeId);
	}

	@Override
	public void deleteTestrayCaseTypeTestrayTask(long testrayCaseTypeId,
		com.liferay.osb.testray.model.TestrayTask testrayTask) {
		_testrayTaskLocalService.deleteTestrayCaseTypeTestrayTask(testrayCaseTypeId,
			testrayTask);
	}
	...
	@Override
	public void deleteTestrayCaseTypeTestrayTasks(long testrayCaseTypeId,
		java.util.List<com.liferay.osb.testray.model.TestrayTask> testrayTasks) {
		_testrayTaskLocalService.deleteTestrayCaseTypeTestrayTasks(testrayCaseTypeId,
			testrayTasks);
	}
	...
	@Override
	public void setTestrayCaseTypeTestrayTasks(long testrayCaseTypeId,
		long[] testrayTaskIds) {
		_testrayTaskLocalService.setTestrayCaseTypeTestrayTasks(testrayCaseTypeId,
			testrayTaskIds);
	}
