 ...
 */
@ProviderType
public class TestrayCaseLocalServiceWrapper implements TestrayCaseLocalService,
	...
	public boolean hasTestrayBuildTestrayCase(long testrayBuildId,
		long testrayCaseId) {
		return _testrayCaseLocalService.hasTestrayBuildTestrayCase(testrayBuildId,
			testrayCaseId);
	}

	@Override
	public boolean hasTestrayBuildTestrayCases(long testrayBuildId) {
		return _testrayCaseLocalService.hasTestrayBuildTestrayCases(testrayBuildId);
	}

	@Override
	public boolean hasTestrayComponentTestrayCase(long testrayComponentId,
		long testrayCaseId) {
		return _testrayCaseLocalService.hasTestrayComponentTestrayCase(testrayComponentId,
			testrayCaseId);
	}

	@Override
	public boolean hasTestrayComponentTestrayCases(long testrayComponentId) {
		return _testrayCaseLocalService.hasTestrayComponentTestrayCases(testrayComponentId);
	}

	@Override
	public boolean hasTestrayRequirementTestrayCase(long testrayRequirementId,
		long testrayCaseId) {
		return _testrayCaseLocalService.hasTestrayRequirementTestrayCase(testrayRequirementId,
			testrayCaseId);
	}

	@Override
	public boolean hasTestrayRequirementTestrayCases(long testrayRequirementId) {
		return _testrayCaseLocalService.hasTestrayRequirementTestrayCases(testrayRequirementId);
	}

	@Override
	public boolean hasTestraySuiteTestrayCase(long testraySuiteId,
		long testrayCaseId) {
		return _testrayCaseLocalService.hasTestraySuiteTestrayCase(testraySuiteId,
			testrayCaseId);
	}

	@Override
	public boolean hasTestraySuiteTestrayCases(long testraySuiteId) {
		return _testrayCaseLocalService.hasTestraySuiteTestrayCases(testraySuiteId);
	}
	...
	*/
	...
	public int getTestrayBuildTestrayCasesCount(long testrayBuildId) {
		return _testrayCaseLocalService.getTestrayBuildTestrayCasesCount(testrayBuildId);
	}
	...
	*/
	...
	public int getTestrayComponentTestrayCasesCount(long testrayComponentId) {
		return _testrayCaseLocalService.getTestrayComponentTestrayCasesCount(testrayComponentId);
	}

	@Override
	public int getTestrayRequirementTestrayCasesCount(long testrayRequirementId) {
		return _testrayCaseLocalService.getTestrayRequirementTestrayCasesCount(testrayRequirementId);
	}

	@Override
	public int getTestraySuiteTestrayCasesCount(long testraySuiteId) {
		return _testrayCaseLocalService.getTestraySuiteTestrayCasesCount(testraySuiteId);
	}
	...
	*/
	...
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestrayBuildTestrayCases(
		long testrayBuildId) {
		return _testrayCaseLocalService.getTestrayBuildTestrayCases(testrayBuildId);
	}
	...
	*/
	...
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestrayComponentTestrayCases(
		long testrayComponentId) {
		return _testrayCaseLocalService.getTestrayComponentTestrayCases(testrayComponentId);
	}
	...
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestrayRequirementTestrayCases(
		long testrayRequirementId) {
		return _testrayCaseLocalService.getTestrayRequirementTestrayCases(testrayRequirementId);
	}
	...
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestraySuiteTestrayCases(
		long testraySuiteId) {
		return _testrayCaseLocalService.getTestraySuiteTestrayCases(testraySuiteId);
	}
	...
	*/
	...
	public long[] getTestrayBuildPrimaryKeys(long testrayCaseId) {
		return _testrayCaseLocalService.getTestrayBuildPrimaryKeys(testrayCaseId);
	}
	...
	*/
	...
	public long[] getTestrayComponentPrimaryKeys(long testrayCaseId) {
		return _testrayCaseLocalService.getTestrayComponentPrimaryKeys(testrayCaseId);
	}
	...
	*/
	...
	public long[] getTestrayRequirementPrimaryKeys(long testrayCaseId) {
		return _testrayCaseLocalService.getTestrayRequirementPrimaryKeys(testrayCaseId);
	}
	...
	*/
	...
	public long[] getTestraySuitePrimaryKeys(long testrayCaseId) {
		return _testrayCaseLocalService.getTestraySuitePrimaryKeys(testrayCaseId);
	}

	@Override
	public void addTestrayBuildTestrayCase(long testrayBuildId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		_testrayCaseLocalService.addTestrayBuildTestrayCase(testrayBuildId,
			testrayCase);
	}
	...
	public void addTestrayBuildTestrayCases(long testrayBuildId,
		...
		_testrayCaseLocalService.addTestrayBuildTestrayCases(testrayBuildId,
			testrayCases);
	}
	...
	public void addTestrayComponentTestrayCase(long testrayComponentId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		_testrayCaseLocalService.addTestrayComponentTestrayCase(testrayComponentId,
			testrayCase);
	}
	...
	public void addTestrayComponentTestrayCases(long testrayComponentId,
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		_testrayCaseLocalService.addTestrayComponentTestrayCases(testrayComponentId,
			testrayCases);
	}
	...
	public void addTestrayRequirementTestrayCase(long testrayRequirementId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		_testrayCaseLocalService.addTestrayRequirementTestrayCase(testrayRequirementId,
			testrayCase);
	}
	...
	public void addTestrayRequirementTestrayCases(long testrayRequirementId,
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		_testrayCaseLocalService.addTestrayRequirementTestrayCases(testrayRequirementId,
			testrayCases);
	}
	...
	public void addTestraySuiteTestrayCase(long testraySuiteId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		_testrayCaseLocalService.addTestraySuiteTestrayCase(testraySuiteId,
			testrayCase);
	}
	...
	public void addTestraySuiteTestrayCases(long testraySuiteId,
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		_testrayCaseLocalService.addTestraySuiteTestrayCases(testraySuiteId,
			testrayCases);
	}
	...
	public void clearTestrayComponentTestrayCases(long testrayComponentId) {
		_testrayCaseLocalService.clearTestrayComponentTestrayCases(testrayComponentId);
	}

	@Override
	public void clearTestrayRequirementTestrayCases(long testrayRequirementId) {
		_testrayCaseLocalService.clearTestrayRequirementTestrayCases(testrayRequirementId);
	}
	...
	public void deleteTestrayBuildTestrayCase(long testrayBuildId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		_testrayCaseLocalService.deleteTestrayBuildTestrayCase(testrayBuildId,
			testrayCase);
	}
	...
	public void deleteTestrayBuildTestrayCases(long testrayBuildId,
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		_testrayCaseLocalService.deleteTestrayBuildTestrayCases(testrayBuildId,
			testrayCases);
	}
	...
	public void deleteTestrayComponentTestrayCase(long testrayComponentId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		_testrayCaseLocalService.deleteTestrayComponentTestrayCase(testrayComponentId,
			testrayCase);
	}
	...
	public void deleteTestrayComponentTestrayCases(long testrayComponentId,
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		_testrayCaseLocalService.deleteTestrayComponentTestrayCases(testrayComponentId,
			testrayCases);
	}
	...
	public void deleteTestrayRequirementTestrayCase(long testrayRequirementId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		_testrayCaseLocalService.deleteTestrayRequirementTestrayCase(testrayRequirementId,
			testrayCase);
	}
	...
	public void deleteTestrayRequirementTestrayCases(
		long testrayRequirementId,
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		_testrayCaseLocalService.deleteTestrayRequirementTestrayCases(testrayRequirementId,
			testrayCases);
	}
	...
	public void deleteTestraySuiteTestrayCase(long testraySuiteId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		_testrayCaseLocalService.deleteTestraySuiteTestrayCase(testraySuiteId,
			testrayCase);
	}
	...
	public void deleteTestraySuiteTestrayCases(long testraySuiteId,
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		_testrayCaseLocalService.deleteTestraySuiteTestrayCases(testraySuiteId,
			testrayCases);
	}
	...
	public void setTestrayBuildTestrayCases(long testrayBuildId,
		long[] testrayCaseIds) {
		_testrayCaseLocalService.setTestrayBuildTestrayCases(testrayBuildId,
			testrayCaseIds);
	}
	...
	public void setTestrayComponentTestrayCases(long testrayComponentId,
		long[] testrayCaseIds) {
		_testrayCaseLocalService.setTestrayComponentTestrayCases(testrayComponentId,
			testrayCaseIds);
	}
	...
	public void setTestrayRequirementTestrayCases(long testrayRequirementId,
		long[] testrayCaseIds) {
		_testrayCaseLocalService.setTestrayRequirementTestrayCases(testrayRequirementId,
			testrayCaseIds);
	}
	...
	public void setTestraySuiteTestrayCases(long testraySuiteId,
		long[] testrayCaseIds) {
		_testrayCaseLocalService.setTestraySuiteTestrayCases(testraySuiteId,
			testrayCaseIds);
	}
