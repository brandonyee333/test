...
/**
 * Provides the local service interface for TestrayBuildMetric. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethan Bustad
 * @see TestrayBuildMetricLocalServiceUtil
...
public interface TestrayBuildMetricLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestrayBuildMetricLocalServiceUtil} to access the testray build metric local service. Add custom service methods to {@link com.liferay.osb.testray.service.impl.TestrayBuildMetricLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public TestrayBuildMetric addTestrayBuildMetric(
	...
	*/
	public TestrayBuildMetric createTestrayBuildMetric(
	...
	*/
	...
	public TestrayBuildMetric deleteTestrayBuildMetric(
		long testrayBuildMetricId) throws PortalException;
	...
	*/
	...
	public TestrayBuildMetric fetchTestrayBuildMetric(long testrayBuildMetricId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TestrayBuildMetric getTestrayBuildMetric(long testrayBuildMetricId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TestrayBuildMetric> getTestrayBuildMetrics(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public TestrayBuildMetric updateTestrayBuildMetric(
		TestrayBuildMetric testrayBuildMetric);
}