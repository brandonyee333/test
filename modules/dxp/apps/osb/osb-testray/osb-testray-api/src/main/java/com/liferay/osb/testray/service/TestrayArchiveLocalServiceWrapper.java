...
public class TestrayArchiveLocalServiceWrapper
	implements ServiceWrapper<TestrayArchiveLocalService>,
	...
	@Override
	public java.io.InputStream openCompressedDataInputStream(
		long testrayArchiveId) {

		return _testrayArchiveLocalService.openCompressedDataInputStream(
			testrayArchiveId);
	}
