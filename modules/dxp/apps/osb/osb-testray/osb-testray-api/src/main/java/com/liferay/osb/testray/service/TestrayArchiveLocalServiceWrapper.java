...
public class TestrayArchiveLocalServiceWrapper
	...
	*/
	...
	public com.liferay.osb.testray.model.TestrayArchive createTestrayArchive(
		...
		return _testrayArchiveLocalService.createTestrayArchive(testrayArchiveId);
	}
	...
	*/
	...
	public com.liferay.osb.testray.model.TestrayArchive deleteTestrayArchive(
		...
		return _testrayArchiveLocalService.deleteTestrayArchive(testrayArchiveId);
	}

	@Override
	public com.liferay.osb.testray.model.TestrayArchive fetchTestrayArchive(
		long testrayArchiveId) {
		return _testrayArchiveLocalService.fetchTestrayArchive(testrayArchiveId);
	}
	...
	*/
	...
	@Override
	public com.liferay.osb.testray.model.TestrayArchiveCompressedDataBlobModel getCompressedDataBlobModel(
		java.io.Serializable primaryKey) {
		return _testrayArchiveLocalService.getCompressedDataBlobModel(primaryKey);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _testrayArchiveLocalService.dynamicQuery(dynamicQuery, start, end);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _testrayArchiveLocalService.dynamicQuery(dynamicQuery, start,
	...
	*/
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayArchive> getTestrayArchives(
		int start, int end) {
