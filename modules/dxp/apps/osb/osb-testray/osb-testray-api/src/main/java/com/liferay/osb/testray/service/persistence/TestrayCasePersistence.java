...
public interface TestrayCasePersistence extends BasePersistence<TestrayCase> {
	...
	*/
	public TestrayCase findByTPI_N(long testrayProjectId, java.lang.String name)
	...
	*/
	public TestrayCase fetchByTPI_N(long testrayProjectId, java.lang.String name);
	...
	* @return the matching testray case, or <code>null</code> if a matching testray case could not be found
	*/
	public TestrayCase fetchByTPI_N(long testrayProjectId,
	...
	*/
	public TestrayCase removeByTPI_N(long testrayProjectId,
		java.lang.String name) throws NoSuchTestrayCaseException;
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TestrayCase> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<TestrayCase> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TestrayCase> orderByComparator);
