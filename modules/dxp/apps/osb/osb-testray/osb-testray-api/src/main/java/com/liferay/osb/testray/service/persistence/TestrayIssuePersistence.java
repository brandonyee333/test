...
public interface TestrayIssuePersistence extends BasePersistence<TestrayIssue> {
	...
	*/
	public TestrayIssue findByName(java.lang.String name)
	...
	*/
	public TestrayIssue fetchByName(java.lang.String name);
	...
	*/
	public TestrayIssue removeByName(java.lang.String name)
		throws NoSuchTestrayIssueException;
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TestrayIssue> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<TestrayIssue> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TestrayIssue> orderByComparator);
