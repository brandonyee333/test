 ...
 * {@link com.liferay.osb.testray.service.impl.TestrayTaskLocalServiceImpl} and is the
 ...
 * @see com.liferay.osb.testray.service.base.TestrayTaskLocalServiceBaseImpl
...
public class TestrayTaskLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.testray.service.impl.TestrayTaskLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static boolean hasTestrayCaseTypeTestrayTask(
		long testrayCaseTypeId, long testrayTaskId) {
		return getService()
				   .hasTestrayCaseTypeTestrayTask(testrayCaseTypeId,
			testrayTaskId);
	}

	public static boolean hasTestrayCaseTypeTestrayTasks(long testrayCaseTypeId) {
	...
	*/
	...
	public static int getTestrayCaseTypeTestrayTasksCount(
		...
		return getService()
				   .getTestrayCaseTypeTestrayTasksCount(testrayCaseTypeId);
	}
	...
	*/
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayTask> getTestrayCaseTypeTestrayTasks(
		long testrayCaseTypeId) {
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayTask> getTestrayCaseTypeTestrayTasks(
		...
		return getService()
				   .getTestrayCaseTypeTestrayTasks(testrayCaseTypeId, start, end);
	}

	public static java.util.List<com.liferay.osb.testray.model.TestrayTask> getTestrayCaseTypeTestrayTasks(
		long testrayCaseTypeId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.osb.testray.model.TestrayTask> orderByComparator) {
		return getService()
				   .getTestrayCaseTypeTestrayTasks(testrayCaseTypeId, start,
	...
	*/
	public static java.util.List<com.liferay.osb.testray.model.TestrayTask> getTestrayTasks(
		int start, int end) {
	...
	*/
	...
	public static void addTestrayCaseTypeTestrayTask(long testrayCaseTypeId,
		com.liferay.osb.testray.model.TestrayTask testrayTask) {
		getService()
			.addTestrayCaseTypeTestrayTask(testrayCaseTypeId, testrayTask);
	}

	public static void addTestrayCaseTypeTestrayTask(long testrayCaseTypeId,
		long testrayTaskId) {
		getService()
			.addTestrayCaseTypeTestrayTask(testrayCaseTypeId, testrayTaskId);
	}

	public static void addTestrayCaseTypeTestrayTasks(long testrayCaseTypeId,
		java.util.List<com.liferay.osb.testray.model.TestrayTask> testrayTasks) {
		getService()
			.addTestrayCaseTypeTestrayTasks(testrayCaseTypeId, testrayTasks);
	}

	public static void addTestrayCaseTypeTestrayTasks(long testrayCaseTypeId,
		long[] testrayTaskIds) {
		getService()
			.addTestrayCaseTypeTestrayTasks(testrayCaseTypeId, testrayTaskIds);
	}

	public static void clearTestrayCaseTypeTestrayTasks(long testrayCaseTypeId) {
	...
	public static void deleteTestrayCaseTypeTestrayTask(
		...
		com.liferay.osb.testray.model.TestrayTask testrayTask) {
		getService()
			.deleteTestrayCaseTypeTestrayTask(testrayCaseTypeId, testrayTask);
	}

	public static void deleteTestrayCaseTypeTestrayTask(
		long testrayCaseTypeId, long testrayTaskId) {
		getService()
			.deleteTestrayCaseTypeTestrayTask(testrayCaseTypeId, testrayTaskId);
	}
	...
	public static void deleteTestrayCaseTypeTestrayTasks(
		...
		java.util.List<com.liferay.osb.testray.model.TestrayTask> testrayTasks) {
		getService()
			.deleteTestrayCaseTypeTestrayTasks(testrayCaseTypeId, testrayTasks);
	}

	public static void deleteTestrayCaseTypeTestrayTasks(
		long testrayCaseTypeId, long[] testrayTaskIds) {
		getService()
			.deleteTestrayCaseTypeTestrayTasks(testrayCaseTypeId, testrayTaskIds);
	}

	public static void setTestrayCaseTypeTestrayTasks(long testrayCaseTypeId,
		long[] testrayTaskIds) {
		getService()
			.setTestrayCaseTypeTestrayTasks(testrayCaseTypeId, testrayTaskIds);
	}
	...
	private static ServiceTracker<TestrayTaskLocalService, TestrayTaskLocalService> _serviceTracker =
		ServiceTrackerFactory.open(TestrayTaskLocalService.class);
}