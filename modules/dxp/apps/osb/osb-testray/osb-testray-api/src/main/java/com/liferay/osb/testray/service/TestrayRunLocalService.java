...
/**
 * Provides the local service interface for TestrayRun. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethan Bustad
 * @see TestrayRunLocalServiceUtil
...
public interface TestrayRunLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestrayRunLocalServiceUtil} to access the testray run local service. Add custom service methods to {@link com.liferay.osb.testray.service.impl.TestrayRunLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TestrayRun getTestrayRun(long testrayRunId)
		throws PortalException;
