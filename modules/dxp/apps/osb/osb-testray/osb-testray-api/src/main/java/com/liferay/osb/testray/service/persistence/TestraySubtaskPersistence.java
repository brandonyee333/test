 ...
 */
@ProviderType
public interface TestraySubtaskPersistence extends BasePersistence<TestraySubtask> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TestraySubtask> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<TestraySubtask> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TestraySubtask> orderByComparator);
