 ...
 */
@ProviderType
public interface TestrayRequirementPersistence extends BasePersistence<TestrayRequirement> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public TestrayRequirement findByTPI_K(long testrayProjectId,
		java.lang.String key) throws NoSuchTestrayRequirementException;
	...
	*/
	public TestrayRequirement fetchByTPI_K(long testrayProjectId,
	...
	*/
	public TestrayRequirement removeByTPI_K(long testrayProjectId,
		java.lang.String key) throws NoSuchTestrayRequirementException;
	...
	*/
	public int countByTPI_K(long testrayProjectId, java.lang.String key);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TestrayRequirement> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<TestrayRequirement> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TestrayRequirement> orderByComparator);
