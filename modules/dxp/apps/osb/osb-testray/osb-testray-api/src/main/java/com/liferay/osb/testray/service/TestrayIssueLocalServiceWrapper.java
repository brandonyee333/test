 ...
 */
@ProviderType
public class TestrayIssueLocalServiceWrapper implements TestrayIssueLocalService,
	ServiceWrapper<TestrayIssueLocalService> {
	...
	public boolean hasTestrayCaseResultTestrayIssue(long testrayCaseResultId,
		long testrayIssueId) {
		return _testrayIssueLocalService.hasTestrayCaseResultTestrayIssue(testrayCaseResultId,
			testrayIssueId);
	}

	@Override
	public boolean hasTestrayCaseResultTestrayIssues(long testrayCaseResultId) {
		return _testrayIssueLocalService.hasTestrayCaseResultTestrayIssues(testrayCaseResultId);
	}

	@Override
	public boolean hasTestraySubtaskTestrayIssue(long testraySubtaskId,
		long testrayIssueId) {
		return _testrayIssueLocalService.hasTestraySubtaskTestrayIssue(testraySubtaskId,
			testrayIssueId);
	}

	@Override
	public boolean hasTestraySubtaskTestrayIssues(long testraySubtaskId) {
		return _testrayIssueLocalService.hasTestraySubtaskTestrayIssues(testraySubtaskId);
	}
	...
	*/
	...
	public int getTestrayCaseResultTestrayIssuesCount(long testrayCaseResultId) {
		return _testrayIssueLocalService.getTestrayCaseResultTestrayIssuesCount(testrayCaseResultId);
	}
	...
	*/
	...
	public int getTestraySubtaskTestrayIssuesCount(long testraySubtaskId) {
		return _testrayIssueLocalService.getTestraySubtaskTestrayIssuesCount(testraySubtaskId);
	}
	...
	*/
	...
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayIssue> getTestrayCaseResultTestrayIssues(
		long testrayCaseResultId) {
		return _testrayIssueLocalService.getTestrayCaseResultTestrayIssues(testrayCaseResultId);
	}
	...
	*/
	...
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayIssue> getTestraySubtaskTestrayIssues(
		long testraySubtaskId) {
		return _testrayIssueLocalService.getTestraySubtaskTestrayIssues(testraySubtaskId);
	}
	...
	*/
	...
	public long[] getTestrayCaseResultPrimaryKeys(long testrayIssueId) {
		return _testrayIssueLocalService.getTestrayCaseResultPrimaryKeys(testrayIssueId);
	}
	...
	*/
	...
	public long[] getTestraySubtaskPrimaryKeys(long testrayIssueId) {
		return _testrayIssueLocalService.getTestraySubtaskPrimaryKeys(testrayIssueId);
	}

	@Override
	public void addTestrayCaseResultTestrayIssue(long testrayCaseResultId,
		com.liferay.osb.testray.model.TestrayIssue testrayIssue) {
		_testrayIssueLocalService.addTestrayCaseResultTestrayIssue(testrayCaseResultId,
			testrayIssue);
	}
	...
	public void addTestrayCaseResultTestrayIssues(long testrayCaseResultId,
		...
		_testrayIssueLocalService.addTestrayCaseResultTestrayIssues(testrayCaseResultId,
			testrayIssues);
	}
	...
	public void addTestraySubtaskTestrayIssue(long testraySubtaskId,
		com.liferay.osb.testray.model.TestrayIssue testrayIssue) {
		_testrayIssueLocalService.addTestraySubtaskTestrayIssue(testraySubtaskId,
			testrayIssue);
	}
	...
	public void addTestraySubtaskTestrayIssues(long testraySubtaskId,
		java.util.List<com.liferay.osb.testray.model.TestrayIssue> testrayIssues) {
		_testrayIssueLocalService.addTestraySubtaskTestrayIssues(testraySubtaskId,
			testrayIssues);
	}
	...
	public void clearTestrayCaseResultTestrayIssues(long testrayCaseResultId) {
		_testrayIssueLocalService.clearTestrayCaseResultTestrayIssues(testrayCaseResultId);
	}

	@Override
	public void clearTestraySubtaskTestrayIssues(long testraySubtaskId) {
		_testrayIssueLocalService.clearTestraySubtaskTestrayIssues(testraySubtaskId);
	}

	@Override
	public void deleteTestrayCaseResultTestrayIssue(long testrayCaseResultId,
		com.liferay.osb.testray.model.TestrayIssue testrayIssue) {
		_testrayIssueLocalService.deleteTestrayCaseResultTestrayIssue(testrayCaseResultId,
			testrayIssue);
	}
	...
	public void deleteTestrayCaseResultTestrayIssues(long testrayCaseResultId,
		java.util.List<com.liferay.osb.testray.model.TestrayIssue> testrayIssues) {
		_testrayIssueLocalService.deleteTestrayCaseResultTestrayIssues(testrayCaseResultId,
			testrayIssues);
	}
	...
	public void deleteTestraySubtaskTestrayIssue(long testraySubtaskId,
		com.liferay.osb.testray.model.TestrayIssue testrayIssue) {
		_testrayIssueLocalService.deleteTestraySubtaskTestrayIssue(testraySubtaskId,
			testrayIssue);
	}
	...
	public void deleteTestraySubtaskTestrayIssues(long testraySubtaskId,
		java.util.List<com.liferay.osb.testray.model.TestrayIssue> testrayIssues) {
		_testrayIssueLocalService.deleteTestraySubtaskTestrayIssues(testraySubtaskId,
			testrayIssues);
	}
	...
	public void setTestrayCaseResultTestrayIssues(long testrayCaseResultId,
		long[] testrayIssueIds) {
		_testrayIssueLocalService.setTestrayCaseResultTestrayIssues(testrayCaseResultId,
			testrayIssueIds);
	}
	...
	public void setTestraySubtaskTestrayIssues(long testraySubtaskId,
		long[] testrayIssueIds) {
		_testrayIssueLocalService.setTestraySubtaskTestrayIssues(testraySubtaskId,
			testrayIssueIds);
	}
