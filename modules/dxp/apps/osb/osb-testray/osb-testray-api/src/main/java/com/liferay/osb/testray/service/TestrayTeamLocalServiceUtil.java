 ...
 * {@link com.liferay.osb.testray.service.impl.TestrayTeamLocalServiceImpl} and is the
...
public class TestrayTeamLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.testray.service.impl.TestrayTeamLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<com.liferay.osb.testray.model.TestrayTeam> getTestrayTeams(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<TestrayTeamLocalService, TestrayTeamLocalService> _serviceTracker =
		ServiceTrackerFactory.open(TestrayTeamLocalService.class);
}