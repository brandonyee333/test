...
public class TestrayCaseTypeLocalServiceWrapper
	...
	@Override
	public boolean hasTestrayTaskTestrayCaseType(long testrayTaskId,
		long testrayCaseTypeId) {
		return _testrayCaseTypeLocalService.hasTestrayTaskTestrayCaseType(testrayTaskId,
			testrayCaseTypeId);
	}

	@Override
	public boolean hasTestrayTaskTestrayCaseTypes(long testrayTaskId) {
		return _testrayCaseTypeLocalService.hasTestrayTaskTestrayCaseTypes(testrayTaskId);
	}
	...
	*/
	...
	public com.liferay.osb.testray.model.TestrayCaseType createTestrayCaseType(
		long testrayCaseTypeId) {
		return _testrayCaseTypeLocalService.createTestrayCaseType(testrayCaseTypeId);
	}
	...
	*/
	...
	public com.liferay.osb.testray.model.TestrayCaseType deleteTestrayCaseType(
		com.liferay.osb.testray.model.TestrayCaseType testrayCaseType) {
		return _testrayCaseTypeLocalService.deleteTestrayCaseType(testrayCaseType);
	}
	...
	*/
	...
	public com.liferay.osb.testray.model.TestrayCaseType deleteTestrayCaseType(
		...
		return _testrayCaseTypeLocalService.deleteTestrayCaseType(testrayCaseTypeId);
	}

	@Override
	public com.liferay.osb.testray.model.TestrayCaseType fetchTestrayCaseType(
		long testrayCaseTypeId) {
		return _testrayCaseTypeLocalService.fetchTestrayCaseType(testrayCaseTypeId);
	}
	...
	*/
	...
	public com.liferay.osb.testray.model.TestrayCaseType getTestrayCaseType(
		long testrayCaseTypeId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _testrayCaseTypeLocalService.getTestrayCaseType(testrayCaseTypeId);
	}
	...
	*/
	...
	public com.liferay.osb.testray.model.TestrayCaseType updateTestrayCaseType(
		com.liferay.osb.testray.model.TestrayCaseType testrayCaseType) {
		return _testrayCaseTypeLocalService.updateTestrayCaseType(testrayCaseType);
	}
	...
	public com.liferay.portal.kernel.dao.orm.IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		return _testrayCaseTypeLocalService.getIndexableActionableDynamicQuery();
	}
	...
	*/
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return _testrayCaseTypeLocalService.deletePersistedModel(persistedModel);
	}
	...
	*/
	...
	public int getTestrayTaskTestrayCaseTypesCount(long testrayTaskId) {
		return _testrayCaseTypeLocalService.getTestrayTaskTestrayCaseTypesCount(testrayTaskId);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _testrayCaseTypeLocalService.dynamicQuery(dynamicQuery, start,
			end);
	}
	...
	*/
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayCaseType> getTestrayCaseTypes(
		int start, int end) {
		return _testrayCaseTypeLocalService.getTestrayCaseTypes(start, end);
	}

	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayCaseType> getTestrayTaskTestrayCaseTypes(
		long testrayTaskId) {
		return _testrayCaseTypeLocalService.getTestrayTaskTestrayCaseTypes(testrayTaskId);
	}
	...
	*/
	...
	public long[] getTestrayTaskPrimaryKeys(long testrayCaseTypeId) {
		return _testrayCaseTypeLocalService.getTestrayTaskPrimaryKeys(testrayCaseTypeId);
	}

	@Override
	public void addTestrayTaskTestrayCaseType(long testrayTaskId,
		com.liferay.osb.testray.model.TestrayCaseType testrayCaseType) {
		_testrayCaseTypeLocalService.addTestrayTaskTestrayCaseType(testrayTaskId,
			testrayCaseType);
	}
	...
	@Override
	public void addTestrayTaskTestrayCaseTypes(long testrayTaskId,
		java.util.List<com.liferay.osb.testray.model.TestrayCaseType> testrayCaseTypes) {
		_testrayCaseTypeLocalService.addTestrayTaskTestrayCaseTypes(testrayTaskId,
			testrayCaseTypes);
	}
	...
	public void clearTestrayTaskTestrayCaseTypes(long testrayTaskId) {
		_testrayCaseTypeLocalService.clearTestrayTaskTestrayCaseTypes(testrayTaskId);
	}

	@Override
	public void deleteTestrayTaskTestrayCaseType(long testrayTaskId,
		com.liferay.osb.testray.model.TestrayCaseType testrayCaseType) {
		_testrayCaseTypeLocalService.deleteTestrayTaskTestrayCaseType(testrayTaskId,
			testrayCaseType);
	}
	...
	@Override
	public void deleteTestrayTaskTestrayCaseTypes(long testrayTaskId,
		java.util.List<com.liferay.osb.testray.model.TestrayCaseType> testrayCaseTypes) {
		_testrayCaseTypeLocalService.deleteTestrayTaskTestrayCaseTypes(testrayTaskId,
			testrayCaseTypes);
	}
	...
	@Override
	public void setTestrayTaskTestrayCaseTypes(long testrayTaskId,
		long[] testrayCaseTypeIds) {
		_testrayCaseTypeLocalService.setTestrayTaskTestrayCaseTypes(testrayTaskId,
			testrayCaseTypeIds);
	}
