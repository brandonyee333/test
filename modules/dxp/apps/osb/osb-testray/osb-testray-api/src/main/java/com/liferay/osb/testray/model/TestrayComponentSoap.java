...
public class TestrayComponentSoap implements Serializable {
	...
	public static TestrayComponentSoap[] toSoapModels(TestrayComponent[] models) {
		TestrayComponentSoap[] soapModels = new TestrayComponentSoap[models.length];
	...
	public static TestrayComponentSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels = new TestrayComponentSoap[models.length][models[0].length];
		}
		else {
	...
	public static TestrayComponentSoap[] toSoapModels(
		...
		List<TestrayComponentSoap> soapModels = new ArrayList<TestrayComponentSoap>(models.size());
