...
/**
 * Provides the local service interface for TestrayFactorCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethan Bustad
 * @see TestrayFactorCategoryLocalServiceUtil
...
public interface TestrayFactorCategoryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestrayFactorCategoryLocalServiceUtil} to access the testray factor category local service. Add custom service methods to {@link com.liferay.osb.testray.service.impl.TestrayFactorCategoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public TestrayFactorCategory deleteTestrayFactorCategory(
		long testrayFactorCategoryId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TestrayFactorCategory> getTestrayFactorCategories(int start,
		int end);
