...
public class TestrayFactorUtil {
	...
	public static TestrayFactor fetchByC_C_T(
		...
		return getPersistence().fetchByC_C_T(
			classNameId, classPK, testrayFactorOptionId, retrieveFromCache);
	}
