...
/**
 * The persistence utility for the testray factor service. This utility wraps {@link com.liferay.osb.testray.service.persistence.impl.TestrayFactorPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TestrayFactorUtil {
	...
	*/
	public static List<TestrayFactor> findByCNI_CP(long classNameId,
		long classPK) {
	...
	*/
	public static List<TestrayFactor> findByCNI_CP(long classNameId,
		...
		OrderByComparator<TestrayFactor> orderByComparator) {
		return getPersistence()
				   .findByCNI_CP(classNameId, classPK, start, end,
			orderByComparator);
	}
	...
	*/
	public static TestrayFactor findByCNI_CP_First(long classNameId,
		...
		return getPersistence()
				   .findByCNI_CP_First(classNameId, classPK, orderByComparator);
	}
	...
	*/
	public static TestrayFactor fetchByCNI_CP_First(long classNameId,
		long classPK, OrderByComparator<TestrayFactor> orderByComparator) {
		return getPersistence()
				   .fetchByCNI_CP_First(classNameId, classPK, orderByComparator);
	}
	...
	* @throws NoSuchTestrayFactorException if a matching testray factor could not be found
	*/
	public static TestrayFactor findByCNI_CP_Last(long classNameId,
		long classPK, OrderByComparator<TestrayFactor> orderByComparator)
		throws com.liferay.osb.testray.exception.NoSuchTestrayFactorException {
		return getPersistence()
				   .findByCNI_CP_Last(classNameId, classPK, orderByComparator);
	}
	...
	*/
	public static TestrayFactor fetchByCNI_CP_Last(long classNameId,
		long classPK, OrderByComparator<TestrayFactor> orderByComparator) {
		return getPersistence()
				   .fetchByCNI_CP_Last(classNameId, classPK, orderByComparator);
	}
	...
	*/
	public static TestrayFactor[] findByCNI_CP_PrevAndNext(
		...
		throws com.liferay.osb.testray.exception.NoSuchTestrayFactorException {
		return getPersistence()
				   .findByCNI_CP_PrevAndNext(testrayFactorId, classNameId,
	...
	* @throws NoSuchTestrayFactorException if a matching testray factor could not be found
	*/
	public static TestrayFactor findByC_C_T(long classNameId, long classPK,
		long testrayFactorOptionId)
		throws com.liferay.osb.testray.exception.NoSuchTestrayFactorException {
		return getPersistence()
				   .findByC_C_T(classNameId, classPK, testrayFactorOptionId);
	}
	...
	*/
	public static TestrayFactor fetchByC_C_T(long classNameId, long classPK,
		long testrayFactorOptionId) {
		return getPersistence()
				   .fetchByC_C_T(classNameId, classPK, testrayFactorOptionId);
	}
	...
	*/
	public static TestrayFactor removeByC_C_T(long classNameId, long classPK,
		long testrayFactorOptionId)
		throws com.liferay.osb.testray.exception.NoSuchTestrayFactorException {
		return getPersistence()
				   .removeByC_C_T(classNameId, classPK, testrayFactorOptionId);
	}
	...
	*/
	public static int countByC_C_T(long classNameId, long classPK,
		long testrayFactorOptionId) {
		return getPersistence()
				   .countByC_C_T(classNameId, classPK, testrayFactorOptionId);
	}
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, TestrayFactor> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<TestrayFactorPersistence, TestrayFactorPersistence> _serviceTracker =
		ServiceTrackerFactory.open(TestrayFactorPersistence.class);
}