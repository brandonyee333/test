...
public interface TestrayRequirementLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestrayRequirementLocalServiceUtil} to access the testray requirement local service. Add custom service methods to {@link com.liferay.osb.testray.service.impl.TestrayRequirementLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public TestrayRequirement deleteTestrayRequirement(
		long testrayRequirementId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TestrayRequirement fetchTestrayRequirement(long testrayRequirementId);
