...
@ProviderType
public interface TestrayTask extends PersistedModel, TestrayTaskModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>com.liferay.osb.testray.model.impl.TestrayTaskImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<TestrayTask, Long> TESTRAY_TASK_ID_ACCESSOR =
		new Accessor<TestrayTask, Long>() {
