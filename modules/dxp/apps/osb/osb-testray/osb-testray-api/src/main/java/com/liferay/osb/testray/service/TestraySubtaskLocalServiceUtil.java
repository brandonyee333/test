 ...
 * {@link com.liferay.osb.testray.service.impl.TestraySubtaskLocalServiceImpl} and is the
...
public class TestraySubtaskLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.testray.service.impl.TestraySubtaskLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static boolean hasTestrayCaseResultTestraySubtask(
		long testrayCaseResultId, long testraySubtaskId) {
		return getService()
				   .hasTestrayCaseResultTestraySubtask(testrayCaseResultId,
			testraySubtaskId);
	}
	...
	public static boolean hasTestrayCaseResultTestraySubtasks(
		...
		return getService()
				   .hasTestrayCaseResultTestraySubtasks(testrayCaseResultId);
	}

	public static boolean hasTestrayIssueTestraySubtask(long testrayIssueId,
		long testraySubtaskId) {
		return getService()
				   .hasTestrayIssueTestraySubtask(testrayIssueId,
			testraySubtaskId);
	}
	...
	*/
	public static com.liferay.osb.testray.model.TestraySubtask addTestraySubtask(
	...
	*/
	public static com.liferay.osb.testray.model.TestraySubtask createTestraySubtask(
		long testraySubtaskId) {
	...
	*/
	public static com.liferay.osb.testray.model.TestraySubtask deleteTestraySubtask(
		com.liferay.osb.testray.model.TestraySubtask testraySubtask) {
	...
	*/
	...
	public static com.liferay.osb.testray.model.TestraySubtask fetchTestraySubtask(
		long testraySubtaskId) {
	...
	* @throws PortalException if a testray subtask with the primary key could not be found
	*/
	public static com.liferay.osb.testray.model.TestraySubtask getTestraySubtask(
		long testraySubtaskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.liferay.osb.testray.model.TestraySubtask updateTestraySubtask(
		com.liferay.osb.testray.model.TestraySubtask testraySubtask) {
	...
	*/
	...
	public static java.util.List<com.liferay.osb.testray.model.TestraySubtask> getTestrayCaseResultTestraySubtasks(
		long testrayCaseResultId) {
		return getService()
				   .getTestrayCaseResultTestraySubtasks(testrayCaseResultId);
	}
	...
	public static java.util.List<com.liferay.osb.testray.model.TestraySubtask> getTestrayIssueTestraySubtasks(
		long testrayIssueId) {
	...
	public static java.util.List<com.liferay.osb.testray.model.TestraySubtask> getTestrayIssueTestraySubtasks(
		...
		return getService()
				   .getTestrayIssueTestraySubtasks(testrayIssueId, start, end);
	}
	...
	*/
	public static java.util.List<com.liferay.osb.testray.model.TestraySubtask> getTestraySubtasks(
		int start, int end) {
	...
	*/
	public static long[] getTestrayCaseResultPrimaryKeys(long testraySubtaskId) {
	...
	*/
	...
	public static void addTestrayCaseResultTestraySubtask(
		...
		com.liferay.osb.testray.model.TestraySubtask testraySubtask) {
		getService()
			.addTestrayCaseResultTestraySubtask(testrayCaseResultId,
			testraySubtask);
	}
	...
	public static void addTestrayCaseResultTestraySubtasks(
		...
		getService()
			.addTestrayCaseResultTestraySubtasks(testrayCaseResultId,
			testraySubtasks);
	}
	...
	public static void addTestrayIssueTestraySubtask(long testrayIssueId,
		com.liferay.osb.testray.model.TestraySubtask testraySubtask) {
		getService()
			.addTestrayIssueTestraySubtask(testrayIssueId, testraySubtask);
	}

	public static void addTestrayIssueTestraySubtask(long testrayIssueId,
		long testraySubtaskId) {
		getService()
			.addTestrayIssueTestraySubtask(testrayIssueId, testraySubtaskId);
	}

	public static void addTestrayIssueTestraySubtasks(long testrayIssueId,
		java.util.List<com.liferay.osb.testray.model.TestraySubtask> testraySubtasks) {
		getService()
			.addTestrayIssueTestraySubtasks(testrayIssueId, testraySubtasks);
	}

	public static void addTestrayIssueTestraySubtasks(long testrayIssueId,
		long[] testraySubtaskIds) {
		getService()
			.addTestrayIssueTestraySubtasks(testrayIssueId, testraySubtaskIds);
	}
	...
	public static void deleteTestrayCaseResultTestraySubtask(
		...
		com.liferay.osb.testray.model.TestraySubtask testraySubtask) {
		getService()
			.deleteTestrayCaseResultTestraySubtask(testrayCaseResultId,
			testraySubtask);
	}
	...
	public static void deleteTestrayCaseResultTestraySubtasks(
		...
		java.util.List<com.liferay.osb.testray.model.TestraySubtask> testraySubtasks) {
		getService()
			.deleteTestrayCaseResultTestraySubtasks(testrayCaseResultId,
			testraySubtasks);
	}
	...
	public static void deleteTestrayIssueTestraySubtask(long testrayIssueId,
		com.liferay.osb.testray.model.TestraySubtask testraySubtask) {
		getService()
			.deleteTestrayIssueTestraySubtask(testrayIssueId, testraySubtask);
	}

	public static void deleteTestrayIssueTestraySubtask(long testrayIssueId,
		long testraySubtaskId) {
		getService()
			.deleteTestrayIssueTestraySubtask(testrayIssueId, testraySubtaskId);
	}

	public static void deleteTestrayIssueTestraySubtasks(long testrayIssueId,
		java.util.List<com.liferay.osb.testray.model.TestraySubtask> testraySubtasks) {
		getService()
			.deleteTestrayIssueTestraySubtasks(testrayIssueId, testraySubtasks);
	}

	public static void deleteTestrayIssueTestraySubtasks(long testrayIssueId,
		long[] testraySubtaskIds) {
		getService()
			.deleteTestrayIssueTestraySubtasks(testrayIssueId, testraySubtaskIds);
	}

	public static void setTestrayCaseResultTestraySubtasks(
		long testrayCaseResultId, long[] testraySubtaskIds) {
		getService()
			.setTestrayCaseResultTestraySubtasks(testrayCaseResultId,
			testraySubtaskIds);
	}

	public static void setTestrayIssueTestraySubtasks(long testrayIssueId,
		long[] testraySubtaskIds) {
		getService()
			.setTestrayIssueTestraySubtasks(testrayIssueId, testraySubtaskIds);
	}
	...
	private static ServiceTracker<TestraySubtaskLocalService, TestraySubtaskLocalService> _serviceTracker =
		ServiceTrackerFactory.open(TestraySubtaskLocalService.class);
}