 ...
 * {@link com.liferay.osb.testray.service.impl.TestrayCaseLocalServiceImpl} and is the
...
public class TestrayCaseLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.testray.service.impl.TestrayCaseLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static boolean hasTestrayBuildTestrayCase(long testrayBuildId,
		long testrayCaseId) {
		return getService()
				   .hasTestrayBuildTestrayCase(testrayBuildId, testrayCaseId);
	}
	...
	public static boolean hasTestrayComponentTestrayCase(
		...
		return getService()
				   .hasTestrayComponentTestrayCase(testrayComponentId,
			testrayCaseId);
	}
	...
	public static boolean hasTestrayRequirementTestrayCase(
		...
		return getService()
				   .hasTestrayRequirementTestrayCase(testrayRequirementId,
			testrayCaseId);
	}
	...
	public static boolean hasTestrayRequirementTestrayCases(
		...
		return getService()
				   .hasTestrayRequirementTestrayCases(testrayRequirementId);
	}

	public static boolean hasTestraySuiteTestrayCase(long testraySuiteId,
		long testrayCaseId) {
		return getService()
				   .hasTestraySuiteTestrayCase(testraySuiteId, testrayCaseId);
	}
	...
	*/
	...
	public static int getTestrayComponentTestrayCasesCount(
		long testrayComponentId) {
		return getService()
				   .getTestrayComponentTestrayCasesCount(testrayComponentId);
	}

	public static int getTestrayRequirementTestrayCasesCount(
		long testrayRequirementId) {
		return getService()
				   .getTestrayRequirementTestrayCasesCount(testrayRequirementId);
	}
	...
	*/
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestrayBuildTestrayCases(
		long testrayBuildId) {
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestrayBuildTestrayCases(
		...
		return getService()
				   .getTestrayBuildTestrayCases(testrayBuildId, start, end);
	}
	...
	*/
	public static java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestrayCases(
		int start, int end) {
		return getService().getTestrayCases(start, end);
	}

	public static java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestrayComponentTestrayCases(
		long testrayComponentId) {
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestrayComponentTestrayCases(
		...
		return getService()
				   .getTestrayComponentTestrayCases(testrayComponentId, start,
			end);
	}
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestrayRequirementTestrayCases(
		long testrayRequirementId) {
		return getService()
				   .getTestrayRequirementTestrayCases(testrayRequirementId);
	}
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestraySuiteTestrayCases(
		long testraySuiteId) {
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayCase> getTestraySuiteTestrayCases(
		...
		return getService()
				   .getTestraySuiteTestrayCases(testraySuiteId, start, end);
	}
	...
	*/
	...
	public static void addTestrayBuildTestrayCase(long testrayBuildId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
	...
	public static void addTestrayBuildTestrayCases(long testrayBuildId,
	...
	public static void addTestrayBuildTestrayCases(long testrayBuildId,
		long[] testrayCaseIds) {
		getService().addTestrayBuildTestrayCases(testrayBuildId, testrayCaseIds);
	}

	public static void addTestrayComponentTestrayCase(long testrayComponentId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		getService()
			.addTestrayComponentTestrayCase(testrayComponentId, testrayCase);
	}

	public static void addTestrayComponentTestrayCase(long testrayComponentId,
		long testrayCaseId) {
		getService()
			.addTestrayComponentTestrayCase(testrayComponentId, testrayCaseId);
	}
	...
	public static void addTestrayComponentTestrayCases(
		...
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		getService()
			.addTestrayComponentTestrayCases(testrayComponentId, testrayCases);
	}

	public static void addTestrayComponentTestrayCases(
		long testrayComponentId, long[] testrayCaseIds) {
		getService()
			.addTestrayComponentTestrayCases(testrayComponentId, testrayCaseIds);
	}
	...
	public static void addTestrayRequirementTestrayCase(
		...
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		getService()
			.addTestrayRequirementTestrayCase(testrayRequirementId, testrayCase);
	}

	public static void addTestrayRequirementTestrayCase(
		long testrayRequirementId, long testrayCaseId) {
		getService()
			.addTestrayRequirementTestrayCase(testrayRequirementId,
			testrayCaseId);
	}
	...
	public static void addTestrayRequirementTestrayCases(
		...
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		getService()
			.addTestrayRequirementTestrayCases(testrayRequirementId,
			testrayCases);
	}
	...
	public static void addTestraySuiteTestrayCase(long testraySuiteId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
	...
	public static void addTestraySuiteTestrayCases(long testraySuiteId,
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
	...
	public static void addTestraySuiteTestrayCases(long testraySuiteId,
		long[] testrayCaseIds) {
		getService().addTestraySuiteTestrayCases(testraySuiteId, testrayCaseIds);
	}
	...
	public static void deleteTestrayBuildTestrayCase(long testrayBuildId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
	...
	public static void deleteTestrayBuildTestrayCase(long testrayBuildId,
		long testrayCaseId) {
		getService().deleteTestrayBuildTestrayCase(testrayBuildId, testrayCaseId);
	}

	public static void deleteTestrayBuildTestrayCases(long testrayBuildId,
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		getService().deleteTestrayBuildTestrayCases(testrayBuildId, testrayCases);
	}

	public static void deleteTestrayBuildTestrayCases(long testrayBuildId,
		long[] testrayCaseIds) {
		getService()
			.deleteTestrayBuildTestrayCases(testrayBuildId, testrayCaseIds);
	}
	...
	public static void deleteTestrayComponentTestrayCase(
		...
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		getService()
			.deleteTestrayComponentTestrayCase(testrayComponentId, testrayCase);
	}

	public static void deleteTestrayComponentTestrayCase(
		long testrayComponentId, long testrayCaseId) {
		getService()
			.deleteTestrayComponentTestrayCase(testrayComponentId, testrayCaseId);
	}
	...
	public static void deleteTestrayComponentTestrayCases(
		...
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		getService()
			.deleteTestrayComponentTestrayCases(testrayComponentId, testrayCases);
	}

	public static void deleteTestrayComponentTestrayCases(
		long testrayComponentId, long[] testrayCaseIds) {
		getService()
			.deleteTestrayComponentTestrayCases(testrayComponentId,
			testrayCaseIds);
	}
	...
	public static void deleteTestrayRequirementTestrayCase(
		...
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
		getService()
			.deleteTestrayRequirementTestrayCase(testrayRequirementId,
			testrayCase);
	}
	...
	public static void deleteTestrayRequirementTestrayCases(
		...
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		getService()
			.deleteTestrayRequirementTestrayCases(testrayRequirementId,
			testrayCases);
	}
	...
	public static void deleteTestraySuiteTestrayCase(long testraySuiteId,
		com.liferay.osb.testray.model.TestrayCase testrayCase) {
	...
	public static void deleteTestraySuiteTestrayCase(long testraySuiteId,
		long testrayCaseId) {
		getService().deleteTestraySuiteTestrayCase(testraySuiteId, testrayCaseId);
	}

	public static void deleteTestraySuiteTestrayCases(long testraySuiteId,
		java.util.List<com.liferay.osb.testray.model.TestrayCase> testrayCases) {
		getService().deleteTestraySuiteTestrayCases(testraySuiteId, testrayCases);
	}

	public static void deleteTestraySuiteTestrayCases(long testraySuiteId,
		long[] testrayCaseIds) {
		getService()
			.deleteTestraySuiteTestrayCases(testraySuiteId, testrayCaseIds);
	}

	public static void setTestrayBuildTestrayCases(long testrayBuildId,
		long[] testrayCaseIds) {
		getService().setTestrayBuildTestrayCases(testrayBuildId, testrayCaseIds);
	}

	public static void setTestrayComponentTestrayCases(
		long testrayComponentId, long[] testrayCaseIds) {
		getService()
			.setTestrayComponentTestrayCases(testrayComponentId, testrayCaseIds);
	}

	public static void setTestrayRequirementTestrayCases(
		long testrayRequirementId, long[] testrayCaseIds) {
		getService()
			.setTestrayRequirementTestrayCases(testrayRequirementId,
			testrayCaseIds);
	}

	public static void setTestraySuiteTestrayCases(long testraySuiteId,
		long[] testrayCaseIds) {
		getService().setTestraySuiteTestrayCases(testraySuiteId, testrayCaseIds);
	}
	...
	private static ServiceTracker<TestrayCaseLocalService, TestrayCaseLocalService> _serviceTracker =
		ServiceTrackerFactory.open(TestrayCaseLocalService.class);
}