 ...
 */
@ProviderType
public interface TestrayCaseTypePersistence extends BasePersistence<TestrayCaseType> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public TestrayCaseType findByGI_N(long groupId, java.lang.String name)
	...
	*/
	public TestrayCaseType fetchByGI_N(long groupId, java.lang.String name);
	...
	*/
	public TestrayCaseType removeByGI_N(long groupId, java.lang.String name)
		throws NoSuchTestrayCaseTypeException;
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TestrayCaseType> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<TestrayCaseType> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TestrayCaseType> orderByComparator);
