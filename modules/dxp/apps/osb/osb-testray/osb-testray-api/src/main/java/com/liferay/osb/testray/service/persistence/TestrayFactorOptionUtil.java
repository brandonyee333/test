...
public class TestrayFactorOptionUtil {
	...
	public static TestrayFactorOption fetchByT_N(
		...
		return getPersistence().fetchByT_N(
			testrayFactorCategoryId, name, retrieveFromCache);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			TestrayFactorOptionPersistence.class);

		ServiceTracker
			<TestrayFactorOptionPersistence, TestrayFactorOptionPersistence>
				serviceTracker =
					new ServiceTracker
						<TestrayFactorOptionPersistence,
						 TestrayFactorOptionPersistence>(
							 bundle.getBundleContext(),
							 TestrayFactorOptionPersistence.class, null);
