...
/**
 * The persistence utility for the testray factor option service. This utility wraps {@link com.liferay.osb.testray.service.persistence.impl.TestrayFactorOptionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TestrayFactorOptionUtil {
	 ...
	 */
	public static TestrayFactorOption update(
		TestrayFactorOption testrayFactorOption, ServiceContext serviceContext) {
	...
	*/
	public static TestrayFactorOption findByT_N(long testrayFactorCategoryId,
		java.lang.String name)
		throws com.liferay.osb.testray.exception.NoSuchTestrayFactorOptionException {
	...
	*/
	public static TestrayFactorOption fetchByT_N(long testrayFactorCategoryId,
		java.lang.String name) {
	...
	*/
	public static TestrayFactorOption fetchByT_N(long testrayFactorCategoryId,
		...
		return getPersistence()
				   .fetchByT_N(testrayFactorCategoryId, name, retrieveFromCache);
	}
	...
	*/
	public static TestrayFactorOption removeByT_N(
		long testrayFactorCategoryId, java.lang.String name)
		throws com.liferay.osb.testray.exception.NoSuchTestrayFactorOptionException {
	...
	*/
	public static int countByT_N(long testrayFactorCategoryId,
		java.lang.String name) {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, TestrayFactorOption> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<TestrayFactorOptionPersistence, TestrayFactorOptionPersistence> _serviceTracker =
		ServiceTrackerFactory.open(TestrayFactorOptionPersistence.class);
}