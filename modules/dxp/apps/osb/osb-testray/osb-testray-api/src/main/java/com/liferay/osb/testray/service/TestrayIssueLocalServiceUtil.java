 ...
 * {@link com.liferay.osb.testray.service.impl.TestrayIssueLocalServiceImpl} and is the
...
public class TestrayIssueLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.testray.service.impl.TestrayIssueLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static boolean hasTestrayCaseResultTestrayIssue(
		long testrayCaseResultId, long testrayIssueId) {
		return getService()
				   .hasTestrayCaseResultTestrayIssue(testrayCaseResultId,
			testrayIssueId);
	}
	...
	public static boolean hasTestrayCaseResultTestrayIssues(
		...
		return getService()
				   .hasTestrayCaseResultTestrayIssues(testrayCaseResultId);
	}

	public static boolean hasTestraySubtaskTestrayIssue(long testraySubtaskId,
		long testrayIssueId) {
		return getService()
				   .hasTestraySubtaskTestrayIssue(testraySubtaskId,
			testrayIssueId);
	}

	public static boolean hasTestraySubtaskTestrayIssues(long testraySubtaskId) {
	...
	*/
	...
	public static int getTestrayCaseResultTestrayIssuesCount(
		long testrayCaseResultId) {
		return getService()
				   .getTestrayCaseResultTestrayIssuesCount(testrayCaseResultId);
	}
	...
	*/
	...
	public static int getTestraySubtaskTestrayIssuesCount(long testraySubtaskId) {
		return getService().getTestraySubtaskTestrayIssuesCount(testraySubtaskId);
	}
	...
	*/
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayIssue> getTestrayCaseResultTestrayIssues(
		long testrayCaseResultId) {
		return getService()
				   .getTestrayCaseResultTestrayIssues(testrayCaseResultId);
	}
	...
	*/
	public static java.util.List<com.liferay.osb.testray.model.TestrayIssue> getTestrayIssues(
		int start, int end) {
		return getService().getTestrayIssues(start, end);
	}

	public static java.util.List<com.liferay.osb.testray.model.TestrayIssue> getTestraySubtaskTestrayIssues(
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayIssue> getTestraySubtaskTestrayIssues(
		...
		return getService()
				   .getTestraySubtaskTestrayIssues(testraySubtaskId, start, end);
	}
	...
	public static java.util.List<com.liferay.osb.testray.model.TestrayIssue> getTestraySubtaskTestrayIssues(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.osb.testray.model.TestrayIssue> orderByComparator) {
		return getService()
				   .getTestraySubtaskTestrayIssues(testraySubtaskId, start,
	...
	*/
	...
	public static void addTestrayCaseResultTestrayIssue(
		...
		com.liferay.osb.testray.model.TestrayIssue testrayIssue) {
		getService()
			.addTestrayCaseResultTestrayIssue(testrayCaseResultId, testrayIssue);
	}

	public static void addTestrayCaseResultTestrayIssue(
		long testrayCaseResultId, long testrayIssueId) {
		getService()
			.addTestrayCaseResultTestrayIssue(testrayCaseResultId,
			testrayIssueId);
	}
	...
	public static void addTestrayCaseResultTestrayIssues(
		...
		getService()
			.addTestrayCaseResultTestrayIssues(testrayCaseResultId,
			testrayIssues);
	}
	...
	public static void addTestraySubtaskTestrayIssue(long testraySubtaskId,
		com.liferay.osb.testray.model.TestrayIssue testrayIssue) {
		getService()
			.addTestraySubtaskTestrayIssue(testraySubtaskId, testrayIssue);
	}

	public static void addTestraySubtaskTestrayIssue(long testraySubtaskId,
		long testrayIssueId) {
		getService()
			.addTestraySubtaskTestrayIssue(testraySubtaskId, testrayIssueId);
	}

	public static void addTestraySubtaskTestrayIssues(long testraySubtaskId,
		java.util.List<com.liferay.osb.testray.model.TestrayIssue> testrayIssues) {
		getService()
			.addTestraySubtaskTestrayIssues(testraySubtaskId, testrayIssues);
	}

	public static void addTestraySubtaskTestrayIssues(long testraySubtaskId,
		long[] testrayIssueIds) {
		getService()
			.addTestraySubtaskTestrayIssues(testraySubtaskId, testrayIssueIds);
	}
	...
	public static void deleteTestrayCaseResultTestrayIssue(
		...
		com.liferay.osb.testray.model.TestrayIssue testrayIssue) {
		getService()
			.deleteTestrayCaseResultTestrayIssue(testrayCaseResultId,
			testrayIssue);
	}
	...
	public static void deleteTestrayCaseResultTestrayIssues(
		...
		java.util.List<com.liferay.osb.testray.model.TestrayIssue> testrayIssues) {
		getService()
			.deleteTestrayCaseResultTestrayIssues(testrayCaseResultId,
			testrayIssues);
	}
	...
	public static void deleteTestraySubtaskTestrayIssue(long testraySubtaskId,
		com.liferay.osb.testray.model.TestrayIssue testrayIssue) {
		getService()
			.deleteTestraySubtaskTestrayIssue(testraySubtaskId, testrayIssue);
	}

	public static void deleteTestraySubtaskTestrayIssue(long testraySubtaskId,
		long testrayIssueId) {
		getService()
			.deleteTestraySubtaskTestrayIssue(testraySubtaskId, testrayIssueId);
	}
	...
	public static void deleteTestraySubtaskTestrayIssues(
		...
		java.util.List<com.liferay.osb.testray.model.TestrayIssue> testrayIssues) {
		getService()
			.deleteTestraySubtaskTestrayIssues(testraySubtaskId, testrayIssues);
	}

	public static void deleteTestraySubtaskTestrayIssues(
		long testraySubtaskId, long[] testrayIssueIds) {
		getService()
			.deleteTestraySubtaskTestrayIssues(testraySubtaskId, testrayIssueIds);
	}

	public static void setTestrayCaseResultTestrayIssues(
		long testrayCaseResultId, long[] testrayIssueIds) {
		getService()
			.setTestrayCaseResultTestrayIssues(testrayCaseResultId,
			testrayIssueIds);
	}

	public static void setTestraySubtaskTestrayIssues(long testraySubtaskId,
		long[] testrayIssueIds) {
		getService()
			.setTestraySubtaskTestrayIssues(testraySubtaskId, testrayIssueIds);
	}
	...
	private static ServiceTracker<TestrayIssueLocalService, TestrayIssueLocalService> _serviceTracker =
		ServiceTrackerFactory.open(TestrayIssueLocalService.class);
}