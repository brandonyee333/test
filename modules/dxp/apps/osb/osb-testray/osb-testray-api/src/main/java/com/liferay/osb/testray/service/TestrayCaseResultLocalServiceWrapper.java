...
public class TestrayCaseResultLocalServiceWrapper
	...
	public boolean hasTestrayIssueTestrayCaseResult(long testrayIssueId,
		...
		return _testrayCaseResultLocalService.hasTestrayIssueTestrayCaseResult(testrayIssueId,
			testrayCaseResultId);
	}

	@Override
	public boolean hasTestrayIssueTestrayCaseResults(long testrayIssueId) {
		return _testrayCaseResultLocalService.hasTestrayIssueTestrayCaseResults(testrayIssueId);
	}

	@Override
	public boolean hasTestraySubtaskTestrayCaseResult(long testraySubtaskId,
		long testrayCaseResultId) {
		return _testrayCaseResultLocalService.hasTestraySubtaskTestrayCaseResult(testraySubtaskId,
			testrayCaseResultId);
	}

	@Override
	public boolean hasTestraySubtaskTestrayCaseResults(long testraySubtaskId) {
		return _testrayCaseResultLocalService.hasTestraySubtaskTestrayCaseResults(testraySubtaskId);
	}
	...
	*/
	...
	public com.liferay.osb.testray.model.TestrayCaseResult addTestrayCaseResult(
		...
		return _testrayCaseResultLocalService.addTestrayCaseResult(testrayCaseResult);
	}
	...
	*/
	@Override
	public com.liferay.osb.testray.model.TestrayCaseResult createTestrayCaseResult(
		long testrayCaseResultId) {
		return _testrayCaseResultLocalService.createTestrayCaseResult(testrayCaseResultId);
	}
	...
	*/
	@Override
	public com.liferay.osb.testray.model.TestrayCaseResult deleteTestrayCaseResult(
		com.liferay.osb.testray.model.TestrayCaseResult testrayCaseResult) {
		return _testrayCaseResultLocalService.deleteTestrayCaseResult(testrayCaseResult);
	}
	...
	*/
	...
	public com.liferay.osb.testray.model.TestrayCaseResult deleteTestrayCaseResult(
		...
		return _testrayCaseResultLocalService.deleteTestrayCaseResult(testrayCaseResultId);
	}

	@Override
	public com.liferay.osb.testray.model.TestrayCaseResult fetchTestrayCaseResult(
		long testrayCaseResultId) {
		return _testrayCaseResultLocalService.fetchTestrayCaseResult(testrayCaseResultId);
	}
	...
	*/
	...
	public com.liferay.osb.testray.model.TestrayCaseResult getTestrayCaseResult(
		long testrayCaseResultId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _testrayCaseResultLocalService.getTestrayCaseResult(testrayCaseResultId);
	}
	...
	*/
	@Override
	public com.liferay.osb.testray.model.TestrayCaseResult updateTestrayCaseResult(
		com.liferay.osb.testray.model.TestrayCaseResult testrayCaseResult) {
		return _testrayCaseResultLocalService.updateTestrayCaseResult(testrayCaseResult);
	}
	...
	public com.liferay.portal.kernel.dao.orm.IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		return _testrayCaseResultLocalService.getIndexableActionableDynamicQuery();
	}
	...
	*/
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return _testrayCaseResultLocalService.deletePersistedModel(persistedModel);
	}
	...
	*/
	...
	public int getTestrayIssueTestrayCaseResultsCount(long testrayIssueId) {
		return _testrayCaseResultLocalService.getTestrayIssueTestrayCaseResultsCount(testrayIssueId);
	}

	@Override
	public int getTestraySubtaskTestrayCaseResultsCount(long testraySubtaskId) {
		return _testrayCaseResultLocalService.getTestraySubtaskTestrayCaseResultsCount(testraySubtaskId);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _testrayCaseResultLocalService.dynamicQuery(dynamicQuery, start,
			end);
	}
	...
	*/
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayCaseResult> getTestrayCaseResults(
		int start, int end) {
		return _testrayCaseResultLocalService.getTestrayCaseResults(start, end);
	}

	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayCaseResult> getTestrayIssueTestrayCaseResults(
		long testrayIssueId) {
		return _testrayCaseResultLocalService.getTestrayIssueTestrayCaseResults(testrayIssueId);
	}
	...
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestrayCaseResult> getTestraySubtaskTestrayCaseResults(
		long testraySubtaskId) {
		return _testrayCaseResultLocalService.getTestraySubtaskTestrayCaseResults(testraySubtaskId);
	}
	...
	*/
	...
	public long[] getTestrayIssuePrimaryKeys(long testrayCaseResultId) {
		return _testrayCaseResultLocalService.getTestrayIssuePrimaryKeys(testrayCaseResultId);
	}
	...
	*/
	...
	public long[] getTestraySubtaskPrimaryKeys(long testrayCaseResultId) {
		return _testrayCaseResultLocalService.getTestraySubtaskPrimaryKeys(testrayCaseResultId);
	}

	@Override
	public void addTestrayIssueTestrayCaseResult(long testrayIssueId,
		com.liferay.osb.testray.model.TestrayCaseResult testrayCaseResult) {
		_testrayCaseResultLocalService.addTestrayIssueTestrayCaseResult(testrayIssueId,
			testrayCaseResult);
	}
	...
	public void addTestrayIssueTestrayCaseResults(long testrayIssueId,
		...
		_testrayCaseResultLocalService.addTestrayIssueTestrayCaseResults(testrayIssueId,
			testrayCaseResults);
	}
	...
	public void addTestraySubtaskTestrayCaseResult(long testraySubtaskId,
		com.liferay.osb.testray.model.TestrayCaseResult testrayCaseResult) {
		_testrayCaseResultLocalService.addTestraySubtaskTestrayCaseResult(testraySubtaskId,
			testrayCaseResult);
	}
	...
	public void addTestraySubtaskTestrayCaseResults(long testraySubtaskId,
		java.util.List<com.liferay.osb.testray.model.TestrayCaseResult> testrayCaseResults) {
		_testrayCaseResultLocalService.addTestraySubtaskTestrayCaseResults(testraySubtaskId,
			testrayCaseResults);
	}
	...
	public void clearTestrayIssueTestrayCaseResults(long testrayIssueId) {
		_testrayCaseResultLocalService.clearTestrayIssueTestrayCaseResults(testrayIssueId);
	}

	@Override
	public void clearTestraySubtaskTestrayCaseResults(long testraySubtaskId) {
		_testrayCaseResultLocalService.clearTestraySubtaskTestrayCaseResults(testraySubtaskId);
	}

	@Override
	public void deleteTestrayIssueTestrayCaseResult(long testrayIssueId,
		com.liferay.osb.testray.model.TestrayCaseResult testrayCaseResult) {
		_testrayCaseResultLocalService.deleteTestrayIssueTestrayCaseResult(testrayIssueId,
			testrayCaseResult);
	}
	...
	public void deleteTestrayIssueTestrayCaseResults(long testrayIssueId,
		java.util.List<com.liferay.osb.testray.model.TestrayCaseResult> testrayCaseResults) {
		_testrayCaseResultLocalService.deleteTestrayIssueTestrayCaseResults(testrayIssueId,
			testrayCaseResults);
	}
	...
	public void deleteTestraySubtaskTestrayCaseResult(long testraySubtaskId,
		com.liferay.osb.testray.model.TestrayCaseResult testrayCaseResult) {
		_testrayCaseResultLocalService.deleteTestraySubtaskTestrayCaseResult(testraySubtaskId,
			testrayCaseResult);
	}
	...
	public void deleteTestraySubtaskTestrayCaseResults(long testraySubtaskId,
		java.util.List<com.liferay.osb.testray.model.TestrayCaseResult> testrayCaseResults) {
		_testrayCaseResultLocalService.deleteTestraySubtaskTestrayCaseResults(testraySubtaskId,
			testrayCaseResults);
	}
	...
	public void setTestrayIssueTestrayCaseResults(long testrayIssueId,
		long[] testrayCaseResultIds) {
		_testrayCaseResultLocalService.setTestrayIssueTestrayCaseResults(testrayIssueId,
			testrayCaseResultIds);
	}
	...
	public void setTestraySubtaskTestrayCaseResults(long testraySubtaskId,
		long[] testrayCaseResultIds) {
		_testrayCaseResultLocalService.setTestraySubtaskTestrayCaseResults(testraySubtaskId,
			testrayCaseResultIds);
	}
