...
public class TestraySubtaskLocalServiceWrapper
	...
	public boolean hasTestrayCaseResultTestraySubtask(
		...
		return _testraySubtaskLocalService.hasTestrayCaseResultTestraySubtask(testrayCaseResultId,
			testraySubtaskId);
	}

	@Override
	public boolean hasTestrayCaseResultTestraySubtasks(long testrayCaseResultId) {
		return _testraySubtaskLocalService.hasTestrayCaseResultTestraySubtasks(testrayCaseResultId);
	}

	@Override
	public boolean hasTestrayIssueTestraySubtask(long testrayIssueId,
		long testraySubtaskId) {
		return _testraySubtaskLocalService.hasTestrayIssueTestraySubtask(testrayIssueId,
			testraySubtaskId);
	}

	@Override
	public boolean hasTestrayIssueTestraySubtasks(long testrayIssueId) {
		return _testraySubtaskLocalService.hasTestrayIssueTestraySubtasks(testrayIssueId);
	}
	...
	*/
	...
	public com.liferay.osb.testray.model.TestraySubtask createTestraySubtask(
		long testraySubtaskId) {
		return _testraySubtaskLocalService.createTestraySubtask(testraySubtaskId);
	}
	...
	*/
	...
	public com.liferay.osb.testray.model.TestraySubtask deleteTestraySubtask(
		...
		return _testraySubtaskLocalService.deleteTestraySubtask(testraySubtaskId);
	}

	@Override
	public com.liferay.osb.testray.model.TestraySubtask fetchTestraySubtask(
		long testraySubtaskId) {
		return _testraySubtaskLocalService.fetchTestraySubtask(testraySubtaskId);
	}
	...
	*/
	...
	public int getTestrayCaseResultTestraySubtasksCount(
		...
		return _testraySubtaskLocalService.getTestrayCaseResultTestraySubtasksCount(testrayCaseResultId);
	}

	@Override
	public int getTestrayIssueTestraySubtasksCount(long testrayIssueId) {
		return _testraySubtaskLocalService.getTestrayIssueTestraySubtasksCount(testrayIssueId);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _testraySubtaskLocalService.dynamicQuery(dynamicQuery, start, end);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _testraySubtaskLocalService.dynamicQuery(dynamicQuery, start,
			end, orderByComparator);
	}

	@Override
	public java.util.List<com.liferay.osb.testray.model.TestraySubtask> getTestrayCaseResultTestraySubtasks(
		long testrayCaseResultId) {
		return _testraySubtaskLocalService.getTestrayCaseResultTestraySubtasks(testrayCaseResultId);
	}
	...
	@Override
	public java.util.List<com.liferay.osb.testray.model.TestraySubtask> getTestrayIssueTestraySubtasks(
		long testrayIssueId) {
		return _testraySubtaskLocalService.getTestrayIssueTestraySubtasks(testrayIssueId);
	}
	...
	*/
	...
	public long[] getTestrayCaseResultPrimaryKeys(long testraySubtaskId) {
		return _testraySubtaskLocalService.getTestrayCaseResultPrimaryKeys(testraySubtaskId);
	}
	...
	*/
	...
	public long[] getTestrayIssuePrimaryKeys(long testraySubtaskId) {
		return _testraySubtaskLocalService.getTestrayIssuePrimaryKeys(testraySubtaskId);
	}

	@Override
	public void addTestrayCaseResultTestraySubtask(long testrayCaseResultId,
		com.liferay.osb.testray.model.TestraySubtask testraySubtask) {
		_testraySubtaskLocalService.addTestrayCaseResultTestraySubtask(testrayCaseResultId,
			testraySubtask);
	}
	...
	public void addTestrayCaseResultTestraySubtasks(long testrayCaseResultId,
		...
		_testraySubtaskLocalService.addTestrayCaseResultTestraySubtasks(testrayCaseResultId,
			testraySubtasks);
	}
	...
	public void addTestrayIssueTestraySubtask(long testrayIssueId,
		com.liferay.osb.testray.model.TestraySubtask testraySubtask) {
		_testraySubtaskLocalService.addTestrayIssueTestraySubtask(testrayIssueId,
			testraySubtask);
	}
	...
	public void addTestrayIssueTestraySubtasks(long testrayIssueId,
		java.util.List<com.liferay.osb.testray.model.TestraySubtask> testraySubtasks) {
		_testraySubtaskLocalService.addTestrayIssueTestraySubtasks(testrayIssueId,
			testraySubtasks);
	}
	...
	public void clearTestrayCaseResultTestraySubtasks(long testrayCaseResultId) {
		_testraySubtaskLocalService.clearTestrayCaseResultTestraySubtasks(testrayCaseResultId);
	}

	@Override
	public void clearTestrayIssueTestraySubtasks(long testrayIssueId) {
		_testraySubtaskLocalService.clearTestrayIssueTestraySubtasks(testrayIssueId);
	}
	...
	public void deleteTestrayCaseResultTestraySubtask(
		long testrayCaseResultId,
		com.liferay.osb.testray.model.TestraySubtask testraySubtask) {
		_testraySubtaskLocalService.deleteTestrayCaseResultTestraySubtask(testrayCaseResultId,
			testraySubtask);
	}
	...
	public void deleteTestrayCaseResultTestraySubtasks(
		long testrayCaseResultId,
		java.util.List<com.liferay.osb.testray.model.TestraySubtask> testraySubtasks) {
		_testraySubtaskLocalService.deleteTestrayCaseResultTestraySubtasks(testrayCaseResultId,
			testraySubtasks);
	}
	...
	public void deleteTestrayIssueTestraySubtask(long testrayIssueId,
		com.liferay.osb.testray.model.TestraySubtask testraySubtask) {
		_testraySubtaskLocalService.deleteTestrayIssueTestraySubtask(testrayIssueId,
			testraySubtask);
	}
	...
	public void deleteTestrayIssueTestraySubtasks(long testrayIssueId,
		java.util.List<com.liferay.osb.testray.model.TestraySubtask> testraySubtasks) {
		_testraySubtaskLocalService.deleteTestrayIssueTestraySubtasks(testrayIssueId,
			testraySubtasks);
	}
	...
	public void setTestrayCaseResultTestraySubtasks(long testrayCaseResultId,
		long[] testraySubtaskIds) {
		_testraySubtaskLocalService.setTestrayCaseResultTestraySubtasks(testrayCaseResultId,
			testraySubtaskIds);
	}
	...
	public void setTestrayIssueTestraySubtasks(long testrayIssueId,
		long[] testraySubtaskIds) {
		_testraySubtaskLocalService.setTestrayIssueTestraySubtasks(testrayIssueId,
			testraySubtaskIds);
	}
