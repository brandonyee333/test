...
public class TestrayBuildUtil {
	...
	public static TestrayBuild fetchByTRI_N(
		...
		return getPersistence().fetchByTRI_N(
			testrayRoutineId, name, retrieveFromCache);
	}
	...
	private static ServiceTracker
		<TestrayBuildPersistence, TestrayBuildPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(TestrayBuildPersistence.class);

		ServiceTracker<TestrayBuildPersistence, TestrayBuildPersistence>
			serviceTracker =
				new ServiceTracker
					<TestrayBuildPersistence, TestrayBuildPersistence>(
						bundle.getBundleContext(),
						TestrayBuildPersistence.class, null);
