...
/**
 * The persistence utility for the testray issue service. This utility wraps {@link com.liferay.osb.testray.service.persistence.impl.TestrayIssuePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.liferay.osb.testray.service.persistence.impl.TestrayIssuePersistenceImpl
 * @generated
 */
@ProviderType
public class TestrayIssueUtil {
	...
	*/
	public static TestrayIssue findByName(java.lang.String name)
	...
	*/
	public static TestrayIssue fetchByName(java.lang.String name) {
	...
	*/
	public static TestrayIssue removeByName(java.lang.String name)
		throws com.liferay.osb.testray.exception.NoSuchTestrayIssueException {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, TestrayIssue> fetchByPrimaryKeys(
	...
	*/
	public static List<com.liferay.osb.testray.model.TestrayCaseResult> getTestrayCaseResults(
		long pk) {
	...
	*/
	public static List<com.liferay.osb.testray.model.TestrayCaseResult> getTestrayCaseResults(
		...
		return getPersistence()
				   .getTestrayCaseResults(pk, start, end, orderByComparator);
	}
	...
	*/
	public static boolean containsTestrayCaseResult(long pk,
		long testrayCaseResultPK) {
		return getPersistence()
				   .containsTestrayCaseResult(pk, testrayCaseResultPK);
	}
	...
	*/
	public static void addTestrayCaseResult(long pk,
	...
	*/
	public static void addTestrayCaseResults(long pk,
		long[] testrayCaseResultPKs) {
	...
	* @param testrayCaseResultPK the primary key of the testray case result
	*/
	public static void removeTestrayCaseResult(long pk, long testrayCaseResultPK) {
	...
	* @param testrayCaseResult the testray case result
	*/
	public static void removeTestrayCaseResult(long pk,
		com.liferay.osb.testray.model.TestrayCaseResult testrayCaseResult) {
	...
	* @param testrayCaseResultPKs the primary keys of the testray case results
	*/
	public static void removeTestrayCaseResults(long pk,
		long[] testrayCaseResultPKs) {
	...
	*/
	public static void setTestrayCaseResults(long pk,
		long[] testrayCaseResultPKs) {
	...
	*/
	...
	private static ServiceTracker<TestrayIssuePersistence, TestrayIssuePersistence> _serviceTracker =
		ServiceTrackerFactory.open(TestrayIssuePersistence.class);
}