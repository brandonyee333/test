...
public class TestrayIssueUtil {
	...
	private static ServiceTracker
		<TestrayIssuePersistence, TestrayIssuePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(TestrayIssuePersistence.class);

		ServiceTracker<TestrayIssuePersistence, TestrayIssuePersistence>
			serviceTracker =
				new ServiceTracker
					<TestrayIssuePersistence, TestrayIssuePersistence>(
						bundle.getBundleContext(),
						TestrayIssuePersistence.class, null);
