...
public interface TestrayTaskPersistence extends BasePersistence<TestrayTask> {
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TestrayTask> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<TestrayTask> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TestrayTask> orderByComparator);
