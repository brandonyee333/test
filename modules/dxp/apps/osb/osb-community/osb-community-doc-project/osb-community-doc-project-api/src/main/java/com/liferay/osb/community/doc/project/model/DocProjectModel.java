...
/**
 * The base model interface for the DocProject service. Represents a row in the &quot;OSBCommunity_DocProject&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.osb.community.doc.project.model.impl.DocProjectModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.osb.community.doc.project.model.impl.DocProjectImpl</code>.
 * </p>
 *
 * @author Ryan Park
 * @see DocProject
 ...
 */
@ProviderType
public interface DocProjectModel
	extends BaseModel<DocProject>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a doc project model instance should use the {@link DocProject} interface instead.
	 */
