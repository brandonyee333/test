...
@ImplementationClassName(
	"com.liferay.osb.community.meetup.model.impl.MeetupGroupImpl"
)
@ProviderType
public interface MeetupGroup extends MeetupGroupModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>com.liferay.osb.community.meetup.model.impl.MeetupGroupImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<MeetupGroup, Long> MEETUP_GROUP_ID_ACCESSOR =
		new Accessor<MeetupGroup, Long>() {
