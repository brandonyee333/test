 ...
 */
@ProviderType
public class MeetupGroupLocalServiceWrapper implements MeetupGroupLocalService,
	...
	*/
	...
	public com.liferay.osb.community.meetup.model.MeetupGroup addMeetupGroup(
		...
		return _meetupGroupLocalService.addMeetupGroup(name, city, memberCount,
			description, url, serviceContext);
	}
	...
	*/
	@Override
	public java.util.List<com.liferay.osb.community.meetup.model.MeetupGroup> getMeetupGroups(
		int start, int end) {
