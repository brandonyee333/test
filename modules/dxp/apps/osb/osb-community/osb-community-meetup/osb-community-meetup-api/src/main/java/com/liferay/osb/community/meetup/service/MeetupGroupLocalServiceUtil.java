 ...
 * <code>com.liferay.osb.community.meetup.service.impl.MeetupGroupLocalServiceImpl</code> and
...
public class MeetupGroupLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.osb.community.meetup.service.impl.MeetupGroupLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect MeetupGroupLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
