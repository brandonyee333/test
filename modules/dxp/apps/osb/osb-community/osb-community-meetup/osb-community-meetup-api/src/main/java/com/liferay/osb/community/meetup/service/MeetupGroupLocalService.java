...
public interface MeetupGroupLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.osb.community.meetup.service.impl.MeetupGroupLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the meetup group local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MeetupGroupLocalServiceUtil} if injection and service tracking are not available.
	 */
