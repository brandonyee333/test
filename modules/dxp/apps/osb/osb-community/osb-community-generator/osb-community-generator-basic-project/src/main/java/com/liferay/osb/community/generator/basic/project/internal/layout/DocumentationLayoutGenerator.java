...
@Component(
	...
	property = {
		...
		"osb.community.layout.friendly.url=/documentation",
		"osb.community.layout.hidden:Boolean=false",
		"osb.community.layout.name=Documentation",
		"osb.community.layout.title=Documentation",
...
public class DocumentationLayoutGenerator extends BaseLayoutGenerator {
	...
	protected void doGenerate(long plid) throws Exception {
		...
		layoutTypePortlet.addPortletId(
			layout.getUserId(),
			BasicProjectSitePortletConstants.KNOWLEDGE_BASE_DISPLAY_PORTLET_ID,
			"column-1", 1, false);
