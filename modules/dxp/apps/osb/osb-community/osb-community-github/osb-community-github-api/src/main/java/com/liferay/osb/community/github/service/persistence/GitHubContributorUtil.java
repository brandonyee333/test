...
/**
 * The persistence utility for the git hub contributor service. This utility wraps <code>com.liferay.osb.community.github.service.persistence.impl.GitHubContributorPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class GitHubContributorUtil {
	 ...
	 */
	public static Map<Serializable, GitHubContributor> fetchByPrimaryKeys(
	...
	public static List<GitHubContributor> findByGitHubRepositoryId(
		...
		return getPersistence().findByGitHubRepositoryId(
			gitHubRepositoryId, start, end);
	}
	...
	public static List<GitHubContributor> findByGitHubRepositoryId(
		...
		return getPersistence().findByGitHubRepositoryId(
			gitHubRepositoryId, start, end, orderByComparator, useFinderCache);
	}
	...
	public static GitHubContributor findByGitHubRepositoryId_First(
		...
		throws com.liferay.osb.community.github.exception.
			NoSuchGitHubContributorException {

		return getPersistence().findByGitHubRepositoryId_First(
	...
	public static GitHubContributor fetchByGitHubRepositoryId_First(
		...
		return getPersistence().fetchByGitHubRepositoryId_First(
			gitHubRepositoryId, orderByComparator);
	}
	...
	public static GitHubContributor findByGitHubRepositoryId_Last(
		...
		return getPersistence().findByGitHubRepositoryId_Last(
			gitHubRepositoryId, orderByComparator);
	}
	...
	public static GitHubContributor fetchByGitHubRepositoryId_Last(
		...
		return getPersistence().fetchByGitHubRepositoryId_Last(
			gitHubRepositoryId, orderByComparator);
	}
	...
	public static GitHubContributor[] findByGitHubRepositoryId_PrevAndNext(
		...
		return getPersistence().findByGitHubRepositoryId_PrevAndNext(
			gitHubContributorId, gitHubRepositoryId, orderByComparator);
	}
	 ...
	 */
	public static GitHubContributor fetchByPrimaryKey(
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			GitHubContributorPersistence.class);

		ServiceTracker
			<GitHubContributorPersistence, GitHubContributorPersistence>
				serviceTracker =
					new ServiceTracker
						<GitHubContributorPersistence,
						 GitHubContributorPersistence>(
							 bundle.getBundleContext(),
							 GitHubContributorPersistence.class, null);
