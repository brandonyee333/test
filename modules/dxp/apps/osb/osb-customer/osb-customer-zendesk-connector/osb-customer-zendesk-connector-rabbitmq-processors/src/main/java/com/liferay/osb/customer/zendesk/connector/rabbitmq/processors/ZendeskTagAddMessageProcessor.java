 ...
 */
@Component(
	immediate = true, property = "routing.key=zendesk.service.tag.add",
	service = ZendeskTagAddMessageProcessor.class
)
public class ZendeskTagAddMessageProcessor extends BaseMessageProcessor {
	...
	protected void doProcess(JSONObject jsonObject) throws Exception {
		...
		JSONObject responseJSONObject = _zendeskHttp.put(
