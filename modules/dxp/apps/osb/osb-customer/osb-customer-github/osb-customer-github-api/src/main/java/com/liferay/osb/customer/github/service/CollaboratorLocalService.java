...
/**
 * Provides the local service interface for Collaborator. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CollaboratorLocalServiceUtil
...
public interface CollaboratorLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CollaboratorLocalServiceUtil} to access the collaborator local service. Add custom service methods to {@link com.liferay.osb.customer.github.service.impl.CollaboratorLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Collaborator addCollaborator(long userId, long accountEntryId,
		java.lang.String emailAddress, java.lang.String fullName,
		java.lang.String gitHubUserName) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Collaborator> getCollaborators(java.lang.String gitHubUserName);
