...
public class TicketAttachmentPersistenceImpl extends BasePersistenceImpl<TicketAttachment>
	...
	protected TicketAttachment toUnwrappedModel(
		...
		ticketAttachmentImpl.setAccountEntryId(ticketAttachment.getAccountEntryId());
		ticketAttachmentImpl.setZendeskTicketId(ticketAttachment.getZendeskTicketId());
		ticketAttachmentImpl.setFileRepositoryId(ticketAttachment.getFileRepositoryId());
