 ...
 */
@Component(
	immediate = true, property = "topic.pattern=entity.user.delete",
	service = UserDeleteMessageSubscriber.class
)
public class UserDeleteMessageSubscriber extends BaseMessageSubscriber {
