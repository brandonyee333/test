...
import com.liferay.osb.customer.service.persistence.AuditFormUtil;
...
public class AuditFormPersistenceImpl
	...
	public void cacheResult(List<AuditForm> auditForms) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (auditForms.size() > _valueObjectFinderCacheListThreshold))) {
	...
	public void afterPropertiesSet() {
		...
		_setAuditFormUtilPersistence(this);
	}

	public void destroy() {
		_setAuditFormUtilPersistence(null);
	...
	private void _setAuditFormUtilPersistence(
		AuditFormPersistence auditFormPersistence) {

		try {
			Field field = AuditFormUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, auditFormPersistence);
		}
