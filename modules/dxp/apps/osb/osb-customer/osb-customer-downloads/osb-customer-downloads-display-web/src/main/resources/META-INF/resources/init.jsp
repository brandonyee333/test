...
page import="com.liferay.osb.customer.downloads.display.constants.DownloadsAssetCategoryConstants" %><%@
page import="com.liferay.osb.customer.downloads.display.constants.DownloadsDDMStructureConstants" %><%@
page import="com.liferay.osb.customer.downloads.display.constants.DownloadsDisplayWebKeys" %><%@
