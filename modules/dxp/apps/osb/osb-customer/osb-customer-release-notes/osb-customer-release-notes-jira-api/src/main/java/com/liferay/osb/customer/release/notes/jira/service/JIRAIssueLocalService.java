...
public interface JIRAIssueLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JIRAIssueLocalServiceUtil} to access the jira issue local service. Add custom service methods to {@link com.liferay.osb.customer.release.notes.jira.service.impl.JIRAIssueLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JIRAIssue getJIRAIssue(java.lang.String jiraIssueKey);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<JIRAIssue> getJIRAIssues(java.lang.String[] jiraIssueKeys)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<JIRAIssue> getJIRALabelJIRAIssues(java.lang.String label,
