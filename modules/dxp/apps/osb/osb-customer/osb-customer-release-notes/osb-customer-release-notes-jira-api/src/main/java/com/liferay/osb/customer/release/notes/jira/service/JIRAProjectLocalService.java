...
public interface JIRAProjectLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JIRAProjectLocalServiceUtil} to access the jira project local service. Add custom service methods to {@link com.liferay.osb.customer.release.notes.jira.service.impl.JIRAProjectLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JIRAProject getJIRAProject(java.lang.String key)
		throws PortalException;
