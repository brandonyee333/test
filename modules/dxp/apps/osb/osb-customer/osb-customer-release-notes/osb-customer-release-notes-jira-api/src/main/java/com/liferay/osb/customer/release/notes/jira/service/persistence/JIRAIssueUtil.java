...
public class JIRAIssueUtil {
	...
	*/
	public static JIRAIssue remove(long jiraIssueId)
		throws com.liferay.osb.customer.release.notes.jira.exception.NoSuchJIRAIssueException {
	...
	*/
	...
	private static ServiceTracker<JIRAIssuePersistence, JIRAIssuePersistence> _serviceTracker =
		ServiceTrackerFactory.open(JIRAIssuePersistence.class);
}