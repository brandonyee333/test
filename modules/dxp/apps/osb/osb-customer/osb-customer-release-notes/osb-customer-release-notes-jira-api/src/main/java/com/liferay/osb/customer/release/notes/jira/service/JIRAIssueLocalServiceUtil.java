 ...
 * {@link com.liferay.osb.customer.release.notes.jira.service.impl.JIRAIssueLocalServiceImpl} and is the
 ...
 * @see com.liferay.osb.customer.release.notes.jira.service.base.JIRAIssueLocalServiceBaseImpl
...
public class JIRAIssueLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.customer.release.notes.jira.service.impl.JIRAIssueLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.osb.customer.release.notes.jira.model.JIRAIssue addJIRAIssue(
	...
	*/
	public static com.liferay.osb.customer.release.notes.jira.model.JIRAIssue createJIRAIssue(
		long jiraIssueId) {
	...
	*/
	public static com.liferay.osb.customer.release.notes.jira.model.JIRAIssue deleteJIRAIssue(
		com.liferay.osb.customer.release.notes.jira.model.JIRAIssue jiraIssue) {
	...
	*/
	...
	public static com.liferay.osb.customer.release.notes.jira.model.JIRAIssue fetchJIRAIssue(
		long jiraIssueId) {
	...
	public static java.util.List<com.liferay.osb.customer.release.notes.jira.model.JIRAIssue> getIsRelatedToJIRAIssues(
		long jiraIssueId) {
	...
	* @throws PortalException if a jira issue with the primary key could not be found
	*/
	public static com.liferay.osb.customer.release.notes.jira.model.JIRAIssue getJIRAIssue(
		long jiraIssueId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.osb.customer.release.notes.jira.model.JIRAIssue> getJIRAIssues(
		int start, int end) {
	...
	*/
	...
	public static java.util.List<com.liferay.osb.customer.release.notes.jira.model.JIRAIssue> getJIRALabelJIRAIssues(
		java.lang.String label, java.lang.String jiraProjectKey) {
		return getService().getJIRALabelJIRAIssues(label, jiraProjectKey);
	}

	public static java.util.List<com.liferay.osb.customer.release.notes.jira.model.JIRAIssue> getJIRAProjectVersionJIRAIssues(
		long jiraProjectVersionId) {
		return getService().getJIRAProjectVersionJIRAIssues(jiraProjectVersionId);
	}
	...
	*/
	public static com.liferay.osb.customer.release.notes.jira.model.JIRAIssue updateJIRAIssue(
		com.liferay.osb.customer.release.notes.jira.model.JIRAIssue jiraIssue) {
	...
	private static ServiceTracker<JIRAIssueLocalService, JIRAIssueLocalService> _serviceTracker =
		ServiceTrackerFactory.open(JIRAIssueLocalService.class);
}