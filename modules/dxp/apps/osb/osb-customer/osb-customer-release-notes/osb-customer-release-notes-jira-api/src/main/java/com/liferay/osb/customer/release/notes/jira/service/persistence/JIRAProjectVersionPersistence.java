 ...
 */
@ProviderType
public interface JIRAProjectVersionPersistence
	extends BasePersistence<JIRAProjectVersion> {
	...
	public java.util.List<JIRAProjectVersion> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<JIRAProjectVersion>
			orderByComparator);
