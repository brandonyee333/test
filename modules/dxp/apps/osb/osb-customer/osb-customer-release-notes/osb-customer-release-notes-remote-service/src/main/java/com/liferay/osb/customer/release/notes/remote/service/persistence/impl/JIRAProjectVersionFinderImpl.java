...
package com.liferay.osb.customer.release.notes.remote.service.persistence.impl;

import com.liferay.osb.customer.release.notes.remote.model.JIRAProjectVersion;
import com.liferay.osb.customer.release.notes.remote.model.impl.JIRAProjectVersionImpl;
import com.liferay.osb.customer.release.notes.remote.service.persistence.JIRAProjectVersionFinder;
...
public class JIRAProjectVersionFinderImpl
	...
	public static final String COUNT_BY_P_N =
		JIRAProjectVersionFinder.class.getName() + ".countByP_N";
	...
	public List<JIRAProjectVersion> findByP_N(
		...
		try {
			...
			return (List<JIRAProjectVersion>)QueryUtil.list(
