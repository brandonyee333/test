...
/**
 * Provides the base implementation for the jira project local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.customer.release.notes.jira.service.impl.JIRAProjectLocalServiceImpl}.
 * </p>
 *
...
public abstract class JIRAProjectLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, JIRAProjectLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JIRAProjectLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>JIRAProjectLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			JIRAProject.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return jiraProjectPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return jiraProjectPersistence.countWithDynamicQuery(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return jiraProjectLocalService.deleteJIRAProject(
			(JIRAProject)persistedModel);
	}

	public BasePersistence<JIRAProject> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(jiraProjectLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = JIRAProjectLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, jiraProjectLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JIRAProjectLocalServiceBaseImpl.class);
