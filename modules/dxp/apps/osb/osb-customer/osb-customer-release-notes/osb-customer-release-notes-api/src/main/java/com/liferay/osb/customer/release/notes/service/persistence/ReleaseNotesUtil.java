...
public class ReleaseNotesUtil {
	...
	private static ServiceTracker
		<ReleaseNotesPersistence, ReleaseNotesPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ReleaseNotesPersistence.class);

		ServiceTracker<ReleaseNotesPersistence, ReleaseNotesPersistence>
			serviceTracker =
				new ServiceTracker
					<ReleaseNotesPersistence, ReleaseNotesPersistence>(
						bundle.getBundleContext(),
						ReleaseNotesPersistence.class, null);
