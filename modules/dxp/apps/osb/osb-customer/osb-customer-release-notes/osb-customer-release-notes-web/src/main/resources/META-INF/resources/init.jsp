...
page import="com.liferay.osb.customer.release.notes.search.ReleaseNotesDisplayTerms" %><%@
page import="com.liferay.osb.customer.release.notes.search.ReleaseNotesSearch" %><%@
