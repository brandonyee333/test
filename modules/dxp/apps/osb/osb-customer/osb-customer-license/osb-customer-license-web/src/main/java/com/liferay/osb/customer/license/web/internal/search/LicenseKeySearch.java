		...
		try {
			...
			if (Validator.isNotNull(orderByCol) &&
				...
				preferences.setValue(
					CustomerLicensePortletKeys.LICENSE,
					"license-key-order-by-col", orderByCol);
				preferences.setValue(
					CustomerLicensePortletKeys.LICENSE,
					"license-key-order-by-type", orderByType);
			}
			else {
				orderByCol = preferences.getValue(
					CustomerLicensePortletKeys.LICENSE,
					"license-key-order-by-col", "start-date");
				orderByType = preferences.getValue(
					CustomerLicensePortletKeys.LICENSE,
					"license-key-order-by-type", "desc");
			}
