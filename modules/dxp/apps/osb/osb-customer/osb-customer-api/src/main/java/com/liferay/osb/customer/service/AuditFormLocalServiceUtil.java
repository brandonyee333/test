 ...
 * {@link com.liferay.osb.customer.service.impl.AuditFormLocalServiceImpl} and is the
...
public class AuditFormLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.customer.service.impl.AuditFormLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<com.liferay.osb.customer.model.AuditForm> getAuditForms(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<AuditFormLocalService, AuditFormLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AuditFormLocalService.class);
}