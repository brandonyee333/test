...
public interface AuditFormLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.osb.customer.service.impl.AuditFormLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the audit form local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AuditFormLocalServiceUtil} if injection and service tracking are not available.
	 */
