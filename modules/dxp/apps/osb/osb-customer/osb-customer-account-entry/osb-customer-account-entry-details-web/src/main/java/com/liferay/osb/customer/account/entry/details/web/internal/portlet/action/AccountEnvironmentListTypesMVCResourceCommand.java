...
@Component(
	property = {
		...
		"mvc.command.name=/account_environment_list_types"
	},
	service = MVCResourceCommand.class
)
public class AccountEnvironmentListTypesMVCResourceCommand
	...
	protected void doServeResource(
		...
		JSONObject jsonObject = OSBRequestUtil.getAccountEnvironmentListTypes(
			resourceRequest);
