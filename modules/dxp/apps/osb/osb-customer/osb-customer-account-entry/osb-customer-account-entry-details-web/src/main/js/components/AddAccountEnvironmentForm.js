...
export class AddAccountEnvironmentForm extends React.Component {
	...
	handleSubmit = () =>
		this.addEnvironmentFormRef.current.submit();
					...
					<div className="row">
						<div className="col-md-12">
							<div className="form-group">
								...
								<input className="form-control" id={`${portletNamespace}accountEnvironmentName`} name={`${portletNamespace}name`} onBlur={props.handleBlur} onChange={props.handleChange} type="text" value={props.values.name} />
							</div>

							{props.touched[`${portletNamespace}name`] && props.errors[`${portletNamespace}name`] && (
						...
						<div className="col-md-9">
							<div className="form-group">
								...
								<select className="form-control" id={`${portletNamespace}accountEnvironmentProduct`} name={`${portletNamespace}product`} onBlur={props.handleBlur} onChange={this.handleSelectChange}>
							...
							{props.touched[`${portletNamespace}product`] && props.errors[`${portletNamespace}product`] && (
								<div className="alert alert-danger" role="alert">
						...
						<div className="col-md-3">
							<div className="form-group">
								...
								<select className="form-control" disabled={productIndex == null} id={`${portletNamespace}envLFR`} name={`${portletNamespace}envLFR`} onBlur={props.handleBlur} onChange={this.handleSelectChange}>
									<option value="" label={Liferay.Language.get('select')} />
							...
							{props.touched[`${portletNamespace}envLFR`] && props.errors[`${portletNamespace}envLFR`] && (
								<div className="alert alert-danger" role="alert">
						...
						<div className="col-md-6">
							<div className="form-group">
								...
								<select className="form-control" disabled={envLFRIndex == null} id={`${portletNamespace}envOS`} name={`${portletNamespace}envOS`} onBlur={props.handleBlur} onChange={props.handleChange}>
									<option value="" label={Liferay.Language.get('select')} />
							...
							{props.touched[`${portletNamespace}envOS`] && props.errors[`${portletNamespace}envOS`] && (
								<div className="alert alert-danger" role="alert">
						...
						<div className="col-md-6">
							<div className="form-group">
								...
								<select className="form-control" disabled={envLFRIndex == null} id={`${portletNamespace}envJVM`} name={`${portletNamespace}envJVM`} onBlur={props.handleBlur} onChange={props.handleChange}>
									<option value="" label={Liferay.Language.get('select')} />
							...
							{props.touched[`${portletNamespace}envJVM`] && props.errors[`${portletNamespace}envJVM`] && (
								<div className="alert alert-danger" role="alert">
						...
						<div className="col-md-6">
							<div className="form-group">
								...
								<select className="form-control" disabled={envLFRIndex == null} id={`${portletNamespace}envAS`} name={`${portletNamespace}envAS`} onBlur={props.handleBlur} onChange={props.handleChange}>
									<option value="" label={Liferay.Language.get('select')} />
							...
							{props.touched[`${portletNamespace}envAS`] && props.errors[`${portletNamespace}envAS`] && (
								<div className="alert alert-danger" role="alert">
						...
						<div className="col-md-6">
							<div className="form-group">
								...
								<select className="form-control" disabled={envLFRIndex == null} id={`${portletNamespace}envDB`} name={`${portletNamespace}envDB`} onBlur={props.handleBlur} onChange={props.handleChange}>
									<option value="" label={Liferay.Language.get('select')} />
							...
							{props.touched[`${portletNamespace}envDB`] && props.errors[`${portletNamespace}envDB`] && (
								<div className="alert alert-danger" role="alert">
						...
						<div className="col-md-6">
							<div className="form-group">
								...
								<select className="form-control" disabled={envLFRIndex == null} id={`${portletNamespace}envBrowser`} name={`${portletNamespace}envBrowser`} onBlur={props.handleBlur} onChange={props.handleChange}>
									<option value="" label={Liferay.Language.get('select')} />
							...
							{props.touched[`${portletNamespace}envBrowser`] && props.errors[`${portletNamespace}envBrowser`] && (
								<div className="alert alert-danger" role="alert">
						...
						{productIndex && envLFRIndex && productEntries[productIndex].envListTypes[envLFRIndex].envCS ? (
							<div className="col-md-6">
								<div className="form-group">
									...
									<select className="form-control" disabled={envLFRIndex == null} id={`${portletNamespace}envCS`} name={`${portletNamespace}envCS`} onBlur={props.handleBlur} onChange={props.handleChange}>
										<option value="" label={Liferay.Language.get('select')} />
								...
								{props.touched[`${portletNamespace}envCS`] && props.errors[`${portletNamespace}envCS`] && (
									<div className="alert alert-danger" role="alert">
						...
						{productIndex && envLFRIndex && productEntries[productIndex].envListTypes[envLFRIndex].envSearch ? (
							<div className="col-md-12">
								<div className="form-group">
									...
									<select className="form-control" disabled={envLFRIndex == null} id={`${portletNamespace}envSearch`} multiple={true} name={`${portletNamespace}envSearch`} onBlur={props.handleBlur} onChange={props.handleChange}>
										{productEntries[productIndex].envListTypes[envLFRIndex].envSearch.map(
											(envSearch, index) => (
												<option id={'envSearch-' + index} key={'envSearch-' + index} label={envSearch.name} value={envSearch.value} />
											)
										)}
									</select>
								</div>

								{props.touched[`${portletNamespace}envSearch`] && props.errors[`${portletNamespace}envSearch`] && (
									<div className="alert alert-danger" role="alert">
						...
						<div className="col-md-12">
							<div className="form-group">
								...
								<div className="upload-dropzone">
									<input className="form-control" id={`${portletNamespace}portalExt`} name={`${portletNamespace}portalExt`} onBlur={props.handleBlur} onChange={this.handleFileChange} type="file" />
							...
							{props.touched[`${portletNamespace}portalExt`] && props.errors[`${portletNamespace}portalExt`] && (
								<div className="alert alert-danger" role="alert">
						...
						<div className="col-md-12">
							<div className="form-group">
								...
								<div className="upload-dropzone">
									<input className="form-control" id={`${portletNamespace}patchLevel`} name={`${portletNamespace}patchLevel`} onBlur={props.handleBlur} onChange={this.handleFileChange} type="file" />
							...
							{props.touched[`${portletNamespace}patchLevel`] && props.errors[`${portletNamespace}patchLevel`] && (
								<div className="alert alert-danger" role="alert">
