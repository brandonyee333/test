 ...
 * @see com.liferay.osb.customer.account.entry.details.service.persistence.impl.EventPersistenceImpl
 * @generated
 */
@ProviderType
public class EventUtil {
	...
	*/
	public static List<Event> findByA_C(long accountEntryId, long classNameId,
		int start, int end) {
		return getPersistence()
				   .findByA_C(accountEntryId, classNameId, start, end);
	}
	...
	*/
	public static Event findByA_C_First(long accountEntryId, long classNameId,
		OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
				   .findByA_C_First(accountEntryId, classNameId,
			orderByComparator);
	}
	...
	*/
	public static Event fetchByA_C_First(long accountEntryId, long classNameId,
		OrderByComparator<Event> orderByComparator) {
		return getPersistence()
				   .fetchByA_C_First(accountEntryId, classNameId,
			orderByComparator);
	}
	...
	* @throws NoSuchEventException if a matching event could not be found
	*/
	public static Event findByA_C_Last(long accountEntryId, long classNameId,
		OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
				   .findByA_C_Last(accountEntryId, classNameId,
			orderByComparator);
	}
	...
	*/
	public static Event fetchByA_C_Last(long accountEntryId, long classNameId,
		OrderByComparator<Event> orderByComparator) {
		return getPersistence()
				   .fetchByA_C_Last(accountEntryId, classNameId,
			orderByComparator);
	}
	...
	*/
	public static Event[] findByA_C_PrevAndNext(long eventId,
		long accountEntryId, long classNameId,
		OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
				   .findByA_C_PrevAndNext(eventId, accountEntryId, classNameId,
			orderByComparator);
	}
	...
	* @throws NoSuchEventException if a matching event could not be found
	*/
	public static Event findByC_C_First(long classNameId, long classPK,
		OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
	...
	* @return the first matching event, or <code>null</code> if a matching event could not be found
	*/
	public static Event fetchByC_C_First(long classNameId, long classPK,
		OrderByComparator<Event> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchEventException if a matching event could not be found
	*/
	public static Event findByC_C_Last(long classNameId, long classPK,
		OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
	...
	* @return the last matching event, or <code>null</code> if a matching event could not be found
	*/
	public static Event fetchByC_C_Last(long classNameId, long classPK,
		OrderByComparator<Event> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchEventException if a event with the primary key could not be found
	*/
	public static Event[] findByC_C_PrevAndNext(long eventId, long classNameId,
		long classPK, OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
				   .findByC_C_PrevAndNext(eventId, classNameId, classPK,
			orderByComparator);
	}
	...
	* @return the matching events
	*/
	public static List<Event> findByC_C_T(long classNameId, long classPK,
		int type) {
	...
	*/
	public static List<Event> findByC_C_T(long classNameId, long classPK,
		int type, int start, int end, OrderByComparator<Event> orderByComparator) {
		return getPersistence()
				   .findByC_C_T(classNameId, classPK, type, start, end,
			orderByComparator);
	}
	...
	* @throws NoSuchEventException if a matching event could not be found
	*/
	public static Event findByC_C_T_First(long classNameId, long classPK,
		int type, OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
	...
	* @return the first matching event, or <code>null</code> if a matching event could not be found
	*/
	public static Event fetchByC_C_T_First(long classNameId, long classPK,
		int type, OrderByComparator<Event> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchEventException if a matching event could not be found
	*/
	public static Event findByC_C_T_Last(long classNameId, long classPK,
		int type, OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
	...
	* @return the last matching event, or <code>null</code> if a matching event could not be found
	*/
	public static Event fetchByC_C_T_Last(long classNameId, long classPK,
		int type, OrderByComparator<Event> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchEventException if a event with the primary key could not be found
	*/
	public static Event[] findByC_C_T_PrevAndNext(long eventId,
		long classNameId, long classPK, int type,
		OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
				   .findByC_C_T_PrevAndNext(eventId, classNameId, classPK,
	...
	*/
	public static List<Event> findByC_C_T(long classNameId, long classPK,
		...
		return getPersistence()
				   .findByC_C_T(classNameId, classPK, types, start, end);
	}
	...
	* @return the number of matching events
	*/
	public static int countByC_C_T(long classNameId, long classPK, int[] types) {
	...
	* @return the matching events
	*/
	public static List<Event> findByC_C_T_TC_TC(long classNameId, long classPK,
		int type, long typeClassNameId, long typeClassPK) {
		return getPersistence()
				   .findByC_C_T_TC_TC(classNameId, classPK, type,
	...
	*/
	public static List<Event> findByC_C_T_TC_TC(long classNameId, long classPK,
		...
		return getPersistence()
				   .findByC_C_T_TC_TC(classNameId, classPK, type,
			typeClassNameId, typeClassPK, start, end);
	}
	...
	*/
	public static List<Event> findByC_C_T_TC_TC(long classNameId, long classPK,
		...
		return getPersistence()
				   .findByC_C_T_TC_TC(classNameId, classPK, type,
			typeClassNameId, typeClassPK, start, end, orderByComparator);
	}
	...
	* @throws NoSuchEventException if a matching event could not be found
	*/
	public static Event findByC_C_T_TC_TC_First(long classNameId, long classPK,
		int type, long typeClassNameId, long typeClassPK,
		OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
				   .findByC_C_T_TC_TC_First(classNameId, classPK, type,
	...
	* @return the first matching event, or <code>null</code> if a matching event could not be found
	*/
	public static Event fetchByC_C_T_TC_TC_First(long classNameId,
		long classPK, int type, long typeClassNameId, long typeClassPK,
		OrderByComparator<Event> orderByComparator) {
		return getPersistence()
				   .fetchByC_C_T_TC_TC_First(classNameId, classPK, type,
			typeClassNameId, typeClassPK, orderByComparator);
	}
	...
	* @throws NoSuchEventException if a matching event could not be found
	*/
	public static Event findByC_C_T_TC_TC_Last(long classNameId, long classPK,
		int type, long typeClassNameId, long typeClassPK,
		OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
				   .findByC_C_T_TC_TC_Last(classNameId, classPK, type,
			typeClassNameId, typeClassPK, orderByComparator);
	}
	...
	* @return the last matching event, or <code>null</code> if a matching event could not be found
	*/
	public static Event fetchByC_C_T_TC_TC_Last(long classNameId, long classPK,
		int type, long typeClassNameId, long typeClassPK,
		OrderByComparator<Event> orderByComparator) {
		return getPersistence()
				   .fetchByC_C_T_TC_TC_Last(classNameId, classPK, type,
			typeClassNameId, typeClassPK, orderByComparator);
	}
	...
	* @throws NoSuchEventException if a event with the primary key could not be found
	*/
	public static Event[] findByC_C_T_TC_TC_PrevAndNext(long eventId,
		long classNameId, long classPK, int type, long typeClassNameId,
		long typeClassPK, OrderByComparator<Event> orderByComparator)
		throws com.liferay.osb.customer.account.entry.details.exception.NoSuchEventException {
		return getPersistence()
				   .findByC_C_T_TC_TC_PrevAndNext(eventId, classNameId,
			classPK, type, typeClassNameId, typeClassPK, orderByComparator);
	}
	...
	* @param typeClassPK the type class pk
	*/
	public static void removeByC_C_T_TC_TC(long classNameId, long classPK,
		int type, long typeClassNameId, long typeClassPK) {
		getPersistence()
			.removeByC_C_T_TC_TC(classNameId, classPK, type, typeClassNameId,
			typeClassPK);
	}
	...
	* @return the number of matching events
	*/
	public static int countByC_C_T_TC_TC(long classNameId, long classPK,
		int type, long typeClassNameId, long typeClassPK) {
		return getPersistence()
				   .countByC_C_T_TC_TC(classNameId, classPK, type,
			typeClassNameId, typeClassPK);
	}
