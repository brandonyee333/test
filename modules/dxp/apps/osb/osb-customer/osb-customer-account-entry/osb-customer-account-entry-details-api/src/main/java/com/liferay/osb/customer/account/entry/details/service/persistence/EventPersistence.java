...
public interface EventPersistence extends BasePersistence<Event> {
	...
	*/
	public java.util.List<Event> findByA_C(long accountEntryId, long classNameId);
	...
	*/
	public java.util.List<Event> findByA_C(long accountEntryId,
	...
	* @return the matching events
	*/
	public java.util.List<Event> findByC_C_T(long classNameId, long classPK,
		int type);
	...
	* @return the matching events
	*/
	public java.util.List<Event> findByC_C_T_TC_TC(long classNameId,
