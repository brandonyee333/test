...
public class JIRAComponentPersistenceImpl extends BasePersistenceImpl<JIRAComponent>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_REMOTEID = new FinderPath(JIRAComponentModelImpl.ENTITY_CACHE_ENABLED,
			JIRAComponentModelImpl.FINDER_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_REMOTEID = new FinderPath(JIRAComponentModelImpl.ENTITY_CACHE_ENABLED,
			JIRAComponentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByRemoteId",
			new String[] { Long.class.getName() });

	/**
	 * Returns the jira component where remoteId = &#63; or throws a {@link NoSuchJIRAComponentException} if it could not be found.
	 *
	...
	public JIRAComponent fetchByRemoteId(long remoteId,
		...
		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_REMOTEID,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_REMOTEID_REMOTEID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_REMOTEID,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
				...
				finderCache.removeResult(FINDER_PATH_FETCH_BY_REMOTEID,
					finderArgs);
	...
	public int countByRemoteId(long remoteId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_REMOTEID;
	...
	private static final String _FINDER_COLUMN_REMOTEID_REMOTEID_2 = "jiraComponent.remoteId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_VISIBLE = new FinderPath(JIRAComponentModelImpl.ENTITY_CACHE_ENABLED,
			JIRAComponentModelImpl.FINDER_CACHE_ENABLED,
			JIRAComponentImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByVisible",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_VISIBLE = new FinderPath(JIRAComponentModelImpl.ENTITY_CACHE_ENABLED,
			JIRAComponentModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<JIRAComponent> findByVisible(boolean visible, int start, int end) {
	 ...
	 */
	@Override
	public List<JIRAComponent> findByVisible(boolean visible, int start,
		int end, OrderByComparator<JIRAComponent> orderByComparator) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (JIRAComponent jiraComponent : list) {
					if ((visible != jiraComponent.getVisible())) {
						list = null;
	 ...
	 */
	@Override
	public JIRAComponent findByVisible_First(boolean visible,
		OrderByComparator<JIRAComponent> orderByComparator)
		throws NoSuchJIRAComponentException {
		JIRAComponent jiraComponent = fetchByVisible_First(visible,
				orderByComparator);
	 ...
	 */
	@Override
	public JIRAComponent fetchByVisible_First(boolean visible,
		OrderByComparator<JIRAComponent> orderByComparator) {
		List<JIRAComponent> list = findByVisible(visible, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public JIRAComponent findByVisible_Last(boolean visible,
		OrderByComparator<JIRAComponent> orderByComparator)
		throws NoSuchJIRAComponentException {
		JIRAComponent jiraComponent = fetchByVisible_Last(visible,
				orderByComparator);
	 ...
	 */
	@Override
	public JIRAComponent fetchByVisible_Last(boolean visible,
		OrderByComparator<JIRAComponent> orderByComparator) {
		...
		List<JIRAComponent> list = findByVisible(visible, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public JIRAComponent[] findByVisible_PrevAndNext(long jiraComponentId,
		...
		try {
			...
			array[0] = getByVisible_PrevAndNext(session, jiraComponent,
					visible, orderByComparator, true);

			array[1] = jiraComponent;

			array[2] = getByVisible_PrevAndNext(session, jiraComponent,
					visible, orderByComparator, false);
	...
	protected JIRAComponent getByVisible_PrevAndNext(Session session,
		JIRAComponent jiraComponent, boolean visible,
	...
	public void removeByVisible(boolean visible) {
		for (JIRAComponent jiraComponent : findByVisible(visible,
	...
	private static final String _FINDER_COLUMN_VISIBLE_VISIBLE_2 = "jiraComponent.visible = ?";
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(FINDER_PATH_COUNT_BY_REMOTEID, args,
			Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_REMOTEID, args,
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_REMOTEID, args);
			finderCache.removeResult(FINDER_PATH_FETCH_BY_REMOTEID, args);
		}

		if ((jiraComponentModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_REMOTEID.getColumnBitmask()) != 0) {
	...
	public JIRAComponent updateImpl(JIRAComponent jiraComponent) {
		...
		if (!JIRAComponentModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			Object[] args = new Object[] { jiraComponentModelImpl.getVisible() };
			...
			if ((jiraComponentModelImpl.getColumnBitmask() &
				...
				args = new Object[] { jiraComponentModelImpl.getVisible() };
