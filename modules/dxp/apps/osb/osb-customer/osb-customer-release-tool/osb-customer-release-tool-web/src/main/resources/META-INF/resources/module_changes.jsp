...
<aui:script>
	ReleaseTool.render(
		ReleaseTool.ModuleChanges,
		{
			...
			filters: <%= productName.equals(ProductConstants.COMMERCE) ? releaseToolDisplayContext.getArtifactVersionFiltersJSONArray(ProductConstants.COMMERCE) : releaseToolDisplayContext.getArtifactVersionFiltersJSONArray(ProductConstants.DXP) %>,
