...
/**
 * Provides the local service interface for ModuleVersion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ModuleVersionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ModuleVersionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ModuleVersionLocalServiceUtil} to access the module version local service. Add custom service methods to <code>com.liferay.osb.customer.release.tool.service.impl.ModuleVersionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
