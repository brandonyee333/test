...
public class JIRAComponentUtil {
	...
	*/
	public static List<JIRAComponent> findByVisible(boolean visible, int start,
		int end) {
	...
	* @throws NoSuchJIRAComponentException if a matching jira component could not be found
	*/
	public static JIRAComponent findByVisible_First(boolean visible,
		OrderByComparator<JIRAComponent> orderByComparator)
		throws com.liferay.osb.customer.release.tool.exception.NoSuchJIRAComponentException {
	...
	*/
	public static JIRAComponent fetchByVisible_First(boolean visible,
		OrderByComparator<JIRAComponent> orderByComparator) {
	...
	* @throws NoSuchJIRAComponentException if a matching jira component could not be found
	*/
	public static JIRAComponent findByVisible_Last(boolean visible,
		OrderByComparator<JIRAComponent> orderByComparator)
		throws com.liferay.osb.customer.release.tool.exception.NoSuchJIRAComponentException {
	...
	*/
	public static JIRAComponent fetchByVisible_Last(boolean visible,
		OrderByComparator<JIRAComponent> orderByComparator) {
	...
	*/
	public static JIRAComponent[] findByVisible_PrevAndNext(
		...
		throws com.liferay.osb.customer.release.tool.exception.NoSuchJIRAComponentException {
		return getPersistence()
				   .findByVisible_PrevAndNext(jiraComponentId, visible,
			orderByComparator);
	}
