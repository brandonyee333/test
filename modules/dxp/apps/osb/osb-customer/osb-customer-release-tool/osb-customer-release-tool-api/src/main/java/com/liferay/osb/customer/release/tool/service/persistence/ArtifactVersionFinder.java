 ...
 */
@ProviderType
public interface ArtifactVersionFinder {
	public java.util.List<com.liferay.osb.customer.release.tool.model.ArtifactVersionRange> findArtifactVersionRangesByRACI_RACI_O_K(
