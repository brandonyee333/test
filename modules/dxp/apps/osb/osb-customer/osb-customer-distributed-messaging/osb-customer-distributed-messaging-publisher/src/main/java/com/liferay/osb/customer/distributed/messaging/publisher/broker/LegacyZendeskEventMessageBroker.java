...
@Component(
	immediate = true,
	property = {
		"exchange=is_entity_exchange",
		"publishing.topic.pattern=zendesk.organization.*",
		"publishing.topic.pattern=zendesk.user.*"
	},
	service = LegacyZendeskEventMessageBroker.class
)
public class LegacyZendeskEventMessageBroker extends BaseMessageBroker {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LegacyZendeskEventMessageBroker.class);
