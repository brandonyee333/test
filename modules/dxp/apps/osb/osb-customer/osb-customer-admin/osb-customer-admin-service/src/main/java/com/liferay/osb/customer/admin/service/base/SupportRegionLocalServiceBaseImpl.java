 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.customer.admin.service.impl.SupportRegionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.customer.admin.service.impl.SupportRegionLocalServiceImpl
 * @generated
 */
public abstract class SupportRegionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, SupportRegionLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SupportRegionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.osb.customer.admin.service.SupportRegionLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SupportRegion.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return supportRegionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return supportRegionPersistence.countWithDynamicQuery(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return supportRegionLocalService.deleteSupportRegion(
			(SupportRegion)persistedModel);
	}

	public BasePersistence<SupportRegion> getBasePersistence() {
	...
	public void addAccountEntrySupportRegion(
		...
		accountEntryPersistence.addSupportRegion(
	...
	public void addAccountEntrySupportRegions(
		...
		accountEntryPersistence.addSupportRegions(
	...
	public void deleteAccountEntrySupportRegion(
		...
		accountEntryPersistence.removeSupportRegion(
			accountEntryId, supportRegionId);
	}
	...
	public void deleteAccountEntrySupportRegions(
		...
		accountEntryPersistence.removeSupportRegions(
			accountEntryId, supportRegionIds);
	}
	...
	public long[] getAccountEntryPrimaryKeys(long supportRegionId) {
		return supportRegionPersistence.getAccountEntryPrimaryKeys(
			supportRegionId);
	}
	...
	public List<SupportRegion> getAccountEntrySupportRegions(
		...
		return accountEntryPersistence.getSupportRegions(
	...
	public boolean hasAccountEntrySupportRegion(
		...
		return accountEntryPersistence.containsSupportRegion(
			accountEntryId, supportRegionId);
	}
