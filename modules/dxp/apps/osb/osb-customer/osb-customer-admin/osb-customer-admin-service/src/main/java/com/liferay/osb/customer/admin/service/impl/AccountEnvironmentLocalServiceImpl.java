...
import com.liferay.osb.customer.admin.exception.AccountEnvironmentEnvCommerceException;
import com.liferay.osb.customer.admin.exception.AccountEnvironmentEnvDBException;
import com.liferay.osb.customer.admin.exception.AccountEnvironmentEnvLFRException;
import com.liferay.osb.customer.admin.exception.AccountEnvironmentEnvOSException;
import com.liferay.osb.customer.admin.exception.AccountEnvironmentEnvSearchException;
	...
	protected void validate(
		...
		if (envCS > 0) {
			...
			if (!ProductEntryConstants.isPortalVersion6_2(envLFR) &&
				...
				!ProductEntryConstants.isDigitalEnterpriseVersion7_3(envLFR) &&
				!ProductEntryConstants.isDigitalEnterpriseVersion7_4(envLFR)) {
