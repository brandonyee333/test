...
public class SupportRegionPersistenceImpl
	...
	public SupportRegion findByName(String name)
		...
		if (supportRegion == null) {
			...
			throw new NoSuchSupportRegionException(sb.toString());
		}
	...
	public SupportRegion fetchByName(String name, boolean useFinderCache) {
		...
		if (result == null) {
			...
			sb.append(_SQL_SELECT_SUPPORTREGION_WHERE);
			...
			try {
				...
				List<SupportRegion> list = query.list();
	...
	public int countByName(String name) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_SUPPORTREGION_WHERE);
	...
	public SupportRegion remove(Serializable primaryKey)
		...
		catch (NoSuchSupportRegionException noSuchEntityException) {
	...
	public Map<Serializable, SupportRegion> fetchByPrimaryKeys(
		...
		sb.append(_SQL_SELECT_SUPPORTREGION_WHERE_PKS_IN);
		...
		try {
			...
			for (SupportRegion supportRegion :
					(List<SupportRegion>)query.list()) {
	...
	public List<SupportRegion> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_SUPPORTREGION);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_SUPPORTREGION);
