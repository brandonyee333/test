...
public abstract class AccountAttachmentServiceBaseImpl
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(accountAttachmentService);
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accountAttachmentPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = AccountAttachmentServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, accountAttachmentService);
		}
