...
public class AccountEnvironmentAttachmentServiceHttp {
	...
	public static
		...
		try {
			MethodKey methodKey = new MethodKey(
				AccountEnvironmentAttachmentServiceUtil.class,
				"getAccountEnvironmentAttachment",
				_getAccountEnvironmentAttachmentParameterTypes0);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, accountEnvironmentAttachmentId);
			...
			return (com.liferay.osb.customer.admin.model.
				AccountEnvironmentAttachment)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(
		AccountEnvironmentAttachmentServiceHttp.class);

	private static final Class<?>[]
		_getAccountEnvironmentAttachmentParameterTypes0 = new Class[] {
			long.class
		};
