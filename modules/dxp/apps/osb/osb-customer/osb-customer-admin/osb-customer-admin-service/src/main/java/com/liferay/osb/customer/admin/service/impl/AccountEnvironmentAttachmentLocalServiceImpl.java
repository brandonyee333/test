...
import com.liferay.osb.customer.admin.exception.DuplicateAccountEnvironmentAttachmentException;
import com.liferay.osb.customer.admin.model.AccountEnvironmentAttachment;
import com.liferay.osb.customer.admin.service.base.AccountEnvironmentAttachmentLocalServiceBaseImpl;
...
public class AccountEnvironmentAttachmentLocalServiceImpl
	...
	protected void addFile(String fileDir, String fileName, File file)
		...
		if (!DLStoreUtil.hasDirectory(
				OSBCustomerConstants.COMPANY_ID, CompanyConstants.SYSTEM,
				fileDir)) {
