...
package com.liferay.osb.customer.admin.web.internal.application.list;
...
public class AdminPanelApp extends BasePanelApp {
	...
	public String getPortletId() {
		return CustomerAdminPortletKeys.ADMIN;
	}

	@Override
	@Reference(
		target = "(javax.portlet.name=" + CustomerAdminPortletKeys.ADMIN + ")",
		unbind = "-"
	)
