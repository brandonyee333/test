...
/**
 * This class is used by SOAP remote services, specifically {@link com.liferay.osb.customer.admin.service.http.AccountEnvironmentServiceSoap}.
 *
...
public class AccountEnvironmentSoap implements Serializable {
	...
	public static AccountEnvironmentSoap[] toSoapModels(
		...
		AccountEnvironmentSoap[] soapModels =
			new AccountEnvironmentSoap[models.length];
	...
	public static AccountEnvironmentSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels =
				new AccountEnvironmentSoap[models.length][models[0].length];
		}
		else {
	...
	public static AccountEnvironmentSoap[] toSoapModels(
		...
		List<AccountEnvironmentSoap> soapModels =
			new ArrayList<AccountEnvironmentSoap>(models.size());
		...
		return soapModels.toArray(
			new AccountEnvironmentSoap[soapModels.size()]);
	}
