...
public class AccountEntryUtil {
	 ...
	 */
	public static List<com.liferay.osb.customer.admin.model.SupportRegion>
	...
	public static List<com.liferay.osb.customer.admin.model.SupportRegion>
		...
		return getPersistence().getSupportRegions(
	 ...
	 */
	public static void addSupportRegion(
		long pk,
	 ...
	 */
	public static void addSupportRegions(
		long pk,
	 ...
	 * @param supportRegion the support region
	 */
	public static void removeSupportRegion(
		long pk,
		com.liferay.osb.customer.admin.model.SupportRegion supportRegion) {
	 ...
	 * @param supportRegions the support regions
	 */
	public static void removeSupportRegions(
		long pk,
		List<com.liferay.osb.customer.admin.model.SupportRegion>
			supportRegions) {
	 ...
	 */
	public static void setSupportRegions(
		long pk,
		List<com.liferay.osb.customer.admin.model.SupportRegion>
			supportRegions) {
