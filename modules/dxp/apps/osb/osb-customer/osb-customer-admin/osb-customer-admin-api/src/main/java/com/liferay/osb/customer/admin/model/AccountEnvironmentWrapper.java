 ...
 * @generated
 */
public class AccountEnvironmentWrapper
	implements AccountEnvironment, ModelWrapper<AccountEnvironment> {
	...
	@Override
	public Object clone() {
		return new AccountEnvironmentWrapper(
			(AccountEnvironment)_accountEnvironment.clone());
	}
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<AccountEnvironment>
		toCacheModel() {
	...
	public AccountEnvironment toEscapedModel() {
		return new AccountEnvironmentWrapper(
			_accountEnvironment.toEscapedModel());
	}
	...
	public AccountEnvironment toUnescapedModel() {
		return new AccountEnvironmentWrapper(
			_accountEnvironment.toUnescapedModel());
	}
