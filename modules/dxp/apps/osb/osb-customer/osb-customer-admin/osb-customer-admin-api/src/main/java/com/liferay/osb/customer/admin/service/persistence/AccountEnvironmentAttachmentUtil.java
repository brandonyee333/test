...
public class AccountEnvironmentAttachmentUtil {
	...
	private static ServiceTracker
		<AccountEnvironmentAttachmentPersistence,
		 AccountEnvironmentAttachmentPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			AccountEnvironmentAttachmentPersistence.class);

		ServiceTracker
			<AccountEnvironmentAttachmentPersistence,
			 AccountEnvironmentAttachmentPersistence> serviceTracker =
				new ServiceTracker
					<AccountEnvironmentAttachmentPersistence,
					 AccountEnvironmentAttachmentPersistence>(
						 bundle.getBundleContext(),
						 AccountEnvironmentAttachmentPersistence.class, null);
