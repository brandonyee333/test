...
/**
 * The persistence utility for the account entry language service. This utility wraps <code>com.liferay.osb.customer.admin.service.persistence.impl.AccountEntryLanguagePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class AccountEntryLanguageUtil {
	 ...
	 */
	public static Map<Serializable, AccountEntryLanguage> fetchByPrimaryKeys(
	...
	public static AccountEntryLanguage findByAccountEntryId_First(
		...
		throws com.liferay.osb.customer.admin.exception.
			NoSuchAccountEntryLanguageException {
	...
	public static AccountEntryLanguage[] findByAccountEntryId_PrevAndNext(
		...
		return getPersistence().findByAccountEntryId_PrevAndNext(
			accountEntryLanguageId, accountEntryId, orderByComparator);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			AccountEntryLanguagePersistence.class);

		ServiceTracker
			<AccountEntryLanguagePersistence, AccountEntryLanguagePersistence>
				serviceTracker =
					new ServiceTracker
						<AccountEntryLanguagePersistence,
						 AccountEntryLanguagePersistence>(
							 bundle.getBundleContext(),
							 AccountEntryLanguagePersistence.class, null);
