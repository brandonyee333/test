...
public class ZendeskArticleLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskArticle updateRemoteUserSegmentId(
		long zendeskArticleId, long remoteUserSegmentId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateRemoteUserSegmentId(zendeskArticleId,
			remoteUserSegmentId);
	}
	...
	*/
	...
	public static com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskArticle updateZendeskArticleTranslation(
		long zendeskArticleId, java.util.Locale locale,
		java.lang.String remoteTitle, java.lang.String remoteBody)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateZendeskArticleTranslation(zendeskArticleId, locale,
			remoteTitle, remoteBody);
	}
	...
	*/
	...
	private static ServiceTracker<ZendeskArticleLocalService, ZendeskArticleLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ZendeskArticleLocalService.class);
}