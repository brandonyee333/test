...
public class ZendeskSectionLocalServiceWrapper
	...
	*/
	@Override
	public com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection addZendeskSection(
	...
	public com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection addZendeskSection(
		...
		java.util.Map<java.util.Locale, java.lang.String> remoteNameMap,
		int position)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _zendeskSectionLocalService.addZendeskSection(zendeskCategoryId,
			documentationKey, remoteNameMap, position);
	}
	...
	*/
	@Override
	public com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection createZendeskSection(
		long zendeskSectionId) {
		return _zendeskSectionLocalService.createZendeskSection(zendeskSectionId);
	}
	...
	*/
	...
	public com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection deleteZendeskSection(
		long zendeskSectionId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _zendeskSectionLocalService.deleteZendeskSection(zendeskSectionId);
	}

	@Override
	public com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection fetchZendeskSection(
		long zendeskCategoryId, java.lang.String documentationKey) {
		return _zendeskSectionLocalService.fetchZendeskSection(zendeskCategoryId,
			documentationKey);
	}
	...
	public com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection fetchZendeskSection(
		long zendeskSectionId) {
		return _zendeskSectionLocalService.fetchZendeskSection(zendeskSectionId);
	}
	...
	*/
	@Override
	public com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection getZendeskSection(
		long zendeskSectionId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection updateZendeskSection(
		com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection zendeskSection) {
	...
	@Override
	public com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection updateZendeskSectionTranslation(
		long zendeskSectionId, java.util.Locale locale,
		java.lang.String remoteName)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _zendeskSectionLocalService.updateZendeskSectionTranslation(zendeskSectionId,
			locale, remoteName);
	}
	...
	*/
	...
	public int getZendeskSectionsCount(long zendeskCategoryId) {
		return _zendeskSectionLocalService.getZendeskSectionsCount(zendeskCategoryId);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _zendeskSectionLocalService.dynamicQuery(dynamicQuery, start, end);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _zendeskSectionLocalService.dynamicQuery(dynamicQuery, start,
	...
	*/
	@Override
	public java.util.List<com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection> getZendeskSections(
		int start, int end) {
	...
	public java.util.List<com.liferay.osb.customer.zendesk.documentation.sync.model.ZendeskSection> getZendeskSections(
		...
		return _zendeskSectionLocalService.getZendeskSections(zendeskCategoryId);
	}
