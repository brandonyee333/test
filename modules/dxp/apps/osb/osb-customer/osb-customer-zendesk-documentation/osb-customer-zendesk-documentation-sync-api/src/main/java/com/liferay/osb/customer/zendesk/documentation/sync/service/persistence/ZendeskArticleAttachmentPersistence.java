 ...
 */
@ProviderType
public interface ZendeskArticleAttachmentPersistence extends BasePersistence<ZendeskArticleAttachment> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<ZendeskArticleAttachment> findByZendeskArticleId(
		long zendeskArticleId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ZendeskArticleAttachment> orderByComparator);
	...
	*/
	public ZendeskArticleAttachment fetchByZAI_FP(long zendeskArticleId,
		java.lang.String filePath, boolean retrieveFromCache);
	...
	* @return the number of matching zendesk article attachments
	*/
	public int countByZAI_FP(long zendeskArticleId, java.lang.String filePath);
