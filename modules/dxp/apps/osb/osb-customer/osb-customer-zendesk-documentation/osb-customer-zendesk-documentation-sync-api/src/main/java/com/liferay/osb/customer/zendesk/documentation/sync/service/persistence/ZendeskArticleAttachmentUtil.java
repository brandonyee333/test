...
public class ZendeskArticleAttachmentUtil {
	...
	*/
	public static ZendeskArticleAttachment fetchByZAI_FP(
		long zendeskArticleId, java.lang.String filePath) {
	...
	* @return the number of matching zendesk article attachments
	*/
	public static int countByZAI_FP(long zendeskArticleId,
		java.lang.String filePath) {
	...
	*/
	...
	private static ServiceTracker<ZendeskArticleAttachmentPersistence, ZendeskArticleAttachmentPersistence> _serviceTracker =
		ServiceTrackerFactory.open(ZendeskArticleAttachmentPersistence.class);
}