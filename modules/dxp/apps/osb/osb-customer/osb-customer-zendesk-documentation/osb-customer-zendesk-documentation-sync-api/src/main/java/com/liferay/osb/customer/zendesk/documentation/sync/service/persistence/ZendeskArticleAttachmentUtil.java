...
/**
 * The persistence utility for the zendesk article attachment service. This utility wraps {@link com.liferay.osb.customer.zendesk.documentation.sync.service.persistence.impl.ZendeskArticleAttachmentPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.liferay.osb.customer.zendesk.documentation.sync.service.persistence.impl.ZendeskArticleAttachmentPersistenceImpl
 * @generated
 */
@ProviderType
public class ZendeskArticleAttachmentUtil {
	...
	public static ZendeskArticleAttachment update(
		...
		return getPersistence().update(zendeskArticleAttachment, serviceContext);
	}
	...
	*/
	public static List<ZendeskArticleAttachment> findByZendeskArticleId(
		...
		return getPersistence()
				   .findByZendeskArticleId(zendeskArticleId, start, end);
	}
	...
	*/
	public static ZendeskArticleAttachment findByZendeskArticleId_First(
		long zendeskArticleId,
		OrderByComparator<ZendeskArticleAttachment> orderByComparator)
		throws com.liferay.osb.customer.zendesk.documentation.sync.exception.NoSuchZendeskArticleAttachmentException {
		return getPersistence()
				   .findByZendeskArticleId_First(zendeskArticleId,
			orderByComparator);
	}
	...
	*/
	public static ZendeskArticleAttachment fetchByZendeskArticleId_First(
		...
		OrderByComparator<ZendeskArticleAttachment> orderByComparator) {
		return getPersistence()
				   .fetchByZendeskArticleId_First(zendeskArticleId,
			orderByComparator);
	}
	...
	*/
	public static ZendeskArticleAttachment findByZendeskArticleId_Last(
		...
		throws com.liferay.osb.customer.zendesk.documentation.sync.exception.NoSuchZendeskArticleAttachmentException {
		return getPersistence()
				   .findByZendeskArticleId_Last(zendeskArticleId,
			orderByComparator);
	}
	...
	*/
	public static ZendeskArticleAttachment fetchByZendeskArticleId_Last(
		...
		OrderByComparator<ZendeskArticleAttachment> orderByComparator) {
		return getPersistence()
				   .fetchByZendeskArticleId_Last(zendeskArticleId,
			orderByComparator);
	}
	...
	*/
	public static ZendeskArticleAttachment[] findByZendeskArticleId_PrevAndNext(
		...
		throws com.liferay.osb.customer.zendesk.documentation.sync.exception.NoSuchZendeskArticleAttachmentException {
		return getPersistence()
				   .findByZendeskArticleId_PrevAndNext(zendeskArticleAttachmentId,
	...
	* @throws NoSuchZendeskArticleAttachmentException if a matching zendesk article attachment could not be found
	*/
	public static ZendeskArticleAttachment findByZAI_FP(long zendeskArticleId,
		String filePath)
		throws com.liferay.osb.customer.zendesk.documentation.sync.exception.NoSuchZendeskArticleAttachmentException {
	...
	*/
	public static ZendeskArticleAttachment fetchByZAI_FP(
		...
		return getPersistence()
				   .fetchByZAI_FP(zendeskArticleId, filePath, retrieveFromCache);
	}
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, ZendeskArticleAttachment> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<ZendeskArticleAttachmentPersistence, ZendeskArticleAttachmentPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ZendeskArticleAttachmentPersistence.class);

		ServiceTracker<ZendeskArticleAttachmentPersistence, ZendeskArticleAttachmentPersistence> serviceTracker =
			new ServiceTracker<ZendeskArticleAttachmentPersistence, ZendeskArticleAttachmentPersistence>(bundle.getBundleContext(),
