...
public class RequiredZendeskCategoryException extends PortalException {
	...
	public RequiredZendeskCategoryException(String msg) {
		super(msg);
	}

	public RequiredZendeskCategoryException(String msg, Throwable cause) {
		super(msg, cause);
	}

	public RequiredZendeskCategoryException(Throwable cause) {
		super(cause);
	}
