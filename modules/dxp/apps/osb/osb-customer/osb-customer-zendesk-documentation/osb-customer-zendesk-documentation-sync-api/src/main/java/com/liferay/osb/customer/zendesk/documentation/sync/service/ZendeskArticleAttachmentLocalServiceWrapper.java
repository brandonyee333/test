...
public class ZendeskArticleAttachmentLocalServiceWrapper
	...
	public ZendeskArticleAttachmentLocalServiceWrapper(
		...
		_zendeskArticleAttachmentLocalService =
			zendeskArticleAttachmentLocalService;
	}
	...
	public com.liferay.osb.customer.zendesk.documentation.sync.model.
		...
		return _zendeskArticleAttachmentLocalService.
			addZendeskArticleAttachment(zendeskArticleId, filePath, bytes);
	}
	...
	public com.liferay.osb.customer.zendesk.documentation.sync.model.
		...
		return _zendeskArticleAttachmentLocalService.
			addZendeskArticleAttachment(zendeskArticleAttachment);
	}
	...
	@Override
	public com.liferay.osb.customer.zendesk.documentation.sync.model.
		ZendeskArticleAttachment createZendeskArticleAttachment(
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		return _zendeskArticleAttachmentLocalService.deletePersistedModel(
			persistedModel);
	}
	...
	@Override
	public com.liferay.osb.customer.zendesk.documentation.sync.model.
		ZendeskArticleAttachment deleteZendeskArticleAttachment(
				long zendeskArticleAttachmentId)
			throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not <code>com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS</code>), then the query will include the default ORDER BY logic from <code>com.liferay.osb.customer.zendesk.documentation.sync.model.impl.ZendeskArticleAttachmentModelImpl</code>. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 *
	 * @param dynamicQuery the dynamic query
	...
	public long dynamicQueryCount(
		...
		return _zendeskArticleAttachmentLocalService.dynamicQueryCount(
			dynamicQuery);
	}
	...
	@Override
	public com.liferay.osb.customer.zendesk.documentation.sync.model.
		ZendeskArticleAttachment fetchZendeskArticleAttachment(
			long zendeskArticleAttachmentId) {
	...
	public com.liferay.portal.kernel.model.PersistedModel getPersistedModel(
		...
		return _zendeskArticleAttachmentLocalService.getPersistedModel(
			primaryKeyObj);
	}
	...
	@Override
	public com.liferay.osb.customer.zendesk.documentation.sync.model.
		ZendeskArticleAttachment getZendeskArticleAttachment(
				long zendeskArticleAttachmentId)
			throws com.liferay.portal.kernel.exception.PortalException {
	...
	public java.util.List
		<com.liferay.osb.customer.zendesk.documentation.sync.model.
			ZendeskArticleAttachment> getZendeskArticleAttachments(
				int start, int end) {

		return _zendeskArticleAttachmentLocalService.
			getZendeskArticleAttachments(start, end);
	}
	...
	public java.util.List
		...
		return _zendeskArticleAttachmentLocalService.
			getZendeskArticleAttachments(zendeskArticleId);
	}
	...
	public int getZendeskArticleAttachmentsCount() {
		return _zendeskArticleAttachmentLocalService.
			getZendeskArticleAttachmentsCount();
	}

	@Override
	public com.liferay.osb.customer.zendesk.documentation.sync.model.
		ZendeskArticleAttachment updateZendeskArticleAttachment(
				long zendeskArticleId, String filePath, byte[] bytes)
			throws com.liferay.portal.kernel.exception.PortalException {

		return _zendeskArticleAttachmentLocalService.
			updateZendeskArticleAttachment(zendeskArticleId, filePath, bytes);
	}
	...
	private ZendeskArticleAttachmentLocalService
		_zendeskArticleAttachmentLocalService;
