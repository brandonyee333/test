...
public class ZendeskArticleUtil {
	...
	*/
	public static ZendeskArticle fetchByDocumentationOriginalURL(
		java.lang.String documentationOriginalURL, boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByDocumentationOriginalURL(documentationOriginalURL,
			retrieveFromCache);
	}
	...
	*/
	...
	private static ServiceTracker<ZendeskArticlePersistence, ZendeskArticlePersistence> _serviceTracker =
		ServiceTrackerFactory.open(ZendeskArticlePersistence.class);
}