...
<portlet:actionURL name="updateZendeskCategory" var="updateZendeskCategoryURL">
	<portlet:param name="mvcPath" value="/admin/edit_zendesk_category.jsp" />
</portlet:actionURL>

<aui:form action="<%= updateZendeskCategoryURL %>" cssClass="container-fluid-1280" method="post">
