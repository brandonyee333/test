 ...
 * @generated
 */
public abstract class SyncStateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, SyncStateLocalService {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SyncState.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return syncStatePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return syncStatePersistence.countWithDynamicQuery(
	...
	public BasePersistence<SyncState> getBasePersistence() {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SyncStateLocalServiceBaseImpl.class);
