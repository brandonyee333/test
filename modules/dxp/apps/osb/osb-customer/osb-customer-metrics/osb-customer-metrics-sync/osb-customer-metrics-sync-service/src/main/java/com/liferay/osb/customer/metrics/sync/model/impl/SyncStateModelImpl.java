 ...
 *
 * <p>
 * This implementation and its corresponding interface <code>SyncStateModel</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link SyncStateImpl}.
 * </p>
 *
 ...
 * @generated
 */
public class SyncStateModelImpl
	extends BaseModelImpl<SyncState> implements SyncStateModel {
	...
	public static final Object[][] TABLE_COLUMNS = {
		{"syncStateId", Types.BIGINT}, {"modelName", Types.VARCHAR},
	...
	public static final String TABLE_SQL_CREATE =
		"create table OSBCustomer_SyncState (syncStateId LONG not null primary key,modelName VARCHAR(75) null,lastRunTime LONG)";

	public static final String TABLE_SQL_DROP =
		"drop table OSBCustomer_SyncState";

	public static final String ORDER_BY_JPQL =
		" ORDER BY syncState.syncStateId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY OSBCustomer_SyncState.syncStateId ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(
		com.liferay.osb.customer.metrics.sync.service.util.ServiceProps.get(
	...
	public Map<String, Object> getModelAttributes() {
		...
		for (Map.Entry<String, Function<SyncState, Object>> entry :
				attributeGetterFunctions.entrySet()) {

			String attributeName = entry.getKey();
			Function<SyncState, Object> attributeGetterFunction =
				entry.getValue();

			attributes.put(
				attributeName, attributeGetterFunction.apply((SyncState)this));
		}
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<SyncState, Object>> attributeSetterBiConsumers =
			getAttributeSetterBiConsumers();

		for (Map.Entry<String, Object> entry : attributes.entrySet()) {
			String attributeName = entry.getKey();

			BiConsumer<SyncState, Object> attributeSetterBiConsumer =
				attributeSetterBiConsumers.get(attributeName);

			if (attributeSetterBiConsumer != null) {
				attributeSetterBiConsumer.accept(
					(SyncState)this, entry.getValue());
			}
		}
	}

	public Map<String, Function<SyncState, Object>>
		getAttributeGetterFunctions() {

		return _attributeGetterFunctions;
	}

	public Map<String, BiConsumer<SyncState, Object>>
		getAttributeSetterBiConsumers() {

		return _attributeSetterBiConsumers;
	}

	private static Function<InvocationHandler, SyncState>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			SyncState.class.getClassLoader(), SyncState.class,
			ModelWrapper.class);

		try {
			Constructor<SyncState> constructor =
				(Constructor<SyncState>)proxyClass.getConstructor(
	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<SyncState, Object>() {
				...
				@Override
				public void accept(
					SyncState syncState, Object lastRunTimeObject) {

					syncState.setLastRunTime((Long)lastRunTimeObject);
				}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(
			0, SyncState.class.getName(), getPrimaryKey());
	}
	...
	public SyncState toEscapedModel() {
		if (_escapedModel == null) {
			Function<InvocationHandler, SyncState>
	...
	public String toString() {
		...
		for (Map.Entry<String, Function<SyncState, Object>> entry :
			...
			Object value = attributeGetterFunction.apply((SyncState)this);
	...
	private static class EscapedModelProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, SyncState>
