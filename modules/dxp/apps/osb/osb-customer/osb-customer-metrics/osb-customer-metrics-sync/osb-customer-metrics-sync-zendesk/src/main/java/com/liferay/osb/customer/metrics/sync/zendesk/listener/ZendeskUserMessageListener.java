 ...
 * @author Kyle Bischof
 */
@Component(immediate = true, service = ZendeskUserMessageListener.class)
public class ZendeskUserMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		_syncStateLocalService.updateSyncState(
			ZendeskUser.class.getName(), now.getTime());
	}
