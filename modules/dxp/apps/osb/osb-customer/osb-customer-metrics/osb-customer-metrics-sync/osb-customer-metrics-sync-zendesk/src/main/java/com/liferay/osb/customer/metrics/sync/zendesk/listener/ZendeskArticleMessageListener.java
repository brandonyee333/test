 ...
 * @author Kyle Bischof
 */
@Component(immediate = true, service = ZendeskArticleMessageListener.class)
public class ZendeskArticleMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		_syncStateLocalService.updateSyncState(
			ZendeskArticle.class.getName(), now.getTime());
	}
