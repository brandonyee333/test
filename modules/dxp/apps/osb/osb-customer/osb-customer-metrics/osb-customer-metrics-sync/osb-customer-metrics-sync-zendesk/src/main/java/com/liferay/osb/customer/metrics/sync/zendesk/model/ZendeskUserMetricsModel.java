...
public class ZendeskUserMetricsModel implements MetricsModel<ZendeskUser> {
	...
	@Override
	public Map<String, Object> getAttributes(ZendeskUser model) {
		return null;
	}
	...
	@Override
	public List<Map<String, Object>> getMappingValues(ZendeskUser model) {
		return null;
	}

	@Override
	public Class getModelClass() {
		return ZendeskUser.class;
	}
