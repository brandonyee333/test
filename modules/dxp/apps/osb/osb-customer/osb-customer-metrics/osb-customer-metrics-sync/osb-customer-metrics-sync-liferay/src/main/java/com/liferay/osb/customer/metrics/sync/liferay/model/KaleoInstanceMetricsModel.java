...
public class KaleoInstanceMetricsModel
	extends BaseModelMetricsModel<KaleoInstance> {

	@Override
	public Map<String, Object> getAttributes(KaleoInstance kaleoInstance) {
		return _metricsTransformationUtil.transformSharedAttributes(
			kaleoInstance.getModelAttributes());
	}
