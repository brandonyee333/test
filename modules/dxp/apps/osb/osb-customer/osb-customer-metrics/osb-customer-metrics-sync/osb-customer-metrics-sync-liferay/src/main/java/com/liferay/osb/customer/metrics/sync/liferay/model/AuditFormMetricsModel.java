...
package main.java.com.liferay.osb.customer.metrics.sync.liferay.model;
...
public class AuditFormMetricsModel extends BaseModelMetricsModel<AuditForm> {

	@Override
	public Map<String, Object> getAttributes(AuditForm auditForm) {
		return _metricsTransformationUtil.transformSharedAttributes(
			auditForm.getModelAttributes());
	}
