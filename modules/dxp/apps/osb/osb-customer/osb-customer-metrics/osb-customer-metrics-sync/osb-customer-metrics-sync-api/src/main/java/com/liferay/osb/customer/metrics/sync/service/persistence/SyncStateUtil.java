...
public class SyncStateUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(SyncStatePersistence.class);

		ServiceTracker<SyncStatePersistence, SyncStatePersistence> serviceTracker =
			new ServiceTracker<SyncStatePersistence, SyncStatePersistence>(bundle.getBundleContext(),
				SyncStatePersistence.class, null);
