...
public class SyncStateUtil {
	...
	private static ServiceTracker<SyncStatePersistence, SyncStatePersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SyncStatePersistence.class);

		ServiceTracker<SyncStatePersistence, SyncStatePersistence>
			serviceTracker =
				new ServiceTracker<SyncStatePersistence, SyncStatePersistence>(
					bundle.getBundleContext(), SyncStatePersistence.class,
					null);
