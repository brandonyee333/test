 ...
 * @generated
 */
public class SyncStateLocalServiceWrapper
	implements ServiceWrapper<SyncStateLocalService>, SyncStateLocalService {
	 ...
	 */
	@Override
	public com.liferay.osb.customer.metrics.sync.model.SyncState
	...
	public long dynamicQueryCount(
		...
		return _syncStateLocalService.dynamicQueryCount(
	 ...
	 */
	@Override
	public java.util.List<com.liferay.osb.customer.metrics.sync.model.SyncState>
		getSyncStates(int start, int end) {
