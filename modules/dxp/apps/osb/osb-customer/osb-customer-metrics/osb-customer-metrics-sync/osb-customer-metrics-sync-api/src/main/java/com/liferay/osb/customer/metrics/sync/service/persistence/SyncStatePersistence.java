...
public interface SyncStatePersistence extends BasePersistence<SyncState> {
	...
	*/
	public SyncState findByModelName(java.lang.String modelName)
	...
	*/
	public SyncState fetchByModelName(java.lang.String modelName);
	...
	*/
	public SyncState removeByModelName(java.lang.String modelName)
		throws NoSuchSyncStateException;
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, SyncState> fetchByPrimaryKeys(
