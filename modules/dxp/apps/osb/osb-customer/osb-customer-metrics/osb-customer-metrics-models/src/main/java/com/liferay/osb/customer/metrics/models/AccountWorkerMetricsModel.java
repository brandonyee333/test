...
public class AccountWorkerMetricsModel
	extends BaseModelMetricsModel<AccountWorker> {

	@Override
	public Map<String, Object> getAttributes(AccountWorker accountWorker) {
		Map<String, Object> attributes =
			_metricsTransformationUtil.transformSharedAttributes(
				accountWorker.getModelAttributes());

		Integer role = (Integer)attributes.get("role");

		if (role != null) {
			attributes.put("role", AccountWorkerConstants.getRoleLabel(role));
		}
