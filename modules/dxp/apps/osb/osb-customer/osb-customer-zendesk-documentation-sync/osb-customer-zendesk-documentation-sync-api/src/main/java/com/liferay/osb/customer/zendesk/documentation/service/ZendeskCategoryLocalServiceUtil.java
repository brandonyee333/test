 ...
 * {@link com.liferay.osb.customer.zendesk.documentation.service.impl.ZendeskCategoryLocalServiceImpl} and is the
 ...
 * @see com.liferay.osb.customer.zendesk.documentation.service.base.ZendeskCategoryLocalServiceBaseImpl
 * @see com.liferay.osb.customer.zendesk.documentation.service.impl.ZendeskCategoryLocalServiceImpl
 * @generated
 */
@ProviderType
public class ZendeskCategoryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.customer.zendesk.documentation.service.impl.ZendeskCategoryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory addZendeskCategory(
	...
	*/
	public static com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory addZendeskCategory(
		com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory zendeskCategory) {
	...
	*/
	public static com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory createZendeskCategory(
	...
	*/
	public static com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory deleteZendeskCategory(
		long zendeskCategoryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory fetchZendeskCategory(
		long zendeskCategoryId) {
	...
	*/
	public static java.util.List<com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory> getZendeskCategories(
		int start, int end) {
	...
	* @throws PortalException if a zendesk category with the primary key could not be found
	*/
	public static com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory getZendeskCategory(
		long zendeskCategoryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory getZendeskCategory(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getZendeskCategory(documentationKey);
	}
	...
	*/
	public static com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory updateZendeskCategory(
		com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory zendeskCategory) {
	...
	private static ServiceTracker<ZendeskCategoryLocalService, ZendeskCategoryLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ZendeskCategoryLocalService.class);

		ServiceTracker<ZendeskCategoryLocalService, ZendeskCategoryLocalService> serviceTracker =
			new ServiceTracker<ZendeskCategoryLocalService, ZendeskCategoryLocalService>(bundle.getBundleContext(),
