...
import com.liferay.osb.customer.zendesk.documentation.exception.NoSuchZendeskCategoryException;
import com.liferay.osb.customer.zendesk.documentation.model.ZendeskCategory;
import com.liferay.osb.customer.zendesk.documentation.model.impl.ZendeskCategoryImpl;
import com.liferay.osb.customer.zendesk.documentation.model.impl.ZendeskCategoryModelImpl;
import com.liferay.osb.customer.zendesk.documentation.service.persistence.ZendeskCategoryPersistence;
 ...
 * @see com.liferay.osb.customer.zendesk.documentation.service.persistence.ZendeskCategoryUtil
 * @generated
 */
@ProviderType
	...
	public ZendeskCategory updateImpl(ZendeskCategory zendeskCategory) {
		...
		if (!(zendeskCategory instanceof ZendeskCategoryModelImpl)) {
			...
			if (ProxyUtil.isProxyClass(zendeskCategory.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(zendeskCategory);
