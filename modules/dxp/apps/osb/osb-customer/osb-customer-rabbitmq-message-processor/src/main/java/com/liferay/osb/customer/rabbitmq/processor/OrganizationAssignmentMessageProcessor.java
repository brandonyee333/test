 ...
 */
@Component(
	immediate = true, property = "routing.key=entity.organization.assigned",
	service = OrganizationAssignmentMessageProcessor.class
)
public class OrganizationAssignmentMessageProcessor
