...
<div class="documentation-search">
	...
	<form action="/documentation/search" class="doc-search-form" method="post" name="docSearchFm">
		<input name="p_p_id" type="hidden" value="1_WAR_osbknowledgebaseportlet" />
		<input name="p_p_state" type="hidden" value="normal" />

		<input class="doc-search-input" id="_1_WAR_osbknowledgebaseportlet_keywords" name="_1_WAR_osbknowledgebaseportlet_keywords" placeholder="<@liferay.language key="search-documentation-by-keyword" />" type="search" value="" />
