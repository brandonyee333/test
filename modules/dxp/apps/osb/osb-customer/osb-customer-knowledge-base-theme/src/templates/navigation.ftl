...
<div class="documentation-search">
	...
	<form action="/documentation/search" class="doc-search-form" method="post" name="docSearchFm">
		...
		<input class="doc-search-input" name="_1_WAR_osbknowledgebaseportlet_keywords" placeholder="<@liferay.language key="search-documentation-by-keyword" />" type="search" value="" />
