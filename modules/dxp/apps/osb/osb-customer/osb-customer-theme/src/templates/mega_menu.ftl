		...
		configs: [
			{
				...
				url: '${zendesk_url}/hc/${current_locale}/requests'
			},
			{
		...
		configs: [
			{
				...
				svgId: '#ticket',
				url: '${zendesk_url}/hc/${current_locale}/requests/new'
			},
			{
				name: '<@liferay.language key="contact-us" />',
				svgId: '#contact',
				url: '${zendesk_url}/hc/${current_locale}/articles/360017784212'
			}
		]
	};
				...
				configs: [
					{
						...
						svgId: '#dxp-logo',
						url: '${zendesk_url}/hc/${current_locale}/categories/360000872531'
					},
					{
						name: '<@liferay.language key="dxp-cloud" />',
						svgId: '#dxp-cloud-logo',
						url: '${zendesk_url}/hc/${current_locale}/categories/360000813091'
					},
					{
						name: '<@liferay.language key="dxp" /> 7.0',
						svgId: '#7-0-logo',
						url: '${zendesk_url}/hc/${current_locale}/categories/360000867932'
					},
					{
						name: '<@liferay.language key="commerce" />',
						svgId: '#commerce-logo',
						url: '${zendesk_url}/hc/${current_locale}/categories/360000867952'
					},
					{
						name: '<@liferay.language key="analytics-cloud" />',
						svgId: '#analytics-cloud-logo',
						url: '${zendesk_url}/hc/${current_locale}/categories/360000872551'
					},
					{
						name: '<@liferay.language key="portal" /> 6.2',
						svgId: '#6-2-logo',
						url: '${zendesk_url}/hc/${current_locale}/categories/360000867972'
					},
					{
						name: '<@liferay.language key="portal" /> 6.1',
						svgId: '#6-1-logo',
						url: '${zendesk_url}/hc/${current_locale}/categories/360000872571'
					},
					{
						name: '<@liferay.language key="portal" /> 6.0',
						svgId: '#6-0-logo',
						url: '${zendesk_url}/hc/${current_locale}/categories/360000867992'
					}
				]
			},
				...
				configs: [
					{
						...
						url: '${zendesk_url}/hc/${current_locale}/articles/360016700231'
					},
					{
						...
						url: '${zendesk_url}/hc/${current_locale}/articles/360015772992'
					},
					{
						...
						url: '${zendesk_url}/hc/${current_locale}/articles/360016700231#Reporting-Security-Issues'
					},
					{
						...
						url: '${zendesk_url}/hc/${current_locale}/articles/360016700231#Liferay-Security-Policy'
					}
				]
			},
			highlightedLinks: highlightedLinks,
				...
				configs: [
					{
						...
						url: '${zendesk_url}/hc/${current_locale}/sections/360002103292'
					},
					{
					...
					},
					{
						...
						url: '${zendesk_url}/hc/${current_locale}/articles/360016515831'
					},
					{
						...
						url: '${zendesk_url}/hc/${current_locale}/articles/360016510271'
					}
				]
			},
			highlightedLinks: highlightedLinks,
