<#assign
	...
	social_link_five_name = themeDisplay.getThemeSetting("social-link-five-name")
	social_link_five_url = themeDisplay.getThemeSetting("social-link-five-url")
	social_link_four_name = themeDisplay.getThemeSetting("social-link-four-name")
	social_link_four_url = themeDisplay.getThemeSetting("social-link-four-url")
	...
	social_link_six_name = themeDisplay.getThemeSetting("social-link-six-name")
	social_link_six_url = themeDisplay.getThemeSetting("social-link-six-url")
