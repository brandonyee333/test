...
package com.liferay.osb.customer.koroneiki.subscriber.rabbitmq.consumer;

import com.liferay.osb.customer.koroneiki.subscriber.rabbitmq.connection.KoroneikiConnection;
...
@Component(
	immediate = true,
	property = {
		"exchange=is_koroneiki_customer_exchange",
