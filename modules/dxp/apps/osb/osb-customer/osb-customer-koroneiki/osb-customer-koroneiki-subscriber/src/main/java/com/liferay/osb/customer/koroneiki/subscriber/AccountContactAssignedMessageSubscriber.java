...
@Component(
	immediate = true,
	property = "topic.pattern=koroneiki.account.contact.assigned",
	service = AccountContactAssignedMessageSubscriber.class
)
public class AccountContactAssignedMessageSubscriber
	...
	public void receive(Message message) {
		try {
			...
			zendeskMessage.put("topic", "koroneiki.account.contact.assigned");
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccountContactAssignedMessageSubscriber.class);
