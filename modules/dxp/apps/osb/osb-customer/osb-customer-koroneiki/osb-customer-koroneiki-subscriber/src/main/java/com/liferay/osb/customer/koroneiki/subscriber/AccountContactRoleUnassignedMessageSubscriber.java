...
@Component(
	...
	service = AccountContactRoleUnassignedMessageSubscriber.class
)
public class AccountContactRoleUnassignedMessageSubscriber
	...
	public void receive(Message message) {
		try {
			...
			zendeskMessage.put(
				"topic", "koroneiki.account.contactrole.unassigned");
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccountContactRoleUnassignedMessageSubscriber.class);
