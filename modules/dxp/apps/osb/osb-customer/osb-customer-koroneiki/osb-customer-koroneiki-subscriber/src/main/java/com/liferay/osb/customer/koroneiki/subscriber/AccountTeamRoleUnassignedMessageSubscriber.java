...
@Component(
	immediate = true,
	property = "topic.pattern=koroneiki.account.teamrole.unassigned",
	service = AccountTeamRoleUnassignedMessageSubscriber.class
)
public class AccountTeamRoleUnassignedMessageSubscriber
	...
	public void receive(Message message) {
		try {
			...
			zendeskMessage.put(
				"topic", "koroneiki.account.teamrole.unassigned");
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccountTeamRoleUnassignedMessageSubscriber.class);
