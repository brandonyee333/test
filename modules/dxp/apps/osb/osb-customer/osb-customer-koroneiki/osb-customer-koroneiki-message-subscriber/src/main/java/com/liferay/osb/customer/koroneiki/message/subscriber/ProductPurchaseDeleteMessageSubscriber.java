...
@Component(
	immediate = true,
	property = "topic.pattern=koroneiki.productpurchase.delete",
	service = ProductPurchaseDeleteMessageSubscriber.class
)
public class ProductPurchaseDeleteMessageSubscriber
