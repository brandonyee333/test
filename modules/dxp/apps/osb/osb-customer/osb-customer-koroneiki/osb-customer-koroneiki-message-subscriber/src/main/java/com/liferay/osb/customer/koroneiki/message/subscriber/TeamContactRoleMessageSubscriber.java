...
@Component(
	immediate = true,
	property = {
		"topic.pattern=koroneiki.team.contactrole.assigned",
		"topic.pattern=koroneiki.team.contactrole.unassigned"
	},
	service = TeamContactRoleMessageSubscriber.class
)
public class TeamContactRoleMessageSubscriber
