...
<%
JournalArticle journalArticle = JournalArticleLocalServiceUtil.getLatestArticle(OSBConstants.GROUP_GUEST_ID, _MARKETPLACE_APP_INSTALLATION_INSTRUCTIONS_ARTICLE_ID);
...
<%!
private static final String _MARKETPLACE_APP_INSTALLATION_INSTRUCTIONS_ARTICLE_ID = "84566404";
%>