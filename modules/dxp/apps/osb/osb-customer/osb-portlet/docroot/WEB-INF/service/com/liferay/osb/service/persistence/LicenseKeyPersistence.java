...
public interface LicenseKeyPersistence extends BasePersistence<LicenseKey> {
	...
	*/
	public java.util.List<LicenseKey> findByUserId(long userId);
	...
	*/
	public java.util.List<LicenseKey> findByUserId(long userId, int start,
		int end);
	...
	* @return the matching license keies
	*/
	public java.util.List<LicenseKey> findByOrderEntryId(long orderEntryId);
