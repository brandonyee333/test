 ...
 * @author Calvin Keum
 */
public class ImportTrainingExamResultsMessageListener
	...
	protected void doReceive(Message message) throws Exception {
		try {
			...
			trainingExamResultsImporter.importTrainingExamResults();
		}
		catch (Exception e) {
			_log.error(e, e);
		}
	...
	private static Log _log = LogFactoryUtil.getLog(
		ImportTrainingExamResultsMessageListener.class);
