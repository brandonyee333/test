...
/**
 * The base implementation of the corp project local service.
 *
 * <p>
...
public abstract class CorpProjectLocalServiceBaseImpl
	...
	public CorpProject addCorpProject(CorpProject corpProject)
		...
		return corpProjectPersistence.update(corpProject, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCorpProjectsCount() throws SystemException {
	...
	public CorpProject updateCorpProject(CorpProject corpProject)
		throws SystemException {
		return updateCorpProject(corpProject, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CorpProject updateCorpProject(CorpProject corpProject, boolean merge)
		throws SystemException {
		corpProject.setNew(false);

		return corpProjectPersistence.update(corpProject, merge);
	}
