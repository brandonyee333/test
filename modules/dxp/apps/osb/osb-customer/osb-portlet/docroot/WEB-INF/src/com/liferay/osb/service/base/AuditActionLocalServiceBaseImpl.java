...
/**
 * The base implementation of the audit action local service.
 *
 * <p>
...
public abstract class AuditActionLocalServiceBaseImpl
	...
	public AuditAction addAuditAction(AuditAction auditAction)
		...
		return auditActionPersistence.update(auditAction, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAuditActionsCount() throws SystemException {
	...
	public AuditAction updateAuditAction(AuditAction auditAction)
		throws SystemException {
		return updateAuditAction(auditAction, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AuditAction updateAuditAction(AuditAction auditAction, boolean merge)
		throws SystemException {
		auditAction.setNew(false);

		return auditActionPersistence.update(auditAction, merge);
	}
