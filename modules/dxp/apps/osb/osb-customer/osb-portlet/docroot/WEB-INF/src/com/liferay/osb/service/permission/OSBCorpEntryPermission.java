 ...
 * @author Amos Fong
 */
public class OSBCorpEntryPermission {

	public static void check(
			PermissionChecker permissionChecker, CorpEntry corpEntry,
			String actionId)
		throws PortalException, SystemException {

		if (!contains(permissionChecker, corpEntry, actionId)) {
			throw new PrincipalException();
		}
	}

	public static void check(
			PermissionChecker permissionChecker, long corpEntryId,
			String actionId)
		throws PortalException, SystemException {

		if (!contains(permissionChecker, corpEntryId, actionId)) {
			throw new PrincipalException();
		}
	}
	...
	public static boolean contains(
		...
		return contains(permissionChecker, corpEntry, actionId);
	}
