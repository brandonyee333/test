...
/**
 * The base implementation of the account entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AccountEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AccountEntryLocalServiceImpl
 * @see com.liferay.osb.service.AccountEntryLocalServiceUtil
 * @generated
 */
public abstract class AccountEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccountEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AccountEntryLocalServiceUtil} to access the account entry local service.
	 */
	...
	public AccountEntry addAccountEntry(AccountEntry accountEntry)
		...
		return accountEntryPersistence.update(accountEntry, false);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccountEntry.class,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccountEntriesCount() throws SystemException {
	...
	public AccountEntry updateAccountEntry(AccountEntry accountEntry)
		throws SystemException {
		return updateAccountEntry(accountEntry, true);
	}
	...
	public AccountEntry updateAccountEntry(AccountEntry accountEntry,
		...
		return accountEntryPersistence.update(accountEntry, merge);
	}
	...
	public void addSupportRegionAccountEntry(long supportRegionId,
		...
		supportRegionPersistence.addAccountEntry(supportRegionId, accountEntryId);
	}
	 ...
	 */
	public void addSupportRegionAccountEntry(long supportRegionId,
		AccountEntry accountEntry) throws SystemException {
	...
	public void addSupportRegionAccountEntries(long supportRegionId,
		long[] accountEntryIds) throws SystemException {
		supportRegionPersistence.addAccountEntries(supportRegionId,
			accountEntryIds);
	}
	 ...
	 */
	public void addSupportRegionAccountEntries(long supportRegionId,
		List<AccountEntry> AccountEntries) throws SystemException {
		supportRegionPersistence.addAccountEntries(supportRegionId,
			AccountEntries);
	}
	...
	public void deleteSupportRegionAccountEntry(long supportRegionId,
		long accountEntryId) throws SystemException {
		supportRegionPersistence.removeAccountEntry(supportRegionId,
			accountEntryId);
	}
	...
	public void deleteSupportRegionAccountEntries(long supportRegionId,
		long[] accountEntryIds) throws SystemException {
		supportRegionPersistence.removeAccountEntries(supportRegionId,
			accountEntryIds);
	}
	...
	public boolean hasSupportRegionAccountEntry(long supportRegionId,
		long accountEntryId) throws SystemException {
		return supportRegionPersistence.containsAccountEntry(supportRegionId,
			accountEntryId);
	}
	...
	public void setSupportRegionAccountEntries(long supportRegionId,
		long[] accountEntryIds) throws SystemException {
		supportRegionPersistence.setAccountEntries(supportRegionId,
			accountEntryIds);
	}
	...
	public void addSupportTeamAccountEntry(long supportTeamId,
		long accountEntryId) throws SystemException {
		supportTeamPersistence.addAccountEntry(supportTeamId, accountEntryId);
	}
	...
	public void addSupportTeamAccountEntry(long supportTeamId,
		AccountEntry accountEntry) throws SystemException {
		supportTeamPersistence.addAccountEntry(supportTeamId, accountEntry);
	}
	...
	public void addSupportTeamAccountEntries(long supportTeamId,
		long[] accountEntryIds) throws SystemException {
		supportTeamPersistence.addAccountEntries(supportTeamId, accountEntryIds);
	}
	...
	public void addSupportTeamAccountEntries(long supportTeamId,
		List<AccountEntry> AccountEntries) throws SystemException {
		supportTeamPersistence.addAccountEntries(supportTeamId, AccountEntries);
	}
	...
	public void clearSupportTeamAccountEntries(long supportTeamId)
		throws SystemException {
		supportTeamPersistence.clearAccountEntries(supportTeamId);
	}
	...
	public void deleteSupportTeamAccountEntry(long supportTeamId,
		long accountEntryId) throws SystemException {
		supportTeamPersistence.removeAccountEntry(supportTeamId, accountEntryId);
	}
	...
	public void deleteSupportTeamAccountEntry(long supportTeamId,
		AccountEntry accountEntry) throws SystemException {
		supportTeamPersistence.removeAccountEntry(supportTeamId, accountEntry);
	}
	...
	public void deleteSupportTeamAccountEntries(long supportTeamId,
		long[] accountEntryIds) throws SystemException {
		supportTeamPersistence.removeAccountEntries(supportTeamId,
			accountEntryIds);
	}
	...
	public List<AccountEntry> getSupportTeamAccountEntries(long supportTeamId)
		throws SystemException {
		return supportTeamPersistence.getAccountEntries(supportTeamId);
	}
	...
	public List<AccountEntry> getSupportTeamAccountEntries(long supportTeamId,
		...
		return supportTeamPersistence.getAccountEntries(supportTeamId, start,
			end);
	}
	...
	public int getSupportTeamAccountEntriesCount(long supportTeamId)
		throws SystemException {
		return supportTeamPersistence.getAccountEntriesSize(supportTeamId);
	}
	...
	public boolean hasSupportTeamAccountEntry(long supportTeamId,
		long accountEntryId) throws SystemException {
		return supportTeamPersistence.containsAccountEntry(supportTeamId,
			accountEntryId);
	}
	...
	public boolean hasSupportTeamAccountEntries(long supportTeamId)
		throws SystemException {
		return supportTeamPersistence.containsAccountEntries(supportTeamId);
	}
	...
	public void setSupportTeamAccountEntries(long supportTeamId,
		long[] accountEntryIds) throws SystemException {
		supportTeamPersistence.setAccountEntries(supportTeamId, accountEntryIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AccountEntry",
	...
	private AccountEntryLocalServiceClpInvoker _clpInvoker = new AccountEntryLocalServiceClpInvoker();
}