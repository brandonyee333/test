...
public class SecurityPatchServiceHttp {
	public static com.liferay.osb.model.SecurityPatch getSecurityPatch(
		...
		try {
			...
			return (com.liferay.osb.model.SecurityPatch)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(SecurityPatchServiceHttp.class);
	private static final Class<?>[] _getSecurityPatchParameterTypes0 = new Class[] {
			long.class
		};
}