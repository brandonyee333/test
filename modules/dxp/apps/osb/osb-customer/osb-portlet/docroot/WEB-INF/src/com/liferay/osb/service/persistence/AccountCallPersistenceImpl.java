...
import com.liferay.osb.NoSuchAccountCallException;
...
public class AccountCallPersistenceImpl extends BasePersistenceImpl<AccountCall>
	...
	public void cacheResult(AccountCall accountCall) {
		EntityCacheUtil.putResult(AccountCallModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache() {
		if (_HIBERNATE_CACHE_USE_SECOND_LEVEL_CACHE) {
			CacheRegistryUtil.clear(AccountCallImpl.class.getName());
		}

		EntityCacheUtil.clearCache(AccountCallImpl.class.getName());
	...
	public void clearCache(AccountCall accountCall) {
		EntityCacheUtil.removeResult(AccountCallModelImpl.ENTITY_CACHE_ENABLED,
	...
	public AccountCall remove(long accountCallId)
		throws NoSuchAccountCallException, SystemException {
		return remove(Long.valueOf(accountCallId));
	}
	...
	protected AccountCall removeImpl(AccountCall accountCall)
		...
		try {
			...
			BatchSessionUtil.delete(session, accountCall);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public AccountCall updateImpl(
		...
		try {
			...
			BatchSessionUtil.update(session, accountCall, merge);
		...
		if (isNew || !AccountCallModelImpl.COLUMN_BITMASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
			...
			if ((accountCallModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(accountCallModelImpl.getOriginalAccountEntryId())
					};
				...
				args = new Object[] {
						Long.valueOf(accountCallModelImpl.getAccountEntryId())
					};
	...
	/**
	 * Returns the account call with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the account call
	 * @return the account call
	 * @throws com.liferay.portal.NoSuchModelException if a account call with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	public AccountCall findByPrimaryKey(long accountCallId)
		throws NoSuchAccountCallException, SystemException {
		AccountCall accountCall = fetchByPrimaryKey(accountCallId);

		if (accountCall == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + accountCallId);
			}
	...
	public AccountCall fetchByPrimaryKey(long accountCallId)
		throws SystemException {
		AccountCall accountCall = (AccountCall)EntityCacheUtil.getResult(AccountCallModelImpl.ENTITY_CACHE_ENABLED,
				AccountCallImpl.class, accountCallId);

		if (accountCall == _nullAccountCall) {
			return null;
		}
		...
		if (accountCall == null) {
			...
			try {
				...
				if (accountCall != null) {
					...
					EntityCacheUtil.putResult(AccountCallModelImpl.ENTITY_CACHE_ENABLED,
						AccountCallImpl.class, accountCallId, _nullAccountCall);
				}
	...
	public List<AccountCall> findByAccountEntryId(long accountEntryId,
		...
		List<AccountCall> list = (List<AccountCall>)FinderCacheUtil.getResult(finderPath,
				finderArgs, this);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AccountCall> findAll() throws SystemException {
	...
	public List<AccountCall> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_ACCOUNTCALL.concat(AccountCallModelImpl.ORDER_BY_JPQL);
			}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.osb.model.AccountCall")));

		if (listenerClassNames.length > 0) {
			try {
				List<ModelListener<AccountCall>> listenersList = new ArrayList<ModelListener<AccountCall>>();

				for (String listenerClassName : listenerClassNames) {
					Class<?> clazz = getClass();

					listenersList.add((ModelListener<AccountCall>)InstanceFactory.newInstance(
	...
	public void destroy() {
		EntityCacheUtil.removeCache(AccountCallImpl.class.getName());
	...
	private static Log _log = LogFactoryUtil.getLog(AccountCallPersistenceImpl.class);
	private static AccountCall _nullAccountCall = new AccountCallImpl() {
			@Override
			public Object clone() {
				return this;
			}
			...
			public CacheModel<AccountCall> toCacheModel() {
				return _nullAccountCallCacheModel;
			}
		};

	private static CacheModel<AccountCall> _nullAccountCallCacheModel = new CacheModel<AccountCall>() {
			public AccountCall toEntityModel() {
				return _nullAccountCall;
			}
		};
}