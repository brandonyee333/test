...
/**
 * Provides the base implementation for the account call local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AccountCallLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AccountCallLocalServiceImpl
 * @see com.liferay.osb.service.AccountCallLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AccountCallLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccountCallLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AccountCallLocalServiceUtil} to access the account call local service.
	 */
	...
	@Override
	public AccountCall addAccountCall(AccountCall accountCall) {
	 ...
	 */
	@Override
	public AccountCall createAccountCall(long accountCallId) {
		return accountCallPersistence.create(accountCallId);
	}
	...
	public AccountCall deleteAccountCall(long accountCallId)
		...
		return accountCallPersistence.remove(accountCallId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AccountCall deleteAccountCall(AccountCall accountCall) {
		return accountCallPersistence.remove(accountCall);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccountCall.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accountCallPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return accountCallPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accountCallPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AccountCall fetchAccountCall(long accountCallId) {
		return accountCallPersistence.fetchByPrimaryKey(accountCallId);
	}
	 ...
	 */
	@Override
	public AccountCall getAccountCall(long accountCallId)
		throws PortalException {
		return accountCallPersistence.findByPrimaryKey(accountCallId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accountCallLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccountCall.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accountCallId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(accountCallLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccountCall.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return accountCallLocalService.deleteAccountCall((AccountCall)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return accountCallPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AccountCall> getAccountCalls(int start, int end) {
		return accountCallPersistence.findAll(start, end);
	}
	...
	public int getAccountCallsCount() {
		return accountCallPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AccountCall",
			accountCallLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccountCallLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accountCallPersistence.getDataSource();
	...
	private AccountCallLocalServiceClpInvoker _clpInvoker = new AccountCallLocalServiceClpInvoker();
}