...
/**
 * The base implementation of the account call local service.
 *
 * <p>
...
public abstract class AccountCallLocalServiceBaseImpl
	...
	public AccountCall addAccountCall(AccountCall accountCall)
		...
		return accountCallPersistence.update(accountCall, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccountCallsCount() throws SystemException {
	...
	public AccountCall updateAccountCall(AccountCall accountCall)
		throws SystemException {
		return updateAccountCall(accountCall, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AccountCall updateAccountCall(AccountCall accountCall, boolean merge)
		throws SystemException {
		accountCall.setNew(false);

		return accountCallPersistence.update(accountCall, merge);
	}
