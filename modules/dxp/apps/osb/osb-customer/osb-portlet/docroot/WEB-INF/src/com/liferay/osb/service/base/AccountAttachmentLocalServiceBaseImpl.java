...
/**
 * The base implementation of the account attachment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AccountAttachmentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AccountAttachmentLocalServiceImpl
 * @see com.liferay.osb.service.AccountAttachmentLocalServiceUtil
 * @generated
 */
public abstract class AccountAttachmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccountAttachmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AccountAttachmentLocalServiceUtil} to access the account attachment local service.
	 */
	...
	public AccountAttachment addAccountAttachment(
		AccountAttachment accountAttachment) throws SystemException {
		accountAttachment.setNew(true);

		return accountAttachmentPersistence.update(accountAttachment, false);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccountAttachment.class,
	...
	public AccountAttachment fetchAccountAttachment(long accountAttachmentId)
		throws SystemException {
		return accountAttachmentPersistence.fetchByPrimaryKey(accountAttachmentId);
	}
	...
	public AccountAttachment getAccountAttachment(long accountAttachmentId)
		throws PortalException, SystemException {
		return accountAttachmentPersistence.findByPrimaryKey(accountAttachmentId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccountAttachmentsCount() throws SystemException {
	...
	public AccountAttachment updateAccountAttachment(
		AccountAttachment accountAttachment) throws SystemException {
		return updateAccountAttachment(accountAttachment, true);
	}
	...
	public AccountAttachment updateAccountAttachment(
		...
		return accountAttachmentPersistence.update(accountAttachment, merge);
	}
