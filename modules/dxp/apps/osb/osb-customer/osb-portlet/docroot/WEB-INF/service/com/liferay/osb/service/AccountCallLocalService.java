...
/**
 * Provides the local service interface for AccountCall. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AccountCallLocalServiceUtil
...
public interface AccountCallLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AccountCallLocalServiceUtil} to access the account call local service. Add custom service methods to {@link com.liferay.osb.service.impl.AccountCallLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
