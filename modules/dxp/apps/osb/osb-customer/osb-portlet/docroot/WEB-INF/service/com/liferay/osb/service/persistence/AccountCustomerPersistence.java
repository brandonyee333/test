...
public interface AccountCustomerPersistence extends BasePersistence<AccountCustomer> {
	...
	* @return the matching account customers
	*/
	public java.util.List<AccountCustomer> findByU_R(long userId, int role);
	...
	* @return the matching account customers
	*/
	public java.util.List<AccountCustomer> findByU_R(long userId, int[] roles);
	...
	* @return the matching account customers
	*/
	public java.util.List<AccountCustomer> findByAEI_NotR(long accountEntryId,
		int role);
	...
	* @return the matching account customers
	*/
	public java.util.List<AccountCustomer> findByAEI_NotN(long accountEntryId,
		int notifications);
