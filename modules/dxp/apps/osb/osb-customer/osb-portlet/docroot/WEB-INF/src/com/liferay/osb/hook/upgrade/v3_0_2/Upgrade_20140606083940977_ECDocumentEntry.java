 ...
 * @author Joan Kim
 */
public class Upgrade_20140606083940977_ECDocumentEntry extends UpgradeProcess {
...
/*@Override
	...
	protected void upgradeECDocumentEntry() throws Exception {
		if (tableHasColumn("ECommerce_ECDocumentEntry", "vatNumber")) {
			return;
		}
