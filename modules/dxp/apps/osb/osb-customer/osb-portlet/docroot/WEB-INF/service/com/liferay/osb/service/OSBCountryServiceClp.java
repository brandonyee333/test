 ...
 */
public class OSBCountryServiceClp implements OSBCountryService {
	public OSBCountryServiceClp(InvokableService invokableService) {
		...
		_methodName4 = "deleteCountry";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "updateCountry";
	...
	public com.liferay.portal.model.Country addCountry(java.lang.String name,
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					...
					ClpSerializer.translateInput(a2),
						
					ClpSerializer.translateInput(a3),
						
					ClpSerializer.translateInput(number),
						
					ClpSerializer.translateInput(idd),
