...
public interface AuditActionPersistence extends BasePersistence<AuditAction> {
	...
	*/
	public java.util.List<AuditAction> findByLtModifiedDate(Date modifiedDate);
	...
	*/
	public java.util.List<AuditAction> findByLtModifiedDate(Date modifiedDate,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AuditAction> orderByComparator);
	...
	* @return the matching audit actions
	*/
	public java.util.List<AuditAction> findByGtMD_C_GtMC_A(Date modifiedDate,
	...
	* @return the matching audit actions
	*/
	public java.util.List<AuditAction> findByGtMD_C_MC_A(Date modifiedDate,
		long classNameId, long mappingClassPK, int action);
	...
	* @return the matching audit actions
	*/
	public java.util.List<AuditAction> findByMD_C_C_MC_A(Date modifiedDate,
	...
	*/
	public void cacheResult(java.util.List<AuditAction> auditActions);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, AuditAction> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<AuditAction> findAll();
	...
	*/
	public java.util.List<AuditAction> findAll(int start, int end);
