...
/**
 * The base implementation of the user profile history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.UserProfileHistoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.UserProfileHistoryLocalServiceImpl
 * @see com.liferay.osb.service.UserProfileHistoryLocalServiceUtil
 * @generated
 */
public abstract class UserProfileHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserProfileHistoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.UserProfileHistoryLocalServiceUtil} to access the user profile history local service.
	 */
	 ...
	 */
	public UserProfileHistory createUserProfileHistory(
		long userProfileHistoryId) {
		return userProfileHistoryPersistence.create(userProfileHistoryId);
	}
	...
	public UserProfileHistory deleteUserProfileHistory(
		long userProfileHistoryId) throws PortalException, SystemException {
		return userProfileHistoryPersistence.remove(userProfileHistoryId);
	}
	...
	public UserProfileHistory deleteUserProfileHistory(
		UserProfileHistory userProfileHistory) throws SystemException {
		return userProfileHistoryPersistence.remove(userProfileHistory);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(UserProfileHistory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return userProfileHistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userProfileHistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public UserProfileHistory fetchUserProfileHistory(long userProfileHistoryId)
		throws SystemException {
		return userProfileHistoryPersistence.fetchByPrimaryKey(userProfileHistoryId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserProfileHistory getUserProfileHistory(long userProfileHistoryId)
		throws PortalException, SystemException {
		return userProfileHistoryPersistence.findByPrimaryKey(userProfileHistoryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userProfileHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<UserProfileHistory> getUserProfileHistories(int start, int end)
		throws SystemException {
		return userProfileHistoryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getUserProfileHistoriesCount() throws SystemException {
		return userProfileHistoryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UserProfileHistory updateUserProfileHistory(
		UserProfileHistory userProfileHistory) throws SystemException {
		return updateUserProfileHistory(userProfileHistory, true);
	}
	...
	public UserProfileHistory updateUserProfileHistory(
		...
		return userProfileHistoryPersistence.update(userProfileHistory, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.UserProfileHistory",
			userProfileHistoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userProfileHistoryPersistence.getDataSource();
	...
	private UserProfileHistoryLocalServiceClpInvoker _clpInvoker = new UserProfileHistoryLocalServiceClpInvoker();
}