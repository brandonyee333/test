...
/**
 * Provides the remote service utility for HolidayCalendarRel. This utility wraps
 * {@link com.liferay.osb.service.impl.HolidayCalendarRelServiceImpl} and is the
...
public class HolidayCalendarRelServiceUtil {
	...
	*/
	...
	public static HolidayCalendarRelService getService() {
		if (_service == null) {
			_service = (HolidayCalendarRelService)PortletBeanLocatorUtil.locate(ServletContextUtil.getServletContextName(),
