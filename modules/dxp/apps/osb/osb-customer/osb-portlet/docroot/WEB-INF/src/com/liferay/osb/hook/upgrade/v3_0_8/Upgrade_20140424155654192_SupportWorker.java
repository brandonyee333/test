 ...
 */
public class Upgrade_20140424155654192_SupportWorker extends UpgradeProcess {
...
/*@Override
	...
	protected void addClockedIn() throws Exception {
		if (tableHasColumn("OSB_SupportWorker", "clockedIn")) {
			return;
		}
	...
	protected void addSupportLaborId() throws Exception {
		if (tableHasColumn("OSB_SupportWorker", "supportLaborId")) {
			return;
		}
