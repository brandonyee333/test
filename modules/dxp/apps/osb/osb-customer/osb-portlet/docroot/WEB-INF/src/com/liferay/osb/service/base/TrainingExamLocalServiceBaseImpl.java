...
/**
 * The base implementation of the training exam local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TrainingExamLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TrainingExamLocalServiceImpl
 * @see com.liferay.osb.service.TrainingExamLocalServiceUtil
 * @generated
 */
public abstract class TrainingExamLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrainingExamLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TrainingExamLocalServiceUtil} to access the training exam local service.
	 */
	...
	public TrainingExam addTrainingExam(TrainingExam trainingExam)
	 ...
	 */
	public TrainingExam createTrainingExam(long trainingExamId) {
		return trainingExamPersistence.create(trainingExamId);
	}
	...
	public TrainingExam deleteTrainingExam(long trainingExamId)
		throws PortalException, SystemException {
		return trainingExamPersistence.remove(trainingExamId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TrainingExam deleteTrainingExam(TrainingExam trainingExam)
		throws SystemException {
		return trainingExamPersistence.remove(trainingExam);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TrainingExam.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return trainingExamPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trainingExamPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrainingExam fetchTrainingExam(long trainingExamId)
		throws SystemException {
		return trainingExamPersistence.fetchByPrimaryKey(trainingExamId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrainingExam getTrainingExam(long trainingExamId)
		throws PortalException, SystemException {
		return trainingExamPersistence.findByPrimaryKey(trainingExamId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trainingExamPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrainingExam> getTrainingExams(int start, int end)
		throws SystemException {
		return trainingExamPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrainingExamsCount() throws SystemException {
		return trainingExamPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TrainingExam updateTrainingExam(TrainingExam trainingExam)
		throws SystemException {
		return updateTrainingExam(trainingExam, true);
	}
	...
	public TrainingExam updateTrainingExam(TrainingExam trainingExam,
		...
		return trainingExamPersistence.update(trainingExam, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TrainingExam",
			trainingExamLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.osb.model.TrainingExam");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trainingExamPersistence.getDataSource();
	...
	private TrainingExamLocalServiceClpInvoker _clpInvoker = new TrainingExamLocalServiceClpInvoker();
}