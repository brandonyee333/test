...
/**
 * The interface for the corp project message local service.
 *
 * <p>
 ...
 * @see CorpProjectMessageLocalServiceUtil
...
public interface CorpProjectMessageLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CorpProjectMessageLocalServiceUtil} to access the corp project message local service. Add custom service methods to {@link com.liferay.osb.service.impl.CorpProjectMessageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
