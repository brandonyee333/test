 ...
 */
public class SupportRegionServiceClpInvoker {
	public SupportRegionServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return SupportRegionServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			SupportRegionServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
