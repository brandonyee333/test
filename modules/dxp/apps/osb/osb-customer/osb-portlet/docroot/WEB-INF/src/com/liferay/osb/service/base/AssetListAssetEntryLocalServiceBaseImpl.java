...
/**
 * The base implementation of the asset list asset entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AssetListAssetEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AssetListAssetEntryLocalServiceImpl
 * @see com.liferay.osb.service.AssetListAssetEntryLocalServiceUtil
 * @generated
 */
public abstract class AssetListAssetEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetListAssetEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AssetListAssetEntryLocalServiceUtil} to access the asset list asset entry local service.
	 */
	...
	public AssetListAssetEntry addAssetListAssetEntry(
		...
		return assetListAssetEntryPersistence.update(assetListAssetEntry, false);
	}
	 ...
	 */
	public AssetListAssetEntry createAssetListAssetEntry(
		long assetListAssetEntryId) {
		return assetListAssetEntryPersistence.create(assetListAssetEntryId);
	}
	...
	public AssetListAssetEntry deleteAssetListAssetEntry(
		long assetListAssetEntryId) throws PortalException, SystemException {
		return assetListAssetEntryPersistence.remove(assetListAssetEntryId);
	}
	...
	public AssetListAssetEntry deleteAssetListAssetEntry(
		...
		return assetListAssetEntryPersistence.remove(assetListAssetEntry);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AssetListAssetEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return assetListAssetEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetListAssetEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AssetListAssetEntry fetchAssetListAssetEntry(
		long assetListAssetEntryId) throws SystemException {
		return assetListAssetEntryPersistence.fetchByPrimaryKey(assetListAssetEntryId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AssetListAssetEntry getAssetListAssetEntry(
		long assetListAssetEntryId) throws PortalException, SystemException {
		return assetListAssetEntryPersistence.findByPrimaryKey(assetListAssetEntryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assetListAssetEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AssetListAssetEntry> getAssetListAssetEntries(int start, int end)
		throws SystemException {
		return assetListAssetEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAssetListAssetEntriesCount() throws SystemException {
		return assetListAssetEntryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AssetListAssetEntry updateAssetListAssetEntry(
		AssetListAssetEntry assetListAssetEntry) throws SystemException {
		return updateAssetListAssetEntry(assetListAssetEntry, true);
	}
	...
	public AssetListAssetEntry updateAssetListAssetEntry(
		...
		return assetListAssetEntryPersistence.update(assetListAssetEntry, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AssetListAssetEntry",
			assetListAssetEntryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assetListAssetEntryPersistence.getDataSource();
	...
	private AssetListAssetEntryLocalServiceClpInvoker _clpInvoker = new AssetListAssetEntryLocalServiceClpInvoker();
}