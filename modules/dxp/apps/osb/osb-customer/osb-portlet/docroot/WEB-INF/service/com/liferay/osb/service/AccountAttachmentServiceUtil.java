...
/**
 * The utility for the account attachment remote service. This utility wraps {@link com.liferay.osb.service.impl.AccountAttachmentServiceImpl} and is the primary access point for service operations in application layer code running on a remote server.
 *
 * <p>
 ...
 * @see com.liferay.osb.service.base.AccountAttachmentServiceBaseImpl
...
public class AccountAttachmentServiceUtil {
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(AccountAttachmentService service) {
	}

	private static AccountAttachmentService _service;
}