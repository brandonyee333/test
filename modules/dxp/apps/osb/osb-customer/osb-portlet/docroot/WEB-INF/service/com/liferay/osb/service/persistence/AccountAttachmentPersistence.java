...
public interface AccountAttachmentPersistence extends BasePersistence<AccountAttachment> {
	...
	*/
	public java.util.List<AccountAttachment> findByAccountEntryId(
		long accountEntryId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AccountAttachment> orderByComparator);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, AccountAttachment> fetchByPrimaryKeys(
