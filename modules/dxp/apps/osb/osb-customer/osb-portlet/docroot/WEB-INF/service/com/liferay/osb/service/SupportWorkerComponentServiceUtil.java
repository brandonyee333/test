...
/**
 * Provides the remote service utility for SupportWorkerComponent. This utility wraps
 * {@link com.liferay.osb.service.impl.SupportWorkerComponentServiceImpl} and is the
...
public class SupportWorkerComponentServiceUtil {
	...
	*/
	...
	public static SupportWorkerComponentService getService() {
		if (_service == null) {
			_service = (SupportWorkerComponentService)PortletBeanLocatorUtil.locate(ServletContextUtil.getServletContextName(),
