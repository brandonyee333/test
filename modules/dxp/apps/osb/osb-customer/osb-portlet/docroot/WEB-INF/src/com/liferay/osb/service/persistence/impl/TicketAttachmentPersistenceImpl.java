...
public class TicketAttachmentPersistenceImpl extends BasePersistenceImpl<TicketAttachment>
	...
	public List<TicketAttachment> findByType(int[] types, int start, int end,
		...
		if (retrieveFromCache) {
			list = (List<TicketAttachment>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_TYPE,
					finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				finderCache.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_TYPE,
					finderArgs, list);
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_TYPE,
					finderArgs);
	...
	public int countByType(int[] types) {
		...
		Long count = (Long)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_TYPE,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				finderCache.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_TYPE,
					finderArgs, count);
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_TYPE,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_TYPE_TYPE_7 = "ticketAttachment.type IN (";
	...
	public List<TicketAttachment> findByCD_T(Date createDate, int type,
		int start, int end,
		OrderByComparator<TicketAttachment> orderByComparator) {
		return findByCD_T(createDate, type, start, end, orderByComparator, true);
	}
	...
	public int countByCD_T(Date createDate, int type) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_CD_T;
	...
	private static final String _FINDER_COLUMN_CD_T_CREATEDATE_1 = "ticketAttachment.createDate IS NULL AND ";
