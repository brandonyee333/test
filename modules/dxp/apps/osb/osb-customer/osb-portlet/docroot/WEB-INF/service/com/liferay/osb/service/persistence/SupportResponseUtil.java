...
public class SupportResponseUtil {
	...
	*/
	public static List<SupportResponse> findBySupportLevel(int supportLevel) {
	...
	* @throws NoSuchSupportResponseException if a matching support response could not be found
	*/
	public static SupportResponse findBySupportLevel_First(int supportLevel,
		OrderByComparator<SupportResponse> orderByComparator)
		throws com.liferay.osb.exception.NoSuchSupportResponseException {
		return getPersistence()
	...
	*/
	public static SupportResponse fetchBySupportLevel_First(int supportLevel,
		OrderByComparator<SupportResponse> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchSupportResponseException if a matching support response could not be found
	*/
	public static SupportResponse findBySupportLevel_Last(int supportLevel,
		OrderByComparator<SupportResponse> orderByComparator)
		throws com.liferay.osb.exception.NoSuchSupportResponseException {
		return getPersistence()
	...
	*/
	public static SupportResponse fetchBySupportLevel_Last(int supportLevel,
		OrderByComparator<SupportResponse> orderByComparator) {
		return getPersistence()
	...
	*/
	public static SupportResponse[] findBySupportLevel_PrevAndNext(
