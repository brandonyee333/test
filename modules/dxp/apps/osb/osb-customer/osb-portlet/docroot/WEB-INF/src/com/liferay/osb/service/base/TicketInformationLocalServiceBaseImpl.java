...
/**
 * The base implementation of the ticket information local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TicketInformationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TicketInformationLocalServiceImpl
 * @see com.liferay.osb.service.TicketInformationLocalServiceUtil
 * @generated
 */
public abstract class TicketInformationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TicketInformationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TicketInformationLocalServiceUtil} to access the ticket information local service.
	 */
	...
	public TicketInformation addTicketInformation(
		TicketInformation ticketInformation) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TicketInformation.class,
	...
	public TicketInformation fetchTicketInformation(long ticketInformationId)
		throws SystemException {
		return ticketInformationPersistence.fetchByPrimaryKey(ticketInformationId);
	}
	...
	public TicketInformation getTicketInformation(long ticketInformationId)
		throws PortalException, SystemException {
		return ticketInformationPersistence.findByPrimaryKey(ticketInformationId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTicketInformationsCount() throws SystemException {
	...
	public TicketInformation updateTicketInformation(
		TicketInformation ticketInformation) throws SystemException {
		return updateTicketInformation(ticketInformation, true);
	}
	...
	public TicketInformation updateTicketInformation(
		...
		return ticketInformationPersistence.update(ticketInformation, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TicketInformation",
	...
	private TicketInformationLocalServiceClpInvoker _clpInvoker = new TicketInformationLocalServiceClpInvoker();
}