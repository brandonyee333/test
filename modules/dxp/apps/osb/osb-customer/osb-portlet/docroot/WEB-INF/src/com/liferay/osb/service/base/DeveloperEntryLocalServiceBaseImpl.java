...
/**
 * The base implementation of the developer entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.DeveloperEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.DeveloperEntryLocalServiceImpl
 * @see com.liferay.osb.service.DeveloperEntryLocalServiceUtil
 * @generated
 */
public abstract class DeveloperEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DeveloperEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.DeveloperEntryLocalServiceUtil} to access the developer entry local service.
	 */
	...
	public DeveloperEntry addDeveloperEntry(DeveloperEntry developerEntry)
		throws SystemException {
		developerEntry.setNew(true);

		return developerEntryPersistence.update(developerEntry, false);
	}
	 ...
	 */
	public DeveloperEntry createDeveloperEntry(long developerEntryId) {
		return developerEntryPersistence.create(developerEntryId);
	}
	...
	public DeveloperEntry deleteDeveloperEntry(long developerEntryId)
		...
		return developerEntryPersistence.remove(developerEntryId);
	}
	...
	public DeveloperEntry deleteDeveloperEntry(DeveloperEntry developerEntry)
		throws PortalException, SystemException {
		return developerEntryPersistence.remove(developerEntry);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(DeveloperEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return developerEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return developerEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DeveloperEntry fetchDeveloperEntry(long developerEntryId)
		throws SystemException {
		return developerEntryPersistence.fetchByPrimaryKey(developerEntryId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DeveloperEntry getDeveloperEntry(long developerEntryId)
		throws PortalException, SystemException {
		return developerEntryPersistence.findByPrimaryKey(developerEntryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return developerEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DeveloperEntry> getDeveloperEntries(int start, int end)
		throws SystemException {
		return developerEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDeveloperEntriesCount() throws SystemException {
		return developerEntryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DeveloperEntry updateDeveloperEntry(DeveloperEntry developerEntry)
		throws SystemException {
		return updateDeveloperEntry(developerEntry, true);
	}
	...
	public DeveloperEntry updateDeveloperEntry(DeveloperEntry developerEntry,
		...
		return developerEntryPersistence.update(developerEntry, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.DeveloperEntry",
			developerEntryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = developerEntryPersistence.getDataSource();
	...
	private DeveloperEntryLocalServiceClpInvoker _clpInvoker = new DeveloperEntryLocalServiceClpInvoker();
}