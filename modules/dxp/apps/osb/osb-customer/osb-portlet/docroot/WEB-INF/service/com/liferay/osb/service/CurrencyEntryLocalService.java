...
/**
 * Provides the local service interface for CurrencyEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CurrencyEntryLocalServiceUtil
...
public interface CurrencyEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CurrencyEntryLocalServiceUtil} to access the currency entry local service. Add custom service methods to {@link com.liferay.osb.service.impl.CurrencyEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
