...
/**
 * The base implementation of the ticket attachment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TicketAttachmentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TicketAttachmentLocalServiceImpl
 * @see com.liferay.osb.service.TicketAttachmentLocalServiceUtil
 * @generated
 */
public abstract class TicketAttachmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TicketAttachmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TicketAttachmentLocalServiceUtil} to access the ticket attachment local service.
	 */
	...
	public TicketAttachment addTicketAttachment(
		TicketAttachment ticketAttachment) throws SystemException {
		ticketAttachment.setNew(true);

		return ticketAttachmentPersistence.update(ticketAttachment, false);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TicketAttachment.class,
	...
	public TicketAttachment fetchTicketAttachment(long ticketAttachmentId)
		throws SystemException {
		return ticketAttachmentPersistence.fetchByPrimaryKey(ticketAttachmentId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTicketAttachmentsCount() throws SystemException {
	...
	public TicketAttachment updateTicketAttachment(
		TicketAttachment ticketAttachment) throws SystemException {
		return updateTicketAttachment(ticketAttachment, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public TicketAttachment updateTicketAttachment(
		TicketAttachment ticketAttachment, boolean merge)
		throws SystemException {
		ticketAttachment.setNew(false);

		return ticketAttachmentPersistence.update(ticketAttachment, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TicketAttachment",
	...
	private TicketAttachmentLocalServiceClpInvoker _clpInvoker = new TicketAttachmentLocalServiceClpInvoker();
}