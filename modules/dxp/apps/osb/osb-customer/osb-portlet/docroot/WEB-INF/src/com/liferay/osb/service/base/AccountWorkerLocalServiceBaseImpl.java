...
/**
 * Provides the base implementation for the account worker local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AccountWorkerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AccountWorkerLocalServiceImpl
 * @see com.liferay.osb.service.AccountWorkerLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AccountWorkerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccountWorkerLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AccountWorkerLocalServiceUtil} to access the account worker local service.
	 */
	...
	public AccountWorker addAccountWorker(AccountWorker accountWorker) {
		...
		return accountWorkerPersistence.update(accountWorker);
	}
	...
	public AccountWorker createAccountWorker(long accountWorkerId) {
		return accountWorkerPersistence.create(accountWorkerId);
	}
	...
	public AccountWorker deleteAccountWorker(long accountWorkerId)
		...
		return accountWorkerPersistence.remove(accountWorkerId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AccountWorker deleteAccountWorker(AccountWorker accountWorker) {
		return accountWorkerPersistence.remove(accountWorker);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccountWorker.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accountWorkerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accountWorkerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AccountWorker fetchAccountWorker(long accountWorkerId) {
		return accountWorkerPersistence.fetchByPrimaryKey(accountWorkerId);
	}
	...
	public AccountWorker getAccountWorker(long accountWorkerId)
		throws PortalException {
		return accountWorkerPersistence.findByPrimaryKey(accountWorkerId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accountWorkerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccountWorker.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accountWorkerId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(accountWorkerLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccountWorker.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return accountWorkerLocalService.deleteAccountWorker((AccountWorker)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return accountWorkerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AccountWorker> getAccountWorkers(int start, int end) {
		return accountWorkerPersistence.findAll(start, end);
	}
	...
	public int getAccountWorkersCount() {
		return accountWorkerPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AccountWorker",
			accountWorkerLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccountWorkerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accountWorkerPersistence.getDataSource();
	...
	private AccountWorkerLocalServiceClpInvoker _clpInvoker = new AccountWorkerLocalServiceClpInvoker();
}