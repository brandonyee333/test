...
/**
 * The base implementation of the account worker local service.
 *
 * <p>
...
public abstract class AccountWorkerLocalServiceBaseImpl
	...
	public AccountWorker addAccountWorker(AccountWorker accountWorker)
		...
		return accountWorkerPersistence.update(accountWorker, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccountWorkersCount() throws SystemException {
	...
	public AccountWorker updateAccountWorker(AccountWorker accountWorker)
		throws SystemException {
		return updateAccountWorker(accountWorker, true);
	}
	...
	public AccountWorker updateAccountWorker(AccountWorker accountWorker,
		...
		return accountWorkerPersistence.update(accountWorker, merge);
	}
