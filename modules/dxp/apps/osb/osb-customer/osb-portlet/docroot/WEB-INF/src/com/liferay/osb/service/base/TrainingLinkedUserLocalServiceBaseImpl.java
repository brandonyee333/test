...
/**
 * The base implementation of the training linked user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TrainingLinkedUserLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TrainingLinkedUserLocalServiceImpl
 * @see com.liferay.osb.service.TrainingLinkedUserLocalServiceUtil
 * @generated
 */
public abstract class TrainingLinkedUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrainingLinkedUserLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TrainingLinkedUserLocalServiceUtil} to access the training linked user local service.
	 */
	...
	public TrainingLinkedUser addTrainingLinkedUser(
		TrainingLinkedUser trainingLinkedUser) throws SystemException {
		trainingLinkedUser.setNew(true);

		return trainingLinkedUserPersistence.update(trainingLinkedUser, false);
	}
	 ...
	 */
	public TrainingLinkedUser createTrainingLinkedUser(
		long trainingLinkedUserId) {
		return trainingLinkedUserPersistence.create(trainingLinkedUserId);
	}
	...
	public TrainingLinkedUser deleteTrainingLinkedUser(
		long trainingLinkedUserId) throws PortalException, SystemException {
		return trainingLinkedUserPersistence.remove(trainingLinkedUserId);
	}
	...
	public TrainingLinkedUser deleteTrainingLinkedUser(
		TrainingLinkedUser trainingLinkedUser) throws SystemException {
		return trainingLinkedUserPersistence.remove(trainingLinkedUser);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TrainingLinkedUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return trainingLinkedUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trainingLinkedUserPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrainingLinkedUser fetchTrainingLinkedUser(long trainingLinkedUserId)
		throws SystemException {
		return trainingLinkedUserPersistence.fetchByPrimaryKey(trainingLinkedUserId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrainingLinkedUser getTrainingLinkedUser(long trainingLinkedUserId)
		throws PortalException, SystemException {
		return trainingLinkedUserPersistence.findByPrimaryKey(trainingLinkedUserId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trainingLinkedUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrainingLinkedUser> getTrainingLinkedUsers(int start, int end)
		throws SystemException {
		return trainingLinkedUserPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrainingLinkedUsersCount() throws SystemException {
		return trainingLinkedUserPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TrainingLinkedUser updateTrainingLinkedUser(
		TrainingLinkedUser trainingLinkedUser) throws SystemException {
		return updateTrainingLinkedUser(trainingLinkedUser, true);
	}
	...
	public TrainingLinkedUser updateTrainingLinkedUser(
		...
		return trainingLinkedUserPersistence.update(trainingLinkedUser, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TrainingLinkedUser",
			trainingLinkedUserLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trainingLinkedUserPersistence.getDataSource();
	...
	private TrainingLinkedUserLocalServiceClpInvoker _clpInvoker = new TrainingLinkedUserLocalServiceClpInvoker();
}