 ...
 */
public class HolidayCalendarServiceClpInvoker {
	public HolidayCalendarServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return HolidayCalendarServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			HolidayCalendarServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
