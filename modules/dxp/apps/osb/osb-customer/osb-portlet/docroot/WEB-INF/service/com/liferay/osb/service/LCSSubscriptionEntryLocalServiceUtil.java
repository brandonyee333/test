...
/**
 * The utility for the l c s subscription entry local service. This utility wraps {@link com.liferay.osb.service.impl.LCSSubscriptionEntryLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class LCSSubscriptionEntryLocalServiceUtil {
	...
	*/
	public static com.liferay.osb.model.LCSSubscriptionEntry updateLCSSubscriptionEntry(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateLCSSubscriptionEntry(lcsSubscriptionEntry, merge);
	}
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(LCSSubscriptionEntryLocalService service) {
	}
