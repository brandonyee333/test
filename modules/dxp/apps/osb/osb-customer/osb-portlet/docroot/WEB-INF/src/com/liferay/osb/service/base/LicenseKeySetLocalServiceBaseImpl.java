...
/**
 * The base implementation of the license key set local service.
 *
 * <p>
...
public abstract class LicenseKeySetLocalServiceBaseImpl
	...
	public LicenseKeySet addLicenseKeySet(LicenseKeySet licenseKeySet)
		...
		return licenseKeySetPersistence.update(licenseKeySet, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLicenseKeySetsCount() throws SystemException {
	...
	public LicenseKeySet updateLicenseKeySet(LicenseKeySet licenseKeySet)
		throws SystemException {
		return updateLicenseKeySet(licenseKeySet, true);
	}
	...
	public LicenseKeySet updateLicenseKeySet(LicenseKeySet licenseKeySet,
		...
		return licenseKeySetPersistence.update(licenseKeySet, merge);
	}
