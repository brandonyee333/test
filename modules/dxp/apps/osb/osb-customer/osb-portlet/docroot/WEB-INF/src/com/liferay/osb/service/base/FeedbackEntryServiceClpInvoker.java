 ...
 */
public class FeedbackEntryServiceClpInvoker {
	public FeedbackEntryServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return FeedbackEntryServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			FeedbackEntryServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
