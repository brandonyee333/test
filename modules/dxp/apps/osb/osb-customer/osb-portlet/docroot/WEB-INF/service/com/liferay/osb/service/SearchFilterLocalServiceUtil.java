...
/**
 * The utility for the search filter local service. This utility wraps {@link com.liferay.osb.service.impl.SearchFilterLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class SearchFilterLocalServiceUtil {
	...
	*/
	public static com.liferay.osb.model.SearchFilter updateSearchFilter(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSearchFilter(searchFilter, merge);
	}
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(SearchFilterLocalService service) {
	}
