...
/**
 * The base implementation of the app flag local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AppFlagLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AppFlagLocalServiceImpl
 * @see com.liferay.osb.service.AppFlagLocalServiceUtil
 * @generated
 */
public abstract class AppFlagLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AppFlagLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AppFlagLocalServiceUtil} to access the app flag local service.
	 */
	...
	public AppFlag addAppFlag(AppFlag appFlag) throws SystemException {
		appFlag.setNew(true);
	 ...
	 */
	public AppFlag createAppFlag(long appFlagId) {
		return appFlagPersistence.create(appFlagId);
	}
	...
	public AppFlag deleteAppFlag(long appFlagId)
		...
		return appFlagPersistence.remove(appFlagId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AppFlag deleteAppFlag(AppFlag appFlag) throws SystemException {
		return appFlagPersistence.remove(appFlag);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AppFlag.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return appFlagPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return appFlagPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return appFlagPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return appFlagPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AppFlag fetchAppFlag(long appFlagId) throws SystemException {
		return appFlagPersistence.fetchByPrimaryKey(appFlagId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AppFlag getAppFlag(long appFlagId)
		throws PortalException, SystemException {
		return appFlagPersistence.findByPrimaryKey(appFlagId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return appFlagPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AppFlag> getAppFlags(int start, int end)
		throws SystemException {
		return appFlagPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAppFlagsCount() throws SystemException {
		return appFlagPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppFlag updateAppFlag(AppFlag appFlag) throws SystemException {
		return updateAppFlag(appFlag, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppFlag updateAppFlag(AppFlag appFlag, boolean merge)
		throws SystemException {
		appFlag.setNew(false);

		return appFlagPersistence.update(appFlag, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AppFlag",
			appFlagLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.osb.model.AppFlag");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = appFlagPersistence.getDataSource();
	...
	private AppFlagLocalServiceClpInvoker _clpInvoker = new AppFlagLocalServiceClpInvoker();
}