 ...
 */
public class AppVersionServiceClpInvoker {
	public AppVersionServiceClpInvoker() {
		...
		_methodName670 = "deleteAppVersion";

		_methodParameterTypes670 = new String[] { "long" };

		_methodName671 = "getAppVersion";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return AppVersionServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			AppVersionServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
		...
		if (_methodName670.equals(name) &&
			...
			return AppVersionServiceUtil.deleteAppVersion(((Long)arguments[0]).longValue());
		}

		if (_methodName671.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes671, parameterTypes)) {
			return AppVersionServiceUtil.getAppVersion(((Long)arguments[0]).longValue());
		}
