 ...
 */
public class TrainingCustomerServiceClpInvoker {
	public TrainingCustomerServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return TrainingCustomerServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			TrainingCustomerServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
