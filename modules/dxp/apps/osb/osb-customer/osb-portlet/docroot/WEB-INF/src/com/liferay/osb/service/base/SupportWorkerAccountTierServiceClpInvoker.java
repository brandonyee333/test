 ...
 */
public class SupportWorkerAccountTierServiceClpInvoker {
	public SupportWorkerAccountTierServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return SupportWorkerAccountTierServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			SupportWorkerAccountTierServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
