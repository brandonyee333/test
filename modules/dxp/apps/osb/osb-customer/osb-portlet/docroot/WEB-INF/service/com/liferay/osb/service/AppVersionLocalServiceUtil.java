...
/**
 * The utility for the app version local service. This utility wraps {@link com.liferay.osb.service.impl.AppVersionLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.liferay.osb.service.base.AppVersionLocalServiceBaseImpl
 * @see com.liferay.osb.service.impl.AppVersionLocalServiceImpl
 * @generated
 */
public class AppVersionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.service.impl.AppVersionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.osb.model.AppVersion addAppVersion(
	...
	*/
	public static com.liferay.osb.model.AppVersion createAppVersion(
		long appVersionId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.osb.model.AppVersion deleteAppVersion(
		long appVersionId)
	...
	*/
	...
	public static com.liferay.osb.model.AppVersion fetchAppVersion(
		long appVersionId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.osb.model.AppVersion getAppVersion(
		long appVersionId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.liferay.osb.model.AppVersion> getAppVersions(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.osb.model.AppVersion updateAppVersion(
		com.liferay.osb.model.AppVersion appVersion)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	public static com.liferay.osb.model.AppVersion updateAppVersion(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateAppVersion(appVersion, merge);
	}
	...
	*/
	...
	public static com.liferay.osb.model.AppVersion fetchAppVersion(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchAppVersion(appEntryId, status, obc);
	}

	public static com.liferay.osb.model.AppVersion fetchAppVersion(
		long appEntryId, int[] statuses,
		com.liferay.portal.kernel.util.OrderByComparator obc)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchAppVersion(appEntryId, statuses, obc);
	}
	...
	public static com.liferay.osb.model.AppVersion fetchAppVersion(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchAppVersion(appEntryId, version);
	}
	...
	public static java.util.List<com.liferay.osb.model.AppVersion> getAppVersions(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getAppVersions(appEntryId, compatibility, status, start, end);
	}
	...
	public static java.util.List<com.liferay.osb.model.AppVersion> getAppVersions(
		...
		com.liferay.portal.kernel.util.OrderByComparator obc)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getAppVersions(appEntryId, status, start, end, obc);
	}
	...
	public static java.util.List<com.liferay.osb.model.AppVersion> getAppVersions(
		...
		com.liferay.portal.kernel.util.OrderByComparator obc)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getAppVersions(appEntryId, statuses, start, end, obc);
	}

	public static int getAppVersionsByReleaseTypeCount(long appEntryId,
		int releaseType)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getAppVersionsByReleaseTypeCount(appEntryId, releaseType);
	}

	public static int getAppVersionsCount(long appEntryId, int status)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getAppVersionsCount(appEntryId, status);
	}

	public static int getAppVersionsCount(long appEntryId, int[] statuses)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getAppVersionsCount(appEntryId, statuses);
	}
