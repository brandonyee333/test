 ...
 * @see TicketCannedResponseServiceSoap
 * @see HttpPrincipal
...
public class TicketCannedResponseServiceHttp {
	...
	public static java.util.List<com.liferay.osb.model.TicketCannedResponse> search(
		...
		try {
			...
			return (java.util.List<com.liferay.osb.model.TicketCannedResponse>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static Log _log = LogFactoryUtil.getLog(TicketCannedResponseServiceHttp.class);
	private static final Class<?>[] _incrementUseCountParameterTypes0 = new Class[] {
			long.class
		};
