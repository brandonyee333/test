 ...
 * @generated
 */
@ImplementationClassName("com.liferay.osb.model.impl.AssetReceiptLicenseImpl")
@ProviderType
public interface AssetReceiptLicense extends AssetReceiptLicenseModel,
	 ...
	 */
	public static final Accessor<AssetReceiptLicense, Long> ASSET_RECEIPT_LICENSE_ID_ACCESSOR =
		new Accessor<AssetReceiptLicense, Long>() {
			@Override
			public Long get(AssetReceiptLicense assetReceiptLicense) {
				return assetReceiptLicense.getAssetReceiptLicenseId();
			}
			...
			@Override
			public Class<AssetReceiptLicense> getTypeClass() {
