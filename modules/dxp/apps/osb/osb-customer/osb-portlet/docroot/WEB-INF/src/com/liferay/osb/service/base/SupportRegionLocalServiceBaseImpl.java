...
/**
 * Provides the base implementation for the support region local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.SupportRegionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.SupportRegionLocalServiceImpl
 * @see com.liferay.osb.service.SupportRegionLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class SupportRegionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SupportRegionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.SupportRegionLocalServiceUtil} to access the support region local service.
	 */
	...
	public SupportRegion createSupportRegion(long supportRegionId) {
		return supportRegionPersistence.create(supportRegionId);
	}
	...
	public SupportRegion deleteSupportRegion(SupportRegion supportRegion) {
		return supportRegionPersistence.remove(supportRegion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SupportRegion.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return supportRegionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return supportRegionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public SupportRegion fetchSupportRegion(long supportRegionId) {
		return supportRegionPersistence.fetchByPrimaryKey(supportRegionId);
	}
	...
	public SupportRegion getSupportRegion(long supportRegionId)
		throws PortalException {
		return supportRegionPersistence.findByPrimaryKey(supportRegionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(supportRegionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SupportRegion.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("supportRegionId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(supportRegionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SupportRegion.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return supportRegionLocalService.deleteSupportRegion((SupportRegion)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return supportRegionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SupportRegion> getSupportRegions(int start, int end) {
		return supportRegionPersistence.findAll(start, end);
	}
	...
	public int getSupportRegionsCount() {
		return supportRegionPersistence.countAll();
	}
	...
	public void addAccountEntrySupportRegion(long accountEntryId,
		...
		accountEntryPersistence.addSupportRegion(accountEntryId, supportRegionId);
	}
	...
	public void addAccountEntrySupportRegion(long accountEntryId,
		...
		accountEntryPersistence.addSupportRegion(accountEntryId, supportRegion);
	}
	...
	public void addAccountEntrySupportRegions(long accountEntryId,
		...
		accountEntryPersistence.addSupportRegions(accountEntryId,
			supportRegionIds);
	}
	...
	public void addAccountEntrySupportRegions(long accountEntryId,
		...
		accountEntryPersistence.addSupportRegions(accountEntryId, supportRegions);
	}
	...
	public void clearAccountEntrySupportRegions(long accountEntryId) {
		accountEntryPersistence.clearSupportRegions(accountEntryId);
	}
	...
	public void deleteAccountEntrySupportRegion(long accountEntryId,
		long supportRegionId) {
		accountEntryPersistence.removeSupportRegion(accountEntryId,
			supportRegionId);
	}
	...
	public void deleteAccountEntrySupportRegions(long accountEntryId,
		long[] supportRegionIds) {
		accountEntryPersistence.removeSupportRegions(accountEntryId,
			supportRegionIds);
	}
	...
	public long[] getAccountEntryPrimaryKeys(long supportRegionId) {
		return supportRegionPersistence.getAccountEntryPrimaryKeys(supportRegionId);
	}
	...
	public List<SupportRegion> getAccountEntrySupportRegions(
		...
		return accountEntryPersistence.getSupportRegions(accountEntryId, start,
			end);
	}
	...
	public int getAccountEntrySupportRegionsCount(long accountEntryId) {
		return accountEntryPersistence.getSupportRegionsSize(accountEntryId);
	}
	...
	public boolean hasAccountEntrySupportRegion(long accountEntryId,
		long supportRegionId) {
		return accountEntryPersistence.containsSupportRegion(accountEntryId,
			supportRegionId);
	}
	...
	public boolean hasAccountEntrySupportRegions(long accountEntryId) {
		return accountEntryPersistence.containsSupportRegions(accountEntryId);
	}
	...
	public void setAccountEntrySupportRegions(long accountEntryId,
		long[] supportRegionIds) {
		accountEntryPersistence.setSupportRegions(accountEntryId,
			supportRegionIds);
	}
	...
	public void addPartnerEntrySupportRegion(long partnerEntryId,
		long supportRegionId) {
		partnerEntryPersistence.addSupportRegion(partnerEntryId, supportRegionId);
	}
	...
	public void addPartnerEntrySupportRegion(long partnerEntryId,
		SupportRegion supportRegion) {
		partnerEntryPersistence.addSupportRegion(partnerEntryId, supportRegion);
	}
	...
	public void addPartnerEntrySupportRegions(long partnerEntryId,
		long[] supportRegionIds) {
		partnerEntryPersistence.addSupportRegions(partnerEntryId,
			supportRegionIds);
	}
	...
	public void addPartnerEntrySupportRegions(long partnerEntryId,
		List<SupportRegion> supportRegions) {
		partnerEntryPersistence.addSupportRegions(partnerEntryId, supportRegions);
	}
	...
	public void clearPartnerEntrySupportRegions(long partnerEntryId) {
		partnerEntryPersistence.clearSupportRegions(partnerEntryId);
	}
	...
	public void deletePartnerEntrySupportRegion(long partnerEntryId,
		long supportRegionId) {
		partnerEntryPersistence.removeSupportRegion(partnerEntryId,
			supportRegionId);
	}
	...
	public void deletePartnerEntrySupportRegions(long partnerEntryId,
		long[] supportRegionIds) {
		partnerEntryPersistence.removeSupportRegions(partnerEntryId,
			supportRegionIds);
	}
	...
	public long[] getPartnerEntryPrimaryKeys(long supportRegionId) {
		return supportRegionPersistence.getPartnerEntryPrimaryKeys(supportRegionId);
	}
	...
	public List<SupportRegion> getPartnerEntrySupportRegions(
		long partnerEntryId) {
		return partnerEntryPersistence.getSupportRegions(partnerEntryId);
	}
	...
	public List<SupportRegion> getPartnerEntrySupportRegions(
		...
		return partnerEntryPersistence.getSupportRegions(partnerEntryId, start,
			end);
	}
	...
	public int getPartnerEntrySupportRegionsCount(long partnerEntryId) {
		return partnerEntryPersistence.getSupportRegionsSize(partnerEntryId);
	}
	...
	public boolean hasPartnerEntrySupportRegion(long partnerEntryId,
		long supportRegionId) {
		return partnerEntryPersistence.containsSupportRegion(partnerEntryId,
			supportRegionId);
	}
	...
	public boolean hasPartnerEntrySupportRegions(long partnerEntryId) {
		return partnerEntryPersistence.containsSupportRegions(partnerEntryId);
	}
	...
	public void setPartnerEntrySupportRegions(long partnerEntryId,
		long[] supportRegionIds) {
		partnerEntryPersistence.setSupportRegions(partnerEntryId,
			supportRegionIds);
	}
	...
	public void addSupportTeamSupportRegion(long supportTeamId,
		long supportRegionId) {
		supportTeamPersistence.addSupportRegion(supportTeamId, supportRegionId);
	}
	...
	public void addSupportTeamSupportRegion(long supportTeamId,
		SupportRegion supportRegion) {
		supportTeamPersistence.addSupportRegion(supportTeamId, supportRegion);
	}
	...
	public void addSupportTeamSupportRegions(long supportTeamId,
		long[] supportRegionIds) {
		supportTeamPersistence.addSupportRegions(supportTeamId, supportRegionIds);
	}
	...
	public void addSupportTeamSupportRegions(long supportTeamId,
		List<SupportRegion> supportRegions) {
		supportTeamPersistence.addSupportRegions(supportTeamId, supportRegions);
	}
	...
	public void clearSupportTeamSupportRegions(long supportTeamId) {
		supportTeamPersistence.clearSupportRegions(supportTeamId);
	}
	...
	public void deleteSupportTeamSupportRegion(long supportTeamId,
		long supportRegionId) {
		supportTeamPersistence.removeSupportRegion(supportTeamId,
			supportRegionId);
	}
	...
	public void deleteSupportTeamSupportRegion(long supportTeamId,
		SupportRegion supportRegion) {
		supportTeamPersistence.removeSupportRegion(supportTeamId, supportRegion);
	}
	...
	public void deleteSupportTeamSupportRegions(long supportTeamId,
		long[] supportRegionIds) {
		supportTeamPersistence.removeSupportRegions(supportTeamId,
			supportRegionIds);
	}
	...
	public long[] getSupportTeamPrimaryKeys(long supportRegionId) {
		return supportRegionPersistence.getSupportTeamPrimaryKeys(supportRegionId);
	}
	...
	public List<SupportRegion> getSupportTeamSupportRegions(long supportTeamId) {
		return supportTeamPersistence.getSupportRegions(supportTeamId);
	}
	...
	public List<SupportRegion> getSupportTeamSupportRegions(
		...
		return supportTeamPersistence.getSupportRegions(supportTeamId, start,
			end);
	}
	...
	public int getSupportTeamSupportRegionsCount(long supportTeamId) {
		return supportTeamPersistence.getSupportRegionsSize(supportTeamId);
	}
	...
	public boolean hasSupportTeamSupportRegion(long supportTeamId,
		long supportRegionId) {
		return supportTeamPersistence.containsSupportRegion(supportTeamId,
			supportRegionId);
	}
	...
	public boolean hasSupportTeamSupportRegions(long supportTeamId) {
		return supportTeamPersistence.containsSupportRegions(supportTeamId);
	}
	...
	public void setSupportTeamSupportRegions(long supportTeamId,
		long[] supportRegionIds) {
		supportTeamPersistence.setSupportRegions(supportTeamId, supportRegionIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.SupportRegion",
	...
	public String getOSGiServiceIdentifier() {
		return SupportRegionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = supportRegionPersistence.getDataSource();
	...
	private SupportRegionLocalServiceClpInvoker _clpInvoker = new SupportRegionLocalServiceClpInvoker();
}