...
/**
 * The base implementation of the asset stats month local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AssetStatsMonthLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AssetStatsMonthLocalServiceImpl
 * @see com.liferay.osb.service.AssetStatsMonthLocalServiceUtil
 * @generated
 */
public abstract class AssetStatsMonthLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetStatsMonthLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AssetStatsMonthLocalServiceUtil} to access the asset stats month local service.
	 */
	...
	public AssetStatsMonth addAssetStatsMonth(AssetStatsMonth assetStatsMonth)
		throws SystemException {
		assetStatsMonth.setNew(true);

		return assetStatsMonthPersistence.update(assetStatsMonth, false);
	}
	 ...
	 */
	public AssetStatsMonth createAssetStatsMonth(long assetStatsMonthId) {
		return assetStatsMonthPersistence.create(assetStatsMonthId);
	}
	...
	public AssetStatsMonth deleteAssetStatsMonth(long assetStatsMonthId)
		throws PortalException, SystemException {
		return assetStatsMonthPersistence.remove(assetStatsMonthId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AssetStatsMonth deleteAssetStatsMonth(
		AssetStatsMonth assetStatsMonth) throws SystemException {
		return assetStatsMonthPersistence.remove(assetStatsMonth);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AssetStatsMonth.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetStatsMonthPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetStatsMonthPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AssetStatsMonth fetchAssetStatsMonth(long assetStatsMonthId)
		throws SystemException {
		return assetStatsMonthPersistence.fetchByPrimaryKey(assetStatsMonthId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AssetStatsMonth getAssetStatsMonth(long assetStatsMonthId)
		throws PortalException, SystemException {
		return assetStatsMonthPersistence.findByPrimaryKey(assetStatsMonthId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assetStatsMonthPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AssetStatsMonth> getAssetStatsMonths(int start, int end)
		throws SystemException {
		return assetStatsMonthPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAssetStatsMonthsCount() throws SystemException {
		return assetStatsMonthPersistence.countAll();
	}
	...
	public AssetStatsMonth updateAssetStatsMonth(
		AssetStatsMonth assetStatsMonth) throws SystemException {
		return updateAssetStatsMonth(assetStatsMonth, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public AssetStatsMonth updateAssetStatsMonth(
		AssetStatsMonth assetStatsMonth, boolean merge)
		throws SystemException {
		assetStatsMonth.setNew(false);

		return assetStatsMonthPersistence.update(assetStatsMonth, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AssetStatsMonth",
			assetStatsMonthLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assetStatsMonthPersistence.getDataSource();
	...
	private AssetStatsMonthLocalServiceClpInvoker _clpInvoker = new AssetStatsMonthLocalServiceClpInvoker();
}