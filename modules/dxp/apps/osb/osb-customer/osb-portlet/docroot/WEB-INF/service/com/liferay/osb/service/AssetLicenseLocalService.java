...
/**
 * Provides the local service interface for AssetLicense. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AssetLicenseLocalServiceUtil
...
public interface AssetLicenseLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssetLicenseLocalServiceUtil} to access the asset license local service. Add custom service methods to {@link com.liferay.osb.service.impl.AssetLicenseLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
