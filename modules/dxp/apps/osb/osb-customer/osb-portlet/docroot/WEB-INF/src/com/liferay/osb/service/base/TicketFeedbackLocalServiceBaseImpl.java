...
/**
 * Provides the base implementation for the ticket feedback local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TicketFeedbackLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TicketFeedbackLocalServiceImpl
 * @see com.liferay.osb.service.TicketFeedbackLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TicketFeedbackLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TicketFeedbackLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TicketFeedbackLocalServiceUtil} to access the ticket feedback local service.
	 */
	...
	public TicketFeedback addTicketFeedback(TicketFeedback ticketFeedback) {
		...
		return ticketFeedbackPersistence.update(ticketFeedback);
	}
	...
	public TicketFeedback createTicketFeedback(long ticketFeedbackId) {
		return ticketFeedbackPersistence.create(ticketFeedbackId);
	}
	...
	public TicketFeedback deleteTicketFeedback(long ticketFeedbackId)
		...
		return ticketFeedbackPersistence.remove(ticketFeedbackId);
	}
	...
	public TicketFeedback deleteTicketFeedback(TicketFeedback ticketFeedback) {
		return ticketFeedbackPersistence.remove(ticketFeedback);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TicketFeedback.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ticketFeedbackPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ticketFeedbackPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public TicketFeedback fetchTicketFeedback(long ticketFeedbackId) {
		return ticketFeedbackPersistence.fetchByPrimaryKey(ticketFeedbackId);
	}
	...
	public TicketFeedback getTicketFeedback(long ticketFeedbackId)
		throws PortalException {
		return ticketFeedbackPersistence.findByPrimaryKey(ticketFeedbackId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ticketFeedbackLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TicketFeedback.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ticketFeedbackId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ticketFeedbackLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TicketFeedback.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ticketFeedbackLocalService.deleteTicketFeedback((TicketFeedback)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ticketFeedbackPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TicketFeedback> getTicketFeedbacks(int start, int end) {
		return ticketFeedbackPersistence.findAll(start, end);
	}
	...
	public int getTicketFeedbacksCount() {
		return ticketFeedbackPersistence.countAll();
	}
