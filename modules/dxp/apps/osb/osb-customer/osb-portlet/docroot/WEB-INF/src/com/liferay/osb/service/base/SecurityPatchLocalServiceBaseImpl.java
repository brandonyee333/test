...
/**
 * Provides the base implementation for the security patch local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.SecurityPatchLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.SecurityPatchLocalServiceImpl
 * @see com.liferay.osb.service.SecurityPatchLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class SecurityPatchLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SecurityPatchLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.SecurityPatchLocalServiceUtil} to access the security patch local service.
	 */
	 ...
	 */
	@Override
	public SecurityPatch createSecurityPatch(long securityPatchId) {
		return securityPatchPersistence.create(securityPatchId);
	}
	...
	@Override
	public SecurityPatch deleteSecurityPatch(long securityPatchId)
		throws PortalException {
		return securityPatchPersistence.remove(securityPatchId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SecurityPatch deleteSecurityPatch(SecurityPatch securityPatch) {
		return securityPatchPersistence.remove(securityPatch);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SecurityPatch.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return securityPatchPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return securityPatchPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SecurityPatch fetchSecurityPatch(long securityPatchId) {
		return securityPatchPersistence.fetchByPrimaryKey(securityPatchId);
	}
	...
	public SecurityPatch getSecurityPatch(long securityPatchId)
		throws PortalException {
		return securityPatchPersistence.findByPrimaryKey(securityPatchId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(securityPatchLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SecurityPatch.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("securityPatchId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(securityPatchLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SecurityPatch.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return securityPatchLocalService.deleteSecurityPatch((SecurityPatch)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return securityPatchPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SecurityPatch> getSecurityPatchs(int start, int end) {
		return securityPatchPersistence.findAll(start, end);
	}
	...
	public int getSecurityPatchsCount() {
		return securityPatchPersistence.countAll();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = securityPatchPersistence.getDataSource();
