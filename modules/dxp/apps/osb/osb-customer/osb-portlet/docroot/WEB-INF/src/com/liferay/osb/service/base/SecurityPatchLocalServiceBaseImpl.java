...
/**
 * The base implementation of the security patch local service.
 *
 * <p>
...
public abstract class SecurityPatchLocalServiceBaseImpl
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSecurityPatchsCount() throws SystemException {
	...
	public SecurityPatch updateSecurityPatch(SecurityPatch securityPatch)
		throws SystemException {
		return updateSecurityPatch(securityPatch, true);
	}
	...
	public SecurityPatch updateSecurityPatch(SecurityPatch securityPatch,
		...
		return securityPatchPersistence.update(securityPatch, merge);
	}
