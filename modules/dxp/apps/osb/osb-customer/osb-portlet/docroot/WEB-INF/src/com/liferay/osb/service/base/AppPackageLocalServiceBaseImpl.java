...
/**
 * The base implementation of the app package local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AppPackageLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AppPackageLocalServiceImpl
 * @see com.liferay.osb.service.AppPackageLocalServiceUtil
 * @generated
 */
public abstract class AppPackageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AppPackageLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AppPackageLocalServiceUtil} to access the app package local service.
	 */
	...
	public AppPackage addAppPackage(AppPackage appPackage)
		throws SystemException {
		appPackage.setNew(true);

		return appPackagePersistence.update(appPackage, false);
	}
	 ...
	 */
	public AppPackage createAppPackage(long appPackageId) {
		return appPackagePersistence.create(appPackageId);
	}
	...
	public AppPackage deleteAppPackage(long appPackageId)
		...
		return appPackagePersistence.remove(appPackageId);
	}
	...
	public AppPackage deleteAppPackage(AppPackage appPackage)
		throws PortalException, SystemException {
		return appPackagePersistence.remove(appPackage);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AppPackage.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return appPackagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return appPackagePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return appPackagePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AppPackage fetchAppPackage(long appPackageId)
		throws SystemException {
		return appPackagePersistence.fetchByPrimaryKey(appPackageId);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return appPackagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AppPackage> getAppPackages(int start, int end)
		throws SystemException {
		return appPackagePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAppPackagesCount() throws SystemException {
		return appPackagePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppPackage updateAppPackage(AppPackage appPackage)
		throws SystemException {
		return updateAppPackage(appPackage, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppPackage updateAppPackage(AppPackage appPackage, boolean merge)
		throws SystemException {
		appPackage.setNew(false);

		return appPackagePersistence.update(appPackage, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AppPackage",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = appPackagePersistence.getDataSource();
	...
	private AppPackageLocalServiceClpInvoker _clpInvoker = new AppPackageLocalServiceClpInvoker();
}