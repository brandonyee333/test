 ...
 * @author Amos Fong
 */
public class UserHolidayCalendarChecker extends RowChecker {

	public UserHolidayCalendarChecker(
		RenderResponse renderResponse, HolidayCalendar holidayCalendar) {
	...
	public boolean isChecked(Object obj) {
		...
		ClassLoader portletClassLoader =
			UserHolidayCalendarChecker.class.getClassLoader();
		...
		try {
			...
			return HolidayCalendarRelLocalServiceUtil.hasHolidayCalendarRel(
				_holidayCalendar.getHolidayCalendarId(), user.getUserId());
		}
		catch (Exception e) {
			_log.error(e, e);
