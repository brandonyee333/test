...
/**
 * Provides the local service utility for AccountProject. This utility wraps
 * {@link com.liferay.osb.service.impl.AccountProjectLocalServiceImpl} and is the
...
public class AccountProjectLocalServiceUtil {
	...
	*/
	...
	public static AccountProjectLocalService getService() {
		if (_service == null) {
			_service = (AccountProjectLocalService)PortletBeanLocatorUtil.locate(ServletContextUtil.getServletContextName(),
