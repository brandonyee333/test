...
public class AccountWorkerLocalServiceClp implements AccountWorkerLocalService {
	public AccountWorkerLocalServiceClp(
		...
		_methodName0 = "hasAccountWorker";

		_methodParameterTypes0 = new String[] { "long", "long" };

		_methodName1 = "hasAccountWorkerRole";

		_methodParameterTypes1 = new String[] { "long", "int" };

		_methodName2 = "addAccountWorker";
	...
	public boolean hasAccountWorkerRole(long userId, int role) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { userId, role });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.liferay.osb.model.AccountWorker deleteAccountWorker(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName7,
					_methodParameterTypes7, new Object[] { accountWorkerId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
