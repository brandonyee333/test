...
/**
 * The utility for the support team language local service. This utility wraps {@link com.liferay.osb.service.impl.SupportTeamLanguageLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class SupportTeamLanguageLocalServiceUtil {
	...
	*/
	public static com.liferay.osb.model.SupportTeamLanguage updateSupportTeamLanguage(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSupportTeamLanguage(supportTeamLanguage, merge);
	}
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(SupportTeamLanguageLocalService service) {
	}
