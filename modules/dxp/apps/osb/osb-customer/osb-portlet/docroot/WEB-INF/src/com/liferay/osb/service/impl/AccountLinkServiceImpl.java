...
import com.liferay.osb.service.base.AccountLinkServiceBaseImpl;
...
public class AccountLinkServiceImpl extends AccountLinkServiceBaseImpl {
	...
	public void addAccountLinks(long accountEntryId, String[] urls)
		...
		accountLinkLocalService.addAccountLinks(
			getUserId(), accountEntryId, urls);
	}
	...
	public AccountLink deleteAccountLink(long accountLinkId)
		...
		OSBAccountEntryPermission.check(
			getPermissionChecker(), accountLink.getAccountEntryId(),
			OSBActionKeys.UPDATE_ACCOUNT_INFO);

		return accountLinkLocalService.deleteAccountLink(accountLink);
	}
