...
public class AccountLinkServiceClpInvoker {
	public AccountLinkServiceClpInvoker() {
		...
		_methodName670 = "addAccountLinks";

		_methodParameterTypes670 = new String[] { "long", "java.lang.String[][]" };

		_methodName671 = "deleteAccountLink";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return AccountLinkServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			AccountLinkServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
