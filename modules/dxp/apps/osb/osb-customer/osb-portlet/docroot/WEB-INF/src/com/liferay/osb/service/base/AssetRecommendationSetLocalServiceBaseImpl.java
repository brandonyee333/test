...
/**
 * The base implementation of the asset recommendation set local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AssetRecommendationSetLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AssetRecommendationSetLocalServiceImpl
 * @see com.liferay.osb.service.AssetRecommendationSetLocalServiceUtil
 * @generated
 */
public abstract class AssetRecommendationSetLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetRecommendationSetLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AssetRecommendationSetLocalServiceUtil} to access the asset recommendation set local service.
	 */
	...
	public AssetRecommendationSet addAssetRecommendationSet(
		...
		return assetRecommendationSetPersistence.update(assetRecommendationSet,
			false);
	}
	 ...
	 */
	public AssetRecommendationSet createAssetRecommendationSet(
		long assetRecommendationSetId) {
		return assetRecommendationSetPersistence.create(assetRecommendationSetId);
	}
	...
	public AssetRecommendationSet deleteAssetRecommendationSet(
		long assetRecommendationSetId) throws PortalException, SystemException {
		return assetRecommendationSetPersistence.remove(assetRecommendationSetId);
	}
	...
	public AssetRecommendationSet deleteAssetRecommendationSet(
		AssetRecommendationSet assetRecommendationSet)
		throws SystemException {
		return assetRecommendationSetPersistence.remove(assetRecommendationSet);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AssetRecommendationSet.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetRecommendationSetPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetRecommendationSetPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AssetRecommendationSet fetchAssetRecommendationSet(
		long assetRecommendationSetId) throws SystemException {
		return assetRecommendationSetPersistence.fetchByPrimaryKey(assetRecommendationSetId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AssetRecommendationSet getAssetRecommendationSet(
		long assetRecommendationSetId) throws PortalException, SystemException {
		return assetRecommendationSetPersistence.findByPrimaryKey(assetRecommendationSetId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assetRecommendationSetPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AssetRecommendationSet> getAssetRecommendationSets(int start,
		int end) throws SystemException {
		return assetRecommendationSetPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAssetRecommendationSetsCount() throws SystemException {
		return assetRecommendationSetPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AssetRecommendationSet updateAssetRecommendationSet(
		AssetRecommendationSet assetRecommendationSet)
		throws SystemException {
		return updateAssetRecommendationSet(assetRecommendationSet, true);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AssetRecommendationSet",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assetRecommendationSetPersistence.getDataSource();
	...
	private AssetRecommendationSetLocalServiceClpInvoker _clpInvoker = new AssetRecommendationSetLocalServiceClpInvoker();
}