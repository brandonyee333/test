...
/**
 * The base implementation of the app audit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AppAuditLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AppAuditLocalServiceImpl
 * @see com.liferay.osb.service.AppAuditLocalServiceUtil
 * @generated
 */
public abstract class AppAuditLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AppAuditLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AppAuditLocalServiceUtil} to access the app audit local service.
	 */
	...
	public AppAudit addAppAudit(AppAudit appAudit) throws SystemException {
		appAudit.setNew(true);

		return appAuditPersistence.update(appAudit, false);
	}
	 ...
	 */
	public AppAudit createAppAudit(long appAuditId) {
		return appAuditPersistence.create(appAuditId);
	}
	...
	public AppAudit deleteAppAudit(long appAuditId)
		throws PortalException, SystemException {
		return appAuditPersistence.remove(appAuditId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AppAudit deleteAppAudit(AppAudit appAudit) throws SystemException {
		return appAuditPersistence.remove(appAudit);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AppAudit.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return appAuditPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return appAuditPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return appAuditPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return appAuditPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AppAudit fetchAppAudit(long appAuditId) throws SystemException {
		return appAuditPersistence.fetchByPrimaryKey(appAuditId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AppAudit getAppAudit(long appAuditId)
		throws PortalException, SystemException {
		return appAuditPersistence.findByPrimaryKey(appAuditId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return appAuditPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AppAudit> getAppAudits(int start, int end)
		throws SystemException {
		return appAuditPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAppAuditsCount() throws SystemException {
		return appAuditPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppAudit updateAppAudit(AppAudit appAudit) throws SystemException {
		return updateAppAudit(appAudit, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppAudit updateAppAudit(AppAudit appAudit, boolean merge)
		throws SystemException {
		appAudit.setNew(false);

		return appAuditPersistence.update(appAudit, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AppAudit",
			appAuditLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.osb.model.AppAudit");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = appAuditPersistence.getDataSource();
	...
	private AppAuditLocalServiceClpInvoker _clpInvoker = new AppAuditLocalServiceClpInvoker();
}