...
/**
 * The base implementation of the training customer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TrainingCustomerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TrainingCustomerLocalServiceImpl
 * @see com.liferay.osb.service.TrainingCustomerLocalServiceUtil
 * @generated
 */
public abstract class TrainingCustomerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrainingCustomerLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TrainingCustomerLocalServiceUtil} to access the training customer local service.
	 */
	...
	public TrainingCustomer addTrainingCustomer(
		TrainingCustomer trainingCustomer) throws SystemException {
		trainingCustomer.setNew(true);

		return trainingCustomerPersistence.update(trainingCustomer, false);
	}
	 ...
	 */
	public TrainingCustomer createTrainingCustomer(long trainingCustomerId) {
		return trainingCustomerPersistence.create(trainingCustomerId);
	}
	...
	public TrainingCustomer deleteTrainingCustomer(long trainingCustomerId)
		...
		return trainingCustomerPersistence.remove(trainingCustomerId);
	}
	...
	public TrainingCustomer deleteTrainingCustomer(
		...
		throws PortalException, SystemException {
		return trainingCustomerPersistence.remove(trainingCustomer);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TrainingCustomer.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return trainingCustomerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trainingCustomerPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrainingCustomer fetchTrainingCustomer(long trainingCustomerId)
		throws SystemException {
		return trainingCustomerPersistence.fetchByPrimaryKey(trainingCustomerId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrainingCustomer getTrainingCustomer(long trainingCustomerId)
		throws PortalException, SystemException {
		return trainingCustomerPersistence.findByPrimaryKey(trainingCustomerId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trainingCustomerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrainingCustomer> getTrainingCustomers(int start, int end)
		throws SystemException {
		return trainingCustomerPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrainingCustomersCount() throws SystemException {
		return trainingCustomerPersistence.countAll();
	}
	...
	public TrainingCustomer updateTrainingCustomer(
		TrainingCustomer trainingCustomer) throws SystemException {
		return updateTrainingCustomer(trainingCustomer, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public TrainingCustomer updateTrainingCustomer(
		TrainingCustomer trainingCustomer, boolean merge)
		throws SystemException {
		trainingCustomer.setNew(false);

		return trainingCustomerPersistence.update(trainingCustomer, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TrainingCustomer",
			trainingCustomerLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trainingCustomerPersistence.getDataSource();
	...
	private TrainingCustomerLocalServiceClpInvoker _clpInvoker = new TrainingCustomerLocalServiceClpInvoker();
}