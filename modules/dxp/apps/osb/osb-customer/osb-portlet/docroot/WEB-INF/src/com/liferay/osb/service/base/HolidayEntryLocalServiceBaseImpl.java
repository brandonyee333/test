...
/**
 * Provides the base implementation for the holiday entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.HolidayEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.HolidayEntryLocalServiceImpl
 * @see com.liferay.osb.service.HolidayEntryLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class HolidayEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements HolidayEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.HolidayEntryLocalServiceUtil} to access the holiday entry local service.
	 */
	 ...
	 */
	@Override
	public HolidayEntry createHolidayEntry(long holidayEntryId) {
		return holidayEntryPersistence.create(holidayEntryId);
	}
	...
	public HolidayEntry deleteHolidayEntry(long holidayEntryId)
		...
		return holidayEntryPersistence.remove(holidayEntryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public HolidayEntry deleteHolidayEntry(HolidayEntry holidayEntry) {
		return holidayEntryPersistence.remove(holidayEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(HolidayEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return holidayEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return holidayEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public HolidayEntry fetchHolidayEntry(long holidayEntryId) {
		return holidayEntryPersistence.fetchByPrimaryKey(holidayEntryId);
	}
	...
	public HolidayEntry getHolidayEntry(long holidayEntryId)
		throws PortalException {
		return holidayEntryPersistence.findByPrimaryKey(holidayEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(holidayEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(HolidayEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("holidayEntryId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(holidayEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(HolidayEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return holidayEntryLocalService.deleteHolidayEntry((HolidayEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return holidayEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<HolidayEntry> getHolidayEntries(int start, int end) {
		return holidayEntryPersistence.findAll(start, end);
	}
	...
	public int getHolidayEntriesCount() {
		return holidayEntryPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.HolidayEntry",
			holidayEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HolidayEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = holidayEntryPersistence.getDataSource();
	...
	private HolidayEntryLocalServiceClpInvoker _clpInvoker = new HolidayEntryLocalServiceClpInvoker();
}