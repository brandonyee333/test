...
/**
 * The base implementation of the holiday entry local service.
 *
 * <p>
...
public abstract class HolidayEntryLocalServiceBaseImpl
	...
	public HolidayEntry addHolidayEntry(HolidayEntry holidayEntry)
		...
		return holidayEntryPersistence.update(holidayEntry, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getHolidayEntriesCount() throws SystemException {
	...
	public HolidayEntry updateHolidayEntry(HolidayEntry holidayEntry)
		throws SystemException {
		return updateHolidayEntry(holidayEntry, true);
	}
	...
	public HolidayEntry updateHolidayEntry(HolidayEntry holidayEntry,
		...
		return holidayEntryPersistence.update(holidayEntry, merge);
	}
