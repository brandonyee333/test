...
public interface OfferingEntryPersistence extends BasePersistence<OfferingEntry> {
	...
	*/
	public java.util.List<OfferingEntry> findByAccountEntryId(
		long accountEntryId);
	...
	*/
	public java.util.List<OfferingEntry> findByAccountEntryId(
		long accountEntryId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<OfferingEntry> orderByComparator);
	...
	* @return the matching offering entries
	*/
	public java.util.List<OfferingEntry> findByOrderEntryId(long orderEntryId);
	...
	* @return the matching offering entries
	*/
	public java.util.List<OfferingEntry> findByVersion(int version);
	...
	* @return the range of matching offering entries
	*/
	public java.util.List<OfferingEntry> findByVersion(int version, int start,
		int end);
	...
	* @return the matching offering entries
	*/
	public java.util.List<OfferingEntry> findBySupportEndDate(
		Date supportEndDate);
	...
	* @return the matching offering entries
	*/
	public java.util.List<OfferingEntry> findByStatus(int status);
	...
	* @return the range of matching offering entries
	*/
	public java.util.List<OfferingEntry> findByStatus(int status, int start,
		int end);
	...
	* @return the matching offering entries
	*/
	public java.util.List<OfferingEntry> findByAEI_S(long accountEntryId,
		int status);
	...
	* @return the matching offering entries
	*/
	public java.util.List<OfferingEntry> findByU_AEI_OEI_T(long userId,
	...
	*/
	public void cacheResult(java.util.List<OfferingEntry> offeringEntries);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, OfferingEntry> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<OfferingEntry> findAll();
	...
	*/
	public java.util.List<OfferingEntry> findAll(int start, int end);
