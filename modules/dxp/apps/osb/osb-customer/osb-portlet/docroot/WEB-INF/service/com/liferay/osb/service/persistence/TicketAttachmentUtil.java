...
public class TicketAttachmentUtil {
	...
	*/
	public static List<TicketAttachment> findByType(int type, int start, int end) {
	...
	*/
	public static List<TicketAttachment> findByType(int type, int start,
	...
	*/
	public static TicketAttachment findByType_First(int type,
		OrderByComparator<TicketAttachment> orderByComparator)
	...
	*/
	public static TicketAttachment fetchByType_First(int type,
		OrderByComparator<TicketAttachment> orderByComparator) {
	...
	* @throws NoSuchTicketAttachmentException if a matching ticket attachment could not be found
	*/
	public static TicketAttachment findByType_Last(int type,
		OrderByComparator<TicketAttachment> orderByComparator)
		throws com.liferay.osb.exception.NoSuchTicketAttachmentException {
	...
	*/
	public static TicketAttachment fetchByType_Last(int type,
		OrderByComparator<TicketAttachment> orderByComparator) {
	...
	* @return the range of matching ticket attachments
	*/
	public static List<TicketAttachment> findByType(int[] types, int start,
		int end) {
	...
	*/
	public static List<TicketAttachment> findByType(int[] types, int start,
		...
		boolean retrieveFromCache) {
		return getPersistence()
				   .findByType(types, start, end, orderByComparator,
			retrieveFromCache);
	}
	...
	* @throws NoSuchTicketAttachmentException if a matching ticket attachment could not be found
	*/
	public static TicketAttachment findByCD_T_First(Date createDate, int type,
		OrderByComparator<TicketAttachment> orderByComparator)
		throws com.liferay.osb.exception.NoSuchTicketAttachmentException {
		return getPersistence()
	...
	* @return the first matching ticket attachment, or <code>null</code> if a matching ticket attachment could not be found
	*/
	public static TicketAttachment fetchByCD_T_First(Date createDate, int type,
		OrderByComparator<TicketAttachment> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchTicketAttachmentException if a matching ticket attachment could not be found
	*/
	public static TicketAttachment findByCD_T_Last(Date createDate, int type,
		OrderByComparator<TicketAttachment> orderByComparator)
		throws com.liferay.osb.exception.NoSuchTicketAttachmentException {
		return getPersistence()
	...
	* @return the last matching ticket attachment, or <code>null</code> if a matching ticket attachment could not be found
	*/
	public static TicketAttachment fetchByCD_T_Last(Date createDate, int type,
		OrderByComparator<TicketAttachment> orderByComparator) {
		return getPersistence()
