...
public class AccountCustomerPersistenceImpl extends BasePersistenceImpl<AccountCustomer>
	...
	public List<AccountCustomer> findByU_R(long userId, int[] roles, int start,
		int end, OrderByComparator<AccountCustomer> orderByComparator) {
		return findByU_R(userId, roles, start, end, orderByComparator, true);
	}
	...
	public List<AccountCustomer> findByU_R(long userId, int[] roles, int start,
		...
		if (roles.length == 1) {
			return findByU_R(userId, roles[0], start, end, orderByComparator);
		}
		...
		if (retrieveFromCache) {
			list = (List<AccountCustomer>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_U_R,
					finderArgs, this);
	...
	private static final String _FINDER_COLUMN_U_R_ROLE_7 = "accountCustomer.role IN (";
	...
	public List<AccountCustomer> findByAEI_NotR(long accountEntryId, int role,
		int start, int end, OrderByComparator<AccountCustomer> orderByComparator) {
		return findByAEI_NotR(accountEntryId, role, start, end,
			orderByComparator, true);
	}
	...
	public int countByAEI_NotR(long accountEntryId, int role) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_AEI_NOTR;
