...
/**
 * The utility for the contract audit local service. This utility wraps {@link com.liferay.osb.service.impl.ContractAuditLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class ContractAuditLocalServiceUtil {
	...
	*/
	public static com.liferay.osb.model.ContractAudit updateContractAudit(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateContractAudit(contractAudit, merge);
	}
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(ContractAuditLocalService service) {
	}
