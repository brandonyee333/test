...
/**
 * The utility for the account entry language local service. This utility wraps {@link com.liferay.osb.service.impl.AccountEntryLanguageLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class AccountEntryLanguageLocalServiceUtil {
	...
	*/
	public static com.liferay.osb.model.AccountEntryLanguage updateAccountEntryLanguage(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateAccountEntryLanguage(accountEntryLanguage, merge);
	}
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(AccountEntryLanguageLocalService service) {
	}
