 ...
 */
public class TrainingCourseServiceClpInvoker {
	public TrainingCourseServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return TrainingCourseServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			TrainingCourseServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
