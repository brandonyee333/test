...
/**
 * The base implementation of the app entry rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AppEntryRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AppEntryRelLocalServiceImpl
 * @see com.liferay.osb.service.AppEntryRelLocalServiceUtil
 * @generated
 */
public abstract class AppEntryRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AppEntryRelLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AppEntryRelLocalServiceUtil} to access the app entry rel local service.
	 */
	...
	public AppEntryRel addAppEntryRel(AppEntryRel appEntryRel)
		throws SystemException {
		appEntryRel.setNew(true);

		return appEntryRelPersistence.update(appEntryRel, false);
	}
	 ...
	 */
	public AppEntryRel createAppEntryRel(long appEntryRelId) {
		return appEntryRelPersistence.create(appEntryRelId);
	}
	...
	public AppEntryRel deleteAppEntryRel(long appEntryRelId)
		...
		return appEntryRelPersistence.remove(appEntryRelId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AppEntryRel deleteAppEntryRel(AppEntryRel appEntryRel)
		throws SystemException {
		return appEntryRelPersistence.remove(appEntryRel);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AppEntryRel.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return appEntryRelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return appEntryRelPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return appEntryRelPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AppEntryRel fetchAppEntryRel(long appEntryRelId)
		throws SystemException {
		return appEntryRelPersistence.fetchByPrimaryKey(appEntryRelId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AppEntryRel getAppEntryRel(long appEntryRelId)
		throws PortalException, SystemException {
		return appEntryRelPersistence.findByPrimaryKey(appEntryRelId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return appEntryRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AppEntryRel> getAppEntryRels(int start, int end)
		throws SystemException {
		return appEntryRelPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAppEntryRelsCount() throws SystemException {
		return appEntryRelPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppEntryRel updateAppEntryRel(AppEntryRel appEntryRel)
		throws SystemException {
		return updateAppEntryRel(appEntryRel, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppEntryRel updateAppEntryRel(AppEntryRel appEntryRel, boolean merge)
		throws SystemException {
		appEntryRel.setNew(false);

		return appEntryRelPersistence.update(appEntryRel, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AppEntryRel",
			appEntryRelLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.osb.model.AppEntryRel");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = appEntryRelPersistence.getDataSource();
	...
	private AppEntryRelLocalServiceClpInvoker _clpInvoker = new AppEntryRelLocalServiceClpInvoker();
}