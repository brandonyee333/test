...
/**
 * The base implementation of the user profile local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.UserProfileLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.UserProfileLocalServiceImpl
 * @see com.liferay.osb.service.UserProfileLocalServiceUtil
 * @generated
 */
public abstract class UserProfileLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.UserProfileLocalServiceUtil} to access the user profile local service.
	 */
	...
	public UserProfile addUserProfile(UserProfile userProfile)
		...
		return userProfilePersistence.update(userProfile, false);
	}
	 ...
	 */
	public UserProfile createUserProfile(long userProfileId) {
		return userProfilePersistence.create(userProfileId);
	}
	...
	public UserProfile deleteUserProfile(long userProfileId)
		...
		return userProfilePersistence.remove(userProfileId);
	}
	...
	public UserProfile fetchUserProfile(long userProfileId)
		throws SystemException {
		return userProfilePersistence.fetchByPrimaryKey(userProfileId);
	}
	...
	public UserProfile getUserProfile(long userProfileId)
		throws PortalException, SystemException {
		return userProfilePersistence.findByPrimaryKey(userProfileId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getUserProfilesCount() throws SystemException {
	...
	public UserProfile updateUserProfile(UserProfile userProfile)
		throws SystemException {
		return updateUserProfile(userProfile, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UserProfile updateUserProfile(UserProfile userProfile, boolean merge)
		throws SystemException {
		userProfile.setNew(false);

		return userProfilePersistence.update(userProfile, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.UserProfile",
	...
	private UserProfileLocalServiceClpInvoker _clpInvoker = new UserProfileLocalServiceClpInvoker();
}