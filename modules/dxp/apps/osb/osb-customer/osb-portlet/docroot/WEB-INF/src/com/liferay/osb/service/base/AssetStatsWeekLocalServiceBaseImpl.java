...
/**
 * The base implementation of the asset stats week local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AssetStatsWeekLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AssetStatsWeekLocalServiceImpl
 * @see com.liferay.osb.service.AssetStatsWeekLocalServiceUtil
 * @generated
 */
public abstract class AssetStatsWeekLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetStatsWeekLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AssetStatsWeekLocalServiceUtil} to access the asset stats week local service.
	 */
	...
	public AssetStatsWeek addAssetStatsWeek(AssetStatsWeek assetStatsWeek)
		throws SystemException {
		assetStatsWeek.setNew(true);

		return assetStatsWeekPersistence.update(assetStatsWeek, false);
	}
	 ...
	 */
	public AssetStatsWeek createAssetStatsWeek(long assetStatsWeekId) {
		return assetStatsWeekPersistence.create(assetStatsWeekId);
	}
	...
	public AssetStatsWeek deleteAssetStatsWeek(long assetStatsWeekId)
		throws PortalException, SystemException {
		return assetStatsWeekPersistence.remove(assetStatsWeekId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AssetStatsWeek deleteAssetStatsWeek(AssetStatsWeek assetStatsWeek)
		throws SystemException {
		return assetStatsWeekPersistence.remove(assetStatsWeek);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AssetStatsWeek.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetStatsWeekPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetStatsWeekPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AssetStatsWeek fetchAssetStatsWeek(long assetStatsWeekId)
		throws SystemException {
		return assetStatsWeekPersistence.fetchByPrimaryKey(assetStatsWeekId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AssetStatsWeek getAssetStatsWeek(long assetStatsWeekId)
		throws PortalException, SystemException {
		return assetStatsWeekPersistence.findByPrimaryKey(assetStatsWeekId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assetStatsWeekPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AssetStatsWeek> getAssetStatsWeeks(int start, int end)
		throws SystemException {
		return assetStatsWeekPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAssetStatsWeeksCount() throws SystemException {
		return assetStatsWeekPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AssetStatsWeek updateAssetStatsWeek(AssetStatsWeek assetStatsWeek)
		throws SystemException {
		return updateAssetStatsWeek(assetStatsWeek, true);
	}
	...
	public AssetStatsWeek updateAssetStatsWeek(AssetStatsWeek assetStatsWeek,
		...
		return assetStatsWeekPersistence.update(assetStatsWeek, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AssetStatsWeek",
			assetStatsWeekLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assetStatsWeekPersistence.getDataSource();
	...
	private AssetStatsWeekLocalServiceClpInvoker _clpInvoker = new AssetStatsWeekLocalServiceClpInvoker();
}