...
/**
 * The utility for the ticket solution local service. This utility wraps {@link com.liferay.osb.service.impl.TicketSolutionLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class TicketSolutionLocalServiceUtil {
	...
	*/
	public static com.liferay.osb.model.TicketSolution updateTicketSolution(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateTicketSolution(ticketSolution, merge);
	}
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(TicketSolutionLocalService service) {
	}
