...
/**
 * The base implementation of the corp group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.CorpGroupLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.CorpGroupLocalServiceImpl
 * @see com.liferay.osb.service.CorpGroupLocalServiceUtil
 * @generated
 */
public abstract class CorpGroupLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CorpGroupLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.CorpGroupLocalServiceUtil} to access the corp group local service.
	 */
	...
	public CorpGroup addCorpGroup(CorpGroup corpGroup)
		throws SystemException {
		corpGroup.setNew(true);

		return corpGroupPersistence.update(corpGroup, false);
	}
	 ...
	 */
	public CorpGroup createCorpGroup(long corpGroupId) {
		return corpGroupPersistence.create(corpGroupId);
	}
	...
	public CorpGroup deleteCorpGroup(long corpGroupId)
		...
		return corpGroupPersistence.remove(corpGroupId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CorpGroup deleteCorpGroup(CorpGroup corpGroup)
		throws SystemException {
		return corpGroupPersistence.remove(corpGroup);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CorpGroup.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return corpGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return corpGroupPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return corpGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CorpGroup fetchCorpGroup(long corpGroupId) throws SystemException {
		return corpGroupPersistence.fetchByPrimaryKey(corpGroupId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CorpGroup getCorpGroup(long corpGroupId)
		throws PortalException, SystemException {
		return corpGroupPersistence.findByPrimaryKey(corpGroupId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return corpGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CorpGroup> getCorpGroups(int start, int end)
		throws SystemException {
		return corpGroupPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCorpGroupsCount() throws SystemException {
		return corpGroupPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CorpGroup updateCorpGroup(CorpGroup corpGroup)
		throws SystemException {
		return updateCorpGroup(corpGroup, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CorpGroup updateCorpGroup(CorpGroup corpGroup, boolean merge)
		throws SystemException {
		corpGroup.setNew(false);

		return corpGroupPersistence.update(corpGroup, merge);
	}
	...
	public void addCorpEntryCorpGroup(long corpEntryId, long corpGroupId)
		throws SystemException {
		corpEntryPersistence.addCorpGroup(corpEntryId, corpGroupId);
	}

	/**
	 * @throws SystemException if a system exception occurred
	 */
	public void addCorpEntryCorpGroup(long corpEntryId, CorpGroup corpGroup)
		throws SystemException {
		corpEntryPersistence.addCorpGroup(corpEntryId, corpGroup);
	}
	...
	public void addCorpEntryCorpGroups(long corpEntryId, long[] corpGroupIds)
		throws SystemException {
		corpEntryPersistence.addCorpGroups(corpEntryId, corpGroupIds);
	}
	...
	public void addCorpEntryCorpGroups(long corpEntryId,
		List<CorpGroup> CorpGroups) throws SystemException {
		corpEntryPersistence.addCorpGroups(corpEntryId, CorpGroups);
	}
	...
	public void clearCorpEntryCorpGroups(long corpEntryId)
		throws SystemException {
		corpEntryPersistence.clearCorpGroups(corpEntryId);
	}
	...
	public void deleteCorpEntryCorpGroup(long corpEntryId, long corpGroupId)
		throws SystemException {
		corpEntryPersistence.removeCorpGroup(corpEntryId, corpGroupId);
	}

	/**
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteCorpEntryCorpGroup(long corpEntryId, CorpGroup corpGroup)
		throws SystemException {
		corpEntryPersistence.removeCorpGroup(corpEntryId, corpGroup);
	}
	...
	public void deleteCorpEntryCorpGroups(long corpEntryId, long[] corpGroupIds)
		throws SystemException {
		corpEntryPersistence.removeCorpGroups(corpEntryId, corpGroupIds);
	}
	...
	public void deleteCorpEntryCorpGroups(long corpEntryId,
		List<CorpGroup> CorpGroups) throws SystemException {
		corpEntryPersistence.removeCorpGroups(corpEntryId, CorpGroups);
	}

	/**
	 * @throws SystemException if a system exception occurred
	 */
	public List<CorpGroup> getCorpEntryCorpGroups(long corpEntryId)
		throws SystemException {
		return corpEntryPersistence.getCorpGroups(corpEntryId);
	}

	/**
	 * @throws SystemException if a system exception occurred
	 */
	public List<CorpGroup> getCorpEntryCorpGroups(long corpEntryId, int start,
		int end) throws SystemException {
		return corpEntryPersistence.getCorpGroups(corpEntryId, start, end);
	}
	...
	public int getCorpEntryCorpGroupsCount(long corpEntryId)
		throws SystemException {
		return corpEntryPersistence.getCorpGroupsSize(corpEntryId);
	}
	...
	public boolean hasCorpEntryCorpGroup(long corpEntryId, long corpGroupId)
		throws SystemException {
		return corpEntryPersistence.containsCorpGroup(corpEntryId, corpGroupId);
	}
	...
	public boolean hasCorpEntryCorpGroups(long corpEntryId)
		throws SystemException {
		return corpEntryPersistence.containsCorpGroups(corpEntryId);
	}
	...
	public void setCorpEntryCorpGroups(long corpEntryId, long[] corpGroupIds)
		throws SystemException {
		corpEntryPersistence.setCorpGroups(corpEntryId, corpGroupIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.CorpGroup",
			corpGroupLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.osb.model.CorpGroup");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = corpGroupPersistence.getDataSource();
	...
	private CorpGroupLocalServiceClpInvoker _clpInvoker = new CorpGroupLocalServiceClpInvoker();
}