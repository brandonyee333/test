...
/**
 * The base implementation of the app package plugin local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AppPackagePluginLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AppPackagePluginLocalServiceImpl
 * @see com.liferay.osb.service.AppPackagePluginLocalServiceUtil
 * @generated
 */
public abstract class AppPackagePluginLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AppPackagePluginLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AppPackagePluginLocalServiceUtil} to access the app package plugin local service.
	 */
	...
	public AppPackagePlugin addAppPackagePlugin(
		AppPackagePlugin appPackagePlugin) throws SystemException {
		appPackagePlugin.setNew(true);

		return appPackagePluginPersistence.update(appPackagePlugin, false);
	}
	 ...
	 */
	public AppPackagePlugin createAppPackagePlugin(long appPackagePluginId) {
		return appPackagePluginPersistence.create(appPackagePluginId);
	}
	...
	public AppPackagePlugin deleteAppPackagePlugin(long appPackagePluginId)
		...
		return appPackagePluginPersistence.remove(appPackagePluginId);
	}
	...
	public AppPackagePlugin deleteAppPackagePlugin(
		...
		throws PortalException, SystemException {
		return appPackagePluginPersistence.remove(appPackagePlugin);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AppPackagePlugin.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return appPackagePluginPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return appPackagePluginPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AppPackagePlugin fetchAppPackagePlugin(long appPackagePluginId)
		throws SystemException {
		return appPackagePluginPersistence.fetchByPrimaryKey(appPackagePluginId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AppPackagePlugin getAppPackagePlugin(long appPackagePluginId)
		throws PortalException, SystemException {
		return appPackagePluginPersistence.findByPrimaryKey(appPackagePluginId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return appPackagePluginPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AppPackagePlugin> getAppPackagePlugins(int start, int end)
		throws SystemException {
		return appPackagePluginPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAppPackagePluginsCount() throws SystemException {
		return appPackagePluginPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppPackagePlugin updateAppPackagePlugin(
		AppPackagePlugin appPackagePlugin) throws SystemException {
		return updateAppPackagePlugin(appPackagePlugin, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public AppPackagePlugin updateAppPackagePlugin(
		AppPackagePlugin appPackagePlugin, boolean merge)
		throws SystemException {
		appPackagePlugin.setNew(false);

		return appPackagePluginPersistence.update(appPackagePlugin, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AppPackagePlugin",
			appPackagePluginLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = appPackagePluginPersistence.getDataSource();
	...
	private AppPackagePluginLocalServiceClpInvoker _clpInvoker = new AppPackagePluginLocalServiceClpInvoker();
}