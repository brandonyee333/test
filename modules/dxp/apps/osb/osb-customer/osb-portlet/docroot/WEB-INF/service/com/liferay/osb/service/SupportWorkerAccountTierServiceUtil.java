...
/**
 * Provides the remote service utility for SupportWorkerAccountTier. This utility wraps
 * {@link com.liferay.osb.service.impl.SupportWorkerAccountTierServiceImpl} and is the
...
public class SupportWorkerAccountTierServiceUtil {
	...
	*/
	...
	public static SupportWorkerAccountTierService getService() {
		if (_service == null) {
			_service = (SupportWorkerAccountTierService)PortletBeanLocatorUtil.locate(ServletContextUtil.getServletContextName(),
