...
/**
 * The base implementation of the holiday calendar local service.
 *
 * <p>
...
public abstract class HolidayCalendarLocalServiceBaseImpl
	...
	public HolidayCalendar updateHolidayCalendar(
		HolidayCalendar holidayCalendar) throws SystemException {
		return updateHolidayCalendar(holidayCalendar, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public HolidayCalendar updateHolidayCalendar(
		HolidayCalendar holidayCalendar, boolean merge)
		throws SystemException {
		holidayCalendar.setNew(false);

		return holidayCalendarPersistence.update(holidayCalendar, merge);
	}
