...
public class LicenseKeyPersistenceImpl extends BasePersistenceImpl<LicenseKey>
	 ...
	 */
	@Override
	public List<LicenseKey> findByUserId(long userId) {
	...
	public void removeByUserId(long userId) {
		for (LicenseKey licenseKey : findByUserId(userId, QueryUtil.ALL_POS,
	...
	public LicenseKey[] findByOrderEntryId_PrevAndNext(long licenseKeyId,
		long orderEntryId, OrderByComparator<LicenseKey> orderByComparator)
		throws NoSuchLicenseKeyException {
		LicenseKey licenseKey = findByPrimaryKey(licenseKeyId);
	...
	public LicenseKey updateImpl(LicenseKey licenseKey) {
		...
		if (!LicenseKeyModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			Object[] args = new Object[] { licenseKeyModelImpl.getUserId() };
			...
			args = new Object[] { licenseKeyModelImpl.getOrderEntryId() };
			...
			if ((licenseKeyModelImpl.getColumnBitmask() &
				...
				args = new Object[] { licenseKeyModelImpl.getUserId() };
