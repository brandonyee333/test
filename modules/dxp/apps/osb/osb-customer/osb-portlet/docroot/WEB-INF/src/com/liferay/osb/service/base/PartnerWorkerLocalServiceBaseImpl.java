...
/**
 * The base implementation of the partner worker local service.
 *
 * <p>
...
public abstract class PartnerWorkerLocalServiceBaseImpl
	...
	public PartnerWorker addPartnerWorker(PartnerWorker partnerWorker)
		...
		return partnerWorkerPersistence.update(partnerWorker, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPartnerWorkersCount() throws SystemException {
	...
	public PartnerWorker updatePartnerWorker(PartnerWorker partnerWorker)
		throws SystemException {
		return updatePartnerWorker(partnerWorker, true);
	}
	...
	public PartnerWorker updatePartnerWorker(PartnerWorker partnerWorker,
		...
		return partnerWorkerPersistence.update(partnerWorker, merge);
	}
