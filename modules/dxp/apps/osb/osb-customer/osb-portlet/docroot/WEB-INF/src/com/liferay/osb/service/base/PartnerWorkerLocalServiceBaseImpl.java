...
/**
 * Provides the base implementation for the partner worker local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.PartnerWorkerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.PartnerWorkerLocalServiceImpl
 * @see com.liferay.osb.service.PartnerWorkerLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class PartnerWorkerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PartnerWorkerLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.PartnerWorkerLocalServiceUtil} to access the partner worker local service.
	 */
	...
	public PartnerWorker addPartnerWorker(PartnerWorker partnerWorker) {
		...
		return partnerWorkerPersistence.update(partnerWorker);
	}
	...
	public PartnerWorker createPartnerWorker(long partnerWorkerId) {
		return partnerWorkerPersistence.create(partnerWorkerId);
	}
	...
	public PartnerWorker deletePartnerWorker(PartnerWorker partnerWorker) {
		return partnerWorkerPersistence.remove(partnerWorker);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PartnerWorker.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return partnerWorkerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return partnerWorkerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public PartnerWorker fetchPartnerWorker(long partnerWorkerId) {
		return partnerWorkerPersistence.fetchByPrimaryKey(partnerWorkerId);
	}
	...
	public PartnerWorker getPartnerWorker(long partnerWorkerId)
		throws PortalException {
		return partnerWorkerPersistence.findByPrimaryKey(partnerWorkerId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(partnerWorkerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PartnerWorker.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("partnerWorkerId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(partnerWorkerLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PartnerWorker.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return partnerWorkerLocalService.deletePartnerWorker((PartnerWorker)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return partnerWorkerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PartnerWorker> getPartnerWorkers(int start, int end) {
		return partnerWorkerPersistence.findAll(start, end);
	}
	...
	public int getPartnerWorkersCount() {
		return partnerWorkerPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.PartnerWorker",
			partnerWorkerLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PartnerWorkerLocalService.class.getName();
	}
