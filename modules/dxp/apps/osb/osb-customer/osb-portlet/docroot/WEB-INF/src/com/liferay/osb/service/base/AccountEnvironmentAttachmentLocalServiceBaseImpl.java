...
/**
 * The base implementation of the account environment attachment local service.
 *
 * <p>
...
public abstract class AccountEnvironmentAttachmentLocalServiceBaseImpl
	...
	implements AccountEnvironmentAttachmentLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public AccountEnvironmentAttachment updateAccountEnvironmentAttachment(
		AccountEnvironmentAttachment accountEnvironmentAttachment)
		throws SystemException {
		return updateAccountEnvironmentAttachment(accountEnvironmentAttachment,
			true);
	}
