...
import com.liferay.osb.NoSuchHolidayEntryException;
...
public class HolidayEntryPersistenceImpl extends BasePersistenceImpl<HolidayEntry>
	...
	public void cacheResult(HolidayEntry holidayEntry) {
		EntityCacheUtil.putResult(HolidayEntryModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache() {
		if (_HIBERNATE_CACHE_USE_SECOND_LEVEL_CACHE) {
			CacheRegistryUtil.clear(HolidayEntryImpl.class.getName());
		}

		EntityCacheUtil.clearCache(HolidayEntryImpl.class.getName());
	...
	public void clearCache(HolidayEntry holidayEntry) {
		EntityCacheUtil.removeResult(HolidayEntryModelImpl.ENTITY_CACHE_ENABLED,
	...
	public HolidayEntry remove(long holidayEntryId)
		throws NoSuchHolidayEntryException, SystemException {
		return remove(Long.valueOf(holidayEntryId));
	}
	...
	protected HolidayEntry removeImpl(HolidayEntry holidayEntry)
		...
		try {
			...
			BatchSessionUtil.delete(session, holidayEntry);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	@Override
	public HolidayEntry updateImpl(
		...
		try {
			...
			BatchSessionUtil.update(session, holidayEntry, merge);
		...
		if (isNew || !HolidayEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
			...
			if ((holidayEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(holidayEntryModelImpl.getOriginalHolidayCalendarId())
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_HOLIDAYCALENDAR,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_HOLIDAYCALENDAR,
					args);

				args = new Object[] {
						Long.valueOf(holidayEntryModelImpl.getHolidayCalendarId())
					};
	...
	/**
	 * Returns the holiday entry with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the holiday entry
	 * @return the holiday entry
	 * @throws com.liferay.portal.NoSuchModelException if a holiday entry with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	public HolidayEntry findByPrimaryKey(long holidayEntryId)
		throws NoSuchHolidayEntryException, SystemException {
		HolidayEntry holidayEntry = fetchByPrimaryKey(holidayEntryId);

		if (holidayEntry == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + holidayEntryId);
			}
	...
	public HolidayEntry fetchByPrimaryKey(long holidayEntryId)
		throws SystemException {
		HolidayEntry holidayEntry = (HolidayEntry)EntityCacheUtil.getResult(HolidayEntryModelImpl.ENTITY_CACHE_ENABLED,
				HolidayEntryImpl.class, holidayEntryId);

		if (holidayEntry == _nullHolidayEntry) {
			return null;
		}
	...
	public List<HolidayEntry> findByHolidayCalendar(long holidayCalendarId,
		...
		List<HolidayEntry> list = (List<HolidayEntry>)FinderCacheUtil.getResult(finderPath,
				finderArgs, this);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<HolidayEntry> findAll() throws SystemException {
	...
	public int countByHolidayCalendar(long holidayCalendarId)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_HOLIDAYCALENDAR,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_HOLIDAYCALENDAR,
					finderArgs, count);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.osb.model.HolidayEntry")));

		if (listenerClassNames.length > 0) {
			try {
				List<ModelListener<HolidayEntry>> listenersList = new ArrayList<ModelListener<HolidayEntry>>();

				for (String listenerClassName : listenerClassNames) {
					Class<?> clazz = getClass();

					listenersList.add((ModelListener<HolidayEntry>)InstanceFactory.newInstance(
	...
	public void destroy() {
		EntityCacheUtil.removeCache(HolidayEntryImpl.class.getName());
	...
	private static Log _log = LogFactoryUtil.getLog(HolidayEntryPersistenceImpl.class);
	private static HolidayEntry _nullHolidayEntry = new HolidayEntryImpl() {
			@Override
			public Object clone() {
				return this;
			}
			...
			public CacheModel<HolidayEntry> toCacheModel() {
				return _nullHolidayEntryCacheModel;
			}
		};

	private static CacheModel<HolidayEntry> _nullHolidayEntryCacheModel = new CacheModel<HolidayEntry>() {
			public HolidayEntry toEntityModel() {
				return _nullHolidayEntry;
			}
		};
}