 ...
 */
public class UserAccountCustomerChecker extends RowChecker {

	public UserAccountCustomerChecker(
	...
	public boolean isChecked(Object obj) {
		...
		ClassLoader portletClassLoader =
			UserAccountCustomerChecker.class.getClassLoader();
		...
		try {
			...
			return AccountCustomerLocalServiceUtil.hasAccountCustomer(
	...
	private static Log _log = LogFactoryUtil.getLog(
		UserAccountCustomerChecker.class);
