...
/**
 * The utility for the audit action local service. This utility wraps {@link com.liferay.osb.service.impl.AuditActionLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class AuditActionLocalServiceUtil {
	...
	*/
	public static com.liferay.osb.model.AuditAction updateAuditAction(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateAuditAction(auditAction, merge);
	}
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(AuditActionLocalService service) {
	}
