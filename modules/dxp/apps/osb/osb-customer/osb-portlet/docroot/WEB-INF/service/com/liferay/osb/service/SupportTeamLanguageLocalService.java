...
/**
 * Provides the local service interface for SupportTeamLanguage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SupportTeamLanguageLocalServiceUtil
...
public interface SupportTeamLanguageLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SupportTeamLanguageLocalServiceUtil} to access the support team language local service. Add custom service methods to {@link com.liferay.osb.service.impl.SupportTeamLanguageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
