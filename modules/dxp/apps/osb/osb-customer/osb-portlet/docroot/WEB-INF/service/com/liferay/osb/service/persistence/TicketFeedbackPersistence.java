...
public interface TicketFeedbackPersistence extends BasePersistence<TicketFeedback> {
	...
	*/
	public java.util.List<TicketFeedback> findByTicketEntryId(
		long ticketEntryId);
	...
	*/
	public java.util.List<TicketFeedback> findByTicketEntryId(
		long ticketEntryId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TicketFeedback> orderByComparator);
	...
	* @return the matching ticket feedbacks
	*/
	public java.util.List<TicketFeedback> findByTEI_S(long ticketEntryId,
		int subject);
	...
	* @return the matching ticket feedbacks
	*/
	public java.util.List<TicketFeedback> findByTEI_S_NotS(long ticketEntryId,
	...
	* @return the matching ticket feedbacks
	*/
	public java.util.List<TicketFeedback> findByTEI_S_S(long ticketEntryId,
		int subject, int status);
	...
	* @return the matching ticket feedbacks
	*/
	public java.util.List<TicketFeedback> findByU_TEI_S_NotS(long userId,
		long ticketEntryId, int subject, int status);
	...
	*/
	public void cacheResult(java.util.List<TicketFeedback> ticketFeedbacks);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TicketFeedback> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<TicketFeedback> findAll();
	...
	*/
	public java.util.List<TicketFeedback> findAll(int start, int end);
