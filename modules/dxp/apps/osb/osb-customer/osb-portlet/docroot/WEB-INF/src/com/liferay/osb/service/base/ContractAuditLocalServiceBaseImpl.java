...
/**
 * Provides the base implementation for the contract audit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.ContractAuditLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.ContractAuditLocalServiceImpl
 * @see com.liferay.osb.service.ContractAuditLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ContractAuditLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ContractAuditLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.ContractAuditLocalServiceUtil} to access the contract audit local service.
	 */
	...
	public ContractAudit addContractAudit(ContractAudit contractAudit) {
		...
		return contractAuditPersistence.update(contractAudit);
	}
	...
	public ContractAudit createContractAudit(long contractAuditId) {
		return contractAuditPersistence.create(contractAuditId);
	}
	...
	public ContractAudit deleteContractAudit(long contractAuditId)
		...
		return contractAuditPersistence.remove(contractAuditId);
	}
	...
	public ContractAudit deleteContractAudit(ContractAudit contractAudit) {
		return contractAuditPersistence.remove(contractAudit);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ContractAudit.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return contractAuditPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return contractAuditPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ContractAudit fetchContractAudit(long contractAuditId) {
		return contractAuditPersistence.fetchByPrimaryKey(contractAuditId);
	}
	...
	public ContractAudit getContractAudit(long contractAuditId)
		throws PortalException {
		return contractAuditPersistence.findByPrimaryKey(contractAuditId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(contractAuditLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ContractAudit.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("contractAuditId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(contractAuditLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ContractAudit.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return contractAuditLocalService.deleteContractAudit((ContractAudit)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return contractAuditPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ContractAudit> getContractAudits(int start, int end) {
		return contractAuditPersistence.findAll(start, end);
	}
	...
	public int getContractAuditsCount() {
		return contractAuditPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.ContractAudit",
			contractAuditLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ContractAuditLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = contractAuditPersistence.getDataSource();
	...
	private ContractAuditLocalServiceClpInvoker _clpInvoker = new ContractAuditLocalServiceClpInvoker();
}