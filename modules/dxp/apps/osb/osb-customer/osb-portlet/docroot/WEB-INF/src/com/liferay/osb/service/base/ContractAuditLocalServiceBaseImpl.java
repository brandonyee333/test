...
/**
 * The base implementation of the contract audit local service.
 *
 * <p>
...
public abstract class ContractAuditLocalServiceBaseImpl
	...
	public ContractAudit addContractAudit(ContractAudit contractAudit)
		...
		return contractAuditPersistence.update(contractAudit, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getContractAuditsCount() throws SystemException {
	...
	public ContractAudit updateContractAudit(ContractAudit contractAudit)
		throws SystemException {
		return updateContractAudit(contractAudit, true);
	}
	...
	public ContractAudit updateContractAudit(ContractAudit contractAudit,
		...
		return contractAuditPersistence.update(contractAudit, merge);
	}
