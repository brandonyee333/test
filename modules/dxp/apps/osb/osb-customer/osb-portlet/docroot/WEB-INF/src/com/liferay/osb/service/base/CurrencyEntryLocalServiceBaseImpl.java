...
/**
 * The base implementation of the currency entry local service.
 *
 * <p>
...
public abstract class CurrencyEntryLocalServiceBaseImpl
	...
	public CurrencyEntry addCurrencyEntry(CurrencyEntry currencyEntry)
		...
		return currencyEntryPersistence.update(currencyEntry, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCurrencyEntriesCount() throws SystemException {
	...
	public CurrencyEntry updateCurrencyEntry(CurrencyEntry currencyEntry)
		throws SystemException {
		return updateCurrencyEntry(currencyEntry, true);
	}
	...
	public CurrencyEntry updateCurrencyEntry(CurrencyEntry currencyEntry,
		...
		return currencyEntryPersistence.update(currencyEntry, merge);
	}
