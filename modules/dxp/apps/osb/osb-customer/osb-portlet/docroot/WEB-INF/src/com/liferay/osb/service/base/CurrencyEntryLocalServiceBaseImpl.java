...
/**
 * Provides the base implementation for the currency entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.CurrencyEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.CurrencyEntryLocalServiceImpl
 * @see com.liferay.osb.service.CurrencyEntryLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CurrencyEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CurrencyEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.CurrencyEntryLocalServiceUtil} to access the currency entry local service.
	 */
	...
	@Override
	public CurrencyEntry addCurrencyEntry(CurrencyEntry currencyEntry) {
		currencyEntry.setNew(true);

		return currencyEntryPersistence.update(currencyEntry);
	}
	 ...
	 */
	@Override
	public CurrencyEntry createCurrencyEntry(long currencyEntryId) {
		return currencyEntryPersistence.create(currencyEntryId);
	}
	...
	@Override
	public CurrencyEntry deleteCurrencyEntry(long currencyEntryId)
		throws PortalException {
		return currencyEntryPersistence.remove(currencyEntryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CurrencyEntry deleteCurrencyEntry(CurrencyEntry currencyEntry) {
		return currencyEntryPersistence.remove(currencyEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CurrencyEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return currencyEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return currencyEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CurrencyEntry fetchCurrencyEntry(long currencyEntryId) {
		return currencyEntryPersistence.fetchByPrimaryKey(currencyEntryId);
	}
	 ...
	 */
	@Override
	public CurrencyEntry getCurrencyEntry(long currencyEntryId)
		throws PortalException {
		return currencyEntryPersistence.findByPrimaryKey(currencyEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(currencyEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CurrencyEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("currencyEntryId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(currencyEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CurrencyEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return currencyEntryLocalService.deleteCurrencyEntry((CurrencyEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return currencyEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CurrencyEntry> getCurrencyEntries(int start, int end) {
		return currencyEntryPersistence.findAll(start, end);
	}
	...
	public int getCurrencyEntriesCount() {
		return currencyEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CurrencyEntry updateCurrencyEntry(CurrencyEntry currencyEntry) {
		return currencyEntryPersistence.update(currencyEntry);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.CurrencyEntry",
			currencyEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CurrencyEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = currencyEntryPersistence.getDataSource();
	...
	private CurrencyEntryLocalServiceClpInvoker _clpInvoker = new CurrencyEntryLocalServiceClpInvoker();
}