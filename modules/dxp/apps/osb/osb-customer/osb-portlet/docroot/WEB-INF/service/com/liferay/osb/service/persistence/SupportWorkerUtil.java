...
public class SupportWorkerUtil {
	...
	* @return the matching support workers
	*/
	public static List<SupportWorker> findByU_MW_R(long userId, double maxWork,
		int role) {
	...
	* @throws NoSuchSupportWorkerException if a matching support worker could not be found
	*/
	public static SupportWorker findByU_MW_R_First(long userId, double maxWork,
	...
	* @return the first matching support worker, or <code>null</code> if a matching support worker could not be found
	*/
	public static SupportWorker fetchByU_MW_R_First(long userId,
	...
	* @throws NoSuchSupportWorkerException if a matching support worker could not be found
	*/
	public static SupportWorker findByU_MW_R_Last(long userId, double maxWork,
		int role, OrderByComparator<SupportWorker> orderByComparator)
		throws com.liferay.osb.exception.NoSuchSupportWorkerException {
		return getPersistence()
	...
	* @return the last matching support worker, or <code>null</code> if a matching support worker could not be found
	*/
	public static SupportWorker fetchByU_MW_R_Last(long userId, double maxWork,
		int role, OrderByComparator<SupportWorker> orderByComparator) {
		return getPersistence()
	...
	* @return the matching support workers
	*/
	public static List<SupportWorker> findByU_MW_R(long[] userIds,
