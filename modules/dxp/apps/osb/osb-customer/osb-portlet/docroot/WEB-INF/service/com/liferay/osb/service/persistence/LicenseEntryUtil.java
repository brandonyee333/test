...
public class LicenseEntryUtil {
	...
	* @return the matching license entries
	*/
	public static List<LicenseEntry> findByPEI_V(long productEntryId,
		int versionMin) {
	...
	*/
	public static List<LicenseEntry> findByPEI_V(long productEntryId,
		int versionMin, int start, int end) {
		return getPersistence()
				   .findByPEI_V(productEntryId, versionMin, start, end);
	}
	...
	* @throws NoSuchLicenseEntryException if a matching license entry could not be found
	*/
	public static LicenseEntry findByPEI_V_First(long productEntryId,
		int versionMin, OrderByComparator<LicenseEntry> orderByComparator)
		throws com.liferay.osb.exception.NoSuchLicenseEntryException {
		return getPersistence()
				   .findByPEI_V_First(productEntryId, versionMin,
			orderByComparator);
	}
	...
	* @return the first matching license entry, or <code>null</code> if a matching license entry could not be found
	*/
	public static LicenseEntry fetchByPEI_V_First(long productEntryId,
		int versionMin, OrderByComparator<LicenseEntry> orderByComparator) {
		return getPersistence()
				   .fetchByPEI_V_First(productEntryId, versionMin,
			orderByComparator);
	}
	...
	* @throws NoSuchLicenseEntryException if a matching license entry could not be found
	*/
	public static LicenseEntry findByPEI_V_Last(long productEntryId,
		int versionMin, OrderByComparator<LicenseEntry> orderByComparator)
		throws com.liferay.osb.exception.NoSuchLicenseEntryException {
		return getPersistence()
				   .findByPEI_V_Last(productEntryId, versionMin,
			orderByComparator);
	}
	...
	* @return the last matching license entry, or <code>null</code> if a matching license entry could not be found
	*/
	public static LicenseEntry fetchByPEI_V_Last(long productEntryId,
		int versionMin, OrderByComparator<LicenseEntry> orderByComparator) {
		return getPersistence()
				   .fetchByPEI_V_Last(productEntryId, versionMin,
			orderByComparator);
	}
	...
	* @throws NoSuchLicenseEntryException if a license entry with the primary key could not be found
	*/
	public static LicenseEntry[] findByPEI_V_PrevAndNext(long licenseEntryId,
		long productEntryId, int versionMin,
		OrderByComparator<LicenseEntry> orderByComparator)
		throws com.liferay.osb.exception.NoSuchLicenseEntryException {
		return getPersistence()
				   .findByPEI_V_PrevAndNext(licenseEntryId, productEntryId,
