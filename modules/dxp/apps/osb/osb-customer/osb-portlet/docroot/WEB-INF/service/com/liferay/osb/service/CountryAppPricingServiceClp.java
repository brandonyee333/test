 ...
 */
public class CountryAppPricingServiceClp implements CountryAppPricingService {
	public CountryAppPricingServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "deleteCountryAppPricings";

		_methodParameterTypes3 = new String[] { "long", "long[][]" };

		_methodName4 = "updateCountryAppPricings";
	...
	public java.util.List<com.liferay.osb.model.CountryAppPricing> updateCountryAppPricings(
		...
		return (java.util.List<com.liferay.osb.model.CountryAppPricing>)ClpSerializer.translateOutput(returnObj);
	}
