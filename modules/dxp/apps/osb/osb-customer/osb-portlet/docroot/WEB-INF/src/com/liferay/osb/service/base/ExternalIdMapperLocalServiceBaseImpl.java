...
/**
 * The base implementation of the external ID mapper local service.
 *
 * <p>
...
public abstract class ExternalIdMapperLocalServiceBaseImpl
	...
	public ExternalIdMapper addExternalIdMapper(
		ExternalIdMapper externalIdMapper) throws SystemException {
		externalIdMapper.setNew(true);

		return externalIdMapperPersistence.update(externalIdMapper, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getExternalIdMappersCount() throws SystemException {
	...
	public ExternalIdMapper updateExternalIdMapper(
		ExternalIdMapper externalIdMapper) throws SystemException {
		return updateExternalIdMapper(externalIdMapper, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public ExternalIdMapper updateExternalIdMapper(
		ExternalIdMapper externalIdMapper, boolean merge)
		throws SystemException {
		externalIdMapper.setNew(false);

		return externalIdMapperPersistence.update(externalIdMapper, merge);
	}
	...
	private ExternalIdMapperLocalServiceClpInvoker _clpInvoker = new ExternalIdMapperLocalServiceClpInvoker();
}