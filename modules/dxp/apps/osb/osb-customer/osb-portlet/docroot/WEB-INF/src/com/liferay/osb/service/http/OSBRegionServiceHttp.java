...
public class OSBRegionServiceHttp {
	public static com.liferay.portal.kernel.model.Region addRegion(
		...
		try {
			MethodKey methodKey = new MethodKey(OSBRegionServiceUtil.class,
	...
	public static com.liferay.portal.kernel.model.Region deleteRegion(
		...
		try {
			MethodKey methodKey = new MethodKey(OSBRegionServiceUtil.class,
					"deleteRegion", _deleteRegionParameterTypes1);
	...
	public static com.liferay.portal.kernel.model.Region updateRegion(
		HttpPrincipal httpPrincipal, long regionId, long countryId,
		java.lang.String regionCode, java.lang.String name, boolean active)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		try {
			MethodKey methodKey = new MethodKey(OSBRegionServiceUtil.class,
					"updateRegion", _updateRegionParameterTypes2);
	...
	private static Log _log = LogFactoryUtil.getLog(OSBRegionServiceHttp.class);
	...
	private static final Class<?>[] _updateRegionParameterTypes2 = new Class[] {
