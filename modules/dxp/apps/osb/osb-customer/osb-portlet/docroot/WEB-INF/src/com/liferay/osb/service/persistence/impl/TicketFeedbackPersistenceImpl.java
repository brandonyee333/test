...
public class TicketFeedbackPersistenceImpl extends BasePersistenceImpl<TicketFeedback>
	...
	public List<TicketFeedback> findByTEI_S_S(long ticketEntryId, int subject,
		int status, int start, int end,
		OrderByComparator<TicketFeedback> orderByComparator) {
		return findByTEI_S_S(ticketEntryId, subject, status, start, end,
			orderByComparator, true);
	}
	...
	public int countByTEI_S_S(long ticketEntryId, int subject, int status) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_TEI_S_S;
		...
		if (!TicketFeedbackModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					ticketFeedbackModelImpl.getTicketEntryId(),
					ticketFeedbackModelImpl.getSubject(),
					ticketFeedbackModelImpl.getStatus()
				};

			finderCache.removeResult(FINDER_PATH_COUNT_BY_TEI_S_S, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_TEI_S_S,
				args);
			...
			if ((ticketFeedbackModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						ticketFeedbackModelImpl.getOriginalTicketEntryId(),
						ticketFeedbackModelImpl.getOriginalSubject(),
						ticketFeedbackModelImpl.getOriginalStatus()
					};
