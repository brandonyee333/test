 ...
 * @generated
 */
@ImplementationClassName("com.liferay.osb.model.impl.CorpProjectMessageImpl")
@ProviderType
public interface CorpProjectMessage extends CorpProjectMessageModel,
	 ...
	 */
	public static final Accessor<CorpProjectMessage, Long> CORP_PROJECT_MESSAGE_ID_ACCESSOR =
		new Accessor<CorpProjectMessage, Long>() {
			@Override
			public Long get(CorpProjectMessage corpProjectMessage) {
				return corpProjectMessage.getCorpProjectMessageId();
			}
			...
			@Override
			public Class<CorpProjectMessage> getTypeClass() {
