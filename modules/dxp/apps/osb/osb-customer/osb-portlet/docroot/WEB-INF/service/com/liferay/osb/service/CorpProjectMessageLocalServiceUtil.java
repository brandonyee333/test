...
/**
 * Provides the local service utility for CorpProjectMessage. This utility wraps
 * {@link com.liferay.osb.service.impl.CorpProjectMessageLocalServiceImpl} and is the
...
public class CorpProjectMessageLocalServiceUtil {
	...
	*/
	...
	public static CorpProjectMessageLocalService getService() {
		if (_service == null) {
			_service = (CorpProjectMessageLocalService)PortletBeanLocatorUtil.locate(ServletContextUtil.getServletContextName(),
