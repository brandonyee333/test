...
/**
 * The base implementation of the account entry language local service.
 *
 * <p>
...
public abstract class AccountEntryLanguageLocalServiceBaseImpl
	...
	public AccountEntryLanguage deleteAccountEntryLanguage(
		long accountEntryLanguageId) throws PortalException, SystemException {
	...
	public AccountEntryLanguage fetchAccountEntryLanguage(
		long accountEntryLanguageId) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccountEntryLanguagesCount() throws SystemException {
	...
	public AccountEntryLanguage updateAccountEntryLanguage(
		AccountEntryLanguage accountEntryLanguage) throws SystemException {
		return updateAccountEntryLanguage(accountEntryLanguage, true);
	}
