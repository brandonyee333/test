 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AccountEntryLanguageLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AccountEntryLanguageLocalServiceImpl
 * @see com.liferay.osb.service.AccountEntryLanguageLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AccountEntryLanguageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccountEntryLanguageLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AccountEntryLanguageLocalServiceUtil} to access the account entry language local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccountEntryLanguage.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accountEntryLanguagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accountEntryLanguagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AccountEntryLanguage fetchAccountEntryLanguage(
		long accountEntryLanguageId) {
		return accountEntryLanguagePersistence.fetchByPrimaryKey(accountEntryLanguageId);
	}
	...
	public AccountEntryLanguage getAccountEntryLanguage(
		long accountEntryLanguageId) throws PortalException {
		return accountEntryLanguagePersistence.findByPrimaryKey(accountEntryLanguageId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accountEntryLanguageLocalService);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(accountEntryLanguageLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccountEntryLanguage.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return accountEntryLanguageLocalService.deleteAccountEntryLanguage((AccountEntryLanguage)persistedModel);
	}
