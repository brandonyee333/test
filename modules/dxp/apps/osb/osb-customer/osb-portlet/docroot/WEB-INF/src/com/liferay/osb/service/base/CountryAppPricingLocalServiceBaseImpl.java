...
/**
 * The base implementation of the country app pricing local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.CountryAppPricingLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.CountryAppPricingLocalServiceImpl
 * @see com.liferay.osb.service.CountryAppPricingLocalServiceUtil
 * @generated
 */
public abstract class CountryAppPricingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CountryAppPricingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.CountryAppPricingLocalServiceUtil} to access the country app pricing local service.
	 */
	...
	public CountryAppPricing addCountryAppPricing(
		CountryAppPricing countryAppPricing) throws SystemException {
		countryAppPricing.setNew(true);

		return countryAppPricingPersistence.update(countryAppPricing, false);
	}
	 ...
	 */
	public CountryAppPricing createCountryAppPricing(long countryAppPricingId) {
		return countryAppPricingPersistence.create(countryAppPricingId);
	}
	...
	public CountryAppPricing deleteCountryAppPricing(long countryAppPricingId)
		throws PortalException, SystemException {
		return countryAppPricingPersistence.remove(countryAppPricingId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CountryAppPricing deleteCountryAppPricing(
		CountryAppPricing countryAppPricing) throws SystemException {
		return countryAppPricingPersistence.remove(countryAppPricing);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CountryAppPricing.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return countryAppPricingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return countryAppPricingPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CountryAppPricing fetchCountryAppPricing(long countryAppPricingId)
		throws SystemException {
		return countryAppPricingPersistence.fetchByPrimaryKey(countryAppPricingId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CountryAppPricing getCountryAppPricing(long countryAppPricingId)
		throws PortalException, SystemException {
		return countryAppPricingPersistence.findByPrimaryKey(countryAppPricingId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return countryAppPricingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CountryAppPricing> getCountryAppPricings(int start, int end)
		throws SystemException {
		return countryAppPricingPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCountryAppPricingsCount() throws SystemException {
		return countryAppPricingPersistence.countAll();
	}
	...
	public CountryAppPricing updateCountryAppPricing(
		CountryAppPricing countryAppPricing) throws SystemException {
		return updateCountryAppPricing(countryAppPricing, true);
	}
	...
	public CountryAppPricing updateCountryAppPricing(
		...
		return countryAppPricingPersistence.update(countryAppPricing, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.CountryAppPricing",
			countryAppPricingLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.osb.model.CountryAppPricing");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = countryAppPricingPersistence.getDataSource();
	...
	private CountryAppPricingLocalServiceClpInvoker _clpInvoker = new CountryAppPricingLocalServiceClpInvoker();
}