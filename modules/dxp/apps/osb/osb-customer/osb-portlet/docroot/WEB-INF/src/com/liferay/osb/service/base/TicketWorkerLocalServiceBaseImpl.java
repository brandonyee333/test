...
/**
 * Provides the base implementation for the ticket worker local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TicketWorkerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TicketWorkerLocalServiceImpl
 * @see com.liferay.osb.service.TicketWorkerLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TicketWorkerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TicketWorkerLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TicketWorkerLocalServiceUtil} to access the ticket worker local service.
	 */
	...
	public TicketWorker addTicketWorker(TicketWorker ticketWorker) {
		...
		return ticketWorkerPersistence.update(ticketWorker);
	}
	...
	public TicketWorker createTicketWorker(long ticketWorkerId) {
		return ticketWorkerPersistence.create(ticketWorkerId);
	}
	...
	public TicketWorker deleteTicketWorker(long ticketWorkerId)
		...
		return ticketWorkerPersistence.remove(ticketWorkerId);
	}
	...
	public TicketWorker deleteTicketWorker(TicketWorker ticketWorker) {
		return ticketWorkerPersistence.remove(ticketWorker);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TicketWorker.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ticketWorkerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ticketWorkerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public TicketWorker fetchTicketWorker(long ticketWorkerId) {
		return ticketWorkerPersistence.fetchByPrimaryKey(ticketWorkerId);
	}
	...
	public TicketWorker getTicketWorker(long ticketWorkerId)
		throws PortalException {
		return ticketWorkerPersistence.findByPrimaryKey(ticketWorkerId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ticketWorkerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TicketWorker.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ticketWorkerId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ticketWorkerLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TicketWorker.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ticketWorkerLocalService.deleteTicketWorker((TicketWorker)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ticketWorkerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TicketWorker> getTicketWorkers(int start, int end) {
		return ticketWorkerPersistence.findAll(start, end);
	}
	...
	public int getTicketWorkersCount() {
		return ticketWorkerPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TicketWorker",
			ticketWorkerLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TicketWorkerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ticketWorkerPersistence.getDataSource();
	...
	private TicketWorkerLocalServiceClpInvoker _clpInvoker = new TicketWorkerLocalServiceClpInvoker();
}