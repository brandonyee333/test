...
/**
 * The base implementation of the ticket worker local service.
 *
 * <p>
...
public abstract class TicketWorkerLocalServiceBaseImpl
	...
	public TicketWorker addTicketWorker(TicketWorker ticketWorker)
		...
		return ticketWorkerPersistence.update(ticketWorker, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTicketWorkersCount() throws SystemException {
	...
	public TicketWorker updateTicketWorker(TicketWorker ticketWorker)
		throws SystemException {
		return updateTicketWorker(ticketWorker, true);
	}
	...
	public TicketWorker updateTicketWorker(TicketWorker ticketWorker,
		...
		return ticketWorkerPersistence.update(ticketWorker, merge);
	}
