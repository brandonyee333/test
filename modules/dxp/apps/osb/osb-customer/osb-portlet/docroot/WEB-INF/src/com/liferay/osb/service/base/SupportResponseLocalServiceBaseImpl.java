...
/**
 * Provides the base implementation for the support response local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.SupportResponseLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.SupportResponseLocalServiceImpl
 * @see com.liferay.osb.service.SupportResponseLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class SupportResponseLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SupportResponseLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.SupportResponseLocalServiceUtil} to access the support response local service.
	 */
	...
	public SupportResponse createSupportResponse(long supportResponseId) {
		return supportResponsePersistence.create(supportResponseId);
	}
	...
	public SupportResponse deleteSupportResponse(
		...
		return supportResponsePersistence.remove(supportResponse);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SupportResponse.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return supportResponsePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return supportResponsePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public SupportResponse fetchSupportResponse(long supportResponseId) {
		return supportResponsePersistence.fetchByPrimaryKey(supportResponseId);
	}
	...
	public SupportResponse getSupportResponse(long supportResponseId)
		throws PortalException {
		return supportResponsePersistence.findByPrimaryKey(supportResponseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(supportResponseLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SupportResponse.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("supportResponseId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(supportResponseLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SupportResponse.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return supportResponseLocalService.deleteSupportResponse((SupportResponse)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return supportResponsePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SupportResponse> getSupportResponses(int start, int end) {
		return supportResponsePersistence.findAll(start, end);
	}
	...
	public int getSupportResponsesCount() {
		return supportResponsePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.SupportResponse",
			supportResponseLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SupportResponseLocalService.class.getName();
	}
	...
	private SupportResponseLocalServiceClpInvoker _clpInvoker = new SupportResponseLocalServiceClpInvoker();
}