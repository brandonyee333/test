...
/**
 * The base implementation of the support response local service.
 *
 * <p>
...
public abstract class SupportResponseLocalServiceBaseImpl
	...
	public SupportResponse addSupportResponse(SupportResponse supportResponse)
		...
		return supportResponsePersistence.update(supportResponse, false);
	}
	...
	public SupportResponse deleteSupportResponse(
		SupportResponse supportResponse) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSupportResponsesCount() throws SystemException {
	...
	public SupportResponse updateSupportResponse(
		SupportResponse supportResponse) throws SystemException {
		return updateSupportResponse(supportResponse, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public SupportResponse updateSupportResponse(
		SupportResponse supportResponse, boolean merge)
		throws SystemException {
		supportResponse.setNew(false);

		return supportResponsePersistence.update(supportResponse, merge);
	}
