 ...
 */
public class UserTrainingCustomerChecker extends RowChecker {

	public UserTrainingCustomerChecker(
	...
	public boolean isChecked(Object obj) {
		...
		ClassLoader portletClassLoader =
			UserTrainingCustomerChecker.class.getClassLoader();
		...
		try {
			...
			return TrainingCustomerLocalServiceUtil.hasTrainingCustomer(
				user.getUserId(),
	...
	private static Log _log = LogFactoryUtil.getLog(
		UserTrainingCustomerChecker.class);
