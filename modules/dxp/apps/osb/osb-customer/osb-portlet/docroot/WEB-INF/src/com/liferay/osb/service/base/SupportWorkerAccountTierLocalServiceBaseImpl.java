...
/**
 * The base implementation of the support worker account tier local service.
 *
 * <p>
...
public abstract class SupportWorkerAccountTierLocalServiceBaseImpl
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSupportWorkerAccountTiersCount() throws SystemException {
	...
	public SupportWorkerAccountTier updateSupportWorkerAccountTier(
		SupportWorkerAccountTier supportWorkerAccountTier)
		throws SystemException {
		return updateSupportWorkerAccountTier(supportWorkerAccountTier, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public SupportWorkerAccountTier updateSupportWorkerAccountTier(
		SupportWorkerAccountTier supportWorkerAccountTier, boolean merge)
		throws SystemException {
