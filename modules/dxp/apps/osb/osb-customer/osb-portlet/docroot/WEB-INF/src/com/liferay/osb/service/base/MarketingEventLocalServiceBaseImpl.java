...
/**
 * The base implementation of the marketing event local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.MarketingEventLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.MarketingEventLocalServiceImpl
 * @see com.liferay.osb.service.MarketingEventLocalServiceUtil
 * @generated
 */
public abstract class MarketingEventLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MarketingEventLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.MarketingEventLocalServiceUtil} to access the marketing event local service.
	 */
	...
	public MarketingEvent addMarketingEvent(MarketingEvent marketingEvent)
		...
		return marketingEventPersistence.update(marketingEvent, false);
	}
	...
	public MarketingEvent createMarketingEvent(long marketingEventId) {
		return marketingEventPersistence.create(marketingEventId);
	}
	...
	public MarketingEvent deleteMarketingEvent(long marketingEventId)
		...
		return marketingEventPersistence.remove(marketingEventId);
	}
	...
	public MarketingEvent deleteMarketingEvent(MarketingEvent marketingEvent)
		throws PortalException, SystemException {
		return marketingEventPersistence.remove(marketingEvent);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(MarketingEvent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return marketingEventPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return marketingEventPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public MarketingEvent fetchMarketingEvent(long marketingEventId)
		throws SystemException {
		return marketingEventPersistence.fetchByPrimaryKey(marketingEventId);
	}
	...
	public MarketingEvent getMarketingEvent(long marketingEventId)
		throws PortalException, SystemException {
		return marketingEventPersistence.findByPrimaryKey(marketingEventId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return marketingEventPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MarketingEvent> getMarketingEvents(int start, int end)
		throws SystemException {
		return marketingEventPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getMarketingEventsCount() throws SystemException {
		return marketingEventPersistence.countAll();
	}
	...
	public MarketingEvent updateMarketingEvent(MarketingEvent marketingEvent)
		throws SystemException {
		return updateMarketingEvent(marketingEvent, true);
	}
	...
	public MarketingEvent updateMarketingEvent(MarketingEvent marketingEvent,
		...
		return marketingEventPersistence.update(marketingEvent, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.MarketingEvent",
			marketingEventLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = marketingEventPersistence.getDataSource();
	...
	private MarketingEventLocalServiceClpInvoker _clpInvoker = new MarketingEventLocalServiceClpInvoker();
}