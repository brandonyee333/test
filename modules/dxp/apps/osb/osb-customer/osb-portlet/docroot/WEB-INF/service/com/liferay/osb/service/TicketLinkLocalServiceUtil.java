...
/**
 * The utility for the ticket link local service. This utility wraps {@link com.liferay.osb.service.impl.TicketLinkLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class TicketLinkLocalServiceUtil {
	...
	*/
	public static com.liferay.osb.model.TicketLink updateTicketLink(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateTicketLink(ticketLink, merge);
	}
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(TicketLinkLocalService service) {
	}
