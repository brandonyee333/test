...
public class AuditEntryLocalServiceClpInvoker {
	public AuditEntryLocalServiceClpInvoker() {
		...
		_methodName279 = "getAuditEntries";

		_methodParameterTypes279 = new String[] { "java.util.Date", "long" };

		_methodName280 = "getAuditEntries";

		_methodParameterTypes280 = new String[] { "long", "long", "int[][]" };

		_methodName281 = "getAuditEntrySets";

		_methodParameterTypes281 = new String[] { "long", "long", "int[][]" };

		_methodName282 = "getLastAuditEntry";

		_methodParameterTypes282 = new String[] { "long", "long", "int" };

		_methodName283 = "getLastAuditEntry";

		_methodParameterTypes283 = new String[] { "long", "long", "int", "int" };

		_methodName284 = "getNextAuditSetId";

		_methodParameterTypes284 = new String[] { "long", "long" };

		_methodName285 = "getNextAuditSetId";

		_methodParameterTypes285 = new String[] { "java.lang.String", "long" };
	}
