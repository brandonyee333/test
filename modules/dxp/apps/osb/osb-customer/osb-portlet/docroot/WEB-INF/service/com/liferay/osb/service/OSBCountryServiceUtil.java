...
/**
 * The utility for the o s b country remote service. This utility wraps {@link com.liferay.osb.service.impl.OSBCountryServiceImpl} and is the primary access point for service operations in application layer code running on a remote server.
 *
 * <p>
 ...
 * @generated
 */
public class OSBCountryServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	...
	public static OSBCountryService getService() {
		if (_service == null) {
			InvokableService invokableService = (InvokableService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					OSBCountryService.class.getName());

			if (invokableService instanceof OSBCountryService) {
				_service = (OSBCountryService)invokableService;
			}
			else {
				_service = new OSBCountryServiceClp(invokableService);
			}

			ReferenceRegistry.registerReference(OSBCountryServiceUtil.class,
				"_service");
		}
	 ...
	 * @deprecated
	 */
	public void setService(OSBCountryService service) {
	}

	private static OSBCountryService _service;
}