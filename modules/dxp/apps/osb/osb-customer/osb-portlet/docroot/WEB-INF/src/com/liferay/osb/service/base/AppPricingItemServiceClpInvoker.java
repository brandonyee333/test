 ...
 */
public class AppPricingItemServiceClpInvoker {
	public AppPricingItemServiceClpInvoker() {
		...
		_methodName670 = "updateAppPricingItem";

		_methodParameterTypes670 = new String[] { "long", "long", "double" };
	}
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return AppPricingItemServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			AppPricingItemServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
		...
		if (_methodName670.equals(name) &&
			...
			return AppPricingItemServiceUtil.updateAppPricingItem(((Long)arguments[0]).longValue(),
