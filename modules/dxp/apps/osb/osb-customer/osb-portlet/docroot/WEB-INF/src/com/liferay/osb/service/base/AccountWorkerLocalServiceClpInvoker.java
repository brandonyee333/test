...
public class AccountWorkerLocalServiceClpInvoker {
	public AccountWorkerLocalServiceClpInvoker() {
		...
		_methodName277 = "addAccountWorkers";

		_methodParameterTypes277 = new String[] {
				"long", "long[][]", "long", "int[][]", "int[][]"
			};

		_methodName278 = "deleteAccountEntryAccountWorkers";

		_methodParameterTypes278 = new String[] { "long" };

		_methodName279 = "deleteAccountWorkers";

		_methodParameterTypes279 = new String[] { "long" };

		_methodName280 = "deleteAccountWorkers";

		_methodParameterTypes280 = new String[] { "long", "long[][]", "long" };

		_methodName281 = "getAccountWorker";

		_methodParameterTypes281 = new String[] { "long", "long" };

		_methodName282 = "getAccountWorkers";

		_methodParameterTypes282 = new String[] { "long" };

		_methodName283 = "getAccountWorkers";

		_methodParameterTypes283 = new String[] { "long", "int" };

		_methodName284 = "getUserAccountWorkers";

		_methodParameterTypes284 = new String[] { "long" };

		_methodName285 = "hasAccountWorker";

		_methodParameterTypes285 = new String[] { "long", "long" };

		_methodName286 = "hasAccountWorkerRole";
