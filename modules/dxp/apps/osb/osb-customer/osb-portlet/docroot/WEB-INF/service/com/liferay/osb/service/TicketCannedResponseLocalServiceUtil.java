...
/**
 * The utility for the ticket canned response local service. This utility wraps {@link com.liferay.osb.service.impl.TicketCannedResponseLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.liferay.osb.service.base.TicketCannedResponseLocalServiceBaseImpl
 * @see com.liferay.osb.service.impl.TicketCannedResponseLocalServiceImpl
 * @generated
 */
public class TicketCannedResponseLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static com.liferay.osb.model.TicketCannedResponse createTicketCannedResponse(
		long ticketCannedResponseId) {
		return getService().createTicketCannedResponse(ticketCannedResponseId);
	}
	...
	*/
	public static com.liferay.osb.model.TicketCannedResponse updateTicketCannedResponse(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateTicketCannedResponse(ticketCannedResponse, merge);
	}
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(TicketCannedResponseLocalService service) {
	}

	private static TicketCannedResponseLocalService _service;
}