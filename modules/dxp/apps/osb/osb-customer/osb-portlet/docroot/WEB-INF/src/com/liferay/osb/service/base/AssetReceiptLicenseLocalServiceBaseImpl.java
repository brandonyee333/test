...
/**
 * Provides the base implementation for the asset receipt license local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AssetReceiptLicenseLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AssetReceiptLicenseLocalServiceImpl
 * @see com.liferay.osb.service.AssetReceiptLicenseLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AssetReceiptLicenseLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetReceiptLicenseLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AssetReceiptLicenseLocalServiceUtil} to access the asset receipt license local service.
	 */
	...
	public AssetReceiptLicense addAssetReceiptLicense(
		...
		return assetReceiptLicensePersistence.update(assetReceiptLicense);
	}
	 ...
	 */
	@Override
	public AssetReceiptLicense createAssetReceiptLicense(
		long assetReceiptLicenseId) {
		return assetReceiptLicensePersistence.create(assetReceiptLicenseId);
	}
	...
	public AssetReceiptLicense deleteAssetReceiptLicense(
		long assetReceiptLicenseId) throws PortalException {
		return assetReceiptLicensePersistence.remove(assetReceiptLicenseId);
	}
	...
	public AssetReceiptLicense deleteAssetReceiptLicense(
		AssetReceiptLicense assetReceiptLicense) {
		return assetReceiptLicensePersistence.remove(assetReceiptLicense);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssetReceiptLicense.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return assetReceiptLicensePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return assetReceiptLicensePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssetReceiptLicense fetchAssetReceiptLicense(
		long assetReceiptLicenseId) {
		return assetReceiptLicensePersistence.fetchByPrimaryKey(assetReceiptLicenseId);
	}
	 ...
	 */
	@Override
	public AssetReceiptLicense getAssetReceiptLicense(
		long assetReceiptLicenseId) throws PortalException {
		return assetReceiptLicensePersistence.findByPrimaryKey(assetReceiptLicenseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(assetReceiptLicenseLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AssetReceiptLicense.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(assetReceiptLicenseLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AssetReceiptLicense.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return assetReceiptLicenseLocalService.deleteAssetReceiptLicense((AssetReceiptLicense)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return assetReceiptLicensePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssetReceiptLicense> getAssetReceiptLicenses(int start, int end) {
		return assetReceiptLicensePersistence.findAll(start, end);
	}
	...
	public int getAssetReceiptLicensesCount() {
		return assetReceiptLicensePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssetReceiptLicense updateAssetReceiptLicense(
		AssetReceiptLicense assetReceiptLicense) {
		return assetReceiptLicensePersistence.update(assetReceiptLicense);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AssetReceiptLicense",
			assetReceiptLicenseLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AssetReceiptLicenseLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = assetReceiptLicensePersistence.getDataSource();
	...
	private AssetReceiptLicenseLocalServiceClpInvoker _clpInvoker = new AssetReceiptLicenseLocalServiceClpInvoker();
}