...
/**
 * The base implementation of the app entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AppEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AppEntryLocalServiceImpl
 * @see com.liferay.osb.service.AppEntryLocalServiceUtil
 * @generated
 */
public abstract class AppEntryLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AppEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AppEntryLocalServiceUtil} to access the app entry local service.
	 */
	...
	public AppEntry addAppEntry(AppEntry appEntry) throws SystemException {
		appEntry.setNew(true);

		return appEntryPersistence.update(appEntry, false);
	}
	 ...
	 */
	public AppEntry createAppEntry(long appEntryId) {
		return appEntryPersistence.create(appEntryId);
	}
	...
	public AppEntry deleteAppEntry(long appEntryId)
		...
		return appEntryPersistence.remove(appEntryId);
	}
	...
	public AppEntry deleteAppEntry(AppEntry appEntry)
		throws PortalException, SystemException {
		return appEntryPersistence.remove(appEntry);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AppEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return appEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return appEntryPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return appEntryPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return appEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AppEntry getAppEntry(long appEntryId)
		throws PortalException, SystemException {
		return appEntryPersistence.findByPrimaryKey(appEntryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return appEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AppEntry> getAppEntries(int start, int end)
		throws SystemException {
		return appEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAppEntriesCount() throws SystemException {
		return appEntryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppEntry updateAppEntry(AppEntry appEntry) throws SystemException {
		return updateAppEntry(appEntry, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppEntry updateAppEntry(AppEntry appEntry, boolean merge)
		throws SystemException {
		appEntry.setNew(false);

		return appEntryPersistence.update(appEntry, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AppEntry",
			appEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.osb.model.AppEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = appEntryPersistence.getDataSource();
	...
	private AppEntryLocalServiceClpInvoker _clpInvoker = new AppEntryLocalServiceClpInvoker();
}