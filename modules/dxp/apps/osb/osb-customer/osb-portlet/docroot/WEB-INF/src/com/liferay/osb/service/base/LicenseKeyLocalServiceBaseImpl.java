...
/**
 * The base implementation of the license key local service.
 *
 * <p>
...
public abstract class LicenseKeyLocalServiceBaseImpl
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLicenseKeiesCount() throws SystemException {
	...
	public LicenseKey updateLicenseKey(LicenseKey licenseKey)
		throws SystemException {
		return updateLicenseKey(licenseKey, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public LicenseKey updateLicenseKey(LicenseKey licenseKey, boolean merge)
		throws SystemException {
		licenseKey.setNew(false);

		return licenseKeyPersistence.update(licenseKey, merge);
	}
