...
import com.liferay.osb.util.comparator.TrainingEventStartDateComparator;
 ...
 * @author Joan Kim
 */
public class TrainingEventSearch extends SearchContainer<TrainingEvent> {
	...
	static {
		...
		headerNames.add("course");
		headerNames.add("credits");
		headerNames.add("location");
		headerNames.add("language");
		headerNames.add("partner");
		headerNames.add("start-date");
		headerNames.add("students");

		orderableHeaders.put("start-date", "start-date");
	}

	public static final String EMPTY_RESULTS_MESSAGE = "no-classes-were-found";

	public TrainingEventSearch(
	...
	protected OrderByComparator getOrderByComparator(
		...
		if (orderByCol.equals("start-date")) {
			return new TrainingEventStartDateComparator(asc);
		}
