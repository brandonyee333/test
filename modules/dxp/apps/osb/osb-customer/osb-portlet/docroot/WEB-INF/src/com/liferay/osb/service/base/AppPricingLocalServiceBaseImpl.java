...
/**
 * The base implementation of the app pricing local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AppPricingLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AppPricingLocalServiceImpl
 * @see com.liferay.osb.service.AppPricingLocalServiceUtil
 * @generated
 */
public abstract class AppPricingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AppPricingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AppPricingLocalServiceUtil} to access the app pricing local service.
	 */
	...
	public AppPricing addAppPricing(AppPricing appPricing)
		throws SystemException {
		appPricing.setNew(true);

		return appPricingPersistence.update(appPricing, false);
	}
	 ...
	 */
	public AppPricing createAppPricing(long appPricingId) {
		return appPricingPersistence.create(appPricingId);
	}
	...
	public AppPricing deleteAppPricing(long appPricingId)
		...
		return appPricingPersistence.remove(appPricingId);
	}
	...
	public AppPricing deleteAppPricing(AppPricing appPricing)
		throws PortalException, SystemException {
		return appPricingPersistence.remove(appPricing);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AppPricing.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return appPricingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return appPricingPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return appPricingPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AppPricing fetchAppPricing(long appPricingId)
		throws SystemException {
		return appPricingPersistence.fetchByPrimaryKey(appPricingId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AppPricing getAppPricing(long appPricingId)
		throws PortalException, SystemException {
		return appPricingPersistence.findByPrimaryKey(appPricingId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return appPricingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AppPricing> getAppPricings(int start, int end)
		throws SystemException {
		return appPricingPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAppPricingsCount() throws SystemException {
		return appPricingPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppPricing updateAppPricing(AppPricing appPricing)
		throws SystemException {
		return updateAppPricing(appPricing, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppPricing updateAppPricing(AppPricing appPricing, boolean merge)
		throws SystemException {
		appPricing.setNew(false);

		return appPricingPersistence.update(appPricing, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AppPricing",
			appPricingLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = appPricingPersistence.getDataSource();
	...
	private AppPricingLocalServiceClpInvoker _clpInvoker = new AppPricingLocalServiceClpInvoker();
}