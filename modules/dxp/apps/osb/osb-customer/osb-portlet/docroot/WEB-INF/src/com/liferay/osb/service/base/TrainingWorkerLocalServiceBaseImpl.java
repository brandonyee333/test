...
/**
 * The base implementation of the training worker local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TrainingWorkerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TrainingWorkerLocalServiceImpl
 * @see com.liferay.osb.service.TrainingWorkerLocalServiceUtil
 * @generated
 */
public abstract class TrainingWorkerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrainingWorkerLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TrainingWorkerLocalServiceUtil} to access the training worker local service.
	 */
	...
	public TrainingWorker addTrainingWorker(TrainingWorker trainingWorker)
		throws SystemException {
		trainingWorker.setNew(true);

		return trainingWorkerPersistence.update(trainingWorker, false);
	}
	 ...
	 */
	public TrainingWorker createTrainingWorker(long trainingWorkerId) {
		return trainingWorkerPersistence.create(trainingWorkerId);
	}
	...
	public TrainingWorker deleteTrainingWorker(long trainingWorkerId)
		throws PortalException, SystemException {
		return trainingWorkerPersistence.remove(trainingWorkerId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TrainingWorker deleteTrainingWorker(TrainingWorker trainingWorker)
		throws SystemException {
		return trainingWorkerPersistence.remove(trainingWorker);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TrainingWorker.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return trainingWorkerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trainingWorkerPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrainingWorker fetchTrainingWorker(long trainingWorkerId)
		throws SystemException {
		return trainingWorkerPersistence.fetchByPrimaryKey(trainingWorkerId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrainingWorker getTrainingWorker(long trainingWorkerId)
		throws PortalException, SystemException {
		return trainingWorkerPersistence.findByPrimaryKey(trainingWorkerId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trainingWorkerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrainingWorker> getTrainingWorkers(int start, int end)
		throws SystemException {
		return trainingWorkerPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrainingWorkersCount() throws SystemException {
		return trainingWorkerPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TrainingWorker updateTrainingWorker(TrainingWorker trainingWorker)
		throws SystemException {
		return updateTrainingWorker(trainingWorker, true);
	}
	...
	public TrainingWorker updateTrainingWorker(TrainingWorker trainingWorker,
		...
		return trainingWorkerPersistence.update(trainingWorker, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TrainingWorker",
			trainingWorkerLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trainingWorkerPersistence.getDataSource();
	...
	private TrainingWorkerLocalServiceClpInvoker _clpInvoker = new TrainingWorkerLocalServiceClpInvoker();
}