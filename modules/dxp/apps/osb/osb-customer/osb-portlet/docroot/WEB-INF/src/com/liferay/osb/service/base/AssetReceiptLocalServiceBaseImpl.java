...
/**
 * The base implementation of the asset receipt local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AssetReceiptLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AssetReceiptLocalServiceImpl
 * @see com.liferay.osb.service.AssetReceiptLocalServiceUtil
 * @generated
 */
public abstract class AssetReceiptLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetReceiptLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AssetReceiptLocalServiceUtil} to access the asset receipt local service.
	 */
	...
	public AssetReceipt addAssetReceipt(AssetReceipt assetReceipt)
		throws SystemException {
		assetReceipt.setNew(true);

		return assetReceiptPersistence.update(assetReceipt, false);
	}
	 ...
	 */
	public AssetReceipt createAssetReceipt(long assetReceiptId) {
		return assetReceiptPersistence.create(assetReceiptId);
	}
	...
	public AssetReceipt deleteAssetReceipt(long assetReceiptId)
		...
		return assetReceiptPersistence.remove(assetReceiptId);
	}
	...
	public AssetReceipt deleteAssetReceipt(AssetReceipt assetReceipt)
		throws PortalException, SystemException {
		return assetReceiptPersistence.remove(assetReceipt);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AssetReceipt.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetReceiptPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetReceiptPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AssetReceipt fetchAssetReceipt(long assetReceiptId)
		throws SystemException {
		return assetReceiptPersistence.fetchByPrimaryKey(assetReceiptId);
	}
	...
	public AssetReceipt getAssetReceipt(long assetReceiptId)
		throws PortalException, SystemException {
		return assetReceiptPersistence.findByPrimaryKey(assetReceiptId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assetReceiptPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AssetReceipt> getAssetReceipts(int start, int end)
		throws SystemException {
		return assetReceiptPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAssetReceiptsCount() throws SystemException {
		return assetReceiptPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AssetReceipt updateAssetReceipt(AssetReceipt assetReceipt)
		throws SystemException {
		return updateAssetReceipt(assetReceipt, true);
	}
	...
	public AssetReceipt updateAssetReceipt(AssetReceipt assetReceipt,
		...
		return assetReceiptPersistence.update(assetReceipt, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AssetReceipt",
			assetReceiptLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assetReceiptPersistence.getDataSource();
	...
	private AssetReceiptLocalServiceClpInvoker _clpInvoker = new AssetReceiptLocalServiceClpInvoker();
}