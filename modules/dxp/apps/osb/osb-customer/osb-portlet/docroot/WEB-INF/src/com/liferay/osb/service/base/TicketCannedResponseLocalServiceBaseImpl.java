...
/**
 * Provides the base implementation for the ticket canned response local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TicketCannedResponseLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TicketCannedResponseLocalServiceImpl
 * @see com.liferay.osb.service.TicketCannedResponseLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TicketCannedResponseLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TicketCannedResponseLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TicketCannedResponseLocalServiceUtil} to access the ticket canned response local service.
	 */
	 ...
	 */
	@Override
	public TicketCannedResponse createTicketCannedResponse(
		long ticketCannedResponseId) {
		return ticketCannedResponsePersistence.create(ticketCannedResponseId);
	}
	...
	public TicketCannedResponse deleteTicketCannedResponse(
		...
		return ticketCannedResponsePersistence.remove(ticketCannedResponseId);
	}
	...
	public TicketCannedResponse deleteTicketCannedResponse(
		TicketCannedResponse ticketCannedResponse) {
		return ticketCannedResponsePersistence.remove(ticketCannedResponse);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TicketCannedResponse.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ticketCannedResponsePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ticketCannedResponsePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public TicketCannedResponse fetchTicketCannedResponse(
		long ticketCannedResponseId) {
		return ticketCannedResponsePersistence.fetchByPrimaryKey(ticketCannedResponseId);
	}
	...
	public TicketCannedResponse getTicketCannedResponse(
		long ticketCannedResponseId) throws PortalException {
		return ticketCannedResponsePersistence.findByPrimaryKey(ticketCannedResponseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ticketCannedResponseLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TicketCannedResponse.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ticketCannedResponseLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TicketCannedResponse.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ticketCannedResponseLocalService.deleteTicketCannedResponse((TicketCannedResponse)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ticketCannedResponsePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TicketCannedResponse> getTicketCannedResponses(int start,
		int end) {
		return ticketCannedResponsePersistence.findAll(start, end);
	}
	...
	public int getTicketCannedResponsesCount() {
		return ticketCannedResponsePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TicketCannedResponse",
			ticketCannedResponseLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TicketCannedResponseLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ticketCannedResponsePersistence.getDataSource();
	...
	private TicketCannedResponseLocalServiceClpInvoker _clpInvoker = new TicketCannedResponseLocalServiceClpInvoker();
}