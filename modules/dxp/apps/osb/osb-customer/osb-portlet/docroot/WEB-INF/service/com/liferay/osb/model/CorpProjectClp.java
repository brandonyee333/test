...
public class CorpProjectClp extends BaseModelImpl<CorpProject>
	...
	public Serializable getPrimaryKeyObj() {
		return new Long(_corpProjectId);
	}
	...
	public java.util.List<com.liferay.osb.model.CorpProjectMessage> getCorpProjectMessages() {
		try {
			String methodName = "getCorpProjectMessages";

			Class<?>[] parameterTypes = new Class<?>[] {  };

			Object[] parameterValues = new Object[] {  };

			java.util.List<com.liferay.osb.model.CorpProjectMessage> returnObj = (java.util.List<com.liferay.osb.model.CorpProjectMessage>)invokeOnRemoteModel(methodName,
					parameterTypes, parameterValues);
