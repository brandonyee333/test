...
/**
 * The base implementation of the support team local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.SupportTeamLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.SupportTeamLocalServiceImpl
 * @see com.liferay.osb.service.SupportTeamLocalServiceUtil
 * @generated
 */
public abstract class SupportTeamLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SupportTeamLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.SupportTeamLocalServiceUtil} to access the support team local service.
	 */
	...
	public SupportTeam addSupportTeam(SupportTeam supportTeam)
		...
		return supportTeamPersistence.update(supportTeam, false);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SupportTeam.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return supportTeamPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSupportTeamsCount() throws SystemException {
	...
	public SupportTeam updateSupportTeam(SupportTeam supportTeam)
		throws SystemException {
		return updateSupportTeam(supportTeam, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SupportTeam updateSupportTeam(SupportTeam supportTeam, boolean merge)
		throws SystemException {
		supportTeam.setNew(false);

		return supportTeamPersistence.update(supportTeam, merge);
	}
	...
	public void addAccountEntrySupportTeam(long accountEntryId,
		long supportTeamId) throws SystemException {
		accountEntryPersistence.addSupportTeam(accountEntryId, supportTeamId);
	}
	 ...
	 */
	public void addAccountEntrySupportTeam(long accountEntryId,
		SupportTeam supportTeam) throws SystemException {
		accountEntryPersistence.addSupportTeam(accountEntryId, supportTeam);
	}
	...
	public void addAccountEntrySupportTeams(long accountEntryId,
		long[] supportTeamIds) throws SystemException {
		accountEntryPersistence.addSupportTeams(accountEntryId, supportTeamIds);
	}
	 ...
	 */
	public void addAccountEntrySupportTeams(long accountEntryId,
		List<SupportTeam> SupportTeams) throws SystemException {
		accountEntryPersistence.addSupportTeams(accountEntryId, SupportTeams);
	}
	...
	public void clearAccountEntrySupportTeams(long accountEntryId)
		throws SystemException {
		accountEntryPersistence.clearSupportTeams(accountEntryId);
	}
	...
	public void deleteAccountEntrySupportTeam(long accountEntryId,
		long supportTeamId) throws SystemException {
		accountEntryPersistence.removeSupportTeam(accountEntryId, supportTeamId);
	}
	...
	public void deleteAccountEntrySupportTeam(long accountEntryId,
		SupportTeam supportTeam) throws SystemException {
		accountEntryPersistence.removeSupportTeam(accountEntryId, supportTeam);
	}
	...
	public void deleteAccountEntrySupportTeams(long accountEntryId,
		long[] supportTeamIds) throws SystemException {
		accountEntryPersistence.removeSupportTeams(accountEntryId,
			supportTeamIds);
	}
	...
	public void deleteAccountEntrySupportTeams(long accountEntryId,
		List<SupportTeam> SupportTeams) throws SystemException {
		accountEntryPersistence.removeSupportTeams(accountEntryId, SupportTeams);
	}
	...
	public List<SupportTeam> getAccountEntrySupportTeams(long accountEntryId)
		throws SystemException {
		return accountEntryPersistence.getSupportTeams(accountEntryId);
	}
	...
	public List<SupportTeam> getAccountEntrySupportTeams(long accountEntryId,
		...
		return accountEntryPersistence.getSupportTeams(accountEntryId, start,
			end);
	}
	...
	public int getAccountEntrySupportTeamsCount(long accountEntryId)
		throws SystemException {
		return accountEntryPersistence.getSupportTeamsSize(accountEntryId);
	}
	...
	public boolean hasAccountEntrySupportTeam(long accountEntryId,
		long supportTeamId) throws SystemException {
		return accountEntryPersistence.containsSupportTeam(accountEntryId,
			supportTeamId);
	}
	...
	public boolean hasAccountEntrySupportTeams(long accountEntryId)
		throws SystemException {
		return accountEntryPersistence.containsSupportTeams(accountEntryId);
	}
	...
	public void setAccountEntrySupportTeams(long accountEntryId,
		long[] supportTeamIds) throws SystemException {
		accountEntryPersistence.setSupportTeams(accountEntryId, supportTeamIds);
	}
	...
	public void addSupportRegionSupportTeam(long supportRegionId,
		long supportTeamId) throws SystemException {
		supportRegionPersistence.addSupportTeam(supportRegionId, supportTeamId);
	}
	...
	public void addSupportRegionSupportTeam(long supportRegionId,
		SupportTeam supportTeam) throws SystemException {
		supportRegionPersistence.addSupportTeam(supportRegionId, supportTeam);
	}
	...
	public void addSupportRegionSupportTeams(long supportRegionId,
		long[] supportTeamIds) throws SystemException {
		supportRegionPersistence.addSupportTeams(supportRegionId, supportTeamIds);
	}
	...
	public void addSupportRegionSupportTeams(long supportRegionId,
		List<SupportTeam> SupportTeams) throws SystemException {
		supportRegionPersistence.addSupportTeams(supportRegionId, SupportTeams);
	}
	...
	public void clearSupportRegionSupportTeams(long supportRegionId)
		throws SystemException {
		supportRegionPersistence.clearSupportTeams(supportRegionId);
	}
	...
	public void deleteSupportRegionSupportTeam(long supportRegionId,
		long supportTeamId) throws SystemException {
		supportRegionPersistence.removeSupportTeam(supportRegionId,
			supportTeamId);
	}
	...
	public void deleteSupportRegionSupportTeam(long supportRegionId,
		SupportTeam supportTeam) throws SystemException {
		supportRegionPersistence.removeSupportTeam(supportRegionId, supportTeam);
	}
	...
	public void deleteSupportRegionSupportTeams(long supportRegionId,
		long[] supportTeamIds) throws SystemException {
		supportRegionPersistence.removeSupportTeams(supportRegionId,
			supportTeamIds);
	}
	...
	public List<SupportTeam> getSupportRegionSupportTeams(long supportRegionId)
		throws SystemException {
		return supportRegionPersistence.getSupportTeams(supportRegionId);
	}
	...
	public List<SupportTeam> getSupportRegionSupportTeams(
		long supportRegionId, int start, int end) throws SystemException {
		return supportRegionPersistence.getSupportTeams(supportRegionId, start,
			end);
	}
	...
	public int getSupportRegionSupportTeamsCount(long supportRegionId)
		throws SystemException {
		return supportRegionPersistence.getSupportTeamsSize(supportRegionId);
	}
	...
	public boolean hasSupportRegionSupportTeam(long supportRegionId,
		long supportTeamId) throws SystemException {
		return supportRegionPersistence.containsSupportTeam(supportRegionId,
			supportTeamId);
	}
	...
	public boolean hasSupportRegionSupportTeams(long supportRegionId)
		throws SystemException {
		return supportRegionPersistence.containsSupportTeams(supportRegionId);
	}
	...
	public void setSupportRegionSupportTeams(long supportRegionId,
		long[] supportTeamIds) throws SystemException {
		supportRegionPersistence.setSupportTeams(supportRegionId, supportTeamIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.SupportTeam",
	...
	private SupportTeamLocalServiceClpInvoker _clpInvoker = new SupportTeamLocalServiceClpInvoker();
}