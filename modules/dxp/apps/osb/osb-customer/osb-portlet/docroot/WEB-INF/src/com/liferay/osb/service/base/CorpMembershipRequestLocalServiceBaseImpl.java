...
/**
 * The base implementation of the corp membership request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.CorpMembershipRequestLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.CorpMembershipRequestLocalServiceImpl
 * @see com.liferay.osb.service.CorpMembershipRequestLocalServiceUtil
 * @generated
 */
public abstract class CorpMembershipRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CorpMembershipRequestLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.CorpMembershipRequestLocalServiceUtil} to access the corp membership request local service.
	 */
	...
	public CorpMembershipRequest addCorpMembershipRequest(
		...
		return corpMembershipRequestPersistence.update(corpMembershipRequest,
			false);
	}
	 ...
	 */
	public CorpMembershipRequest createCorpMembershipRequest(
		long corpMembershipRequestId) {
		return corpMembershipRequestPersistence.create(corpMembershipRequestId);
	}
	...
	public CorpMembershipRequest deleteCorpMembershipRequest(
		long corpMembershipRequestId) throws PortalException, SystemException {
		return corpMembershipRequestPersistence.remove(corpMembershipRequestId);
	}
	...
	public CorpMembershipRequest deleteCorpMembershipRequest(
		CorpMembershipRequest corpMembershipRequest) throws SystemException {
		return corpMembershipRequestPersistence.remove(corpMembershipRequest);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CorpMembershipRequest.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return corpMembershipRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return corpMembershipRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CorpMembershipRequest fetchCorpMembershipRequest(
		long corpMembershipRequestId) throws SystemException {
		return corpMembershipRequestPersistence.fetchByPrimaryKey(corpMembershipRequestId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CorpMembershipRequest getCorpMembershipRequest(
		long corpMembershipRequestId) throws PortalException, SystemException {
		return corpMembershipRequestPersistence.findByPrimaryKey(corpMembershipRequestId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return corpMembershipRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CorpMembershipRequest> getCorpMembershipRequests(int start,
		int end) throws SystemException {
		return corpMembershipRequestPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCorpMembershipRequestsCount() throws SystemException {
		return corpMembershipRequestPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CorpMembershipRequest updateCorpMembershipRequest(
		CorpMembershipRequest corpMembershipRequest) throws SystemException {
		return updateCorpMembershipRequest(corpMembershipRequest, true);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.CorpMembershipRequest",
			corpMembershipRequestLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = corpMembershipRequestPersistence.getDataSource();
	...
	private CorpMembershipRequestLocalServiceClpInvoker _clpInvoker = new CorpMembershipRequestLocalServiceClpInvoker();
}