 ...
 * @author Ryan Park
 */
public class OSBCorpMembershipRequestPermission {

	public static void check(
			PermissionChecker permissionChecker,
			CorpMembershipRequest corpMembershipRequest, String actionId)
		throws PortalException, SystemException {

		if (!contains(permissionChecker, corpMembershipRequest, actionId)) {
			throw new PrincipalException();
		}
	}

	public static void check(
			PermissionChecker permissionChecker, long corpMembershipRequestId,
			String actionId)
		throws PortalException, SystemException {

		if (!contains(permissionChecker, corpMembershipRequestId, actionId)) {
			throw new PrincipalException();
		}
	}
	...
	public static boolean contains(
		...
		return contains(permissionChecker, corpMembershipRequest, actionId);
	}
