...
/**
 * The base implementation of the account project local service.
 *
 * <p>
...
public abstract class AccountProjectLocalServiceBaseImpl
	...
	public AccountProject addAccountProject(AccountProject accountProject)
		...
		return accountProjectPersistence.update(accountProject, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccountProjectsCount() throws SystemException {
	...
	public AccountProject updateAccountProject(AccountProject accountProject)
		throws SystemException {
		return updateAccountProject(accountProject, true);
	}
	...
	public AccountProject updateAccountProject(AccountProject accountProject,
		...
		return accountProjectPersistence.update(accountProject, merge);
	}
