...
/**
 * Provides the base implementation for the account project local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AccountProjectLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AccountProjectLocalServiceImpl
 * @see com.liferay.osb.service.AccountProjectLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AccountProjectLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccountProjectLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AccountProjectLocalServiceUtil} to access the account project local service.
	 */
	...
	@Override
	public AccountProject addAccountProject(AccountProject accountProject) {
		accountProject.setNew(true);

		return accountProjectPersistence.update(accountProject);
	}
	 ...
	 */
	@Override
	public AccountProject createAccountProject(long accountProjectId) {
		return accountProjectPersistence.create(accountProjectId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AccountProject deleteAccountProject(AccountProject accountProject) {
		return accountProjectPersistence.remove(accountProject);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccountProject.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accountProjectPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accountProjectPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AccountProject fetchAccountProject(long accountProjectId) {
		return accountProjectPersistence.fetchByPrimaryKey(accountProjectId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accountProjectLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccountProject.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accountProjectId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(accountProjectLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccountProject.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return accountProjectLocalService.deleteAccountProject((AccountProject)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return accountProjectPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AccountProject> getAccountProjects(int start, int end) {
		return accountProjectPersistence.findAll(start, end);
	}
	...
	public int getAccountProjectsCount() {
		return accountProjectPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AccountProject",
			accountProjectLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccountProjectLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accountProjectPersistence.getDataSource();
	...
	private AccountProjectLocalServiceClpInvoker _clpInvoker = new AccountProjectLocalServiceClpInvoker();
}