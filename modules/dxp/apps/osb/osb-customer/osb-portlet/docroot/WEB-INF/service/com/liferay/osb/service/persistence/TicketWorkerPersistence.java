...
public interface TicketWorkerPersistence extends BasePersistence<TicketWorker> {
	...
	*/
	public java.util.List<TicketWorker> findByUserId(long userId, int start,
		int end);
	...
	*/
	public java.util.List<TicketWorker> findByUserId(long userId, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<TicketWorker> orderByComparator);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TicketWorker> fetchByPrimaryKeys(
