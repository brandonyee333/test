...
public class HolidayCalendarRelLocalServiceClpInvoker {
	public HolidayCalendarRelLocalServiceClpInvoker() {
		...
		_methodName277 = "addUsers";

		_methodParameterTypes277 = new String[] { "long", "long[][]" };

		_methodName278 = "deleteHolidayCalendarRels";

		_methodParameterTypes278 = new String[] { "long" };

		_methodName279 = "deleteHolidayCalendarRels";

		_methodParameterTypes279 = new String[] { "long", "long[][]" };

		_methodName280 = "getHolidayCalendarRel";

		_methodParameterTypes280 = new String[] { "long", "long" };

		_methodName281 = "getHolidayCalendarRels";

		_methodParameterTypes281 = new String[] { "long" };

		_methodName282 = "hasHolidayCalendarRel";
