...
/**
 * The base implementation of the asset recommendation entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AssetRecommendationEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AssetRecommendationEntryLocalServiceImpl
 * @see com.liferay.osb.service.AssetRecommendationEntryLocalServiceUtil
 * @generated
 */
public abstract class AssetRecommendationEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetRecommendationEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AssetRecommendationEntryLocalServiceUtil} to access the asset recommendation entry local service.
	 */
	...
	public AssetRecommendationEntry addAssetRecommendationEntry(
		AssetRecommendationEntry assetRecommendationEntry)
		throws SystemException {
		assetRecommendationEntry.setNew(true);

		return assetRecommendationEntryPersistence.update(assetRecommendationEntry,
			false);
	}
	 ...
	 */
	public AssetRecommendationEntry createAssetRecommendationEntry(
		long assetRecommendationEntryId) {
		return assetRecommendationEntryPersistence.create(assetRecommendationEntryId);
	}
	...
	public AssetRecommendationEntry deleteAssetRecommendationEntry(
		long assetRecommendationEntryId)
		throws PortalException, SystemException {
		return assetRecommendationEntryPersistence.remove(assetRecommendationEntryId);
	}
	...
	public AssetRecommendationEntry deleteAssetRecommendationEntry(
		AssetRecommendationEntry assetRecommendationEntry)
		throws SystemException {
		return assetRecommendationEntryPersistence.remove(assetRecommendationEntry);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AssetRecommendationEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetRecommendationEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetRecommendationEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AssetRecommendationEntry fetchAssetRecommendationEntry(
		long assetRecommendationEntryId) throws SystemException {
		return assetRecommendationEntryPersistence.fetchByPrimaryKey(assetRecommendationEntryId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AssetRecommendationEntry getAssetRecommendationEntry(
		long assetRecommendationEntryId)
		throws PortalException, SystemException {
		return assetRecommendationEntryPersistence.findByPrimaryKey(assetRecommendationEntryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assetRecommendationEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AssetRecommendationEntry> getAssetRecommendationEntries(
		...
		return assetRecommendationEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAssetRecommendationEntriesCount() throws SystemException {
		return assetRecommendationEntryPersistence.countAll();
	}
	...
	public AssetRecommendationEntry updateAssetRecommendationEntry(
		AssetRecommendationEntry assetRecommendationEntry)
		throws SystemException {
		return updateAssetRecommendationEntry(assetRecommendationEntry, true);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AssetRecommendationEntry",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assetRecommendationEntryPersistence.getDataSource();
	...
	private AssetRecommendationEntryLocalServiceClpInvoker _clpInvoker = new AssetRecommendationEntryLocalServiceClpInvoker();
}