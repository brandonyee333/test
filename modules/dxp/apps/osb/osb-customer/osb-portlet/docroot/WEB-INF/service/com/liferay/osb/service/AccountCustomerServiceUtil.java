...
/**
 * The utility for the account customer remote service. This utility wraps {@link com.liferay.osb.service.impl.AccountCustomerServiceImpl} and is the primary access point for service operations in application layer code running on a remote server.
 *
 * <p>
...
public class AccountCustomerServiceUtil {
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(AccountCustomerService service) {
	}

	private static AccountCustomerService _service;
}