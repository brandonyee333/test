...
/**
 * The base implementation of the contract entry local service.
 *
 * <p>
...
public abstract class ContractEntryLocalServiceBaseImpl
	...
	public ContractEntry addContractEntry(ContractEntry contractEntry)
		...
		return contractEntryPersistence.update(contractEntry, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getContractEntriesCount() throws SystemException {
	...
	public ContractEntry updateContractEntry(ContractEntry contractEntry)
		throws SystemException {
		return updateContractEntry(contractEntry, true);
	}
	...
	public ContractEntry updateContractEntry(ContractEntry contractEntry,
		...
		return contractEntryPersistence.update(contractEntry, merge);
	}
