...
/**
 * Provides the base implementation for the contract entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.ContractEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.ContractEntryLocalServiceImpl
 * @see com.liferay.osb.service.ContractEntryLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ContractEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ContractEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.ContractEntryLocalServiceUtil} to access the contract entry local service.
	 */
	...
	public ContractEntry addContractEntry(ContractEntry contractEntry) {
		...
		return contractEntryPersistence.update(contractEntry);
	}
	 ...
	 */
	@Override
	public ContractEntry createContractEntry(long contractEntryId) {
		return contractEntryPersistence.create(contractEntryId);
	}
	...
	@Override
	public ContractEntry deleteContractEntry(long contractEntryId)
		throws PortalException {
		return contractEntryPersistence.remove(contractEntryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ContractEntry deleteContractEntry(ContractEntry contractEntry) {
		return contractEntryPersistence.remove(contractEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ContractEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return contractEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return contractEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ContractEntry fetchContractEntry(long contractEntryId) {
		return contractEntryPersistence.fetchByPrimaryKey(contractEntryId);
	}
	...
	public ContractEntry getContractEntry(long contractEntryId)
		throws PortalException {
		return contractEntryPersistence.findByPrimaryKey(contractEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(contractEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ContractEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("contractEntryId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(contractEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ContractEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return contractEntryLocalService.deleteContractEntry((ContractEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return contractEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ContractEntry> getContractEntries(int start, int end) {
		return contractEntryPersistence.findAll(start, end);
	}
	...
	public int getContractEntriesCount() {
		return contractEntryPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.ContractEntry",
			contractEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ContractEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = contractEntryPersistence.getDataSource();
	...
	private ContractEntryLocalServiceClpInvoker _clpInvoker = new ContractEntryLocalServiceClpInvoker();
}