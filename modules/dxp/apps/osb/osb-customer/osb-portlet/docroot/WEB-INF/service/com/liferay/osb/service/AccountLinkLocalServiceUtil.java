...
/**
 * The utility for the account link local service. This utility wraps {@link com.liferay.osb.service.impl.AccountLinkLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class AccountLinkLocalServiceUtil {
	...
	*/
	public static com.liferay.osb.model.AccountLink updateAccountLink(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateAccountLink(accountLink, merge);
	}
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(AccountLinkLocalService service) {
	}
