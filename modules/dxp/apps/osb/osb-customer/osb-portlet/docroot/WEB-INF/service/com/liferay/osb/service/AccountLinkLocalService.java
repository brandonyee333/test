...
/**
 * Provides the local service interface for AccountLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AccountLinkLocalServiceUtil
...
public interface AccountLinkLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AccountLinkLocalServiceUtil} to access the account link local service. Add custom service methods to {@link com.liferay.osb.service.impl.AccountLinkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
