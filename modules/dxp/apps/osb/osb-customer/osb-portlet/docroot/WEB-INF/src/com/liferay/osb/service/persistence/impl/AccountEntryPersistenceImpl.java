...
public class AccountEntryPersistenceImpl extends BasePersistenceImpl<AccountEntry>
	...
	public void removeByHighestSupportResponseId(long highestSupportResponseId) {
		for (AccountEntry accountEntry : findByHighestSupportResponseId(
				highestSupportResponseId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(accountEntry);
		}
	}
	...
	public int countByHighestSupportResponseId(long highestSupportResponseId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_HIGHESTSUPPORTRESPONSEID;
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] { accountEntryModelImpl.getCorpProjectId() };
	...
	public AccountEntry updateImpl(AccountEntry accountEntry) {
		...
		if (!AccountEntryModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					accountEntryModelImpl.getHighestSupportResponseId()
				};

			finderCache.removeResult(FINDER_PATH_COUNT_BY_HIGHESTSUPPORTRESPONSEID,
				args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_HIGHESTSUPPORTRESPONSEID,
				args);
			...
			if ((accountEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						accountEntryModelImpl.getOriginalHighestSupportResponseId()
					};
