 ...
 */
public class AccountWorkerServiceClp implements AccountWorkerService {
	public AccountWorkerServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "addAccountWorkers";

		_methodParameterTypes3 = new String[] {
				"long[][]", "long", "int[][]", "int[][]"
			};

		_methodName4 = "deleteAccountWorkers";
