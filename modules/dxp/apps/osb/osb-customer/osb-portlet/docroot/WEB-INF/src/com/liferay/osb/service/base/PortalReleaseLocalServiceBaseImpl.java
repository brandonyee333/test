...
/**
 * The base implementation of the portal release local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.PortalReleaseLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.PortalReleaseLocalServiceImpl
 * @see com.liferay.osb.service.PortalReleaseLocalServiceUtil
 * @generated
 */
public abstract class PortalReleaseLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PortalReleaseLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.PortalReleaseLocalServiceUtil} to access the portal release local service.
	 */
	...
	public PortalRelease addPortalRelease(PortalRelease portalRelease)
		throws SystemException {
		portalRelease.setNew(true);

		return portalReleasePersistence.update(portalRelease, false);
	}
	 ...
	 */
	public PortalRelease createPortalRelease(long portalReleaseId) {
		return portalReleasePersistence.create(portalReleaseId);
	}
	...
	public PortalRelease deletePortalRelease(long portalReleaseId)
		throws PortalException, SystemException {
		return portalReleasePersistence.remove(portalReleaseId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public PortalRelease deletePortalRelease(PortalRelease portalRelease)
		throws SystemException {
		return portalReleasePersistence.remove(portalRelease);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PortalRelease.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return portalReleasePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return portalReleasePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PortalRelease fetchPortalRelease(long portalReleaseId)
		throws SystemException {
		return portalReleasePersistence.fetchByPrimaryKey(portalReleaseId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PortalRelease getPortalRelease(long portalReleaseId)
		throws PortalException, SystemException {
		return portalReleasePersistence.findByPrimaryKey(portalReleaseId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return portalReleasePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PortalRelease> getPortalReleases(int start, int end)
		throws SystemException {
		return portalReleasePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPortalReleasesCount() throws SystemException {
		return portalReleasePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PortalRelease updatePortalRelease(PortalRelease portalRelease)
		throws SystemException {
		return updatePortalRelease(portalRelease, true);
	}
	...
	public PortalRelease updatePortalRelease(PortalRelease portalRelease,
		...
		return portalReleasePersistence.update(portalRelease, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.PortalRelease",
			portalReleaseLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = portalReleasePersistence.getDataSource();
	...
	private PortalReleaseLocalServiceClpInvoker _clpInvoker = new PortalReleaseLocalServiceClpInvoker();
}