...
/**
 * Provides the base implementation for the feedback entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.FeedbackEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.FeedbackEntryLocalServiceImpl
 * @see com.liferay.osb.service.FeedbackEntryLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class FeedbackEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FeedbackEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.FeedbackEntryLocalServiceUtil} to access the feedback entry local service.
	 */
	...
	@Override
	public FeedbackEntry addFeedbackEntry(FeedbackEntry feedbackEntry) {
	 ...
	 */
	@Override
	public FeedbackEntry createFeedbackEntry(long feedbackEntryId) {
		return feedbackEntryPersistence.create(feedbackEntryId);
	}
	...
	@Override
	public FeedbackEntry deleteFeedbackEntry(long feedbackEntryId)
		throws PortalException {
		return feedbackEntryPersistence.remove(feedbackEntryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FeedbackEntry deleteFeedbackEntry(FeedbackEntry feedbackEntry) {
		return feedbackEntryPersistence.remove(feedbackEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FeedbackEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return feedbackEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return feedbackEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FeedbackEntry fetchFeedbackEntry(long feedbackEntryId) {
		return feedbackEntryPersistence.fetchByPrimaryKey(feedbackEntryId);
	}
	 ...
	 */
	@Override
	public FeedbackEntry getFeedbackEntry(long feedbackEntryId)
		throws PortalException {
		return feedbackEntryPersistence.findByPrimaryKey(feedbackEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(feedbackEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FeedbackEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("feedbackEntryId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(feedbackEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FeedbackEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return feedbackEntryLocalService.deleteFeedbackEntry((FeedbackEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return feedbackEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FeedbackEntry> getFeedbackEntries(int start, int end) {
		return feedbackEntryPersistence.findAll(start, end);
	}
	...
	public int getFeedbackEntriesCount() {
		return feedbackEntryPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.FeedbackEntry",
			feedbackEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FeedbackEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = feedbackEntryPersistence.getDataSource();
	...
	private FeedbackEntryLocalServiceClpInvoker _clpInvoker = new FeedbackEntryLocalServiceClpInvoker();
}