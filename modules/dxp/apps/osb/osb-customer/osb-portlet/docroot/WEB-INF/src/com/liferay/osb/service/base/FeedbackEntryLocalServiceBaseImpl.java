...
/**
 * The base implementation of the feedback entry local service.
 *
 * <p>
...
public abstract class FeedbackEntryLocalServiceBaseImpl
	...
	public FeedbackEntry addFeedbackEntry(FeedbackEntry feedbackEntry)
		...
		return feedbackEntryPersistence.update(feedbackEntry, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFeedbackEntriesCount() throws SystemException {
	...
	public FeedbackEntry updateFeedbackEntry(FeedbackEntry feedbackEntry)
		throws SystemException {
		return updateFeedbackEntry(feedbackEntry, true);
	}
	...
	public FeedbackEntry updateFeedbackEntry(FeedbackEntry feedbackEntry,
		...
		return feedbackEntryPersistence.update(feedbackEntry, merge);
	}
