...
/**
 * The utility for the holiday calendar local service. This utility wraps {@link com.liferay.osb.service.impl.HolidayCalendarLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class HolidayCalendarLocalServiceUtil {
	...
	*/
	public static com.liferay.osb.model.HolidayCalendar updateHolidayCalendar(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateHolidayCalendar(holidayCalendar, merge);
	}
