...
/**
 * The base implementation of the training import log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TrainingImportLogLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TrainingImportLogLocalServiceImpl
 * @see com.liferay.osb.service.TrainingImportLogLocalServiceUtil
 * @generated
 */
public abstract class TrainingImportLogLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrainingImportLogLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TrainingImportLogLocalServiceUtil} to access the training import log local service.
	 */
	...
	public TrainingImportLog addTrainingImportLog(
		TrainingImportLog trainingImportLog) throws SystemException {
		trainingImportLog.setNew(true);

		return trainingImportLogPersistence.update(trainingImportLog, false);
	}
	 ...
	 */
	public TrainingImportLog createTrainingImportLog(long trainingImportLogId) {
		return trainingImportLogPersistence.create(trainingImportLogId);
	}
	...
	public TrainingImportLog deleteTrainingImportLog(long trainingImportLogId)
		throws PortalException, SystemException {
		return trainingImportLogPersistence.remove(trainingImportLogId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TrainingImportLog deleteTrainingImportLog(
		TrainingImportLog trainingImportLog) throws SystemException {
		return trainingImportLogPersistence.remove(trainingImportLog);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TrainingImportLog.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return trainingImportLogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trainingImportLogPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrainingImportLog fetchTrainingImportLog(long trainingImportLogId)
		throws SystemException {
		return trainingImportLogPersistence.fetchByPrimaryKey(trainingImportLogId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrainingImportLog getTrainingImportLog(long trainingImportLogId)
		throws PortalException, SystemException {
		return trainingImportLogPersistence.findByPrimaryKey(trainingImportLogId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trainingImportLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrainingImportLog> getTrainingImportLogs(int start, int end)
		throws SystemException {
		return trainingImportLogPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrainingImportLogsCount() throws SystemException {
		return trainingImportLogPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TrainingImportLog updateTrainingImportLog(
		TrainingImportLog trainingImportLog) throws SystemException {
		return updateTrainingImportLog(trainingImportLog, true);
	}
	...
	public TrainingImportLog updateTrainingImportLog(
		...
		return trainingImportLogPersistence.update(trainingImportLog, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TrainingImportLog",
			trainingImportLogLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.osb.model.TrainingImportLog");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trainingImportLogPersistence.getDataSource();
	...
	private TrainingImportLogLocalServiceClpInvoker _clpInvoker = new TrainingImportLogLocalServiceClpInvoker();
}