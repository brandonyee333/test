 ...
 */
public class AppEntryRelServiceClpInvoker {
	public AppEntryRelServiceClpInvoker() {
		...
		_methodName670 = "addAppEntryRel";

		_methodParameterTypes670 = new String[] { "long", "long", "int" };

		_methodName671 = "deleteAppEntryRel";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return AppEntryRelServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			AppEntryRelServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
		...
		if (_methodName670.equals(name) &&
			...
			return AppEntryRelServiceUtil.addAppEntryRel(((Long)arguments[0]).longValue(),
		...
		if (_methodName671.equals(name) &&
			...
			return AppEntryRelServiceUtil.deleteAppEntryRel(((Long)arguments[0]).longValue());
		}
