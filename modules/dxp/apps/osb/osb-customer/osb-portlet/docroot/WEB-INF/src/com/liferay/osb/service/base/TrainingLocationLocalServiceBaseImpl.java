...
/**
 * The base implementation of the training location local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TrainingLocationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TrainingLocationLocalServiceImpl
 * @see com.liferay.osb.service.TrainingLocationLocalServiceUtil
 * @generated
 */
public abstract class TrainingLocationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrainingLocationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TrainingLocationLocalServiceUtil} to access the training location local service.
	 */
	...
	public TrainingLocation addTrainingLocation(
		TrainingLocation trainingLocation) throws SystemException {
		trainingLocation.setNew(true);

		return trainingLocationPersistence.update(trainingLocation, false);
	}
	 ...
	 */
	public TrainingLocation createTrainingLocation(long trainingLocationId) {
		return trainingLocationPersistence.create(trainingLocationId);
	}
	...
	public TrainingLocation deleteTrainingLocation(long trainingLocationId)
		...
		return trainingLocationPersistence.remove(trainingLocationId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TrainingLocation deleteTrainingLocation(
		TrainingLocation trainingLocation) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TrainingLocation.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return trainingLocationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trainingLocationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrainingLocation fetchTrainingLocation(long trainingLocationId)
		throws SystemException {
		return trainingLocationPersistence.fetchByPrimaryKey(trainingLocationId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrainingLocation getTrainingLocation(long trainingLocationId)
		throws PortalException, SystemException {
		return trainingLocationPersistence.findByPrimaryKey(trainingLocationId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trainingLocationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrainingLocation> getTrainingLocations(int start, int end)
		throws SystemException {
		return trainingLocationPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrainingLocationsCount() throws SystemException {
		return trainingLocationPersistence.countAll();
	}
	...
	public TrainingLocation updateTrainingLocation(
		TrainingLocation trainingLocation) throws SystemException {
		return updateTrainingLocation(trainingLocation, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public TrainingLocation updateTrainingLocation(
		TrainingLocation trainingLocation, boolean merge)
		throws SystemException {
		trainingLocation.setNew(false);

		return trainingLocationPersistence.update(trainingLocation, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TrainingLocation",
			trainingLocationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.osb.model.TrainingLocation");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trainingLocationPersistence.getDataSource();
	...
	private TrainingLocationLocalServiceClpInvoker _clpInvoker = new TrainingLocationLocalServiceClpInvoker();
}