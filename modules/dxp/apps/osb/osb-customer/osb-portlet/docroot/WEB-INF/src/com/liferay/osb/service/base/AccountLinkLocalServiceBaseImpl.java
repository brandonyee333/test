...
/**
 * Provides the base implementation for the account link local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AccountLinkLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AccountLinkLocalServiceImpl
 * @see com.liferay.osb.service.AccountLinkLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AccountLinkLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccountLinkLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AccountLinkLocalServiceUtil} to access the account link local service.
	 */
	...
	public AccountLink addAccountLink(AccountLink accountLink) {
		...
		return accountLinkPersistence.update(accountLink);
	}
	 ...
	 */
	@Override
	public AccountLink createAccountLink(long accountLinkId) {
		return accountLinkPersistence.create(accountLinkId);
	}
	...
	public AccountLink deleteAccountLink(long accountLinkId)
		...
		return accountLinkPersistence.remove(accountLinkId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AccountLink deleteAccountLink(AccountLink accountLink) {
		return accountLinkPersistence.remove(accountLink);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccountLink.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accountLinkPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return accountLinkPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accountLinkPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AccountLink fetchAccountLink(long accountLinkId) {
		return accountLinkPersistence.fetchByPrimaryKey(accountLinkId);
	}
	...
	public AccountLink getAccountLink(long accountLinkId)
		throws PortalException {
		return accountLinkPersistence.findByPrimaryKey(accountLinkId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accountLinkLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccountLink.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accountLinkId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(accountLinkLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccountLink.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return accountLinkLocalService.deleteAccountLink((AccountLink)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return accountLinkPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AccountLink> getAccountLinks(int start, int end) {
		return accountLinkPersistence.findAll(start, end);
	}
	...
	public int getAccountLinksCount() {
		return accountLinkPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AccountLink",
			accountLinkLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccountLinkLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accountLinkPersistence.getDataSource();
	...
	private AccountLinkLocalServiceClpInvoker _clpInvoker = new AccountLinkLocalServiceClpInvoker();
}