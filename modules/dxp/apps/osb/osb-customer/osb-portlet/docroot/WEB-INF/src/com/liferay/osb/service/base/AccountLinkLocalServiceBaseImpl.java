...
/**
 * The base implementation of the account link local service.
 *
 * <p>
...
public abstract class AccountLinkLocalServiceBaseImpl
	...
	public AccountLink addAccountLink(AccountLink accountLink)
		...
		return accountLinkPersistence.update(accountLink, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccountLinksCount() throws SystemException {
	...
	public AccountLink updateAccountLink(AccountLink accountLink)
		throws SystemException {
		return updateAccountLink(accountLink, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AccountLink updateAccountLink(AccountLink accountLink, boolean merge)
		throws SystemException {
		accountLink.setNew(false);

		return accountLinkPersistence.update(accountLink, merge);
	}
