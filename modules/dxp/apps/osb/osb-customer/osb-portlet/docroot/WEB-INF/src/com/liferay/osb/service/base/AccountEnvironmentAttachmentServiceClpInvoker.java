...
public class AccountEnvironmentAttachmentServiceClpInvoker {
	public AccountEnvironmentAttachmentServiceClpInvoker() {
		...
		_methodName670 = "getAccountEnvironmentAttachment";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return AccountEnvironmentAttachmentServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			AccountEnvironmentAttachmentServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
