...
/**
 * Provides the base implementation for the asset license local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AssetLicenseLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class AssetLicenseLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetLicenseLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AssetLicenseLocalServiceUtil} to access the asset license local service.
	 */
	...
	@Override
	public AssetLicense addAssetLicense(AssetLicense assetLicense) {
		assetLicense.setNew(true);

		return assetLicensePersistence.update(assetLicense);
	}
	 ...
	 */
	@Override
	public AssetLicense createAssetLicense(long assetLicenseId) {
		return assetLicensePersistence.create(assetLicenseId);
	}
	...
	public AssetLicense deleteAssetLicense(long assetLicenseId)
		...
		return assetLicensePersistence.remove(assetLicenseId);
	}
	...
	public AssetLicense deleteAssetLicense(AssetLicense assetLicense) {
		return assetLicensePersistence.remove(assetLicense);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssetLicense.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return assetLicensePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return assetLicensePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssetLicense fetchAssetLicense(long assetLicenseId) {
		return assetLicensePersistence.fetchByPrimaryKey(assetLicenseId);
	}
	 ...
	 */
	@Override
	public AssetLicense getAssetLicense(long assetLicenseId)
		throws PortalException {
		return assetLicensePersistence.findByPrimaryKey(assetLicenseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(assetLicenseLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AssetLicense.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("assetLicenseId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(assetLicenseLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AssetLicense.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return assetLicenseLocalService.deleteAssetLicense((AssetLicense)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return assetLicensePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssetLicense> getAssetLicenses(int start, int end) {
		return assetLicensePersistence.findAll(start, end);
	}
	...
	public int getAssetLicensesCount() {
		return assetLicensePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssetLicense updateAssetLicense(AssetLicense assetLicense) {
		return assetLicensePersistence.update(assetLicense);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AssetLicense",
			assetLicenseLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AssetLicenseLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = assetLicensePersistence.getDataSource();
	...
	private AssetLicenseLocalServiceClpInvoker _clpInvoker = new AssetLicenseLocalServiceClpInvoker();
}