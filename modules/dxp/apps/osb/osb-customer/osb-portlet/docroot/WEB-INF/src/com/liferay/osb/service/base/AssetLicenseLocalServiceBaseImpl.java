...
/**
 * The base implementation of the asset license local service.
 *
 * <p>
...
public abstract class AssetLicenseLocalServiceBaseImpl
	...
	public AssetLicense addAssetLicense(AssetLicense assetLicense)
		...
		return assetLicensePersistence.update(assetLicense, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAssetLicensesCount() throws SystemException {
	...
	public AssetLicense updateAssetLicense(AssetLicense assetLicense)
		throws SystemException {
		return updateAssetLicense(assetLicense, true);
	}
	...
	public AssetLicense updateAssetLicense(AssetLicense assetLicense,
		...
		return assetLicensePersistence.update(assetLicense, merge);
	}
