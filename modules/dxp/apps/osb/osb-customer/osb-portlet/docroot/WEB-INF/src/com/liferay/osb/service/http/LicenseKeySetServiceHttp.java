...
public class LicenseKeySetServiceHttp {
	public static com.liferay.osb.model.LicenseKeySet addLicenseKeySet(
		...
		try {
			...
			return (com.liferay.osb.model.LicenseKeySet)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(LicenseKeySetServiceHttp.class);
	private static final Class<?>[] _addLicenseKeySetParameterTypes0 = new Class[] {
