...
/**
 * The utility for the support labor local service. This utility wraps {@link com.liferay.osb.service.impl.SupportLaborLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class SupportLaborLocalServiceUtil {
	...
	*/
	public static com.liferay.osb.model.SupportLabor updateSupportLabor(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSupportLabor(supportLabor, merge);
	}
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(SupportLaborLocalService service) {
	}
