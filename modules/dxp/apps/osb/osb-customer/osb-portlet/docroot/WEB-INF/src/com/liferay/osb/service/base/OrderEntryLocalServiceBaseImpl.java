...
/**
 * The base implementation of the order entry local service.
 *
 * <p>
...
public abstract class OrderEntryLocalServiceBaseImpl
	...
	public OrderEntry addOrderEntry(OrderEntry orderEntry)
		...
		return orderEntryPersistence.update(orderEntry, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getOrderEntriesCount() throws SystemException {
	...
	public OrderEntry updateOrderEntry(OrderEntry orderEntry)
		throws SystemException {
		return updateOrderEntry(orderEntry, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public OrderEntry updateOrderEntry(OrderEntry orderEntry, boolean merge)
		throws SystemException {
		orderEntry.setNew(false);

		return orderEntryPersistence.update(orderEntry, merge);
	}
