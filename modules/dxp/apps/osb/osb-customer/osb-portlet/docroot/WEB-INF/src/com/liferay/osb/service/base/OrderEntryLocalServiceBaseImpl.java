...
/**
 * Provides the base implementation for the order entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.OrderEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.OrderEntryLocalServiceImpl
 * @see com.liferay.osb.service.OrderEntryLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class OrderEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OrderEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.OrderEntryLocalServiceUtil} to access the order entry local service.
	 */
	...
	public OrderEntry addOrderEntry(OrderEntry orderEntry) {
		...
		return orderEntryPersistence.update(orderEntry);
	}
	...
	public OrderEntry createOrderEntry(long orderEntryId) {
		return orderEntryPersistence.create(orderEntryId);
	}
	...
	public OrderEntry deleteOrderEntry(long orderEntryId)
		...
		return orderEntryPersistence.remove(orderEntryId);
	}
	...
	public OrderEntry deleteOrderEntry(OrderEntry orderEntry)
		throws PortalException {
		return orderEntryPersistence.remove(orderEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OrderEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return orderEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return orderEntryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return orderEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public OrderEntry fetchOrderEntry(long orderEntryId) {
		return orderEntryPersistence.fetchByPrimaryKey(orderEntryId);
	}
	...
	public OrderEntry getOrderEntry(long orderEntryId)
		throws PortalException {
		return orderEntryPersistence.findByPrimaryKey(orderEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(orderEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(OrderEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("orderEntryId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(orderEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(OrderEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return orderEntryLocalService.deleteOrderEntry((OrderEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return orderEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<OrderEntry> getOrderEntries(int start, int end) {
		return orderEntryPersistence.findAll(start, end);
	}
	...
	public int getOrderEntriesCount() {
		return orderEntryPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.OrderEntry",
			orderEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return OrderEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = orderEntryPersistence.getDataSource();
	...
	private OrderEntryLocalServiceClpInvoker _clpInvoker = new OrderEntryLocalServiceClpInvoker();
}