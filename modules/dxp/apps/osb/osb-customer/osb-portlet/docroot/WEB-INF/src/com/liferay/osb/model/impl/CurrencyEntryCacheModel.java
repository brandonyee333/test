...
public class CurrencyEntryCacheModel implements CacheModel<CurrencyEntry>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CurrencyEntryCacheModel)) {
			return false;
		}

		CurrencyEntryCacheModel currencyEntryCacheModel = (CurrencyEntryCacheModel)obj;

		if (currencyEntryId == currencyEntryCacheModel.currencyEntryId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, currencyEntryId);
	}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		currencyEntryId = objectInput.readLong();

		countryId = objectInput.readLong();
		currencyCode = objectInput.readUTF();

		marketplaceEnabled = objectInput.readBoolean();

		marketplaceMinPrice = objectInput.readDouble();
	}

	@Override
	public void writeExternal(ObjectOutput objectOutput)
		throws IOException {
		objectOutput.writeLong(currencyEntryId);
		...
		objectOutput.writeBoolean(marketplaceEnabled);

		objectOutput.writeDouble(marketplaceMinPrice);
	}
