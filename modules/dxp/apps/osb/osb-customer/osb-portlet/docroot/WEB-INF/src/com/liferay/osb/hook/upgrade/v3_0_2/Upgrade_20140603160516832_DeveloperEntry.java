 ...
 * @author Douglas Wong
 */
public class Upgrade_20140603160516832_DeveloperEntry extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		if (tableHasColumn(
				"OSB_DeveloperEntry", "fatcaWithholdingPercentage")) {

			return;
		}

		runSQL(
			"alter table OSB_DeveloperEntry add column " +
