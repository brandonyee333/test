 ...
 */
public class TrainingCertificateTemplateServiceClpInvoker {
	public TrainingCertificateTemplateServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return TrainingCertificateTemplateServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			TrainingCertificateTemplateServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
