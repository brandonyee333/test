...
/**
 * The base implementation of the asset audit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AssetAuditLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AssetAuditLocalServiceImpl
 * @see com.liferay.osb.service.AssetAuditLocalServiceUtil
 * @generated
 */
public abstract class AssetAuditLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetAuditLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AssetAuditLocalServiceUtil} to access the asset audit local service.
	 */
	...
	public AssetAudit addAssetAudit(AssetAudit assetAudit)
		...
		return assetAuditPersistence.update(assetAudit, false);
	}
	 ...
	 */
	public AssetAudit createAssetAudit(long assetAuditId) {
		return assetAuditPersistence.create(assetAuditId);
	}
	...
	public AssetAudit deleteAssetAudit(long assetAuditId)
		throws PortalException, SystemException {
		return assetAuditPersistence.remove(assetAuditId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AssetAudit deleteAssetAudit(AssetAudit assetAudit)
		throws SystemException {
		return assetAuditPersistence.remove(assetAudit);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AssetAudit.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetAuditPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return assetAuditPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetAuditPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AssetAudit fetchAssetAudit(long assetAuditId)
		throws SystemException {
		return assetAuditPersistence.fetchByPrimaryKey(assetAuditId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AssetAudit getAssetAudit(long assetAuditId)
		throws PortalException, SystemException {
		return assetAuditPersistence.findByPrimaryKey(assetAuditId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assetAuditPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AssetAudit> getAssetAudits(int start, int end)
		throws SystemException {
		return assetAuditPersistence.findAll(start, end);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AssetAudit updateAssetAudit(AssetAudit assetAudit)
		throws SystemException {
		return updateAssetAudit(assetAudit, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AssetAudit updateAssetAudit(AssetAudit assetAudit, boolean merge)
		throws SystemException {
		assetAudit.setNew(false);

		return assetAuditPersistence.update(assetAudit, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AssetAudit",
			assetAuditLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assetAuditPersistence.getDataSource();
	...
	private AssetAuditLocalServiceClpInvoker _clpInvoker = new AssetAuditLocalServiceClpInvoker();
}