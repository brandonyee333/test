...
/**
 * The base implementation of the ticket entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TicketEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TicketEntryLocalServiceImpl
 * @see com.liferay.osb.service.TicketEntryLocalServiceUtil
 * @generated
 */
public abstract class TicketEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TicketEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TicketEntryLocalServiceUtil} to access the ticket entry local service.
	 */
	...
	public TicketEntry addTicketEntry(TicketEntry ticketEntry)
		...
		return ticketEntryPersistence.update(ticketEntry, false);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TicketEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return ticketEntryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public TicketEntry updateTicketEntry(TicketEntry ticketEntry)
		throws SystemException {
		return updateTicketEntry(ticketEntry, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TicketEntry updateTicketEntry(TicketEntry ticketEntry, boolean merge)
		throws SystemException {
		ticketEntry.setNew(false);

		return ticketEntryPersistence.update(ticketEntry, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TicketEntry",
	...
	private TicketEntryLocalServiceClpInvoker _clpInvoker = new TicketEntryLocalServiceClpInvoker();
}