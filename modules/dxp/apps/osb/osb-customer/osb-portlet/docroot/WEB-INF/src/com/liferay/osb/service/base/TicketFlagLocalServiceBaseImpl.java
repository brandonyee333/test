...
/**
 * Provides the base implementation for the ticket flag local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TicketFlagLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TicketFlagLocalServiceImpl
 * @see com.liferay.osb.service.TicketFlagLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TicketFlagLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TicketFlagLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TicketFlagLocalServiceUtil} to access the ticket flag local service.
	 */
	...
	public TicketFlag createTicketFlag(long ticketFlagId) {
		return ticketFlagPersistence.create(ticketFlagId);
	}
	...
	public TicketFlag deleteTicketFlag(long ticketFlagId)
		...
		return ticketFlagPersistence.remove(ticketFlagId);
	}
	...
	public TicketFlag deleteTicketFlag(TicketFlag ticketFlag) {
		return ticketFlagPersistence.remove(ticketFlag);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TicketFlag.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ticketFlagPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return ticketFlagPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ticketFlagPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public TicketFlag fetchTicketFlag(long ticketFlagId) {
		return ticketFlagPersistence.fetchByPrimaryKey(ticketFlagId);
	}
	...
	public TicketFlag getTicketFlag(long ticketFlagId)
		throws PortalException {
		return ticketFlagPersistence.findByPrimaryKey(ticketFlagId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ticketFlagLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TicketFlag.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ticketFlagId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ticketFlagLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TicketFlag.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ticketFlagLocalService.deleteTicketFlag((TicketFlag)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ticketFlagPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TicketFlag> getTicketFlags(int start, int end) {
		return ticketFlagPersistence.findAll(start, end);
	}
	...
	public int getTicketFlagsCount() {
		return ticketFlagPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TicketFlag",
	...
	public String getOSGiServiceIdentifier() {
		return TicketFlagLocalService.class.getName();
	}
	...
	private TicketFlagLocalServiceClpInvoker _clpInvoker = new TicketFlagLocalServiceClpInvoker();
}