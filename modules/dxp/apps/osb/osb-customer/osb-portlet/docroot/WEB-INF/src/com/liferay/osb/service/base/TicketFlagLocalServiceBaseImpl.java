...
/**
 * The base implementation of the ticket flag local service.
 *
 * <p>
...
public abstract class TicketFlagLocalServiceBaseImpl
	...
	public TicketFlag addTicketFlag(TicketFlag ticketFlag)
		...
		return ticketFlagPersistence.update(ticketFlag, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTicketFlagsCount() throws SystemException {
	...
	public TicketFlag updateTicketFlag(TicketFlag ticketFlag)
		throws SystemException {
		return updateTicketFlag(ticketFlag, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TicketFlag updateTicketFlag(TicketFlag ticketFlag, boolean merge)
		throws SystemException {
		ticketFlag.setNew(false);

		return ticketFlagPersistence.update(ticketFlag, merge);
	}
