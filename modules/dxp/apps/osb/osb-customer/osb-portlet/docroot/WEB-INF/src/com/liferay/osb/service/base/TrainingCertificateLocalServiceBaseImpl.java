...
/**
 * The base implementation of the training certificate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TrainingCertificateLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TrainingCertificateLocalServiceImpl
 * @see com.liferay.osb.service.TrainingCertificateLocalServiceUtil
 * @generated
 */
public abstract class TrainingCertificateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrainingCertificateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TrainingCertificateLocalServiceUtil} to access the training certificate local service.
	 */
	...
	public TrainingCertificate addTrainingCertificate(
		...
		return trainingCertificatePersistence.update(trainingCertificate, false);
	}
	 ...
	 */
	public TrainingCertificate createTrainingCertificate(
		long trainingCertificateId) {
		return trainingCertificatePersistence.create(trainingCertificateId);
	}
	...
	public TrainingCertificate deleteTrainingCertificate(
		long trainingCertificateId) throws PortalException, SystemException {
		return trainingCertificatePersistence.remove(trainingCertificateId);
	}
	...
	public TrainingCertificate deleteTrainingCertificate(
		TrainingCertificate trainingCertificate) throws SystemException {
		return trainingCertificatePersistence.remove(trainingCertificate);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TrainingCertificate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return trainingCertificatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trainingCertificatePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrainingCertificate fetchTrainingCertificate(
		long trainingCertificateId) throws SystemException {
		return trainingCertificatePersistence.fetchByPrimaryKey(trainingCertificateId);
	}
	...
	public TrainingCertificate getTrainingCertificate(
		long trainingCertificateId) throws PortalException, SystemException {
		return trainingCertificatePersistence.findByPrimaryKey(trainingCertificateId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trainingCertificatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrainingCertificate> getTrainingCertificates(int start, int end)
		throws SystemException {
		return trainingCertificatePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrainingCertificatesCount() throws SystemException {
		return trainingCertificatePersistence.countAll();
	}
	...
	public TrainingCertificate updateTrainingCertificate(
		TrainingCertificate trainingCertificate) throws SystemException {
		return updateTrainingCertificate(trainingCertificate, true);
	}
	...
	public TrainingCertificate updateTrainingCertificate(
		...
		return trainingCertificatePersistence.update(trainingCertificate, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TrainingCertificate",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trainingCertificatePersistence.getDataSource();
	...
	private TrainingCertificateLocalServiceClpInvoker _clpInvoker = new TrainingCertificateLocalServiceClpInvoker();
}