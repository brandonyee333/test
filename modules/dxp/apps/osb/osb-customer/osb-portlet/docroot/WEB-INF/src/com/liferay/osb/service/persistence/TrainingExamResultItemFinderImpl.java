 ...
 * @author Calvin Keum
 */
public class TrainingExamResultItemFinderImpl
	extends BasePersistenceImpl<AccountEntry>
		implements TrainingExamResultItemFinder {

	public static final String FILTER_BY_NO_SECTION_KEY =
		TrainingExamResultItemFinder.class.getName() + ".filterByNoSectionKey";
	...
	public List<TrainingExamResultItem> findByTrainingExamResultId(
		...
		try {
			...
			q.addEntity(
				"OSB_TrainingExamResultItem", TrainingExamResultItemImpl.class);
