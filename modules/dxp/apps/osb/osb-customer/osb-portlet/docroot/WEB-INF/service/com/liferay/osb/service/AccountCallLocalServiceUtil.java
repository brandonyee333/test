...
/**
 * The utility for the account call local service. This utility wraps {@link com.liferay.osb.service.impl.AccountCallLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.liferay.osb.service.base.AccountCallLocalServiceBaseImpl
 * @see com.liferay.osb.service.impl.AccountCallLocalServiceImpl
 * @generated
 */
public class AccountCallLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.service.impl.AccountCallLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.osb.model.AccountCall addAccountCall(
		com.liferay.osb.model.AccountCall accountCall)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addAccountCall(accountCall);
	}
	...
	*/
	public static com.liferay.osb.model.AccountCall createAccountCall(
		long accountCallId) {
		return getService().createAccountCall(accountCallId);
	}
	...
	*/
	public static com.liferay.osb.model.AccountCall deleteAccountCall(
		com.liferay.osb.model.AccountCall accountCall)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteAccountCall(accountCall);
	}
	...
	*/
	...
	public static com.liferay.osb.model.AccountCall fetchAccountCall(
		long accountCallId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchAccountCall(accountCallId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.osb.model.AccountCall getAccountCall(
		long accountCallId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getAccountCall(accountCallId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getAccountCallsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getAccountCallsCount();
	}
	...
	*/
	public static com.liferay.osb.model.AccountCall updateAccountCall(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateAccountCall(accountCall, merge);
	}
	...
	*/
	...
	public static AccountCallLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					AccountCallLocalService.class.getName());

			if (invokableLocalService instanceof AccountCallLocalService) {
				_service = (AccountCallLocalService)invokableLocalService;
			}
			else {
				_service = new AccountCallLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(AccountCallLocalServiceUtil.class,
				"_service");
		}
	 ...
	 * @deprecated
	 */
	public void setService(AccountCallLocalService service) {
	}

	private static AccountCallLocalService _service;
}