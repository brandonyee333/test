...
/**
 * The utility for the account environment remote service. This utility wraps {@link com.liferay.osb.service.impl.AccountEnvironmentServiceImpl} and is the primary access point for service operations in application layer code running on a remote server.
 *
 * <p>
...
public class AccountEnvironmentServiceUtil {
	...
	*/
	 ...
	 * @deprecated
	 */
	public void setService(AccountEnvironmentService service) {
	}

	private static AccountEnvironmentService _service;
}