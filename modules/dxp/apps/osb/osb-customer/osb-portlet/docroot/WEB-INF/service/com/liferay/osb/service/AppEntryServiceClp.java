 ...
 */
public class AppEntryServiceClp implements AppEntryService {
	public AppEntryServiceClp(InvokableService invokableService) {
		...
		_methodName4 = "addAppEntryMedia";

		_methodParameterTypes4 = new String[] {
				"long", "java.lang.String", "java.io.File"
			};

		_methodName5 = "buildLiferayPackage";

		_methodParameterTypes5 = new String[] {
				"com.liferay.osb.model.AppPackage", "boolean"
			};

		_methodName6 = "deleteAppEntry";

		_methodParameterTypes6 = new String[] { "long" };

		_methodName7 = "deleteAppEntryMedia";

		_methodParameterTypes7 = new String[] { "long", "long" };

		_methodName8 = "getAppEntry";

		_methodParameterTypes8 = new String[] { "long" };

		_methodName9 = "updateAppEntry";
	...
	public com.liferay.osb.model.AppEntry addAppEntry(long developerEntryId,
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					...
					ClpSerializer.translateInput(demoWebsite),
						
					ClpSerializer.translateInput(documentationWebsite),
						
					ClpSerializer.translateInput(referenceWebsite),
						
					ClpSerializer.translateInput(sourceCodeWebsite),
						
					ClpSerializer.translateInput(supportWebsite),
					...
					ClpSerializer.translateInput(changeLogMap),
						
					ClpSerializer.translateInput(iconFile),
						
					paclEnabled,
						
					ClpSerializer.translateInput(eulaContentMap),
						
					licenseType,
						
					ClpSerializer.translateInput(orderURL),
		...
		return (com.liferay.osb.model.AppEntry)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.io.File buildLiferayPackage(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName5,
					...
					new Object[] {
						ClpSerializer.translateInput(appPackage),
	...
	public com.liferay.osb.model.AppEntry deleteAppEntry(long appEntryId)
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName6,
					_methodParameterTypes6, new Object[] { appEntryId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void deleteAppEntryMedia(long appEntryId, long assetAttachmentId)
		...
		try {
			_invokableService.invokeMethod(_methodName7,
				...
				new Object[] { appEntryId, assetAttachmentId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.liferay.osb.model.AppEntry getAppEntry(long appEntryId)
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName8,
					_methodParameterTypes8, new Object[] { appEntryId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.liferay.osb.model.AppEntry updateAppEntry(long appEntryId,
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName9,
					...
					ClpSerializer.translateInput(standardQuantities),
						
					standardUnlimited,
						
					ClpSerializer.translateInput(developerQuantities),
