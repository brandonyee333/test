...
/**
 * The base implementation of the partner entry local service.
 *
 * <p>
...
public abstract class PartnerEntryLocalServiceBaseImpl
	...
	public PartnerEntry addPartnerEntry(PartnerEntry partnerEntry)
		...
		return partnerEntryPersistence.update(partnerEntry, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPartnerEntriesCount() throws SystemException {
	...
	public PartnerEntry updatePartnerEntry(PartnerEntry partnerEntry)
		throws SystemException {
		return updatePartnerEntry(partnerEntry, true);
	}
	...
	public PartnerEntry updatePartnerEntry(PartnerEntry partnerEntry,
		...
		return partnerEntryPersistence.update(partnerEntry, merge);
	}
	 ...
	 */
	public void addSupportRegionPartnerEntry(long supportRegionId,
		PartnerEntry partnerEntry) throws SystemException {
	...
	public void addSupportRegionPartnerEntries(long supportRegionId,
		long[] partnerEntryIds) throws SystemException {
	 ...
	 */
	public void addSupportRegionPartnerEntries(long supportRegionId,
		List<PartnerEntry> PartnerEntries) throws SystemException {
		supportRegionPersistence.addPartnerEntries(supportRegionId,
			PartnerEntries);
	}
