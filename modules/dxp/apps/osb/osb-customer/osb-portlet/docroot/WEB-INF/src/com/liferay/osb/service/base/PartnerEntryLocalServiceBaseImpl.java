...
/**
 * Provides the base implementation for the partner entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.PartnerEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.PartnerEntryLocalServiceImpl
 * @see com.liferay.osb.service.PartnerEntryLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class PartnerEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PartnerEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.PartnerEntryLocalServiceUtil} to access the partner entry local service.
	 */
	...
	public PartnerEntry addPartnerEntry(PartnerEntry partnerEntry) {
		...
		return partnerEntryPersistence.update(partnerEntry);
	}
	...
	public PartnerEntry createPartnerEntry(long partnerEntryId) {
		return partnerEntryPersistence.create(partnerEntryId);
	}
	...
	public PartnerEntry deletePartnerEntry(PartnerEntry partnerEntry) {
		return partnerEntryPersistence.remove(partnerEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PartnerEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return partnerEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return partnerEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public PartnerEntry fetchPartnerEntry(long partnerEntryId) {
		return partnerEntryPersistence.fetchByPrimaryKey(partnerEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(partnerEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PartnerEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("partnerEntryId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(partnerEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PartnerEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return partnerEntryLocalService.deletePartnerEntry((PartnerEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return partnerEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PartnerEntry> getPartnerEntries(int start, int end) {
		return partnerEntryPersistence.findAll(start, end);
	}
	...
	public int getPartnerEntriesCount() {
		return partnerEntryPersistence.countAll();
	}
	...
	public void addSupportRegionPartnerEntry(long supportRegionId,
		long partnerEntryId) {
		supportRegionPersistence.addPartnerEntry(supportRegionId, partnerEntryId);
	}
	...
	public void addSupportRegionPartnerEntry(long supportRegionId,
		...
		supportRegionPersistence.addPartnerEntry(supportRegionId, partnerEntry);
	}
	...
	public void addSupportRegionPartnerEntries(long supportRegionId,
		...
		supportRegionPersistence.addPartnerEntries(supportRegionId,
			partnerEntryIds);
	}
	...
	public void clearSupportRegionPartnerEntries(long supportRegionId) {
		supportRegionPersistence.clearPartnerEntries(supportRegionId);
	}
	...
	public void deleteSupportRegionPartnerEntry(long supportRegionId,
		long partnerEntryId) {
		supportRegionPersistence.removePartnerEntry(supportRegionId,
			partnerEntryId);
	}
	...
	public void deleteSupportRegionPartnerEntries(long supportRegionId,
		long[] partnerEntryIds) {
		supportRegionPersistence.removePartnerEntries(supportRegionId,
			partnerEntryIds);
	}
	...
	public long[] getSupportRegionPrimaryKeys(long partnerEntryId) {
		return partnerEntryPersistence.getSupportRegionPrimaryKeys(partnerEntryId);
	}
	...
	public List<PartnerEntry> getSupportRegionPartnerEntries(
		...
		return supportRegionPersistence.getPartnerEntries(supportRegionId);
	}
	...
	public int getSupportRegionPartnerEntriesCount(long supportRegionId) {
		return supportRegionPersistence.getPartnerEntriesSize(supportRegionId);
	}
	...
	public boolean hasSupportRegionPartnerEntry(long supportRegionId,
		long partnerEntryId) {
		return supportRegionPersistence.containsPartnerEntry(supportRegionId,
			partnerEntryId);
	}
	...
	public boolean hasSupportRegionPartnerEntries(long supportRegionId) {
		return supportRegionPersistence.containsPartnerEntries(supportRegionId);
	}
	...
	public void setSupportRegionPartnerEntries(long supportRegionId,
		long[] partnerEntryIds) {
		supportRegionPersistence.setPartnerEntries(supportRegionId,
			partnerEntryIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.PartnerEntry",
			partnerEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PartnerEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = partnerEntryPersistence.getDataSource();
	...
	private PartnerEntryLocalServiceClpInvoker _clpInvoker = new PartnerEntryLocalServiceClpInvoker();
}