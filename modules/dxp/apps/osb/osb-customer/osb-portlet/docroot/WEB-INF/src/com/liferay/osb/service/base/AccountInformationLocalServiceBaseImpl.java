...
/**
 * The base implementation of the account information local service.
 *
 * <p>
...
public abstract class AccountInformationLocalServiceBaseImpl
	...
	public AccountInformation addAccountInformation(
		...
		return accountInformationPersistence.update(accountInformation, false);
	}
	...
	public AccountInformation deleteAccountInformation(
		long accountInformationId) throws PortalException, SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccountInformationsCount() throws SystemException {
	...
	public AccountInformation updateAccountInformation(
		AccountInformation accountInformation) throws SystemException {
		return updateAccountInformation(accountInformation, true);
	}
	...
	public AccountInformation updateAccountInformation(
		...
		return accountInformationPersistence.update(accountInformation, merge);
	}
