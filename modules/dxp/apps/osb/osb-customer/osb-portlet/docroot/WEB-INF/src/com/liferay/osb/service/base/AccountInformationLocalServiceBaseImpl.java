...
/**
 * Provides the base implementation for the account information local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AccountInformationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AccountInformationLocalServiceImpl
 * @see com.liferay.osb.service.AccountInformationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AccountInformationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccountInformationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AccountInformationLocalServiceUtil} to access the account information local service.
	 */
	...
	@Override
	public AccountInformation addAccountInformation(
		AccountInformation accountInformation) {
		accountInformation.setNew(true);

		return accountInformationPersistence.update(accountInformation);
	}
	...
	public AccountInformation createAccountInformation(
		...
		return accountInformationPersistence.create(accountInformationId);
	}
	...
	@Override
	public AccountInformation deleteAccountInformation(
		long accountInformationId) throws PortalException {
		return accountInformationPersistence.remove(accountInformationId);
	}
	...
	public AccountInformation deleteAccountInformation(
		AccountInformation accountInformation) {
		return accountInformationPersistence.remove(accountInformation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccountInformation.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accountInformationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accountInformationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AccountInformation fetchAccountInformation(long accountInformationId) {
		return accountInformationPersistence.fetchByPrimaryKey(accountInformationId);
	}
	 ...
	 */
	@Override
	public AccountInformation getAccountInformation(long accountInformationId)
		throws PortalException {
		return accountInformationPersistence.findByPrimaryKey(accountInformationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accountInformationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccountInformation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accountInformationId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(accountInformationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccountInformation.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return accountInformationLocalService.deleteAccountInformation((AccountInformation)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return accountInformationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AccountInformation> getAccountInformations(int start, int end) {
		return accountInformationPersistence.findAll(start, end);
	}
	...
	public int getAccountInformationsCount() {
		return accountInformationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AccountInformation updateAccountInformation(
		AccountInformation accountInformation) {
		return accountInformationPersistence.update(accountInformation);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.AccountInformation",
			accountInformationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccountInformationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accountInformationPersistence.getDataSource();
	...
	private AccountInformationLocalServiceClpInvoker _clpInvoker = new AccountInformationLocalServiceClpInvoker();
}