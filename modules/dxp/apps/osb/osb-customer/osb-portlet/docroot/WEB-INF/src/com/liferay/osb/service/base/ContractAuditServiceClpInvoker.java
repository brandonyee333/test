...
public class ContractAuditServiceClpInvoker {
	public ContractAuditServiceClpInvoker() {
		...
		_methodName670 = "addContractAudit";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return ContractAuditServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			ContractAuditServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
