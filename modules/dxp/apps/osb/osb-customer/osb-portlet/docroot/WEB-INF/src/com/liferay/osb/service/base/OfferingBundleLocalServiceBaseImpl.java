...
/**
 * Provides the base implementation for the offering bundle local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.OfferingBundleLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.OfferingBundleLocalServiceImpl
 * @see com.liferay.osb.service.OfferingBundleLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class OfferingBundleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OfferingBundleLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.OfferingBundleLocalServiceUtil} to access the offering bundle local service.
	 */
	...
	public OfferingBundle addOfferingBundle(OfferingBundle offeringBundle) {
		...
		return offeringBundlePersistence.update(offeringBundle);
	}
	...
	public OfferingBundle createOfferingBundle(long offeringBundleId) {
		return offeringBundlePersistence.create(offeringBundleId);
	}
	...
	public OfferingBundle deleteOfferingBundle(long offeringBundleId)
		...
		return offeringBundlePersistence.remove(offeringBundleId);
	}
	...
	public OfferingBundle deleteOfferingBundle(OfferingBundle offeringBundle) {
		return offeringBundlePersistence.remove(offeringBundle);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OfferingBundle.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return offeringBundlePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return offeringBundlePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public OfferingBundle fetchOfferingBundle(long offeringBundleId) {
		return offeringBundlePersistence.fetchByPrimaryKey(offeringBundleId);
	}
	...
	public OfferingBundle getOfferingBundle(long offeringBundleId)
		throws PortalException {
		return offeringBundlePersistence.findByPrimaryKey(offeringBundleId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(offeringBundleLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(OfferingBundle.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("offeringBundleId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(offeringBundleLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(OfferingBundle.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return offeringBundleLocalService.deleteOfferingBundle((OfferingBundle)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return offeringBundlePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<OfferingBundle> getOfferingBundles(int start, int end) {
		return offeringBundlePersistence.findAll(start, end);
	}
	...
	public int getOfferingBundlesCount() {
		return offeringBundlePersistence.countAll();
	}
	...
	public void addOfferingDefinitionOfferingBundle(long offeringDefinitionId,
		...
		offeringDefinitionPersistence.addOfferingBundle(offeringDefinitionId,
			offeringBundleId);
	}
	...
	public void addOfferingDefinitionOfferingBundles(
		...
		offeringDefinitionPersistence.addOfferingBundles(offeringDefinitionId,
			offeringBundleIds);
	}
	...
	public void clearOfferingDefinitionOfferingBundles(
		...
		offeringDefinitionPersistence.clearOfferingBundles(offeringDefinitionId);
	}
	...
	public void deleteOfferingDefinitionOfferingBundle(
		...
		offeringDefinitionPersistence.removeOfferingBundle(offeringDefinitionId,
			offeringBundleId);
	}
	...
	public void deleteOfferingDefinitionOfferingBundles(
		long offeringDefinitionId, long[] offeringBundleIds) {
		offeringDefinitionPersistence.removeOfferingBundles(offeringDefinitionId,
			offeringBundleIds);
	}
	...
	public long[] getOfferingDefinitionPrimaryKeys(long offeringBundleId) {
		return offeringBundlePersistence.getOfferingDefinitionPrimaryKeys(offeringBundleId);
	}
	...
	public List<OfferingBundle> getOfferingDefinitionOfferingBundles(
		long offeringDefinitionId) {
		return offeringDefinitionPersistence.getOfferingBundles(offeringDefinitionId);
	}
	...
	public int getOfferingDefinitionOfferingBundlesCount(
		long offeringDefinitionId) {
		return offeringDefinitionPersistence.getOfferingBundlesSize(offeringDefinitionId);
	}
	...
	public boolean hasOfferingDefinitionOfferingBundle(
		long offeringDefinitionId, long offeringBundleId) {
		return offeringDefinitionPersistence.containsOfferingBundle(offeringDefinitionId,
			offeringBundleId);
	}
	...
	public boolean hasOfferingDefinitionOfferingBundles(
		long offeringDefinitionId) {
		return offeringDefinitionPersistence.containsOfferingBundles(offeringDefinitionId);
	}
	...
	public void setOfferingDefinitionOfferingBundles(
		long offeringDefinitionId, long[] offeringBundleIds) {
		offeringDefinitionPersistence.setOfferingBundles(offeringDefinitionId,
			offeringBundleIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.OfferingBundle",
			offeringBundleLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return OfferingBundleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = offeringBundlePersistence.getDataSource();
	...
	private OfferingBundleLocalServiceClpInvoker _clpInvoker = new OfferingBundleLocalServiceClpInvoker();
}