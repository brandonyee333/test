...
/**
 * The base implementation of the search filter local service.
 *
 * <p>
...
public abstract class SearchFilterLocalServiceBaseImpl
	...
	public SearchFilter addSearchFilter(SearchFilter searchFilter)
		...
		return searchFilterPersistence.update(searchFilter, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSearchFiltersCount() throws SystemException {
	...
	public SearchFilter updateSearchFilter(SearchFilter searchFilter)
		throws SystemException {
		return updateSearchFilter(searchFilter, true);
	}
	...
	public SearchFilter updateSearchFilter(SearchFilter searchFilter,
		...
		return searchFilterPersistence.update(searchFilter, merge);
	}
