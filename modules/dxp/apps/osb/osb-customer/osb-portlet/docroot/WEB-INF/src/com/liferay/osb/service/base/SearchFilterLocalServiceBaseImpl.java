...
/**
 * Provides the base implementation for the search filter local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.SearchFilterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.SearchFilterLocalServiceImpl
 * @see com.liferay.osb.service.SearchFilterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class SearchFilterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SearchFilterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.SearchFilterLocalServiceUtil} to access the search filter local service.
	 */
	...
	public SearchFilter createSearchFilter(long searchFilterId) {
		return searchFilterPersistence.create(searchFilterId);
	}
	...
	public SearchFilter deleteSearchFilter(long searchFilterId)
		...
		return searchFilterPersistence.remove(searchFilterId);
	}
	...
	public SearchFilter deleteSearchFilter(SearchFilter searchFilter) {
		return searchFilterPersistence.remove(searchFilter);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SearchFilter.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return searchFilterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return searchFilterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public SearchFilter fetchSearchFilter(long searchFilterId) {
		return searchFilterPersistence.fetchByPrimaryKey(searchFilterId);
	}
	...
	public SearchFilter getSearchFilter(long searchFilterId)
		throws PortalException {
		return searchFilterPersistence.findByPrimaryKey(searchFilterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(searchFilterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SearchFilter.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("searchFilterId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(searchFilterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SearchFilter.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return searchFilterLocalService.deleteSearchFilter((SearchFilter)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return searchFilterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SearchFilter> getSearchFilters(int start, int end) {
		return searchFilterPersistence.findAll(start, end);
	}
	...
	public int getSearchFiltersCount() {
		return searchFilterPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.SearchFilter",
			searchFilterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SearchFilterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = searchFilterPersistence.getDataSource();
	...
	private SearchFilterLocalServiceClpInvoker _clpInvoker = new SearchFilterLocalServiceClpInvoker();
}