...
/**
 * The base implementation of the offering entry local service.
 *
 * <p>
...
public abstract class OfferingEntryLocalServiceBaseImpl
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getOfferingEntriesCount() throws SystemException {
	...
	public OfferingEntry updateOfferingEntry(OfferingEntry offeringEntry)
		throws SystemException {
		return updateOfferingEntry(offeringEntry, true);
	}
	...
	public OfferingEntry updateOfferingEntry(OfferingEntry offeringEntry,
		...
		return offeringEntryPersistence.update(offeringEntry, merge);
	}
