...
/**
 * Provides the base implementation for the offering entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.OfferingEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.OfferingEntryLocalServiceImpl
 * @see com.liferay.osb.service.OfferingEntryLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class OfferingEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OfferingEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.OfferingEntryLocalServiceUtil} to access the offering entry local service.
	 */
	...
	public OfferingEntry createOfferingEntry(long offeringEntryId) {
		return offeringEntryPersistence.create(offeringEntryId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OfferingEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return offeringEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return offeringEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public OfferingEntry getOfferingEntry(long offeringEntryId)
		throws PortalException {
		return offeringEntryPersistence.findByPrimaryKey(offeringEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(offeringEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(OfferingEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("offeringEntryId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(offeringEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(OfferingEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return offeringEntryLocalService.deleteOfferingEntry((OfferingEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return offeringEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<OfferingEntry> getOfferingEntries(int start, int end) {
		return offeringEntryPersistence.findAll(start, end);
	}
	...
	public int getOfferingEntriesCount() {
		return offeringEntryPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.OfferingEntry",
			offeringEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return OfferingEntryLocalService.class.getName();
	}
	...
	private OfferingEntryLocalServiceClpInvoker _clpInvoker = new OfferingEntryLocalServiceClpInvoker();
}