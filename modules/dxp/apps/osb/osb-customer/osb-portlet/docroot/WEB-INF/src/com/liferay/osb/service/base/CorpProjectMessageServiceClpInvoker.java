...
public class CorpProjectMessageServiceClpInvoker {
	public CorpProjectMessageServiceClpInvoker() {
		...
		_methodName670 = "getCorpProjectMessages";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName664.equals(name) &&
			...
			return CorpProjectMessageServiceUtil.getBeanIdentifier();
		}

		if (_methodName665.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes665, parameterTypes)) {
			CorpProjectMessageServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
		...
		if (_methodName670.equals(name) &&
			...
			return CorpProjectMessageServiceUtil.getCorpProjectMessages(((Long)arguments[0]).longValue());
		}
