...
/**
 * The base implementation of the training event local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TrainingEventLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TrainingEventLocalServiceImpl
 * @see com.liferay.osb.service.TrainingEventLocalServiceUtil
 * @generated
 */
public abstract class TrainingEventLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrainingEventLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TrainingEventLocalServiceUtil} to access the training event local service.
	 */
	...
	public TrainingEvent addTrainingEvent(TrainingEvent trainingEvent)
		...
		return trainingEventPersistence.update(trainingEvent, false);
	}
	 ...
	 */
	public TrainingEvent createTrainingEvent(long trainingEventId) {
		return trainingEventPersistence.create(trainingEventId);
	}
	...
	public TrainingEvent deleteTrainingEvent(long trainingEventId)
		...
		return trainingEventPersistence.remove(trainingEventId);
	}
	...
	public TrainingEvent deleteTrainingEvent(TrainingEvent trainingEvent)
		throws PortalException, SystemException {
		return trainingEventPersistence.remove(trainingEvent);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TrainingEvent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return trainingEventPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trainingEventPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrainingEvent fetchTrainingEvent(long trainingEventId)
		throws SystemException {
		return trainingEventPersistence.fetchByPrimaryKey(trainingEventId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrainingEvent getTrainingEvent(long trainingEventId)
		throws PortalException, SystemException {
		return trainingEventPersistence.findByPrimaryKey(trainingEventId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trainingEventPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrainingEvent> getTrainingEvents(int start, int end)
		throws SystemException {
		return trainingEventPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrainingEventsCount() throws SystemException {
		return trainingEventPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TrainingEvent updateTrainingEvent(TrainingEvent trainingEvent)
		throws SystemException {
		return updateTrainingEvent(trainingEvent, true);
	}
	...
	public TrainingEvent updateTrainingEvent(TrainingEvent trainingEvent,
		...
		return trainingEventPersistence.update(trainingEvent, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TrainingEvent",
			trainingEventLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trainingEventPersistence.getDataSource();
	...
	private TrainingEventLocalServiceClpInvoker _clpInvoker = new TrainingEventLocalServiceClpInvoker();
}