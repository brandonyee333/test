...
/**
 * Provides the base implementation for the support labor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.SupportLaborLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.SupportLaborLocalServiceImpl
 * @see com.liferay.osb.service.SupportLaborLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class SupportLaborLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SupportLaborLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.SupportLaborLocalServiceUtil} to access the support labor local service.
	 */
	...
	public SupportLabor createSupportLabor(long supportLaborId) {
		return supportLaborPersistence.create(supportLaborId);
	}
	...
	public SupportLabor deleteSupportLabor(SupportLabor supportLabor) {
		return supportLaborPersistence.remove(supportLabor);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SupportLabor.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return supportLaborPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return supportLaborPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public SupportLabor fetchSupportLabor(long supportLaborId) {
		return supportLaborPersistence.fetchByPrimaryKey(supportLaborId);
	}
	...
	public SupportLabor getSupportLabor(long supportLaborId)
		throws PortalException {
		return supportLaborPersistence.findByPrimaryKey(supportLaborId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(supportLaborLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SupportLabor.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("supportLaborId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(supportLaborLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SupportLabor.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return supportLaborLocalService.deleteSupportLabor((SupportLabor)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return supportLaborPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SupportLabor> getSupportLabors(int start, int end) {
		return supportLaborPersistence.findAll(start, end);
	}
	...
	public int getSupportLaborsCount() {
		return supportLaborPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.SupportLabor",
	...
	public String getOSGiServiceIdentifier() {
		return SupportLaborLocalService.class.getName();
	}
	...
	private SupportLaborLocalServiceClpInvoker _clpInvoker = new SupportLaborLocalServiceClpInvoker();
}