...
import com.liferay.osb.NoSuchTicketCommentException;
...
public class TicketCommentPersistenceImpl extends BasePersistenceImpl<TicketComment>
	...
	public void cacheResult(TicketComment ticketComment) {
		EntityCacheUtil.putResult(TicketCommentModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache() {
		if (_HIBERNATE_CACHE_USE_SECOND_LEVEL_CACHE) {
			CacheRegistryUtil.clear(TicketCommentImpl.class.getName());
		}

		EntityCacheUtil.clearCache(TicketCommentImpl.class.getName());
	...
	public void clearCache(TicketComment ticketComment) {
		EntityCacheUtil.removeResult(TicketCommentModelImpl.ENTITY_CACHE_ENABLED,
			TicketCommentImpl.class, ticketComment.getPrimaryKey());
	...
	public TicketComment remove(long ticketCommentId)
		throws NoSuchTicketCommentException, SystemException {
		return remove(Long.valueOf(ticketCommentId));
	}
	...
	protected TicketComment removeImpl(TicketComment ticketComment)
		...
		try {
			...
			BatchSessionUtil.delete(session, ticketComment);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	@Override
	public TicketComment updateImpl(
		...
		try {
			...
			BatchSessionUtil.update(session, ticketComment, merge);
		...
		if (isNew || !TicketCommentModelImpl.COLUMN_BITMASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
			...
			if ((ticketCommentModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(ticketCommentModelImpl.getOriginalTicketEntryId())
					};
				...
				args = new Object[] {
						Long.valueOf(ticketCommentModelImpl.getTicketEntryId())
					};
			...
			if ((ticketCommentModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(ticketCommentModelImpl.getOriginalTicketEntryId()),
						Integer.valueOf(ticketCommentModelImpl.getOriginalType())
					};
				...
				args = new Object[] {
						Long.valueOf(ticketCommentModelImpl.getTicketEntryId()),
						Integer.valueOf(ticketCommentModelImpl.getType())
					};
			...
			if ((ticketCommentModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(ticketCommentModelImpl.getOriginalTicketEntryId()),
						Integer.valueOf(ticketCommentModelImpl.getOriginalVisibility()),
						Integer.valueOf(ticketCommentModelImpl.getOriginalStatus())
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_TEI_V_S, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_TEI_V_S,
					args);

				args = new Object[] {
						Long.valueOf(ticketCommentModelImpl.getTicketEntryId()),
						Integer.valueOf(ticketCommentModelImpl.getVisibility()),
						Integer.valueOf(ticketCommentModelImpl.getStatus())
					};
			...
			if ((ticketCommentModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(ticketCommentModelImpl.getOriginalUserId()),
						Long.valueOf(ticketCommentModelImpl.getOriginalTicketEntryId()),
						Integer.valueOf(ticketCommentModelImpl.getOriginalVisibility()),
						Integer.valueOf(ticketCommentModelImpl.getOriginalStatus())
					};
				...
				args = new Object[] {
						Long.valueOf(ticketCommentModelImpl.getUserId()),
						Long.valueOf(ticketCommentModelImpl.getTicketEntryId()),
						Integer.valueOf(ticketCommentModelImpl.getVisibility()),
						Integer.valueOf(ticketCommentModelImpl.getStatus())
					};
			...
			if ((ticketCommentModelImpl.getColumnBitmask() &
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_U_TEI_V_S_T,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_TEI_V_S_T,
					args);
	...
	/**
	 * Returns the ticket comment with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the ticket comment
	 * @return the ticket comment
	 * @throws com.liferay.portal.NoSuchModelException if a ticket comment with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	public TicketComment findByPrimaryKey(long ticketCommentId)
		throws NoSuchTicketCommentException, SystemException {
		TicketComment ticketComment = fetchByPrimaryKey(ticketCommentId);

		if (ticketComment == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + ticketCommentId);
			}
	...
	public TicketComment fetchByPrimaryKey(long ticketCommentId)
		throws SystemException {
		TicketComment ticketComment = (TicketComment)EntityCacheUtil.getResult(TicketCommentModelImpl.ENTITY_CACHE_ENABLED,
				TicketCommentImpl.class, ticketCommentId);

		if (ticketComment == _nullTicketComment) {
			return null;
		}
	...
	public List<TicketComment> findByTicketEntryId(long ticketEntryId,
		...
		List<TicketComment> list = (List<TicketComment>)FinderCacheUtil.getResult(finderPath,
				finderArgs, this);
	...
	public List<TicketComment> findByTEI_V_S(long ticketEntryId,
		int[] visibilities, int[] statuses, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_TEI_V_S;
		Object[] finderArgs = null;
		...
		if ((list != null) && !list.isEmpty()) {
			for (TicketComment ticketComment : list) {
				if ((ticketEntryId != ticketComment.getTicketEntryId()) ||
						...
						!ArrayUtil.contains(statuses, ticketComment.getStatus())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_TEI_V_S_TICKETENTRYID_5);
			...
			if ((visibilities == null) || (visibilities.length > 0)) {
				...
				for (int i = 0; i < visibilities.length; i++) {
					query.append(_FINDER_COLUMN_TEI_V_S_VISIBILITY_5);
			...
			if ((statuses == null) || (statuses.length > 0)) {
				...
				for (int i = 0; i < statuses.length; i++) {
					query.append(_FINDER_COLUMN_TEI_V_S_STATUS_5);
	...
	public List<TicketComment> findByU_TEI_V_S(long userId, long ticketEntryId,
		int[] visibilities, int[] statuses, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_U_TEI_V_S;
		Object[] finderArgs = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_U_TEI_V_S_USERID_5);
			...
			query.append(_FINDER_COLUMN_U_TEI_V_S_TICKETENTRYID_5);
			...
			if ((visibilities == null) || (visibilities.length > 0)) {
				...
				for (int i = 0; i < visibilities.length; i++) {
					query.append(_FINDER_COLUMN_U_TEI_V_S_VISIBILITY_5);
			...
			if ((statuses == null) || (statuses.length > 0)) {
				...
				for (int i = 0; i < statuses.length; i++) {
					query.append(_FINDER_COLUMN_U_TEI_V_S_STATUS_5);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TicketComment> findAll() throws SystemException {
	...
	public List<TicketComment> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_TICKETCOMMENT.concat(TicketCommentModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeByU_TEI_V_S_T(long userId, long ticketEntryId,
		int visibility, int status, int type) throws SystemException {
		for (TicketComment ticketComment : findByU_TEI_V_S_T(userId,
				ticketEntryId, visibility, status, type)) {
			remove(ticketComment);
		}
	}
	...
	public int countByTEI_V_S(long ticketEntryId, int visibility, int status)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_TEI_V_S,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_TEI_V_S,
					finderArgs, count);
	...
	public int countByTEI_V_S(long ticketEntryId, int[] visibilities,
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_TEI_V_S,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_TEI_V_S,
					finderArgs, count);
	...
	public int countByU_TEI_V_S(long userId, long ticketEntryId,
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_U_TEI_V_S,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_U_TEI_V_S,
					finderArgs, count);
	...
	public int countByU_TEI_V_S_T(long userId, long ticketEntryId,
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_U_TEI_V_S_T,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_U_TEI_V_S_T,
					finderArgs, count);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.osb.model.TicketComment")));

		if (listenerClassNames.length > 0) {
			try {
				List<ModelListener<TicketComment>> listenersList = new ArrayList<ModelListener<TicketComment>>();

				for (String listenerClassName : listenerClassNames) {
					Class<?> clazz = getClass();

					listenersList.add((ModelListener<TicketComment>)InstanceFactory.newInstance(
	...
	public void destroy() {
		EntityCacheUtil.removeCache(TicketCommentImpl.class.getName());
	...
	private static final String _FINDER_COLUMN_TEI_V_S_TICKETENTRYID_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_TEI_V_S_TICKETENTRYID_2) + ")";
	private static final String _FINDER_COLUMN_TEI_V_S_VISIBILITY_2 = "ticketComment.visibility = ? AND ";
	private static final String _FINDER_COLUMN_TEI_V_S_VISIBILITY_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_TEI_V_S_VISIBILITY_2) + ")";
	private static final String _FINDER_COLUMN_TEI_V_S_STATUS_2 = "ticketComment.status = ?";
	private static final String _FINDER_COLUMN_TEI_V_S_STATUS_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_TEI_V_S_STATUS_2) + ")";
	private static final String _FINDER_COLUMN_U_TEI_V_S_USERID_2 = "ticketComment.userId = ? AND ";
	private static final String _FINDER_COLUMN_U_TEI_V_S_USERID_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_U_TEI_V_S_USERID_2) + ")";
	private static final String _FINDER_COLUMN_U_TEI_V_S_TICKETENTRYID_2 = "ticketComment.ticketEntryId = ? AND ";
	private static final String _FINDER_COLUMN_U_TEI_V_S_TICKETENTRYID_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_U_TEI_V_S_TICKETENTRYID_2) + ")";
	private static final String _FINDER_COLUMN_U_TEI_V_S_VISIBILITY_2 = "ticketComment.visibility = ? AND ";
	private static final String _FINDER_COLUMN_U_TEI_V_S_VISIBILITY_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_U_TEI_V_S_VISIBILITY_2) + ")";
	private static final String _FINDER_COLUMN_U_TEI_V_S_STATUS_2 = "ticketComment.status = ?";
	private static final String _FINDER_COLUMN_U_TEI_V_S_STATUS_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_U_TEI_V_S_STATUS_2) + ")";
	...
	private static Log _log = LogFactoryUtil.getLog(TicketCommentPersistenceImpl.class);
	private static TicketComment _nullTicketComment = new TicketCommentImpl() {
			@Override
			public Object clone() {
				return this;
			}
			...
			public CacheModel<TicketComment> toCacheModel() {
				return _nullTicketCommentCacheModel;
			}
		};

	private static CacheModel<TicketComment> _nullTicketCommentCacheModel = new CacheModel<TicketComment>() {
			public TicketComment toEntityModel() {
				return _nullTicketComment;
			}
		};
}