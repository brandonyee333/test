...
/**
 * Provides the base implementation for the account customer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.AccountCustomerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.AccountCustomerLocalServiceImpl
 * @see com.liferay.osb.service.AccountCustomerLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AccountCustomerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccountCustomerLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.AccountCustomerLocalServiceUtil} to access the account customer local service.
	 */
	 ...
	 */
	@Override
	public AccountCustomer createAccountCustomer(long accountCustomerId) {
		return accountCustomerPersistence.create(accountCustomerId);
	}
	...
	@Override
	public AccountCustomer deleteAccountCustomer(long accountCustomerId)
		throws PortalException {
		return accountCustomerPersistence.remove(accountCustomerId);
	}
	...
	public AccountCustomer deleteAccountCustomer(
		...
		return accountCustomerPersistence.remove(accountCustomer);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccountCustomer.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accountCustomerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accountCustomerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AccountCustomer fetchAccountCustomer(long accountCustomerId) {
		return accountCustomerPersistence.fetchByPrimaryKey(accountCustomerId);
	}
	...
	public AccountCustomer getAccountCustomer(long accountCustomerId)
		throws PortalException {
		return accountCustomerPersistence.findByPrimaryKey(accountCustomerId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accountCustomerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccountCustomer.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accountCustomerId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(accountCustomerLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccountCustomer.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return accountCustomerLocalService.deleteAccountCustomer((AccountCustomer)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return accountCustomerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AccountCustomer> getAccountCustomers(int start, int end) {
		return accountCustomerPersistence.findAll(start, end);
	}
	...
	public int getAccountCustomersCount() {
		return accountCustomerPersistence.countAll();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accountCustomerPersistence.getDataSource();
