...
/**
 * The base implementation of the account customer local service.
 *
 * <p>
...
public abstract class AccountCustomerLocalServiceBaseImpl
	...
	public AccountCustomer addAccountCustomer(AccountCustomer accountCustomer)
		...
		return accountCustomerPersistence.update(accountCustomer, false);
	}
	...
	public AccountCustomer deleteAccountCustomer(
		AccountCustomer accountCustomer) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccountCustomersCount() throws SystemException {
	...
	public AccountCustomer updateAccountCustomer(
		AccountCustomer accountCustomer) throws SystemException {
		return updateAccountCustomer(accountCustomer, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public AccountCustomer updateAccountCustomer(
		AccountCustomer accountCustomer, boolean merge)
		throws SystemException {
		accountCustomer.setNew(false);

		return accountCustomerPersistence.update(accountCustomer, merge);
	}
