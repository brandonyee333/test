...
/**
 * The base implementation of the ticket call local service.
 *
 * <p>
...
public abstract class TicketCallLocalServiceBaseImpl
	...
	public TicketCall addTicketCall(TicketCall ticketCall)
		...
		return ticketCallPersistence.update(ticketCall, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTicketCallsCount() throws SystemException {
	...
	public TicketCall updateTicketCall(TicketCall ticketCall)
		throws SystemException {
		return updateTicketCall(ticketCall, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TicketCall updateTicketCall(TicketCall ticketCall, boolean merge)
		throws SystemException {
		ticketCall.setNew(false);

		return ticketCallPersistence.update(ticketCall, merge);
	}
