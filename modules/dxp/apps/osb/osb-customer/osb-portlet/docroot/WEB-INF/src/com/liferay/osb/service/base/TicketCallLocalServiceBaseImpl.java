...
/**
 * Provides the base implementation for the ticket call local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TicketCallLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TicketCallLocalServiceImpl
 * @see com.liferay.osb.service.TicketCallLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TicketCallLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TicketCallLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TicketCallLocalServiceUtil} to access the ticket call local service.
	 */
	...
	@Override
	public TicketCall addTicketCall(TicketCall ticketCall) {
		ticketCall.setNew(true);

		return ticketCallPersistence.update(ticketCall);
	}
	 ...
	 */
	@Override
	public TicketCall createTicketCall(long ticketCallId) {
		return ticketCallPersistence.create(ticketCallId);
	}
	...
	@Override
	public TicketCall deleteTicketCall(long ticketCallId)
		throws PortalException {
		return ticketCallPersistence.remove(ticketCallId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TicketCall deleteTicketCall(TicketCall ticketCall) {
		return ticketCallPersistence.remove(ticketCall);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TicketCall.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ticketCallPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return ticketCallPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ticketCallPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TicketCall fetchTicketCall(long ticketCallId) {
		return ticketCallPersistence.fetchByPrimaryKey(ticketCallId);
	}
	 ...
	 */
	@Override
	public TicketCall getTicketCall(long ticketCallId)
		throws PortalException {
		return ticketCallPersistence.findByPrimaryKey(ticketCallId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ticketCallLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TicketCall.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ticketCallId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ticketCallLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TicketCall.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ticketCallLocalService.deleteTicketCall((TicketCall)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ticketCallPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TicketCall> getTicketCalls(int start, int end) {
		return ticketCallPersistence.findAll(start, end);
	}
	...
	public int getTicketCallsCount() {
		return ticketCallPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TicketCall updateTicketCall(TicketCall ticketCall) {
		return ticketCallPersistence.update(ticketCall);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TicketCall",
			ticketCallLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.osb.model.TicketCall");
	}
	...
	public String getOSGiServiceIdentifier() {
		return TicketCallLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ticketCallPersistence.getDataSource();
	...
	private TicketCallLocalServiceClpInvoker _clpInvoker = new TicketCallLocalServiceClpInvoker();
}