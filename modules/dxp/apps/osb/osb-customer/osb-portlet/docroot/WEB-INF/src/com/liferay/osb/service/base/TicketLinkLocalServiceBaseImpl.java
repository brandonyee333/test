...
/**
 * The base implementation of the ticket link local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.TicketLinkLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.TicketLinkLocalServiceImpl
 * @see com.liferay.osb.service.TicketLinkLocalServiceUtil
 * @generated
 */
public abstract class TicketLinkLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TicketLinkLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.TicketLinkLocalServiceUtil} to access the ticket link local service.
	 */
	...
	public TicketLink addTicketLink(TicketLink ticketLink)
		...
		return ticketLinkPersistence.update(ticketLink, false);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TicketLink.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return ticketLinkPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTicketLinksCount() throws SystemException {
	...
	public TicketLink updateTicketLink(TicketLink ticketLink)
		throws SystemException {
		return updateTicketLink(ticketLink, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TicketLink updateTicketLink(TicketLink ticketLink, boolean merge)
		throws SystemException {
		ticketLink.setNew(false);

		return ticketLinkPersistence.update(ticketLink, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.TicketLink",
	...
	private TicketLinkLocalServiceClpInvoker _clpInvoker = new TicketLinkLocalServiceClpInvoker();
}