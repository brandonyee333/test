...
/**
 * Provides the base implementation for the corp project message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.CorpProjectMessageLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.CorpProjectMessageLocalServiceImpl
 * @see com.liferay.osb.service.CorpProjectMessageLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CorpProjectMessageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CorpProjectMessageLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.CorpProjectMessageLocalServiceUtil} to access the corp project message local service.
	 */
	 ...
	 */
	@Override
	public CorpProjectMessage createCorpProjectMessage(
		long corpProjectMessageId) {
		return corpProjectMessagePersistence.create(corpProjectMessageId);
	}
	...
	public CorpProjectMessage deleteCorpProjectMessage(
		CorpProjectMessage corpProjectMessage) {
		return corpProjectMessagePersistence.remove(corpProjectMessage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CorpProjectMessage.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return corpProjectMessagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return corpProjectMessagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public CorpProjectMessage fetchCorpProjectMessage(long corpProjectMessageId) {
		return corpProjectMessagePersistence.fetchByPrimaryKey(corpProjectMessageId);
	}
	...
	public CorpProjectMessage getCorpProjectMessage(long corpProjectMessageId)
		...
		return corpProjectMessagePersistence.findByPrimaryKey(corpProjectMessageId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(corpProjectMessageLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CorpProjectMessage.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("corpProjectMessageId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(corpProjectMessageLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CorpProjectMessage.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return corpProjectMessageLocalService.deleteCorpProjectMessage((CorpProjectMessage)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return corpProjectMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CorpProjectMessage> getCorpProjectMessages(int start, int end) {
		return corpProjectMessagePersistence.findAll(start, end);
	}
	...
	public int getCorpProjectMessagesCount() {
		return corpProjectMessagePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.osb.model.CorpProjectMessage",
			corpProjectMessageLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CorpProjectMessageLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = corpProjectMessagePersistence.getDataSource();
	...
	private CorpProjectMessageLocalServiceClpInvoker _clpInvoker = new CorpProjectMessageLocalServiceClpInvoker();
}