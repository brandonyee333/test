...
/**
 * Provides the base implementation for the offering definition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.service.impl.OfferingDefinitionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.service.impl.OfferingDefinitionLocalServiceImpl
 * @see com.liferay.osb.service.OfferingDefinitionLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class OfferingDefinitionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OfferingDefinitionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.service.OfferingDefinitionLocalServiceUtil} to access the offering definition local service.
	 */
	...
	public OfferingDefinition createOfferingDefinition(
		...
		return offeringDefinitionPersistence.create(offeringDefinitionId);
	}
	...
	public OfferingDefinition deleteOfferingDefinition(
		OfferingDefinition offeringDefinition) {
		return offeringDefinitionPersistence.remove(offeringDefinition);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OfferingDefinition.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return offeringDefinitionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return offeringDefinitionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public OfferingDefinition fetchOfferingDefinition(long offeringDefinitionId) {
		return offeringDefinitionPersistence.fetchByPrimaryKey(offeringDefinitionId);
	}
	...
	public OfferingDefinition getOfferingDefinition(long offeringDefinitionId)
		...
		return offeringDefinitionPersistence.findByPrimaryKey(offeringDefinitionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(offeringDefinitionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(OfferingDefinition.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("offeringDefinitionId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(offeringDefinitionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(OfferingDefinition.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return offeringDefinitionLocalService.deleteOfferingDefinition((OfferingDefinition)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return offeringDefinitionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public void addOfferingBundleOfferingDefinition(long offeringBundleId,
		long offeringDefinitionId) {
		offeringBundlePersistence.addOfferingDefinition(offeringBundleId,
			offeringDefinitionId);
	}
	...
	public void addOfferingBundleOfferingDefinitions(long offeringBundleId,
		...
		offeringBundlePersistence.addOfferingDefinitions(offeringBundleId,
	...
	public void clearOfferingBundleOfferingDefinitions(long offeringBundleId) {
		offeringBundlePersistence.clearOfferingDefinitions(offeringBundleId);
	}
	...
	public void deleteOfferingBundleOfferingDefinition(long offeringBundleId,
		long offeringDefinitionId) {
		offeringBundlePersistence.removeOfferingDefinition(offeringBundleId,
			offeringDefinitionId);
	}
	...
	public void deleteOfferingBundleOfferingDefinitions(long offeringBundleId,
		long[] offeringDefinitionIds) {
		offeringBundlePersistence.removeOfferingDefinitions(offeringBundleId,
			offeringDefinitionIds);
	}
	...
	public long[] getOfferingBundlePrimaryKeys(long offeringDefinitionId) {
		return offeringDefinitionPersistence.getOfferingBundlePrimaryKeys(offeringDefinitionId);
	}
	...
	public List<OfferingDefinition> getOfferingBundleOfferingDefinitions(
		...
		return offeringBundlePersistence.getOfferingDefinitions(offeringBundleId);
	}
	...
	public int getOfferingBundleOfferingDefinitionsCount(long offeringBundleId) {
		return offeringBundlePersistence.getOfferingDefinitionsSize(offeringBundleId);
	}
	...
	public boolean hasOfferingBundleOfferingDefinition(long offeringBundleId,
		long offeringDefinitionId) {
		return offeringBundlePersistence.containsOfferingDefinition(offeringBundleId,
			offeringDefinitionId);
	}
	...
	public boolean hasOfferingBundleOfferingDefinitions(long offeringBundleId) {
		return offeringBundlePersistence.containsOfferingDefinitions(offeringBundleId);
	}
	...
	public void setOfferingBundleOfferingDefinitions(long offeringBundleId,
		long[] offeringDefinitionIds) {
		offeringBundlePersistence.setOfferingDefinitions(offeringBundleId,
			offeringDefinitionIds);
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = offeringDefinitionPersistence.getDataSource();
