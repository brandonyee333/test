...
/**
 * The base implementation of the offering definition local service.
 *
 * <p>
...
public abstract class OfferingDefinitionLocalServiceBaseImpl
	...
	public OfferingDefinition addOfferingDefinition(
		...
		return offeringDefinitionPersistence.update(offeringDefinition, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getOfferingDefinitionsCount() throws SystemException {
	...
	public OfferingDefinition updateOfferingDefinition(
		OfferingDefinition offeringDefinition) throws SystemException {
		return updateOfferingDefinition(offeringDefinition, true);
	}
	...
	public OfferingDefinition updateOfferingDefinition(
		...
		return offeringDefinitionPersistence.update(offeringDefinition, merge);
	}
	...
	public void addOfferingBundleOfferingDefinitions(long offeringBundleId,
		long[] offeringDefinitionIds) throws SystemException {
	 ...
	 */
	public void addOfferingBundleOfferingDefinitions(long offeringBundleId,
		List<OfferingDefinition> OfferingDefinitions) throws SystemException {
		offeringBundlePersistence.addOfferingDefinitions(offeringBundleId,
			OfferingDefinitions);
	}
	 ...
	 */
	public List<OfferingDefinition> getOfferingBundleOfferingDefinitions(
		long offeringBundleId, int start, int end) throws SystemException {
		return offeringBundlePersistence.getOfferingDefinitions(offeringBundleId,
			start, end);
	}
