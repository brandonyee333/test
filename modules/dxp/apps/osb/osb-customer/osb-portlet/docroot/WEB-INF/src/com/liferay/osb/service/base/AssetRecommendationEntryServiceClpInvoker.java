 ...
 */
public class AssetRecommendationEntryServiceClpInvoker {
	public AssetRecommendationEntryServiceClpInvoker() {
		...
		_methodName676 = "getAssetRecommendationEntries";

		_methodParameterTypes676 = new String[] { "long", "int", "int", "int" };
	}
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName670.equals(name) &&
			...
			return AssetRecommendationEntryServiceUtil.getBeanIdentifier();
		}

		if (_methodName671.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes671, parameterTypes)) {
			AssetRecommendationEntryServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
		...
		if (_methodName676.equals(name) &&
			...
			return AssetRecommendationEntryServiceUtil.getAssetRecommendationEntries(((Long)arguments[0]).longValue(),
