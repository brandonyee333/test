...
<liferay-ui:tabs
	names="teams,support-regions,canned-responses,holidays,labor-hours,support-worker-statuses"
	param="tabs2"
	url="<%= portletURL.toString() %>"
/>

<c:choose>
	<c:when test='<%= tabs2.equals("canned-responses") %>'>
		<%@ include file="/admin/support_ticket_canned_responses.jspf" %>
	</c:when>
	<c:when test='<%= tabs2.equals("holidays") %>'>
		<%@ include file="/admin/holidays.jspf" %>
	</c:when>
