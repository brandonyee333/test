...
<div class="marketplace-registration-wrapper">
	...
	<p>
		<liferay-ui:message arguments="<%= OSBConstants.MARKETPLACE_FAX_NUMBER %>" key="thank-you-for-submitting-a-request-to-have-your-company-represented-on-the-liferay-marketplace" />
	</p>
	...
	<aui:button onClick="<%= marketplaceURL %>" value="go-to-marketplace" />
</div>