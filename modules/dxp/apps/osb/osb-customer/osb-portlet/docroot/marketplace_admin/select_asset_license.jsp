...
portletURL.setParameter("mvcPath", "/marketplace_admin/select_asset_license.jsp");
portletURL.setParameter("assetReceiptId", String.valueOf(assetReceiptId));
%>

<aui:form method="post" name="fm">
	<liferay-ui:tabs names="licenses" />

	<liferay-ui:search-container
		emptyResultsMessage="no-licenses-were-found"
	>
		<liferay-ui:search-container-results
			results="<%= assetLicenses %>"
			total="<%= assetLicenses.size() %>"
		/>

		<liferay-ui:search-container-row
			className="com.liferay.osb.model.AssetLicense"
			escapedModel="<%= true %>"
			keyProperty="assetLicenseId"
			modelVar="assetLicense"
		>
