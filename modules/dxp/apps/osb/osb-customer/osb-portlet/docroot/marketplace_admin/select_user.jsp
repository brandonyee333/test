...
long userParamValue = ParamUtil.getLong(request, userParam);

String callback = ParamUtil.getString(request, "callback");

PortletURL portletURL = renderResponse.createRenderURL();

portletURL.setParameter("mvcPath", "/marketplace_admin/select_user.jsp");
portletURL.setParameter("userParam", userParam);

if (Validator.isNotNull(userParam)) {
	portletURL.setParameter(userParam, String.valueOf(userParamValue));
}
...
<aui:form action="<%= portletURL.toString() %>" method="post" name="fm" onSubmit="submitForm(this); return false;">
	<div class="unit">
		<div class="unit-content">
			...
			if (userParam.equals("corpProjectId")) {
				userParams.put(userParam, new CustomSQLParam(CustomSQLUtil.get("com.liferay.portal.service.persistence.UserFinder.joinByCorpProject"), userParamValue));
			}
			%>
