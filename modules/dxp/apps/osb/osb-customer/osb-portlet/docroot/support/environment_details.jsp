...
<portlet:actionURL name="updateAccountEnvironment" var="updateAccountEnvironmentURL">
	<portlet:param name="mvcPath" value="/support/environment_details.jsp" />
</portlet:actionURL>
...
<aui:script>
	function <portlet:namespace />selectAccountEnvironment() {
		var selectAccountEnvironmentURL = '<portlet:renderURL><portlet:param name="mvcPath" value="/support/view.jsp" /><portlet:param name="tabs1" value="environment-details" /></portlet:renderURL>';
