...
@Component(
	immediate = true,
	property = {
		"com.liferay.portlet.css-class-wrapper=osb-portal-side-navigation-portlet",
		"com.liferay.portlet.display-category=category.osb",
		"com.liferay.portlet.header-portlet-css=/side_navigation/css/main.css",
		"javax.portlet.display-name=OSB Portal Side Navigation",
		...
		"javax.portlet.name=" + OSBCustomerPortalPortletKeys.SIDE_NAVIGATION,
