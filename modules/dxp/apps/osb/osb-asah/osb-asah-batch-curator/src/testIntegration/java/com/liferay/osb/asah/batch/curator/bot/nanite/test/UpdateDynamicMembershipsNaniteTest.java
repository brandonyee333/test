...
public class UpdateDynamicMembershipsNaniteTest extends BaseNaniteTestCase {
	...
	public void testBehavioralCriteria() throws Exception {
		...
		String individualSegmentId = _updateDynamicMemberships(
			"(((activities/ever eq 'Page#pageViewed#" +
				assetJSONObject.getString("id") + "')))");

		String individual1Id = individual1JSONObject.getString("id");
	...
	public void testRemoveMembershipsWithDifferentChannel() throws Exception {
		...
		individualSegmentJSONObject = faroInfoElasticsearchInvoker.add(
			"individual-segments",
		...
		Assert.assertEquals(
			individualSegmentIndividualIds.toString(), 1,
	...
	private String _updateDynamicMemberships(String filter) throws Exception {
		JSONObject individualSegmentJSONObject =
			faroInfoElasticsearchInvoker.add(
				"individual-segments",
				FaroInfoTestUtil.buildDynamicIndividualSegmentJSONObject(
		...
		return individualSegmentJSONObject.getString("id");
	}
