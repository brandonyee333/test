...
INSERT INTO BQEvent (id, channelId, eventDate, eventId, sessionId, title, userId) VALUES (2004, 1, timestamp '${now-15d}', 'test', '4', 'Test', '1');
INSERT INTO BQEvent (id, channelId, eventDate, eventId, sessionId, title, userId) VALUES (2005, 1, timestamp '${now-14d}', 'test', '5', 'Test', '1');
INSERT INTO BQEvent (id, channelId, eventDate, eventId, sessionId, title, userId) VALUES (2006, 1, timestamp '${now-13d}', 'test', '6', 'Test', '1');
INSERT INTO BQEvent (id, channelId, eventDate, eventId, sessionId, title, userId) VALUES (2007, 1, timestamp '${now-12d}', 'test', '7', 'Test', '1');
INSERT INTO BQEvent (id, channelId, eventDate, eventId, sessionId, title, userId) VALUES (2008, 1, timestamp '${now-11d}', 'test', '8', 'Test', '1');
INSERT INTO BQEvent (id, channelId, eventDate, eventId, sessionId, title, userId) VALUES (2009, 1, timestamp '${now-10d}', 'test', '9', 'Test', '1');
