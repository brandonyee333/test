...
INSERT INTO Event (applicationId, channelId, createDate, eventDate, eventId, id, userId) VALUES ('Blog', 2, timestamp '${now-11d}', timestamp '${now-11d}', 'blogClicked', '3', '3');
...
INSERT INTO IdentityActivitySummary (channelId, identityId, individualId, lastActivityDate) VALUES (2, 'efg-789', '5f20f61b2cfaa86c4f3cb3557751a702776af029deabed8e943fb55cfa604e34', timestamp '${now-11d}');
...
INSERT INTO Individual (emailAddress, fields, id, memberships) VALUES ('marcus@beta.com', ARRAY[STRUCT(123, 'classPK', '41848'), STRUCT(123, 'osbAsahDataSourceId', '123'), STRUCT(123, 'Organization', 'Engineer')], '5970d88ec4ed505177361de1b17a3f2debf7c4f630c14f075a823ec97942692a', ARRAY[STRUCT(['23k92323l923lf0as'], 'groupIds')]);
INSERT INTO Individual (emailAddress, fields, id, memberships) VALUES ('nina@delta.com', ARRAY[STRUCT(123, 'classPK', '41849'), STRUCT(123, 'osbAsahDataSourceId', '123'), STRUCT(123, 'Organization', 'Developer')], '5f20f61b2cfaa86c4f3cb3557751a702776af029deabed8e943fb55cfa604e34', ARRAY[STRUCT(['23k92323l923lf0as'], 'userGroupIds')]);