...
INSERT INTO Membership (channelId, createDate, identityId, individualId, modifiedDate, segmentId, status) VALUES (34, timestamp '${now}', '11', '12', timestamp '${now}', 34, 'ACTIVE');
INSERT INTO Membership (channelId, createDate, identityId, individualId, modifiedDate, segmentId, status) VALUES (34, timestamp '${now}', '12', '12', timestamp '${now}', 34, 'ACTIVE');
INSERT INTO Membership (channelId, createDate, identityId, individualId, modifiedDate, segmentId, status) VALUES (56, timestamp '${now}', '12', '12', timestamp '${now}', 56, 'INACTIVE');
INSERT INTO Membership (channelId, createDate, identityId, individualId, modifiedDate, segmentId, status) VALUES (34, timestamp '${now}', '78', '78', timestamp '${now}', 34, 'ACTIVE');
