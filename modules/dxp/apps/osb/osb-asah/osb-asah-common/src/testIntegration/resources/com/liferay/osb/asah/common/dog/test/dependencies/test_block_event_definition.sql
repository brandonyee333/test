...
INSERT INTO Event (id, channelId, eventDate, eventDefinitionId) VALUES (1000, (SELECT id from Channel WHERE name='testChannelName'), '2021-04-19 00:00:00-00', (SELECT id from EventDefinition WHERE name='subscribed'));
INSERT INTO Event (id, channelId, eventDate, eventDefinitionId) VALUES (1001, (SELECT id from Channel WHERE name='testChannelName'), '2021-04-19 12:35:00-00', (SELECT id from EventDefinition WHERE name='subscribed'));
