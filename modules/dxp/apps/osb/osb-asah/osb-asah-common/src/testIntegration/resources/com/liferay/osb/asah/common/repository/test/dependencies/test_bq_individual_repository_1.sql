...
INSERT INTO Individual (emailAddress, fields, firstName, id, jobTitle, memberships) VALUES ('joe@alpha.com', ARRAY[STRUCT(123, 'classPK', '41847'), STRUCT(123, 'osbAsahDataSourceId', '123'), STRUCT(123, 'Organization', 'Developer')], 'Joe','761319ac0d9f6e0f3467ad26bc8c63989d06c5f491849d6aa12fabdbd6c6b7bb', '', ARRAY[STRUCT(['23k92323l923lf0as'], 'organizationIds')]);
INSERT INTO Individual (emailAddress, fields, firstName, id, jobTitle, memberships) VALUES ('marcus@beta.com', ARRAY[STRUCT(123, 'classPK', '41848'), STRUCT(123, 'osbAsahDataSourceId', '123'), STRUCT(123, 'Organization', 'Engineer')], 'Marcus', '5970d88ec4ed505177361de1b17a3f2debf7c4f630c14f075a823ec97942692a', 'Engineer', ARRAY[STRUCT(['9823423jh23908234'], 'groupIds')]);
