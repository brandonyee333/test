 ...
 */
public class ItemGetResponse extends BaseGetResponse {

	@Override
	public String respond() throws Exception {
		JSONObject responseJSONObject = elasticsearchInvoker.get(
			collectionName, _id);

		if (_embeddedJSONObjectCreator != null) {
			responseJSONObject.put(
				"_embedded", _embeddedJSONObjectCreator.create(_id));
		}
