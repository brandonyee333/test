...
import com.liferay.osb.asah.stream.curator.bot.nanite.journal.click.JournalClickNanite;
...
public class JournalNaniteTest extends BaseNaniteTestCase {
	...
	@Test
	public void testJournalClickNanite() throws Exception {
		test(JournalClickNanite.class);
	}
