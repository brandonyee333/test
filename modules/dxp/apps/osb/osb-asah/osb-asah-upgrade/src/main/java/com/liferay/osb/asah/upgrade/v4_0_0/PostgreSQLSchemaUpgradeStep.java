 ...
 */
@Component
public class PostgreSQLSchemaUpgradeStep implements UpgradeStep {
	...
	public void upgrade(String version) {
		try {
			...
			if (_log.isInfoEnabled()) {
				_log.info("PostgreSQL successfully upgraded to schema 4.0.0");
			}
		}
	...
	private static final Log _log = LogFactory.getLog(
		PostgreSQLSchemaUpgradeStep.class);
