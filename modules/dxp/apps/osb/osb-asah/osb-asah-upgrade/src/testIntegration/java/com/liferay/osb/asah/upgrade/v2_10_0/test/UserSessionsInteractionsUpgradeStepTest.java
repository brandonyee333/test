...
package com.liferay.osb.asah.upgrade.v2_10_0.test;
...
public class UserSessionsInteractionsUpgradeStepTest {
	...
	public void testUpgrade() throws Exception {
		...
		_userSessionsInteractionsUpgradeStep.upgrade("");

		_elasticsearchInvoker.refresh();

		JSONAssert.assertEquals(
			ResourceUtil.readResourceToJSONArray(
				"dependencies/expected_user_sessions.json", this),
			_elasticsearchInvoker.get("user-sessions"), false);
	}
