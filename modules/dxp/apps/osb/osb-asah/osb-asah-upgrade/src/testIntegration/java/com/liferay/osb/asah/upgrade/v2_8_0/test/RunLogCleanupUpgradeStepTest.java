...
public class RunLogCleanupUpgradeStepTest {
	...
	public void testUpgrade() throws Exception {
		_runLogCleanupUpgradeStep.upgrade("");

		_elasticsearchInvoker.refresh();

		JSONAssert.assertEquals(
			ResourceUtil.readResourceToJSONArray(
				"dependencies/expected_run_logs.json", this),
			_elasticsearchInvoker.get("run-logs"), false);
	}
