...
INSERT INTO DocumentLibrary (assetId, channelId, eventDate, individualId, previews, projectId, segmentNames) VALUES ('e131fabc', 1, date_trunc('HOUR', timestamp '${today-1h}'), 3, 5, 'test', ARRAY []);
