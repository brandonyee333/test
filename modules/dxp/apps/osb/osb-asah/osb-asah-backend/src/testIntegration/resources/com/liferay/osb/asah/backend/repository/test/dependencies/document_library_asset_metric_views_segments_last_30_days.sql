...
INSERT INTO DocumentLibrary (assetId, channelId, eventDate, individualId, previews, projectId, segmentNames) VALUES ('e131fabc', 1, date_trunc('HOUR', timestamp '${now-20h}'), 3, 5, 'test', ARRAY []);
