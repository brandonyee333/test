...
INSERT INTO Form (assetId, channelId, eventDate, projectId, canonicalUrl) VALUES ('e131fabc', 1, date_trunc('HOUR', timestamp '${today-4h}'), 'test', 'https://www.beryl.com/products/commercial/irrigation');
INSERT INTO Form (assetId, channelId, eventDate, projectId, canonicalUrl) VALUES ('e131fabc', 1, date_trunc('HOUR', timestamp '${today-6h}'), 'test', 'https://www.beryl.com/delivery');