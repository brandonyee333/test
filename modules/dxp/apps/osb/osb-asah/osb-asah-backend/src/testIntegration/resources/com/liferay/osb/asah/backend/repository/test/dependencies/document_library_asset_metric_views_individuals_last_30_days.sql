...
INSERT INTO DocumentLibrary (assetId, channelId, eventDate, individualId, knownIndividual, previews, projectId) VALUES ('e131fabc', 1, date_trunc('HOUR', timestamp '${today-1h}'), 3, true, 5, 'test');
