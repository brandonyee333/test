...
INSERT INTO DocumentLibrary (assetId, channelId, eventDate, individualId, knownIndividual, previews, projectId) VALUES ('e131fabc', 1, date_trunc('HOUR', timestamp '${now-20h}'), 3, true, 5, 'test');
