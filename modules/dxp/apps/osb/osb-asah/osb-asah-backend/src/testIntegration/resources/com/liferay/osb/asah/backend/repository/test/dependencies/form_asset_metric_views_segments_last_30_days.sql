...
INSERT INTO Form (assetId, channelId, eventDate, individualId, projectId, segmentNames, views) VALUES ('e131fabc', 1, date_trunc('HOUR', timestamp '${now-20h}'), 3, 'test', ARRAY [], 5);
