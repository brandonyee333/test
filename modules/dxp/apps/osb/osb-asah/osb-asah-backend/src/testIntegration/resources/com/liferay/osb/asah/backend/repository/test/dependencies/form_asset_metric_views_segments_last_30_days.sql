...
INSERT INTO Form (assetId, channelId, eventDate, individualId, projectId, segmentNames, views) VALUES ('e131fabc', 1, date_trunc('HOUR', timestamp '${today-1h}'), 3, 'test', ARRAY [], 5);
