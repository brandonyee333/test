...
INSERT INTO DocumentLibrary (assetId, browserName, channelId, eventDate, projectId, previews) VALUES ('e131fabc', 'Firefox', 1, date_trunc('HOUR', timestamp '${today-1h}'), 'test', 5);
