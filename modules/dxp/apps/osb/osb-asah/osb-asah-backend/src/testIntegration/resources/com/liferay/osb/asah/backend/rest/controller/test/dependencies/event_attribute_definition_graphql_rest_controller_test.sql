...
INSERT INTO Event(analyticsEventId, applicationId, channelId, createDate, dataSourceId, eventDate, eventDefinitionId, userId) VALUES ('analyticsEventId1', 'Custom', (SELECT id from Channel WHERE name='testChannelName'), '2021-03-03 18:12:00-07', 1, '2021-03-03 18:12:00-00', (SELECT id from EventDefinition WHERE name='addedToCart'), 'userId1');
INSERT INTO Event(analyticsEventId, applicationId, channelId, createDate, dataSourceId, eventDate, eventDefinitionId, userId) VALUES ('analyticsEventId2', 'Custom', (SELECT id from Channel WHERE name='testChannelName'), '2021-03-03 18:12:12-07', 1, '2021-03-03 18:12:12-00', (SELECT id from EventDefinition WHERE name='addedToCart'), 'userId2');
