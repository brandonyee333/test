...
public class SitesSyncDetailDataFetcher
	extends BaseDataFetcher<DataSourceDTO.ProviderDTO.SitesSyncDetailDTO> {

	@Override
	public DataSourceDTO.ProviderDTO.SitesSyncDetailDTO get(
