...
public interface BounceEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BounceEntryLocalServiceUtil} to access the bounce entry local service. Add custom service methods to {@link com.liferay.osb.email.blacklist.service.impl.BounceEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public BounceEntry addBounceEntry(java.lang.String emailAddress,
		Date bounceDate, java.lang.String bounceType,
		java.lang.String bounceSubtype) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BounceEntry> getBounceEntries(Date bounceDateLT, int start,
		int end, OrderByComparator<BounceEntry> obc);
