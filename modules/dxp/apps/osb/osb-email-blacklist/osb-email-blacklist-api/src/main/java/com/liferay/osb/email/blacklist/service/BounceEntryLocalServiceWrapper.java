 ...
 */
@ProviderType
public class BounceEntryLocalServiceWrapper implements BounceEntryLocalService,
	...
	*/
	...
	public com.liferay.osb.email.blacklist.model.BounceEntry addBounceEntry(
		...
		return _bounceEntryLocalService.addBounceEntry(emailAddress,
			bounceDate, bounceType, bounceSubtype);
	}
	...
	*/
	@Override
	public java.util.List<com.liferay.osb.email.blacklist.model.BounceEntry> getBounceEntries(
		int start, int end) {
	...
	public java.util.List<com.liferay.osb.email.blacklist.model.BounceEntry> getBounceEntries(
		...
		return _bounceEntryLocalService.getBounceEntries(bounceDateLT, start,
			end, obc);
	}
