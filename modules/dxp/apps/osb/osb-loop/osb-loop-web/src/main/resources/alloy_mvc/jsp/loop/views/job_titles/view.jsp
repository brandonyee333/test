...
<div id="${renderResponse.namespace}loopSurfaceMain">
	<div id="${renderResponse.namespace}loopSurfaceMain-default">
		<div id="${renderResponse.namespace}jobTitlesProfile"></div>

		<aui:script use="aui-node">
			var RC = window.RC;

			RC.actions.hydrateJobTitle(${loopJobTitleComposite.entityClassPK}, ${loopJobTitleComposite.JSONObject});

			RC.render(
				RC.LoopApp,
				{},
				A.one('#${renderResponse.namespace}jobTitlesProfile').getDOMNode()
			);
		</aui:script>
	</div>
</div>