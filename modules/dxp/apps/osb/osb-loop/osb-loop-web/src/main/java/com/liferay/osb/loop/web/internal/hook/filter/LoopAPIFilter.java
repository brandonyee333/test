...
@Component(
	...
	property = {
		...
		"servlet-context-name=", "servlet-filter-name=Loop API Filter",
		"url-pattern=/*"
	},
	service = Filter.class
)
public class LoopAPIFilter extends BaseFilter {
	...
	public boolean isFilterEnabled(
		...
		if (Validator.isNull(format)) {
			if (_log.isDebugEnabled()) {
				_log.debug(
					"Skipping filter for Loop URL " + currentURL +
						" due to empty format.");
			}
	...
	private static final Log _log = LogFactoryUtil.getLog(LoopAPIFilter.class);
