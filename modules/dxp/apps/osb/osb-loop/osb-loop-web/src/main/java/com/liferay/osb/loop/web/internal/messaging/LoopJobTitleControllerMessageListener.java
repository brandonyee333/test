 ...
 * @author Timothy Bell
 */
public class LoopJobTitleControllerMessageListener
	extends BaseLoopControllerMessageListener {

	public static LoopJobTitleControllerMessageListener getInstance(
	...
	protected String getMethodName(String apiName) throws Exception {
		...
		if (apiName.equals("add")) {
			methodName = "syncAddLoopJobTitle";
		}
		else if (apiName.equals("delete")) {
			methodName = "syncDeleteLoopJobTitle";
		}
		else if (apiName.equals("update")) {
			methodName = "syncUpdateLoopJobTitle";
		}
		else {
			throw new Exception(
				"The Loop job title sync api name does not exist for " +
					apiName);
		}
	...
	private static final LoopJobTitleControllerMessageListener _instance =
		new LoopJobTitleControllerMessageListener();
