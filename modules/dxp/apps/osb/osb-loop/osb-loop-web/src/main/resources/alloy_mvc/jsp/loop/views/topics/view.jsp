...
<div id="${renderResponse.namespace}loopSurfaceMain">
	<div id="${renderResponse.namespace}loopSurfaceMain-default">
		<div id="${renderResponse.namespace}topicProfile"></div>

		<aui:script use="aui-node">
			var RC = window.RC;

			RC.actions.hydrateTopic(${loopTopicComposite.entityClassPK}, ${loopTopicComposite.JSONObject});

			RC.render(
				RC.LoopApp,
				{},
				A.one('#${renderResponse.namespace}topicProfile').getDOMNode()
			);
		</aui:script>
	</div>
</div>