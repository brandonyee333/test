...
public interface AssetEntrySetLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssetEntrySetLocalServiceUtil} to access the asset entry set local service. Add custom service methods to {@link com.liferay.osb.loop.asset.entry.set.service.impl.AssetEntrySetLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AssetEntrySet addAssetEntrySet(long userId,
		...
		long stickyTime, java.lang.String title, int type, int status)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AssetEntrySet fetchAssetEntrySet(long classNameId, long classPK,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AssetEntrySet> getNewChildAssetEntrySets(long createTime,
		long parentAssetEntrySetId, int start, int end,
		OrderByComparator orderByComparator) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AssetEntrySet> getOldChildAssetEntrySets(long createTime,
		long parentAssetEntrySetId, int start, int end,
		OrderByComparator orderByComparator) throws PortalException;
	...
	*/
	...
	public AssetEntrySet updateAssetEntrySet(long assetEntrySetId,
		JSONObject payloadJSONObject, boolean privateAssetEntrySet,
		long stickyTime, java.lang.String title, int type, int status)
		throws PortalException;
}