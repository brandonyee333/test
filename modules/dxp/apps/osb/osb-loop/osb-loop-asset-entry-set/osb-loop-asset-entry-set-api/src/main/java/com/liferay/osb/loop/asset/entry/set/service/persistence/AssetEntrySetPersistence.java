 ...
 */
@ProviderType
public interface AssetEntrySetPersistence
	extends BasePersistence<AssetEntrySet> {
	...
	public java.util.List<AssetEntrySet> findByParentAssetEntrySetId(
		long parentAssetEntrySetId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AssetEntrySet>
			orderByComparator);
	 ...
	 * @return the matching asset entry sets
	 */
	public java.util.List<AssetEntrySet> findByGtCT_PAESI(
	 ...
	 * @return the matching asset entry sets
	 */
	public java.util.List<AssetEntrySet> findByLtCT_PAESI(
		long createTime, long parentAssetEntrySetId);
	 ...
	 * @return the matching asset entry sets
	 */
	public java.util.List<AssetEntrySet> findByCNI_CPK(
	 ...
	 * @return the matching asset entry sets that the user has permission to view
	 */
	public java.util.List<AssetEntrySet> filterFindByCNI_CPK(
		long classNameId, long classPK);
	 ...
	 * @return the matching asset entry sets
	 */
	public java.util.List<AssetEntrySet> findByCNI_CPK_Type(
