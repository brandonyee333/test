 ...
 * {@link com.liferay.osb.loop.asset.entry.set.service.impl.AssetEntrySetLocalServiceImpl} and is the
 ...
 * @see com.liferay.osb.loop.asset.entry.set.service.base.AssetEntrySetLocalServiceBaseImpl
...
public class AssetEntrySetLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.loop.asset.entry.set.service.impl.AssetEntrySetLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet addAssetEntrySet(
	...
	*/
	public static com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet createAssetEntrySet(
	...
	*/
	public static com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet deleteAssetEntrySet(
		com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet assetEntrySet)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet fetchAssetEntrySet(
		long assetEntrySetId) {
	...
	* @throws PortalException if a asset entry set with the primary key could not be found
	*/
	public static com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet getAssetEntrySet(
		long assetEntrySetId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet> getAssetEntrySets(
		int start, int end) {
	...
	*/
	...
	public static int getAssetEntrySetsCount(long classNameId, long classPK,
		int type) {
		return getService().getAssetEntrySetsCount(classNameId, classPK, type);
	}

	public static java.util.List<com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet> getChildAssetEntrySets(
	...
	public static java.util.List<com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet> getNewChildAssetEntrySets(
		long createTime, long parentAssetEntrySetId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getNewChildAssetEntrySets(createTime,
			parentAssetEntrySetId, start, end, orderByComparator);
	}

	public static java.util.List<com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet> getOldChildAssetEntrySets(
		long createTime, long parentAssetEntrySetId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getOldChildAssetEntrySets(createTime,
			parentAssetEntrySetId, start, end, orderByComparator);
	}
	...
	*/
	...
	public static com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet likeAssetEntrySet(
		long userId, long assetEntrySetId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().likeAssetEntrySet(userId, assetEntrySetId);
	}

	public static com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet unlikeAssetEntrySet(
		long userId, long assetEntrySetId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet updateAssetEntrySet(
		com.liferay.osb.loop.asset.entry.set.model.AssetEntrySet assetEntrySet) {
	...
	private static ServiceTracker<AssetEntrySetLocalService, AssetEntrySetLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(AssetEntrySetLocalService.class);

		ServiceTracker<AssetEntrySetLocalService, AssetEntrySetLocalService> serviceTracker =
			new ServiceTracker<AssetEntrySetLocalService, AssetEntrySetLocalService>(bundle.getBundleContext(),
