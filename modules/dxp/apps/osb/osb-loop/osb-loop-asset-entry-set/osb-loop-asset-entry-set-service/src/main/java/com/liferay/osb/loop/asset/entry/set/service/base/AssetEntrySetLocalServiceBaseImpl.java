...
public abstract class AssetEntrySetLocalServiceBaseImpl
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(assetEntrySetLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = AssetEntrySetLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, assetEntrySetLocalService);
		}
