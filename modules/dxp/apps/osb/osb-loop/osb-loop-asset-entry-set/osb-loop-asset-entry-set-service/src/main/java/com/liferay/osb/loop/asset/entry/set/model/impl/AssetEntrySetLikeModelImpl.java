 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link AssetEntrySetLikeModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AssetEntrySetLikeImpl}.
 * </p>
 *
...
public class AssetEntrySetLikeModelImpl extends BaseModelImpl<AssetEntrySetLike>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a asset entry set like model instance should use the {@link AssetEntrySetLike} interface instead.
	 */
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.osb.loop.asset.entry.set.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.osb.loop.asset.entry.set.model.AssetEntrySetLike"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.osb.loop.asset.entry.set.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.osb.loop.asset.entry.set.model.AssetEntrySetLike"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.osb.loop.asset.entry.set.service.util.ServiceProps.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.osb.loop.asset.entry.set.service.util.ServiceProps.get(
	...
	private static final ClassLoader _classLoader = AssetEntrySetLike.class.getClassLoader();
