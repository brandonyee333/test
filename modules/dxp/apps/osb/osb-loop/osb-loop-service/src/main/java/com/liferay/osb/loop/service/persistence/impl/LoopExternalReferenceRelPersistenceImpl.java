...
public class LoopExternalReferenceRelPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setLoopExternalReferenceRelUtilPersistence(this);
	}

	public void destroy() {
		_setLoopExternalReferenceRelUtilPersistence(null);
	...
	private void _setLoopExternalReferenceRelUtilPersistence(
		LoopExternalReferenceRelPersistence
			loopExternalReferenceRelPersistence) {

		try {
			Field field = LoopExternalReferenceRelUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, loopExternalReferenceRelPersistence);
		}
