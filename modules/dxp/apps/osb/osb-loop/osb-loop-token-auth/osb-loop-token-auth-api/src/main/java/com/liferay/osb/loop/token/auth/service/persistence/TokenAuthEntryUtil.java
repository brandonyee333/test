...
public class TokenAuthEntryUtil {
	...
	private static ServiceTracker
		<TokenAuthEntryPersistence, TokenAuthEntryPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			TokenAuthEntryPersistence.class);

		ServiceTracker<TokenAuthEntryPersistence, TokenAuthEntryPersistence>
			serviceTracker =
				new ServiceTracker
