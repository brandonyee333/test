 ...
 * {@link com.liferay.osb.loop.token.auth.service.impl.TokenAuthEntryLocalServiceImpl} and is the
 ...
 * @see com.liferay.osb.loop.token.auth.service.base.TokenAuthEntryLocalServiceBaseImpl
...
public class TokenAuthEntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.loop.token.auth.service.impl.TokenAuthEntryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static com.liferay.osb.loop.token.auth.model.TokenAuthEntry addTokenAuthEntry(
		long userId, java.lang.String device)
	...
	*/
	public static com.liferay.osb.loop.token.auth.model.TokenAuthEntry addTokenAuthEntry(
		com.liferay.osb.loop.token.auth.model.TokenAuthEntry tokenAuthEntry) {
	...
	*/
	public static com.liferay.osb.loop.token.auth.model.TokenAuthEntry createTokenAuthEntry(
	...
	*/
	...
	public static com.liferay.osb.loop.token.auth.model.TokenAuthEntry fetchTokenAuthEntry(
		long tokenAuthEntryId) {
	...
	*/
	...
	public static java.util.List<com.liferay.osb.loop.token.auth.model.TokenAuthEntry> getTokenAuthEntries(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getTokenAuthEntries(userId, start, end, orderByComparator);
	}
	...
	* @throws PortalException if a token auth entry with the primary key could not be found
	*/
	public static com.liferay.osb.loop.token.auth.model.TokenAuthEntry getTokenAuthEntry(
		long tokenAuthEntryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static void updateLoginDate(long tokenAuthEntryId,
	...
	*/
	public static com.liferay.osb.loop.token.auth.model.TokenAuthEntry updateTokenAuthEntry(
		com.liferay.osb.loop.token.auth.model.TokenAuthEntry tokenAuthEntry) {
	...
	private static ServiceTracker<TokenAuthEntryLocalService, TokenAuthEntryLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(TokenAuthEntryLocalService.class);

		ServiceTracker<TokenAuthEntryLocalService, TokenAuthEntryLocalService> serviceTracker =
			new ServiceTracker<TokenAuthEntryLocalService, TokenAuthEntryLocalService>(bundle.getBundleContext(),
