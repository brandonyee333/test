...
public interface TokenAuthEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TokenAuthEntryLocalServiceUtil} to access the token auth entry local service. Add custom service methods to {@link com.liferay.osb.loop.token.auth.service.impl.TokenAuthEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public TokenAuthEntry addTokenAuthEntry(long userId, java.lang.String device)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TokenAuthEntry> getTokenAuthEntries(long userId, int start,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TokenAuthEntry getTokenAuthEntry(java.lang.String token)
		throws PortalException;
