...
public class LoopUserNotificationSubscriptionWrapper
	...
	@Override
	public Object clone() {
		return new LoopUserNotificationSubscriptionWrapper(
			(LoopUserNotificationSubscription)
				_loopUserNotificationSubscription.clone());
	}
	...
	public int compareTo(
		...
		return _loopUserNotificationSubscription.compareTo(
			loopUserNotificationSubscription);
	}
	...
	public void setExpandoBridgeAttributes(ExpandoBridge expandoBridge) {
		_loopUserNotificationSubscription.setExpandoBridgeAttributes(
			expandoBridge);
	}
	...
	public void setLoopUserNotificationSubscriptionId(
		...
		_loopUserNotificationSubscription.setLoopUserNotificationSubscriptionId(
			loopUserNotificationSubscriptionId);
	}
	...
	public com.liferay.portal.kernel.model.CacheModel
		<LoopUserNotificationSubscription> toCacheModel() {
	...
	public LoopUserNotificationSubscription toEscapedModel() {
		return new LoopUserNotificationSubscriptionWrapper(
			_loopUserNotificationSubscription.toEscapedModel());
	}
	...
	public LoopUserNotificationSubscription toUnescapedModel() {
		return new LoopUserNotificationSubscriptionWrapper(
			_loopUserNotificationSubscription.toUnescapedModel());
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof LoopUserNotificationSubscriptionWrapper)) {
			return false;
		}

		LoopUserNotificationSubscriptionWrapper
			loopUserNotificationSubscriptionWrapper =
				(LoopUserNotificationSubscriptionWrapper)object;

		if (Objects.equals(
				_loopUserNotificationSubscription,
				loopUserNotificationSubscriptionWrapper.
					_loopUserNotificationSubscription)) {
	...
	private final LoopUserNotificationSubscription
		_loopUserNotificationSubscription;
