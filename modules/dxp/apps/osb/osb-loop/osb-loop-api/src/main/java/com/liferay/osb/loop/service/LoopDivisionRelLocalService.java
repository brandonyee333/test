...
/**
 * Provides the local service interface for LoopDivisionRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethan Bustad
 * @see LoopDivisionRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LoopDivisionRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.osb.loop.service.impl.LoopDivisionRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the loop division rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LoopDivisionRelLocalServiceUtil} if injection and service tracking are not available.
	 */
