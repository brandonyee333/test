...
/**
 * Provides the local service interface for LoopUserNotificationEvent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethan Bustad
 * @see LoopUserNotificationEventLocalServiceUtil
...
public interface LoopUserNotificationEventLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoopUserNotificationEventLocalServiceUtil} to access the loop user notification event local service. Add custom service methods to {@link com.liferay.osb.loop.service.impl.LoopUserNotificationEventLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public LoopUserNotificationEvent deleteLoopUserNotificationEvent(
		long loopUserNotificationEventId) throws PortalException;
