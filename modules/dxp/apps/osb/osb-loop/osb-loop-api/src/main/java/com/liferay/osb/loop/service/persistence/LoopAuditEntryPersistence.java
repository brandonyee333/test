 ...
 */
@ProviderType
public interface LoopAuditEntryPersistence extends BasePersistence<LoopAuditEntry> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, LoopAuditEntry> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<LoopAuditEntry> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<LoopAuditEntry> orderByComparator);
