 ...
 * {@link com.liferay.osb.loop.service.impl.LoopJobTitleLocalServiceImpl} and is the
...
public class LoopJobTitleLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.loop.service.impl.LoopJobTitleLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<com.liferay.osb.loop.model.LoopJobTitle> getLoopJobTitles(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<LoopJobTitleLocalService, LoopJobTitleLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LoopJobTitleLocalService.class);

		ServiceTracker<LoopJobTitleLocalService, LoopJobTitleLocalService> serviceTracker =
			new ServiceTracker<LoopJobTitleLocalService, LoopJobTitleLocalService>(bundle.getBundleContext(),
