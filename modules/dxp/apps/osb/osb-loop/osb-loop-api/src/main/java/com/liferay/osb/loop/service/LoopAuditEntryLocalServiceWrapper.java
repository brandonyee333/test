...
public class LoopAuditEntryLocalServiceWrapper
	...
	*/
	...
	public com.liferay.osb.loop.model.LoopAuditEntry createLoopAuditEntry(
		...
		return _loopAuditEntryLocalService.createLoopAuditEntry(loopAuditEntryId);
	}
	...
	*/
	...
	public com.liferay.osb.loop.model.LoopAuditEntry deleteLoopAuditEntry(
		...
		return _loopAuditEntryLocalService.deleteLoopAuditEntry(loopAuditEntryId);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _loopAuditEntryLocalService.dynamicQuery(dynamicQuery, start, end);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _loopAuditEntryLocalService.dynamicQuery(dynamicQuery, start,
	...
	*/
	...
	public com.liferay.osb.loop.model.LoopAuditEntry fetchLoopAuditEntry(
		long loopAuditEntryId) {
		return _loopAuditEntryLocalService.fetchLoopAuditEntry(loopAuditEntryId);
	}
	...
	*/
	@Override
	public java.util.List<com.liferay.osb.loop.model.LoopAuditEntry> getLoopAuditEntries(
		int start, int end) {
