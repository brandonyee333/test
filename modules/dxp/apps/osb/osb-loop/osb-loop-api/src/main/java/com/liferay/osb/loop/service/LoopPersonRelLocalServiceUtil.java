 ...
 * {@link com.liferay.osb.loop.service.impl.LoopPersonRelLocalServiceImpl} and is the
 ...
 * @see com.liferay.osb.loop.service.base.LoopPersonRelLocalServiceBaseImpl
 * @see com.liferay.osb.loop.service.impl.LoopPersonRelLocalServiceImpl
 * @generated
 */
@ProviderType
public class LoopPersonRelLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.loop.service.impl.LoopPersonRelLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<com.liferay.osb.loop.model.LoopPersonRel> getLoopPersonRels(
		int start, int end) {
	...
	*/
	public static int getLoopPersonRelsCount() {
		return getService().getLoopPersonRelsCount();
	}
	...
	*/
	...
	private static ServiceTracker<LoopPersonRelLocalService, LoopPersonRelLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LoopPersonRelLocalService.class);

		ServiceTracker<LoopPersonRelLocalService, LoopPersonRelLocalService> serviceTracker =
			new ServiceTracker<LoopPersonRelLocalService, LoopPersonRelLocalService>(bundle.getBundleContext(),
