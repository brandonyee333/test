...
public class LoopStreamEntrySoap implements Serializable {
	public static LoopStreamEntrySoap toSoapModel(LoopStreamEntry model) {
		...
		soapModel.setFollowing(model.getFollowing());
	...
	public static LoopStreamEntrySoap[] toSoapModels(LoopStreamEntry[] models) {
		LoopStreamEntrySoap[] soapModels = new LoopStreamEntrySoap[models.length];
	...
	public static LoopStreamEntrySoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels = new LoopStreamEntrySoap[models.length][models[0].length];
		}
		else {
	...
	public static LoopStreamEntrySoap[] toSoapModels(
		...
		List<LoopStreamEntrySoap> soapModels = new ArrayList<LoopStreamEntrySoap>(models.size());
