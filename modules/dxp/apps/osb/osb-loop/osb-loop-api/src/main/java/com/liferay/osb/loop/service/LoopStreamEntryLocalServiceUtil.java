...
public class LoopStreamEntryLocalServiceUtil {
	 ...
	 */
	public static LoopStreamEntry addLoopStreamEntry(
	 ...
	 */
	public static LoopStreamEntry createLoopStreamEntry(
	 ...
	 */
	public static LoopStreamEntry deleteLoopStreamEntry(long loopStreamEntryId)
	 ...
	 * @return the loop stream entry that was removed
	 */
	public static LoopStreamEntry deleteLoopStreamEntry(
		LoopStreamEntry loopStreamEntry) {
	...
	public static LoopStreamEntry fetchLoopStreamEntry(long loopStreamEntryId) {
	 ...
	 * @throws PortalException if a loop stream entry with the primary key could not be found
	 */
	public static LoopStreamEntry getLoopStreamEntry(long loopStreamEntryId)
		throws PortalException {
	 ...
	 */
	public static LoopStreamEntry updateLoopStreamEntry(
		LoopStreamEntry loopStreamEntry) {
