...
public class LoopUserNotificationSubscriptionUtil {
	...
	private static ServiceTracker
		<LoopUserNotificationSubscriptionPersistence,
		 LoopUserNotificationSubscriptionPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			LoopUserNotificationSubscriptionPersistence.class);

		ServiceTracker
			<LoopUserNotificationSubscriptionPersistence,
			 LoopUserNotificationSubscriptionPersistence> serviceTracker =
				new ServiceTracker
					<LoopUserNotificationSubscriptionPersistence,
					 LoopUserNotificationSubscriptionPersistence>(
