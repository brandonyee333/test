...
public class LoopUserNotificationSubscriptionUtil {
	...
	public static LoopUserNotificationSubscription update(
		...
		return getPersistence()
				   .update(loopUserNotificationSubscription, serviceContext);
	}
	...
	*/
	public static LoopUserNotificationSubscription findByLPI_CNI_CP_DT(
		...
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationSubscriptionException {
		return getPersistence()
				   .findByLPI_CNI_CP_DT(loopPersonId, classNameId, classPK,
			deliveryType);
	}
	...
	*/
	public static LoopUserNotificationSubscription fetchByLPI_CNI_CP_DT(
		long loopPersonId, long classNameId, long classPK, int deliveryType) {
		return getPersistence()
				   .fetchByLPI_CNI_CP_DT(loopPersonId, classNameId, classPK,
			deliveryType);
	}
	...
	*/
	public static LoopUserNotificationSubscription fetchByLPI_CNI_CP_DT(
		...
		return getPersistence()
				   .fetchByLPI_CNI_CP_DT(loopPersonId, classNameId, classPK,
			deliveryType, retrieveFromCache);
	}
	...
	*/
	public static LoopUserNotificationSubscription removeByLPI_CNI_CP_DT(
		...
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationSubscriptionException {
		return getPersistence()
				   .removeByLPI_CNI_CP_DT(loopPersonId, classNameId, classPK,
			deliveryType);
	}
	...
	*/
	public static int countByLPI_CNI_CP_DT(long loopPersonId, long classNameId,
		long classPK, int deliveryType) {
		return getPersistence()
				   .countByLPI_CNI_CP_DT(loopPersonId, classNameId, classPK,
			deliveryType);
	}
	...
	*/
	public static LoopUserNotificationSubscription findByPrimaryKey(
		...
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationSubscriptionException {
		return getPersistence()
				   .findByPrimaryKey(loopUserNotificationSubscriptionId);
	}
	...
	*/
	public static LoopUserNotificationSubscription fetchByPrimaryKey(
		long loopUserNotificationSubscriptionId) {
		return getPersistence()
				   .fetchByPrimaryKey(loopUserNotificationSubscriptionId);
	}

	public static java.util.Map<java.io.Serializable, LoopUserNotificationSubscription> fetchByPrimaryKeys(
	...
	*/
	public static List<LoopUserNotificationSubscription> findAll(int start,
		int end) {
	...
	*/
	...
	private static ServiceTracker<LoopUserNotificationSubscriptionPersistence, LoopUserNotificationSubscriptionPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LoopUserNotificationSubscriptionPersistence.class);

		ServiceTracker<LoopUserNotificationSubscriptionPersistence, LoopUserNotificationSubscriptionPersistence> serviceTracker =
			new ServiceTracker<LoopUserNotificationSubscriptionPersistence, LoopUserNotificationSubscriptionPersistence>(bundle.getBundleContext(),
				LoopUserNotificationSubscriptionPersistence.class, null);
