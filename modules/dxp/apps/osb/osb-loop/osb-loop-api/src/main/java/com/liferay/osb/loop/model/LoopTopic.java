...
public interface LoopTopic extends LoopTopicModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.liferay.osb.loop.model.impl.LoopTopicImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<LoopTopic, Long> LOOP_TOPIC_ID_ACCESSOR = new Accessor<LoopTopic, Long>() {
			@Override
