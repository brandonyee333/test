...
/**
 * Provides the local service interface for LoopJobTitle. Methods of this
...
public interface LoopJobTitleLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.osb.loop.service.impl.LoopJobTitleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the loop job title local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LoopJobTitleLocalServiceUtil} if injection and service tracking are not available.
	 */
