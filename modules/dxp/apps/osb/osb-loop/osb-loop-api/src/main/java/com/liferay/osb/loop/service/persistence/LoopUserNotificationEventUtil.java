...
/**
 * The persistence utility for the loop user notification event service. This utility wraps {@link com.liferay.osb.loop.service.persistence.impl.LoopUserNotificationEventPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class LoopUserNotificationEventUtil {
	...
	public static LoopUserNotificationEvent update(
		...
		return getPersistence().update(loopUserNotificationEvent, serviceContext);
	}
	...
	*/
	public static List<LoopUserNotificationEvent> findByGroupKey(long groupKey) {
	...
	*/
	public static List<LoopUserNotificationEvent> findByGroupKey(
		...
		OrderByComparator<LoopUserNotificationEvent> orderByComparator) {
		return getPersistence()
				   .findByGroupKey(groupKey, start, end, orderByComparator);
	}
	...
	*/
	public static LoopUserNotificationEvent findByGroupKey_First(
		long groupKey,
		OrderByComparator<LoopUserNotificationEvent> orderByComparator)
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationEventException {
		return getPersistence().findByGroupKey_First(groupKey, orderByComparator);
	}
	...
	* @throws NoSuchLoopUserNotificationEventException if a matching loop user notification event could not be found
	*/
	public static LoopUserNotificationEvent findByGroupKey_Last(long groupKey,
		OrderByComparator<LoopUserNotificationEvent> orderByComparator)
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationEventException {
		return getPersistence().findByGroupKey_Last(groupKey, orderByComparator);
	}
	...
	*/
	public static LoopUserNotificationEvent fetchByGroupKey_Last(
		long groupKey,
		OrderByComparator<LoopUserNotificationEvent> orderByComparator) {
		return getPersistence().fetchByGroupKey_Last(groupKey, orderByComparator);
	}
	...
	*/
	public static LoopUserNotificationEvent[] findByGroupKey_PrevAndNext(
		...
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationEventException {
		return getPersistence()
				   .findByGroupKey_PrevAndNext(loopUserNotificationEventId,
	...
	*/
	public static List<LoopUserNotificationEvent> findByGCNI_GCP(
		...
		return getPersistence()
				   .findByGCNI_GCP(groupClassNameId, groupClassPK, start, end);
	}
	...
	*/
	public static LoopUserNotificationEvent findByGCNI_GCP_First(
		...
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationEventException {
		return getPersistence()
				   .findByGCNI_GCP_First(groupClassNameId, groupClassPK,
			orderByComparator);
	}
	...
	*/
	public static LoopUserNotificationEvent fetchByGCNI_GCP_First(
		...
		OrderByComparator<LoopUserNotificationEvent> orderByComparator) {
		return getPersistence()
				   .fetchByGCNI_GCP_First(groupClassNameId, groupClassPK,
			orderByComparator);
	}
	...
	*/
	public static LoopUserNotificationEvent findByGCNI_GCP_Last(
		...
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationEventException {
		return getPersistence()
				   .findByGCNI_GCP_Last(groupClassNameId, groupClassPK,
			orderByComparator);
	}
	...
	*/
	public static LoopUserNotificationEvent fetchByGCNI_GCP_Last(
		...
		OrderByComparator<LoopUserNotificationEvent> orderByComparator) {
		return getPersistence()
				   .fetchByGCNI_GCP_Last(groupClassNameId, groupClassPK,
			orderByComparator);
	}
	...
	*/
	public static LoopUserNotificationEvent[] findByGCNI_GCP_PrevAndNext(
		...
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationEventException {
		return getPersistence()
				   .findByGCNI_GCP_PrevAndNext(loopUserNotificationEventId,
	...
	* @param groupClassPK the group class pk
	*/
	public static void removeByGCNI_GCP(long groupClassNameId, long groupClassPK) {
	...
	* @return the number of matching loop user notification events
	*/
	public static int countByGCNI_GCP(long groupClassNameId, long groupClassPK) {
	...
	*/
	public static List<LoopUserNotificationEvent> findByGCNI_GCP_T(
		...
		return getPersistence()
				   .findByGCNI_GCP_T(groupClassNameId, groupClassPK, type);
	}
	...
	*/
	public static LoopUserNotificationEvent findByGCNI_GCP_T_First(
		...
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationEventException {
		return getPersistence()
				   .findByGCNI_GCP_T_First(groupClassNameId, groupClassPK,
	...
	*/
	public static LoopUserNotificationEvent fetchByGCNI_GCP_T_First(
		...
		OrderByComparator<LoopUserNotificationEvent> orderByComparator) {
		return getPersistence()
				   .fetchByGCNI_GCP_T_First(groupClassNameId, groupClassPK,
			type, orderByComparator);
	}
	...
	*/
	public static LoopUserNotificationEvent findByGCNI_GCP_T_Last(
		...
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationEventException {
		return getPersistence()
				   .findByGCNI_GCP_T_Last(groupClassNameId, groupClassPK, type,
			orderByComparator);
	}
	...
	*/
	public static LoopUserNotificationEvent fetchByGCNI_GCP_T_Last(
		...
		OrderByComparator<LoopUserNotificationEvent> orderByComparator) {
		return getPersistence()
				   .fetchByGCNI_GCP_T_Last(groupClassNameId, groupClassPK,
			type, orderByComparator);
	}
	...
	*/
	public static LoopUserNotificationEvent[] findByGCNI_GCP_T_PrevAndNext(
		...
		throws com.liferay.osb.loop.exception.NoSuchLoopUserNotificationEventException {
		return getPersistence()
				   .findByGCNI_GCP_T_PrevAndNext(loopUserNotificationEventId,
	...
	* @param type the type
	*/
	public static void removeByGCNI_GCP_T(long groupClassNameId,
		long groupClassPK, int type) {
		getPersistence().removeByGCNI_GCP_T(groupClassNameId, groupClassPK, type);
	}
	...
	* @return the number of matching loop user notification events
	*/
	public static int countByGCNI_GCP_T(long groupClassNameId,
		long groupClassPK, int type) {
		return getPersistence()
				   .countByGCNI_GCP_T(groupClassNameId, groupClassPK, type);
	}
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, LoopUserNotificationEvent> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<LoopUserNotificationEventPersistence, LoopUserNotificationEventPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LoopUserNotificationEventPersistence.class);

		ServiceTracker<LoopUserNotificationEventPersistence, LoopUserNotificationEventPersistence> serviceTracker =
			new ServiceTracker<LoopUserNotificationEventPersistence, LoopUserNotificationEventPersistence>(bundle.getBundleContext(),
