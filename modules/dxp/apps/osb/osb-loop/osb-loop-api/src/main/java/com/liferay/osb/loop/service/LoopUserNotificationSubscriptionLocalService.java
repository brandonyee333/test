...
public interface LoopUserNotificationSubscriptionLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoopUserNotificationSubscriptionLocalServiceUtil} to access the loop user notification subscription local service. Add custom service methods to <code>com.liferay.osb.loop.service.impl.LoopUserNotificationSubscriptionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
