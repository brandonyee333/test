...
public class LoopPersonLocalServiceUtil {
	...
	public static com.liferay.osb.loop.model.LoopPerson
		fetchLoopPersonByPersonUserId(long personUserId) {
	...
	public static com.liferay.osb.loop.model.LoopPerson
			getLoopPersonByPersonUserId(long personUserId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<com.liferay.osb.loop.model.LoopPerson>
		getLoopPersons(int start, int end) {
	...
	private static ServiceTracker
		<LoopPersonLocalService, LoopPersonLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LoopPersonLocalService.class);

		ServiceTracker<LoopPersonLocalService, LoopPersonLocalService>
			serviceTracker =
				new ServiceTracker
					<LoopPersonLocalService, LoopPersonLocalService>(
						bundle.getBundleContext(), LoopPersonLocalService.class,
						null);
