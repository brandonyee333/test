 ...
 * @generated
 */
public class LoopPersonLocalServiceWrapper
	implements LoopPersonLocalService, ServiceWrapper<LoopPersonLocalService> {
	...
	public long dynamicQueryCount(
		...
		return _loopPersonLocalService.dynamicQueryCount(
	...
	public com.liferay.osb.loop.model.LoopPerson fetchLoopPersonByPersonUserId(
		...
		return _loopPersonLocalService.fetchLoopPersonByPersonUserId(
			personUserId);
	}
	...
	public com.liferay.osb.loop.model.LoopPerson getLoopPersonByPersonUserId(
		...
		return _loopPersonLocalService.getLoopPersonByPersonUserId(
			personUserId);
	}
