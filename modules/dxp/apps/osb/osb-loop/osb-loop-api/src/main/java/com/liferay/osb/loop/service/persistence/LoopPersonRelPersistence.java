 ...
 */
@ProviderType
public interface LoopPersonRelPersistence extends BasePersistence<LoopPersonRel> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, LoopPersonRel> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<LoopPersonRel> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<LoopPersonRel> orderByComparator);
