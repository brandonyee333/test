...
public class LoopTopicUtil {
	...
	*/
	public static LoopTopic findByC_N(long companyId, java.lang.String name)
	...
	*/
	public static LoopTopic fetchByC_N(long companyId, java.lang.String name) {
	...
	*/
	public static LoopTopic removeByC_N(long companyId, java.lang.String name)
		throws com.liferay.osb.loop.exception.NoSuchLoopTopicException {
	...
	*/
	...
	private static ServiceTracker<LoopTopicPersistence, LoopTopicPersistence> _serviceTracker =
		ServiceTrackerFactory.open(LoopTopicPersistence.class);
}