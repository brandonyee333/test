...
/**
 * The persistence utility for the loop person service. This utility wraps <code>com.liferay.osb.loop.service.persistence.impl.LoopPersonPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class LoopPersonUtil {
	 ...
	 */
	public static Map<Serializable, LoopPerson> fetchByPrimaryKeys(
	 ...
	 */
	public static LoopPerson update(
		LoopPerson loopPerson, ServiceContext serviceContext) {
	 ...
	 * @return the matching loop person, or <code>null</code> if a matching loop person could not be found
	 */
	public static LoopPerson fetchByPersonUserId(
		long personUserId, boolean useFinderCache) {

		return getPersistence().fetchByPersonUserId(
			personUserId, useFinderCache);
	}
	...
	private static ServiceTracker<LoopPersonPersistence, LoopPersonPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LoopPersonPersistence.class);

		ServiceTracker<LoopPersonPersistence, LoopPersonPersistence>
			serviceTracker =
				new ServiceTracker
					<LoopPersonPersistence, LoopPersonPersistence>(
						bundle.getBundleContext(), LoopPersonPersistence.class,
						null);
