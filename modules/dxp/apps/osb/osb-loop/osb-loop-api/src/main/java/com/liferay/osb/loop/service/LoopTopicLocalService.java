...
public interface LoopTopicLocalService extends BaseLocalService,
	...
	public boolean isLoopTopic(long companyId, java.lang.String name);
	...
	*/
	...
	public LoopTopic addLoopTopic(long userId, java.lang.String name,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LoopTopic fetchLoopTopic(long companyId, java.lang.String name);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LoopTopic fetchLoopTopic(long loopTopicId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LoopTopic getLoopTopic(long companyId, java.lang.String name)
		throws PortalException;
	...
	*/
	...
	public void updateLoopTopic(long userId, java.lang.String name,
		java.lang.String description) throws PortalException;
}