...
public interface LoopParticipantAssignmentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.osb.loop.service.impl.LoopParticipantAssignmentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the loop participant assignment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LoopParticipantAssignmentLocalServiceUtil} if injection and service tracking are not available.
	 */
