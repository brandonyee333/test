...
public interface LoopUserNotificationRecordLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoopUserNotificationRecordLocalServiceUtil} to access the loop user notification record local service. Add custom service methods to <code>com.liferay.osb.loop.service.impl.LoopUserNotificationRecordLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
