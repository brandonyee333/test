...
public interface LoopStreamLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoopStreamLocalServiceUtil} to access the loop stream local service. Add custom service methods to {@link com.liferay.osb.loop.service.impl.LoopStreamLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LoopStream getLoopStream(long loopStreamId)
		throws PortalException;
