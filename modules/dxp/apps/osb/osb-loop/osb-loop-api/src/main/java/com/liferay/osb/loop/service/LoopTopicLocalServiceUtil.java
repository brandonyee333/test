...
public class LoopTopicLocalServiceUtil {
	 ...
	 */
	public static boolean isLoopTopic(long companyId, java.lang.String name) {
	...
	*/
	...
	public static void updateLoopTopic(long userId, java.lang.String name,
	...
	private static ServiceTracker<LoopTopicLocalService, LoopTopicLocalService> _serviceTracker =
		ServiceTrackerFactory.open(LoopTopicLocalService.class);
}