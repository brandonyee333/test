 ...
 * {@link com.liferay.osb.loop.service.impl.LoopTopicLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class LoopTopicLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.loop.service.impl.LoopTopicLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<com.liferay.osb.loop.model.LoopTopic> getLoopTopics(
		int start, int end) {
	...
	*/
	public static int getLoopTopicsCount() {
		return getService().getLoopTopicsCount();
	}
	...
	*/
	...
	public static boolean isLoopTopic(long companyId, String name) {
		return getService().isLoopTopic(companyId, name);
	}

	public static void updateLoopTopic(long userId, String name,
		String description)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	private static ServiceTracker<LoopTopicLocalService, LoopTopicLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LoopTopicLocalService.class);

		ServiceTracker<LoopTopicLocalService, LoopTopicLocalService> serviceTracker =
			new ServiceTracker<LoopTopicLocalService, LoopTopicLocalService>(bundle.getBundleContext(),
				LoopTopicLocalService.class, null);
