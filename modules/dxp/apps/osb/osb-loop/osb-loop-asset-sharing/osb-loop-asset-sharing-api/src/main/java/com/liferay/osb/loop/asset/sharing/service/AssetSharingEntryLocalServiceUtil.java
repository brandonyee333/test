 ...
 * {@link com.liferay.osb.loop.asset.sharing.service.impl.AssetSharingEntryLocalServiceImpl} and is the
...
public class AssetSharingEntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.osb.loop.asset.sharing.service.impl.AssetSharingEntryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.osb.loop.asset.sharing.model.AssetSharingEntry addAssetSharingEntry(
		com.liferay.osb.loop.asset.sharing.model.AssetSharingEntry assetSharingEntry) {
	...
	*/
	public static com.liferay.osb.loop.asset.sharing.model.AssetSharingEntry createAssetSharingEntry(
		com.liferay.osb.loop.asset.sharing.service.persistence.AssetSharingEntryPK assetSharingEntryPK) {
	...
	*/
	public static com.liferay.osb.loop.asset.sharing.model.AssetSharingEntry deleteAssetSharingEntry(
		com.liferay.osb.loop.asset.sharing.model.AssetSharingEntry assetSharingEntry) {
	...
	*/
	...
	public static com.liferay.osb.loop.asset.sharing.model.AssetSharingEntry fetchAssetSharingEntry(
		com.liferay.osb.loop.asset.sharing.service.persistence.AssetSharingEntryPK assetSharingEntryPK) {
	...
	*/
	public static java.util.List<com.liferay.osb.loop.asset.sharing.model.AssetSharingEntry> getAssetSharingEntries(
		int start, int end) {
	...
	* @throws PortalException if a asset sharing entry with the primary key could not be found
	*/
	public static com.liferay.osb.loop.asset.sharing.model.AssetSharingEntry getAssetSharingEntry(
		com.liferay.osb.loop.asset.sharing.service.persistence.AssetSharingEntryPK assetSharingEntryPK)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static java.util.List<com.liferay.osb.loop.asset.sharing.model.AssetSharingEntry> getSharedToAssetSharingEntries(
	...
	*/
	public static com.liferay.osb.loop.asset.sharing.model.AssetSharingEntry updateAssetSharingEntry(
		com.liferay.osb.loop.asset.sharing.model.AssetSharingEntry assetSharingEntry) {
	...
	private static ServiceTracker<AssetSharingEntryLocalService, AssetSharingEntryLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(AssetSharingEntryLocalService.class);

		ServiceTracker<AssetSharingEntryLocalService, AssetSharingEntryLocalService> serviceTracker =
			new ServiceTracker<AssetSharingEntryLocalService, AssetSharingEntryLocalService>(bundle.getBundleContext(),
