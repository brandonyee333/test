 ...
 */
@ProviderType
public interface AssetSharingEntryPersistence
	extends BasePersistence<AssetSharingEntry> {
	 ...
	 */
	public java.util.List<AssetSharingEntry> findByC_C(
	...
	public java.util.List<AssetSharingEntry> findByC_C(
		long classNameId, long classPK, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AssetSharingEntry>
			orderByComparator);
	 ...
	 * @return the matching asset sharing entries
	 */
	public java.util.List<AssetSharingEntry> findByC_C_S(
	 ...
	 * @return the matching asset sharing entries
	 */
	public java.util.List<AssetSharingEntry> findByC_S_S(
