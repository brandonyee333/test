...
public interface AssetSharingEntryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.osb.loop.asset.sharing.service.impl.AssetSharingEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the asset sharing entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AssetSharingEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
