...
/**
 * Provides the local service interface for ConnectorTransaction. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ConnectorTransactionLocalServiceUtil
...
public interface ConnectorTransactionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ConnectorTransactionLocalServiceUtil} to access the connector transaction local service. Add custom service methods to {@link com.liferay.pulpo.connector.de.service.impl.ConnectorTransactionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
