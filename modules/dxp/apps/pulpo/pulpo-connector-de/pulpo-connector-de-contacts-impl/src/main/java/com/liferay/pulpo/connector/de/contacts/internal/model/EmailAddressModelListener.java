...
public class EmailAddressModelListener
	extends ContactsModelListener<EmailAddress> {

	@Override
	public void onAfterCreate(EmailAddress model)
	...
	@Override
	protected List<EmailAddress> getModels(User user) {
