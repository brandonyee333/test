...
/**
 * The persistence implementation for the watson token auth entry service.
 *
 * <p>
...
public class WatsonTokenAuthEntryPersistenceImpl
	...
	public WatsonTokenAuthEntry fetchByUserId(
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					WatsonTokenAuthEntry watsonTokenAuthEntry = list.get(0);
		...
		if (result instanceof List<?>) {
			...
			return (WatsonTokenAuthEntry)result;
		}
	}
	...
	public void clearCache() {
		entityCache.clearCache(WatsonTokenAuthEntryImpl.class);
	...
	@Override
	public void clearCache(List<WatsonTokenAuthEntry> watsonTokenAuthEntries) {
		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITH_PAGINATION);
		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
	...
	protected WatsonTokenAuthEntry removeImpl(
		...
		if (watsonTokenAuthEntry != null) {
			clearCache(watsonTokenAuthEntry);
		}
	...
	public WatsonTokenAuthEntry updateImpl(
		...
		if (isNew && (watsonTokenAuthEntry.getCreateDate() == null)) {
			...
			if (serviceContext == null) {
				...
				watsonTokenAuthEntry.setCreateDate(
		...
		clearUniqueFindersCache(watsonTokenAuthEntryModelImpl, false);
		cacheUniqueFindersCache(watsonTokenAuthEntryModelImpl);
	...
	public WatsonTokenAuthEntry fetchByPrimaryKey(long watsonTokenAuthEntryId) {
		return fetchByPrimaryKey((Serializable)watsonTokenAuthEntryId);
	}
		...
		for (Serializable primaryKey : primaryKeys) {
			...
			if (serializable != nullModel) {
				if (serializable == null) {
					...
					map.put(primaryKey, (WatsonTokenAuthEntry)serializable);
				}
			}
		}
	...
	public void removeAll() {
		for (WatsonTokenAuthEntry watsonTokenAuthEntry : findAll()) {
			remove(watsonTokenAuthEntry);
		}
	}
	...
	protected Map<String, Integer> getTableColumnsMap() {
		return WatsonTokenAuthEntryModelImpl.TABLE_COLUMNS_MAP;
	}
