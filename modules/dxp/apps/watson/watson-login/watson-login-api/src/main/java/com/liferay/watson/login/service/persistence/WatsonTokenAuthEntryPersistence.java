 ...
 */
@ProviderType
public interface WatsonTokenAuthEntryPersistence extends BasePersistence<WatsonTokenAuthEntry> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<WatsonTokenAuthEntry> findByC_U(long companyId,
		long userId);
	...
	*/
	public java.util.List<WatsonTokenAuthEntry> findByC_U(long companyId,
		long userId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<WatsonTokenAuthEntry> orderByComparator);
