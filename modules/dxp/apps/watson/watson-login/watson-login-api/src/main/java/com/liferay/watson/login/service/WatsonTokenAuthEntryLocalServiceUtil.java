 ...
 * {@link com.liferay.watson.login.service.impl.WatsonTokenAuthEntryLocalServiceImpl} and is the
...
public class WatsonTokenAuthEntryLocalServiceUtil {
	...
	*/
	public static com.liferay.watson.login.model.WatsonTokenAuthEntry createWatsonTokenAuthEntry(
	...
	*/
	public static com.liferay.watson.login.model.WatsonTokenAuthEntry deleteWatsonTokenAuthEntry(
		long watsonTokenAuthEntryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.watson.login.model.WatsonTokenAuthEntry> getWatsonTokenAuthEntries(
		int start, int end) {
	...
	* @throws PortalException if a watson token auth entry with the primary key could not be found
	*/
	public static com.liferay.watson.login.model.WatsonTokenAuthEntry getWatsonTokenAuthEntry(
		long watsonTokenAuthEntryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.liferay.watson.login.model.WatsonTokenAuthEntry updateWatsonTokenAuthEntry(
		com.liferay.watson.login.model.WatsonTokenAuthEntry watsonTokenAuthEntry) {
	...
	private static ServiceTracker<WatsonTokenAuthEntryLocalService, WatsonTokenAuthEntryLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WatsonTokenAuthEntryLocalService.class);

		ServiceTracker<WatsonTokenAuthEntryLocalService, WatsonTokenAuthEntryLocalService> serviceTracker =
			new ServiceTracker<WatsonTokenAuthEntryLocalService, WatsonTokenAuthEntryLocalService>(bundle.getBundleContext(),
