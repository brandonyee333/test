...
/**
 * The persistence utility for the watson token auth entry service. This utility wraps <code>com.liferay.watson.login.service.persistence.impl.WatsonTokenAuthEntryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WatsonTokenAuthEntryUtil {
	 ...
	 */
	public static Map<Serializable, WatsonTokenAuthEntry> fetchByPrimaryKeys(
	 ...
	 * @throws NoSuchEntryException if a matching watson token auth entry could not be found
	 */
	public static WatsonTokenAuthEntry findByC_U_First(
			long companyId, long userId,
			OrderByComparator<WatsonTokenAuthEntry> orderByComparator)
		throws com.liferay.watson.login.exception.NoSuchEntryException {
	 ...
	 */
	public static WatsonTokenAuthEntry fetchByC_U_First(
		long companyId, long userId,
		OrderByComparator<WatsonTokenAuthEntry> orderByComparator) {
	 ...
	 * @throws NoSuchEntryException if a matching watson token auth entry could not be found
	 */
	public static WatsonTokenAuthEntry findByC_U_Last(
			long companyId, long userId,
			OrderByComparator<WatsonTokenAuthEntry> orderByComparator)
		throws com.liferay.watson.login.exception.NoSuchEntryException {
	 ...
	 */
	public static WatsonTokenAuthEntry fetchByC_U_Last(
		long companyId, long userId,
		OrderByComparator<WatsonTokenAuthEntry> orderByComparator) {
	...
	public static WatsonTokenAuthEntry[] findByC_U_PrevAndNext(
		...
		return getPersistence().findByC_U_PrevAndNext(
			watsonTokenAuthEntryId, companyId, userId, orderByComparator);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			WatsonTokenAuthEntryPersistence.class);

		ServiceTracker
			<WatsonTokenAuthEntryPersistence, WatsonTokenAuthEntryPersistence>
				serviceTracker =
					new ServiceTracker
						<WatsonTokenAuthEntryPersistence,
						 WatsonTokenAuthEntryPersistence>(
