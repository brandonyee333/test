...
public class WatsonIncidentRelLocalServiceUtil {
	...
	*/
	...
	public static WatsonIncidentRelLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					WatsonIncidentRelLocalService.class.getName());

			if (invokableLocalService instanceof WatsonIncidentRelLocalService) {
				_service = (WatsonIncidentRelLocalService)invokableLocalService;
			}
			else {
				_service = new WatsonIncidentRelLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(WatsonIncidentRelLocalServiceUtil.class,
				"_service");
		}
	...
	private static WatsonIncidentRelLocalService _service;
}