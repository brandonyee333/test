 ...
 * {@link com.liferay.watson.service.impl.WatsonAddressLocalServiceImpl} and is the
...
public class WatsonAddressLocalServiceUtil {
	...
	*/
	...
	public static WatsonAddressLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					WatsonAddressLocalService.class.getName());

			if (invokableLocalService instanceof WatsonAddressLocalService) {
				_service = (WatsonAddressLocalService)invokableLocalService;
			}
			else {
				_service = new WatsonAddressLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(WatsonAddressLocalServiceUtil.class,
				"_service");
		}
	...
	private static WatsonAddressLocalService _service;
}