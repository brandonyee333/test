...
public class WatsonIncidentUtil {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, WatsonIncident> fetchByPrimaryKeys(
	...
	*/
	...
	public static WatsonIncidentPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (WatsonIncidentPersistence)PortletBeanLocatorUtil.locate(com.liferay.watson.service.ClpSerializer.getServletContextName(),
					WatsonIncidentPersistence.class.getName());

			ReferenceRegistry.registerReference(WatsonIncidentUtil.class,
				"_persistence");
		}
	...
	private static WatsonIncidentPersistence _persistence;
}