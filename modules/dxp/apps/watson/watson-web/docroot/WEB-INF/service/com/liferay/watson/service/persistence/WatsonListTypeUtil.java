	...
	*/
	...
	public static WatsonListTypePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (WatsonListTypePersistence)PortletBeanLocatorUtil.locate(com.liferay.watson.service.ClpSerializer.getServletContextName(),
					WatsonListTypePersistence.class.getName());

			ReferenceRegistry.registerReference(WatsonListTypeUtil.class,
				"_persistence");
		}
	...
	private static WatsonListTypePersistence _persistence;
}