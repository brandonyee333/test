	...
	*/
	...
	public static WatsonAddressPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (WatsonAddressPersistence)PortletBeanLocatorUtil.locate(com.liferay.watson.service.ClpSerializer.getServletContextName(),
					WatsonAddressPersistence.class.getName());

			ReferenceRegistry.registerReference(WatsonAddressUtil.class,
				"_persistence");
		}
	...
	private static WatsonAddressPersistence _persistence;
}