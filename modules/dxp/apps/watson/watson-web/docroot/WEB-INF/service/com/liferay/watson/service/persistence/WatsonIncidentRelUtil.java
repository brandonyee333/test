	...
	*/
	...
	public static WatsonIncidentRelPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (WatsonIncidentRelPersistence)PortletBeanLocatorUtil.locate(com.liferay.watson.service.ClpSerializer.getServletContextName(),
					WatsonIncidentRelPersistence.class.getName());

			ReferenceRegistry.registerReference(WatsonIncidentRelUtil.class,
				"_persistence");
		}
	...
	private static WatsonIncidentRelPersistence _persistence;
}