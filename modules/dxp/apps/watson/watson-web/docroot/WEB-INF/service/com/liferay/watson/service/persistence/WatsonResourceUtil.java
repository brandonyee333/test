	...
	*/
	...
	public static WatsonResourcePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (WatsonResourcePersistence)PortletBeanLocatorUtil.locate(com.liferay.watson.service.ClpSerializer.getServletContextName(),
					WatsonResourcePersistence.class.getName());

			ReferenceRegistry.registerReference(WatsonResourceUtil.class,
				"_persistence");
		}
	...
	private static WatsonResourcePersistence _persistence;
}