...
public static class AlloyControllerImpl extends WatsonAlloyControllerImpl {
	...
	public void add() throws Exception {
		...
		if (!WatsonPermission.check(user, WatsonChild.fetch(watsonDocument.getWatsonChildId()))) {
		...
		if (!watsonDocument.isValid(null)) {
	...
	public void index() throws Exception {
		...
		watsonDocuments = WatsonChild.getWatsonDocuments(watsonChildId, includeInactive, sort, start, end, user);
	...
	public void search() throws Exception {
		...
		SearchContext searchContext = getPopulatedSearchContext(WatsonDocument.baseModelClass);
		...
		respondWith(WatsonDocument.getAsJSONDataArray(WatsonDocument.filterDocuments(searchResultWatsonDocuments, user), getTotalHits(searchContext)));
	}
	...
	public void update() throws Exception {
		...
		Object[] generatedWatsonRelationships = WatsonRelationship.generateValidationData(request, watsonDocument, watsonRelationshipJSONArray, watsonChildId);
		...
		if (!watsonDocument.isValid(watsonRelationships)) {
			JSONObject jsonObject = JSONFactoryUtil.createJSONObject();

			jsonObject.put("errors", watsonDocument.getDocumentFormErrors());

			jsonObject.put("model", WatsonDocument.getAsJSONObject(watsonDocument, watsonRelationships));
