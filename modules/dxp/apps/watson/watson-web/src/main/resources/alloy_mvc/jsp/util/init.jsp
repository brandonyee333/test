...
page import="com.liferay.portal.kernel.security.SecureRandomUtil" %><%@
...
page import="com.liferay.watson.login.constants.WatsonTokenAuthEntryConstants" %><%@
page import="com.liferay.watson.login.model.WatsonTokenAuthEntry" %><%@
page import="com.liferay.watson.login.service.WatsonTokenAuthEntryLocalServiceUtil" %><%@
page import="com.liferay.watson.model.WatsonActivityWrapper" %><%@
page import="com.liferay.watson.model.WatsonActivityAudit" %><%@
page import="com.liferay.watson.model.WatsonAddressWrapper" %><%@
page import="com.liferay.watson.model.WatsonAddressAudit" %><%@
page import="com.liferay.watson.model.WatsonChildWrapper" %><%@
page import="com.liferay.watson.model.WatsonChildAudit" %><%@
page import="com.liferay.watson.model.WatsonDocumentWrapper" %><%@
page import="com.liferay.watson.model.WatsonDocumentAudit" %><%@
page import="com.liferay.watson.model.WatsonHistoryWrapper" %><%@
page import="com.liferay.watson.model.WatsonHistoryAudit" %><%@
page import="com.liferay.watson.model.WatsonIncidentWrapper" %><%@
page import="com.liferay.watson.model.WatsonIncidentAudit" %><%@
page import="com.liferay.watson.model.WatsonIncidentRelWrapper" %><%@
page import="com.liferay.watson.model.WatsonIncidentRelAudit" %><%@
page import="com.liferay.watson.model.WatsonListTypeRelWrapper" %><%@
page import="com.liferay.watson.model.WatsonListTypeRelAudit" %><%@
page import="com.liferay.watson.model.WatsonListTypeWrapper" %><%@
page import="com.liferay.watson.model.WatsonListTypeAudit" %><%@
page import="com.liferay.watson.model.WatsonPersonWrapper" %><%@
page import="com.liferay.watson.model.WatsonPersonAudit" %><%@
page import="com.liferay.watson.model.WatsonRelationshipWrapper" %><%@
page import="com.liferay.watson.model.WatsonRelationshipAudit" %><%@
page import="com.liferay.watson.model.WatsonReportWrapper" %><%@
page import="com.liferay.watson.model.WatsonReportAudit" %><%@
page import="com.liferay.watson.model.WatsonResourceWrapper" %><%@
page import="com.liferay.watson.model.WatsonResourceAudit" %><%@
page import="com.liferay.watson.model.WatsonVehicleWrapper" %><%@
page import="com.liferay.watson.model.WatsonVehicleAudit" %><%@
page import="com.liferay.watson.model.impl.WatsonActivityImpl" %><%@
page import="com.liferay.watson.model.impl.WatsonAddressImpl" %><%@
page import="com.liferay.watson.model.impl.WatsonChildImpl" %><%@
page import="com.liferay.watson.model.impl.WatsonDocumentImpl" %><%@
...
page import="com.liferay.watson.model.impl.WatsonReportImpl" %><%@
page import="com.liferay.watson.model.impl.WatsonResourceImpl" %><%@
page import="com.liferay.watson.model.impl.WatsonVehicleImpl" %><%@
page import="com.liferay.watson.service.WatsonActivityAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonAddressAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonChildAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonDocumentAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonHistoryAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonIncidentAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonIncidentRelAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonListTypeAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonListTypeRelAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonPersonAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonRelationshipAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonReportAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonResourceAuditLocalServiceUtil" %><%@
page import="com.liferay.watson.service.WatsonVehicleAuditLocalServiceUtil" %><%@
...
<%@ include file="/alloy_mvc/jsp/util/watson_email_util.jspf" %>
<%@ include file="/alloy_mvc/jsp/util/watson_file_uploader_util.jspf" %>
<%@ include file="/alloy_mvc/jsp/util/watson_indexer_util.jspf" %>
...
<%@ include file="/alloy_mvc/jsp/watson/models/child_model.jspf" %>
<%@ include file="/alloy_mvc/jsp/watson/models/document_model.jspf" %>
...
<%@ include file="/alloy_mvc/jsp/watson/models/report_model.jspf" %>
