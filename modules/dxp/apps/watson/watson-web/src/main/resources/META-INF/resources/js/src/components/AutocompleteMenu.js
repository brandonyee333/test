...
class AutocompleteMenu extends JSXComponent {
	created() {
...
class AutocompleteList extends JSXComponent {
	render() {
...
class AutocompleteListItem extends JSXComponent {
	created() {
		bindAll(
			this,
			'handleItemClick_',
	...
	render() {
		...
		const classes = !items && highlightedIndex === this._index ? 'menu-item active' : 'menu-item';
