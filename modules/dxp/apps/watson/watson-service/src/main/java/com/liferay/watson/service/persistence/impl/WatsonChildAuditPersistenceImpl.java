...
public class WatsonChildAuditPersistenceImpl extends BasePersistenceImpl<WatsonChildAudit>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	private final FinderPath _finderPathWithPaginationFindAll = new FinderPath(WatsonChildAuditModelImpl.ENTITY_CACHE_ENABLED,
			WatsonChildAuditModelImpl.FINDER_CACHE_ENABLED,
			WatsonChildAuditImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);
	private final FinderPath _finderPathWithoutPaginationFindAll = new FinderPath(WatsonChildAuditModelImpl.ENTITY_CACHE_ENABLED,
			WatsonChildAuditModelImpl.FINDER_CACHE_ENABLED,
			WatsonChildAuditImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	private final FinderPath _finderPathCountAll = new FinderPath(WatsonChildAuditModelImpl.ENTITY_CACHE_ENABLED,
