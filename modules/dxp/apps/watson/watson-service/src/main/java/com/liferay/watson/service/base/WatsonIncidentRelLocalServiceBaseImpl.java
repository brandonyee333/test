...
public abstract class WatsonIncidentRelLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, WatsonIncidentRelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WatsonIncidentRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WatsonIncidentRelLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			WatsonIncidentRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return watsonIncidentRelPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return watsonIncidentRelPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public WatsonIncidentRel fetchWatsonIncidentRel(long watsonIncidentRelId) {
		return watsonIncidentRelPersistence.fetchByPrimaryKey(
			watsonIncidentRelId);
	}
	...
	public WatsonIncidentRel getWatsonIncidentRel(long watsonIncidentRelId)
		...
		return watsonIncidentRelPersistence.findByPrimaryKey(
			watsonIncidentRelId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return watsonIncidentRelLocalService.deleteWatsonIncidentRel(
			(WatsonIncidentRel)persistedModel);
	}

	public BasePersistence<WatsonIncidentRel> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(watsonIncidentRelLocalService);
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				watsonIncidentRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				WatsonIncidentRelLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, watsonIncidentRelLocalService);
		}
