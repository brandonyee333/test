...
/**
 * Provides the base implementation for the watson address local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.watson.service.impl.WatsonAddressLocalServiceImpl}.
 * </p>
 *
 * @author Steven Smith
...
public abstract class WatsonAddressLocalServiceBaseImpl
	...
	implements WatsonAddressLocalService, IdentifiableOSGiService {
	...
	public WatsonAddress addWatsonAddress(WatsonAddress watsonAddress) {
		...
		return watsonAddressPersistence.update(watsonAddress);
	}
	...
	public WatsonAddress deleteWatsonAddress(WatsonAddress watsonAddress) {
		return watsonAddressPersistence.remove(watsonAddress);
	}
	...
	public WatsonAddress fetchWatsonAddress(long watsonAddressId) {
		return watsonAddressPersistence.fetchByPrimaryKey(watsonAddressId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("watsonAddressId");
	...
	public List<WatsonAddress> getWatsonAddresses(int start, int end) {
		return watsonAddressPersistence.findAll(start, end);
	}
	...
	public int getWatsonAddressesCount() {
		return watsonAddressPersistence.countAll();
	}
	 ...
	 */
	public WatsonAddressLocalService getWatsonAddressLocalService() {
	...
	public String getOSGiServiceIdentifier() {
		return WatsonAddressLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = watsonAddressPersistence.getDataSource();
