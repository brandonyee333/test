...
public class WatsonPersonPersistenceImpl extends BasePersistenceImpl<WatsonPerson>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	private final FinderPath _finderPathWithPaginationFindAll = new FinderPath(WatsonPersonModelImpl.ENTITY_CACHE_ENABLED,
			WatsonPersonModelImpl.FINDER_CACHE_ENABLED, WatsonPersonImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	private final FinderPath _finderPathWithoutPaginationFindAll = new FinderPath(WatsonPersonModelImpl.ENTITY_CACHE_ENABLED,
			WatsonPersonModelImpl.FINDER_CACHE_ENABLED, WatsonPersonImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	private final FinderPath _finderPathCountAll = new FinderPath(WatsonPersonModelImpl.ENTITY_CACHE_ENABLED,
