...
import com.liferay.watson.service.persistence.WatsonIncidentUtil;
...
public class WatsonIncidentPersistenceImpl
	...
	public void cacheResult(List<WatsonIncident> watsonIncidents) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (watsonIncidents.size() > _valueObjectFinderCacheListThreshold))) {
	...
	public void afterPropertiesSet() {
		...
		_setWatsonIncidentUtilPersistence(this);
	}

	public void destroy() {
		_setWatsonIncidentUtilPersistence(null);
	...
	private void _setWatsonIncidentUtilPersistence(
		WatsonIncidentPersistence watsonIncidentPersistence) {

		try {
			Field field = WatsonIncidentUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, watsonIncidentPersistence);
		}
