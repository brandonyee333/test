...
public abstract class WatsonListTypeRelLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, WatsonListTypeRelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WatsonListTypeRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WatsonListTypeRelLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			WatsonListTypeRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return watsonListTypeRelPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return watsonListTypeRelPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public WatsonListTypeRel fetchWatsonListTypeRel(long watsonListTypeRelId) {
		return watsonListTypeRelPersistence.fetchByPrimaryKey(
			watsonListTypeRelId);
	}
	...
	public WatsonListTypeRel getWatsonListTypeRel(long watsonListTypeRelId)
		...
		return watsonListTypeRelPersistence.findByPrimaryKey(
			watsonListTypeRelId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return watsonListTypeRelLocalService.deleteWatsonListTypeRel(
			(WatsonListTypeRel)persistedModel);
	}

	public BasePersistence<WatsonListTypeRel> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(watsonListTypeRelLocalService);
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				watsonListTypeRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				WatsonListTypeRelLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, watsonListTypeRelLocalService);
		}
