...
import com.liferay.watson.service.persistence.WatsonDocumentUtil;
...
public class WatsonDocumentPersistenceImpl
	...
	public void cacheResult(List<WatsonDocument> watsonDocuments) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (watsonDocuments.size() > _valueObjectFinderCacheListThreshold))) {
	...
	public void afterPropertiesSet() {
		...
		_setWatsonDocumentUtilPersistence(this);
	}

	public void destroy() {
		_setWatsonDocumentUtilPersistence(null);
	...
	private void _setWatsonDocumentUtilPersistence(
		WatsonDocumentPersistence watsonDocumentPersistence) {

		try {
			Field field = WatsonDocumentUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, watsonDocumentPersistence);
		}
