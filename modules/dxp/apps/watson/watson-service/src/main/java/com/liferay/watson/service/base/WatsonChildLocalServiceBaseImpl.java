...
public abstract class WatsonChildLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, WatsonChildLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WatsonChildLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WatsonChildLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			WatsonChild.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return watsonChildPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return watsonChildPersistence.countWithDynamicQuery(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return watsonChildLocalService.deleteWatsonChild(
			(WatsonChild)persistedModel);
	}

	public BasePersistence<WatsonChild> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.liferay.watson.model.WatsonChild", watsonChildLocalService);

		_setLocalServiceUtilService(watsonChildLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = WatsonChildLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, watsonChildLocalService);
		}
