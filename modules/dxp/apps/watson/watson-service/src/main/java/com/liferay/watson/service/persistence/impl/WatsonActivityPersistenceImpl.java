...
public class WatsonActivityPersistenceImpl extends BasePersistenceImpl<WatsonActivity>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	private final FinderPath _finderPathWithPaginationFindAll = new FinderPath(WatsonActivityModelImpl.ENTITY_CACHE_ENABLED,
			WatsonActivityModelImpl.FINDER_CACHE_ENABLED,
			WatsonActivityImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);
	private final FinderPath _finderPathWithoutPaginationFindAll = new FinderPath(WatsonActivityModelImpl.ENTITY_CACHE_ENABLED,
			WatsonActivityModelImpl.FINDER_CACHE_ENABLED,
			WatsonActivityImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	private final FinderPath _finderPathCountAll = new FinderPath(WatsonActivityModelImpl.ENTITY_CACHE_ENABLED,
