...
import com.liferay.watson.service.persistence.WatsonActivityUtil;
...
public class WatsonActivityPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setWatsonActivityUtilPersistence(this);
	}

	public void destroy() {
		_setWatsonActivityUtilPersistence(null);
	...
	private void _setWatsonActivityUtilPersistence(
		WatsonActivityPersistence watsonActivityPersistence) {

		try {
			Field field = WatsonActivityUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, watsonActivityPersistence);
		}
