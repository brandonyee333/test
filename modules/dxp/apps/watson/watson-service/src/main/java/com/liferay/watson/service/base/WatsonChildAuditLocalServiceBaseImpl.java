...
public abstract class WatsonChildAuditLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, WatsonChildAuditLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WatsonChildAuditLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WatsonChildAuditLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			WatsonChildAudit.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return watsonChildAuditPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return watsonChildAuditPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public WatsonChildAudit fetchWatsonChildAudit(long watsonChildAuditId) {
		return watsonChildAuditPersistence.fetchByPrimaryKey(
			watsonChildAuditId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return watsonChildAuditLocalService.deleteWatsonChildAudit(
			(WatsonChildAudit)persistedModel);
	}

	public BasePersistence<WatsonChildAudit> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(watsonChildAuditLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				WatsonChildAuditLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, watsonChildAuditLocalService);
		}
