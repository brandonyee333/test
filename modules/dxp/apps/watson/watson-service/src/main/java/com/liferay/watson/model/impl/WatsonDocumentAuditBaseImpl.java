...
/**
 * The extended model base implementation for the WatsonDocumentAudit service. Represents a row in the &quot;WatsonDocumentAudit&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This class exists only as a container for the default extended model level methods generated by ServiceBuilder. Helper methods and all application logic should be put in {@link WatsonDocumentAuditImpl}.
 * </p>
 *
 * @author Steven Smith
...
public abstract class WatsonDocumentAuditBaseImpl
	...
	public void persist() {
		if (this.isNew()) {
			WatsonDocumentAuditLocalServiceUtil.addWatsonDocumentAudit(this);
		}
		else {
