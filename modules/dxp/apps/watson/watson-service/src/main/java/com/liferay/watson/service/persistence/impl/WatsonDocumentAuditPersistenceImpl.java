...
public class WatsonDocumentAuditPersistenceImpl extends BasePersistenceImpl<WatsonDocumentAudit>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	private final FinderPath _finderPathWithPaginationFindAll = new FinderPath(WatsonDocumentAuditModelImpl.ENTITY_CACHE_ENABLED,
			WatsonDocumentAuditModelImpl.FINDER_CACHE_ENABLED,
			WatsonDocumentAuditImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	private final FinderPath _finderPathWithoutPaginationFindAll = new FinderPath(WatsonDocumentAuditModelImpl.ENTITY_CACHE_ENABLED,
			WatsonDocumentAuditModelImpl.FINDER_CACHE_ENABLED,
			WatsonDocumentAuditImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	private final FinderPath _finderPathCountAll = new FinderPath(WatsonDocumentAuditModelImpl.ENTITY_CACHE_ENABLED,
