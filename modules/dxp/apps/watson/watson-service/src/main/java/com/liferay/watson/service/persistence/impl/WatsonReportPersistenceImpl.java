 ...
 * @see com.liferay.watson.service.persistence.WatsonReportUtil
 * @generated
 */
@ProviderType
public class WatsonReportPersistenceImpl extends BasePersistenceImpl<WatsonReport>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link WatsonReportUtil} to access the watson report persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(WatsonReportModelImpl.ENTITY_CACHE_ENABLED,
			WatsonReportModelImpl.FINDER_CACHE_ENABLED, WatsonReportImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(WatsonReportModelImpl.ENTITY_CACHE_ENABLED,
			WatsonReportModelImpl.FINDER_CACHE_ENABLED, WatsonReportImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(WatsonReportModelImpl.ENTITY_CACHE_ENABLED,
	...
	public WatsonReport create(long watsonReportId) {
		...
		watsonReport.setCompanyId(companyProvider.getCompanyId());
	...
	/**
	 * Returns the watson report with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the watson report
	...
	public Map<Serializable, WatsonReport> fetchByPrimaryKeys(
		...
		try {
			...
			for (WatsonReport watsonReport : (List<WatsonReport>)q.list()) {
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_WATSONREPORT);
