...
import com.liferay.watson.service.persistence.WatsonIncidentAuditUtil;
...
public class WatsonIncidentAuditPersistenceImpl
	...
	public WatsonIncidentAudit updateImpl(
		...
		if (isNew && (watsonIncidentAudit.getCreateDate() == null)) {
			if (serviceContext == null) {
				watsonIncidentAudit.setCreateDate(date);
			}
			else {
		...
		if (!watsonIncidentAuditModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				watsonIncidentAudit.setModifiedDate(date);
			}
			else {
	...
	public void afterPropertiesSet() {
		...
		_setWatsonIncidentAuditUtilPersistence(this);
	}

	public void destroy() {
		_setWatsonIncidentAuditUtilPersistence(null);
	...
	private void _setWatsonIncidentAuditUtilPersistence(
		WatsonIncidentAuditPersistence watsonIncidentAuditPersistence) {

		try {
			Field field = WatsonIncidentAuditUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, watsonIncidentAuditPersistence);
		}
