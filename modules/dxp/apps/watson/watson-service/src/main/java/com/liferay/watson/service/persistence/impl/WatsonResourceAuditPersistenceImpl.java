...
public class WatsonResourceAuditPersistenceImpl extends BasePersistenceImpl<WatsonResourceAudit>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	private final FinderPath _finderPathWithPaginationFindAll = new FinderPath(WatsonResourceAuditModelImpl.ENTITY_CACHE_ENABLED,
			WatsonResourceAuditModelImpl.FINDER_CACHE_ENABLED,
			WatsonResourceAuditImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	private final FinderPath _finderPathWithoutPaginationFindAll = new FinderPath(WatsonResourceAuditModelImpl.ENTITY_CACHE_ENABLED,
			WatsonResourceAuditModelImpl.FINDER_CACHE_ENABLED,
			WatsonResourceAuditImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	private final FinderPath _finderPathCountAll = new FinderPath(WatsonResourceAuditModelImpl.ENTITY_CACHE_ENABLED,
