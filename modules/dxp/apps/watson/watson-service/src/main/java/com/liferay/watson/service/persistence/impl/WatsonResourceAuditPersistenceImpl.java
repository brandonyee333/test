...
import com.liferay.watson.service.persistence.WatsonResourceAuditUtil;
...
public class WatsonResourceAuditPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setWatsonResourceAuditUtilPersistence(this);
	}

	public void destroy() {
		_setWatsonResourceAuditUtilPersistence(null);
	...
	private void _setWatsonResourceAuditUtilPersistence(
		WatsonResourceAuditPersistence watsonResourceAuditPersistence) {

		try {
			Field field = WatsonResourceAuditUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, watsonResourceAuditPersistence);
		}
