...
public class WatsonIncidentLocalServiceUtil {
	...
	*/
	...
	public static WatsonIncidentLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					WatsonIncidentLocalService.class.getName());

			if (invokableLocalService instanceof WatsonIncidentLocalService) {
				_service = (WatsonIncidentLocalService)invokableLocalService;
			}
			else {
				_service = new WatsonIncidentLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(WatsonIncidentLocalServiceUtil.class,
				"_service");
		}
	...
	private static WatsonIncidentLocalService _service;
}