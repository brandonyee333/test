...
/**
 * Provides the local service interface for WatsonIncidentRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Eddie Olson
 * @see WatsonIncidentRelLocalServiceUtil
...
public interface WatsonIncidentRelLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonIncidentRelLocalServiceUtil} to access the watson incident rel local service. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonIncidentRelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WatsonIncidentRel addWatsonIncidentRel(
	...
	*/
	public WatsonIncidentRel createWatsonIncidentRel(long watsonIncidentRelId);
	...
	*/
	...
	public WatsonIncidentRel deleteWatsonIncidentRel(long watsonIncidentRelId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WatsonIncidentRel deleteWatsonIncidentRel(
		WatsonIncidentRel watsonIncidentRel);
	...
	*/
	...
	public WatsonIncidentRel fetchWatsonIncidentRel(long watsonIncidentRelId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonIncidentRel getWatsonIncidentRel(long watsonIncidentRelId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonIncidentRel> getWatsonIncidentRels(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WatsonIncidentRel updateWatsonIncidentRel(
		WatsonIncidentRel watsonIncidentRel);
}