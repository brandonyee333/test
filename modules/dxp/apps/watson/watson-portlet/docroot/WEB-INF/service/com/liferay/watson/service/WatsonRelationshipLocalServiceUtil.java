...
public class WatsonRelationshipLocalServiceUtil {
	...
	*/
	...
	public static WatsonRelationshipLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					WatsonRelationshipLocalService.class.getName());

			if (invokableLocalService instanceof WatsonRelationshipLocalService) {
				_service = (WatsonRelationshipLocalService)invokableLocalService;
			}
			else {
				_service = new WatsonRelationshipLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(WatsonRelationshipLocalServiceUtil.class,
				"_service");
		}
	...
	private static WatsonRelationshipLocalService _service;
}