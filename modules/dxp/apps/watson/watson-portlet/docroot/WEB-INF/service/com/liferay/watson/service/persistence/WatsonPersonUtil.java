...
/**
 * The persistence utility for the watson person service. This utility wraps {@link com.liferay.watson.service.persistence.impl.WatsonPersonPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WatsonPersonUtil {
	 ...
	 */
	public static void clearCache(WatsonPerson watsonPerson) {
		getPersistence().clearCache(watsonPerson);
	}
	...
	public static WatsonPerson update(WatsonPerson watsonPerson) {
		return getPersistence().update(watsonPerson);
	}
	...
	*/
	...
	public static WatsonPerson updateImpl(WatsonPerson watsonPerson) {
		return getPersistence().updateImpl(watsonPerson);
	}
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, WatsonPerson> fetchByPrimaryKeys(
	...
	*/
	...
	public static WatsonPersonPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (WatsonPersonPersistence)PortletBeanLocatorUtil.locate(com.liferay.watson.service.ClpSerializer.getServletContextName(),
					WatsonPersonPersistence.class.getName());

			ReferenceRegistry.registerReference(WatsonPersonUtil.class,
				"_persistence");
		}
	...
	private static WatsonPersonPersistence _persistence;
}