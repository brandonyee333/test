...
public class WatsonRelationshipUtil {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, WatsonRelationship> fetchByPrimaryKeys(
	...
	*/
	...
	public static WatsonRelationshipPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (WatsonRelationshipPersistence)PortletBeanLocatorUtil.locate(com.liferay.watson.service.ClpSerializer.getServletContextName(),
					WatsonRelationshipPersistence.class.getName());

			ReferenceRegistry.registerReference(WatsonRelationshipUtil.class,
				"_persistence");
		}
	...
	private static WatsonRelationshipPersistence _persistence;
}