...
public class WatsonHistoryLocalServiceUtil {
	...
	*/
	...
	public static WatsonHistoryLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					WatsonHistoryLocalService.class.getName());

			if (invokableLocalService instanceof WatsonHistoryLocalService) {
				_service = (WatsonHistoryLocalService)invokableLocalService;
			}
			else {
				_service = new WatsonHistoryLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(WatsonHistoryLocalServiceUtil.class,
				"_service");
		}
	...
	private static WatsonHistoryLocalService _service;
}