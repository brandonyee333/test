 ...
 */
@ProviderType
public class WatsonResourceClp extends BaseModelImpl<WatsonResource>
	implements WatsonResource {
	public WatsonResourceClp() {
	}
	...
	public void setWatsonResourceId(long watsonResourceId) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				Class<?> clazz = _watsonResourceRemoteModel.getClass();

				Method method = clazz.getMethod("setWatsonResourceId",
						long.class);

				method.invoke(_watsonResourceRemoteModel, watsonResourceId);
			}
			catch (Exception e) {
	...
	public void setCompanyId(long companyId) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				method.invoke(_watsonResourceRemoteModel, companyId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserId(long userId) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				method.invoke(_watsonResourceRemoteModel, userId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserName(String userName) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				method.invoke(_watsonResourceRemoteModel, userName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreateDate(Date createDate) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				method.invoke(_watsonResourceRemoteModel, createDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				method.invoke(_watsonResourceRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setOriginalWatsonResourceId(long originalWatsonResourceId) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setOriginalWatsonResourceId",
						long.class);

				method.invoke(_watsonResourceRemoteModel,
					originalWatsonResourceId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
	...
	public void setTypeWatsonListTypeId(long typeWatsonListTypeId) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				method.invoke(_watsonResourceRemoteModel, typeWatsonListTypeId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setWatsonIncidentId(long watsonIncidentId) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				method.invoke(_watsonResourceRemoteModel, watsonIncidentId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setName(String name) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				method.invoke(_watsonResourceRemoteModel, name);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setDescription(String description) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				method.invoke(_watsonResourceRemoteModel, description);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setImagePayload(String imagePayload) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				method.invoke(_watsonResourceRemoteModel, imagePayload);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setStatus(int status) {
		...
		if (_watsonResourceRemoteModel != null) {
			try {
				...
				method.invoke(_watsonResourceRemoteModel, status);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getWatsonResourceRemoteModel() {
		return _watsonResourceRemoteModel;
	}

	public void setWatsonResourceRemoteModel(
		BaseModel<?> watsonResourceRemoteModel) {
		_watsonResourceRemoteModel = watsonResourceRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _watsonResourceRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_watsonResourceRemoteModel,
	...
	public WatsonResource toEscapedModel() {
		return (WatsonResource)ProxyUtil.newProxyInstance(WatsonResource.class.getClassLoader(),
			new Class[] { WatsonResource.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		WatsonResourceClp clone = new WatsonResourceClp();

		clone.setWatsonResourceId(getWatsonResourceId());
		clone.setCompanyId(getCompanyId());
		clone.setUserId(getUserId());
		clone.setUserName(getUserName());
		clone.setCreateDate(getCreateDate());
		clone.setModifiedDate(getModifiedDate());
		clone.setOriginalWatsonResourceId(getOriginalWatsonResourceId());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof WatsonResourceClp)) {
			return false;
		}

		WatsonResourceClp watsonResource = (WatsonResourceClp)obj;
	...
	private int _status;
	private BaseModel<?> _watsonResourceRemoteModel;
