...
public class WatsonResourceLocalServiceUtil {
	...
	*/
	...
	public static WatsonResourceLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					WatsonResourceLocalService.class.getName());

			if (invokableLocalService instanceof WatsonResourceLocalService) {
				_service = (WatsonResourceLocalService)invokableLocalService;
			}
			else {
				_service = new WatsonResourceLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(WatsonResourceLocalServiceUtil.class,
				"_service");
		}
	...
	private static WatsonResourceLocalService _service;
}