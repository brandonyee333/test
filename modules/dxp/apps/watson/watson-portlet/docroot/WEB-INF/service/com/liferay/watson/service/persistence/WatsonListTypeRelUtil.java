	...
	*/
	...
	public static WatsonListTypeRelPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (WatsonListTypeRelPersistence)PortletBeanLocatorUtil.locate(com.liferay.watson.service.ClpSerializer.getServletContextName(),
					WatsonListTypeRelPersistence.class.getName());

			ReferenceRegistry.registerReference(WatsonListTypeRelUtil.class,
				"_persistence");
		}
	...
	private static WatsonListTypeRelPersistence _persistence;
}