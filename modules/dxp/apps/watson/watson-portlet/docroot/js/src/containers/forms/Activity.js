	...
	render() {
		...
		if (action === 'edit') {
			if (storeData) {
				...
				translateHref = (disabled || !WatsonConstants.currentUser.translator) ? undefined : `${WatsonConstants.urls.baseURL}/incidents/${watsonIncidentId}/edit/activities/${watsonActivityId}/translate`;
