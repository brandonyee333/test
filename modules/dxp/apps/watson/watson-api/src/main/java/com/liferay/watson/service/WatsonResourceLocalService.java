...
/**
 * Provides the local service interface for WatsonResource. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Steven Smith
 * @see WatsonResourceLocalServiceUtil
 * @see com.liferay.watson.service.base.WatsonResourceLocalServiceBaseImpl
 * @see com.liferay.watson.service.impl.WatsonResourceLocalServiceImpl
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface WatsonResourceLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonResourceLocalServiceUtil} to access the watson resource local service. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonResourceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WatsonResource addWatsonResource(WatsonResource watsonResource);
	...
	*/
	...
	public WatsonResource deleteWatsonResource(long watsonResourceId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WatsonResource deleteWatsonResource(WatsonResource watsonResource);
	...
	*/
	...
	public WatsonResource fetchWatsonResource(long watsonResourceId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonResource getWatsonResource(long watsonResourceId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonResource> getWatsonResources(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WatsonResource updateWatsonResource(WatsonResource watsonResource);
}