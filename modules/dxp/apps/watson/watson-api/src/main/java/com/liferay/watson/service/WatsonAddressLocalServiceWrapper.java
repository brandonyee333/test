...
public class WatsonAddressLocalServiceWrapper
	implements WatsonAddressLocalService,
		ServiceWrapper<WatsonAddressLocalService> {
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _watsonAddressLocalService.dynamicQuery(dynamicQuery, start, end);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _watsonAddressLocalService.dynamicQuery(dynamicQuery, start,
