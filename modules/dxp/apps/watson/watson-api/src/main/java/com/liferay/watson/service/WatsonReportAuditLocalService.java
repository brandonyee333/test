...
/**
 * Provides the local service interface for WatsonReportAudit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Steven Smith
 * @see WatsonReportAuditLocalServiceUtil
...
public interface WatsonReportAuditLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonReportAuditLocalServiceUtil} to access the watson report audit local service. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonReportAuditLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WatsonReportAudit addWatsonReportAudit(
	...
	*/
	...
	public WatsonReportAudit deleteWatsonReportAudit(long watsonReportAuditId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WatsonReportAudit deleteWatsonReportAudit(
		WatsonReportAudit watsonReportAudit);
	...
	*/
	...
	public WatsonReportAudit fetchWatsonReportAudit(long watsonReportAuditId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonReportAudit getWatsonReportAudit(long watsonReportAuditId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonReportAudit> getWatsonReportAudits(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WatsonReportAudit updateWatsonReportAudit(
		WatsonReportAudit watsonReportAudit);
}