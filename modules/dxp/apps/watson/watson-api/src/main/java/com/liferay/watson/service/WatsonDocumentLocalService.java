...
/**
 * Provides the local service interface for WatsonDocument. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Steven Smith
 * @see WatsonDocumentLocalServiceUtil
 * @see com.liferay.watson.service.base.WatsonDocumentLocalServiceBaseImpl
 * @see com.liferay.watson.service.impl.WatsonDocumentLocalServiceImpl
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface WatsonDocumentLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonDocumentLocalServiceUtil} to access the watson document local service. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonDocumentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WatsonDocument addWatsonDocument(WatsonDocument watsonDocument);
	...
	*/
	...
	public WatsonDocument deleteWatsonDocument(long watsonDocumentId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WatsonDocument deleteWatsonDocument(WatsonDocument watsonDocument);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonDocument fetchWatsonDocument(long watsonDocumentId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonDocument getWatsonDocument(long watsonDocumentId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonDocument> getWatsonDocuments(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WatsonDocument updateWatsonDocument(WatsonDocument watsonDocument);
}