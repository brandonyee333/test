 ...
 */
@ProviderType
public interface WatsonRelationshipPersistence
	extends BasePersistence<WatsonRelationship> {
	...
	public java.util.List<WatsonRelationship> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<WatsonRelationship>
			orderByComparator);
