 ...
 */
@ProviderType
public interface WatsonReportAuditPersistence extends BasePersistence<WatsonReportAudit> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<WatsonReportAudit> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<WatsonReportAudit> orderByComparator);
