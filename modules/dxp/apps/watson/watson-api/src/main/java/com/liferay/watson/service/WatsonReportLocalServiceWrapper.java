 ...
 */
@ProviderType
public class WatsonReportLocalServiceWrapper implements WatsonReportLocalService,
	ServiceWrapper<WatsonReportLocalService> {
	...
	*/
	@Override
	public java.util.List<com.liferay.watson.model.WatsonReport> getWatsonReports(
		int start, int end) {
