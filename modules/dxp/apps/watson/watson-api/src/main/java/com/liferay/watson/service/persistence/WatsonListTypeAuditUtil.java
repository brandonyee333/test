...
/**
 * The persistence utility for the watson list type audit service. This utility wraps {@link com.liferay.watson.service.persistence.impl.WatsonListTypeAuditPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WatsonListTypeAuditUtil {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, WatsonListTypeAudit> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<WatsonListTypeAuditPersistence, WatsonListTypeAuditPersistence> _serviceTracker =
		ServiceTrackerFactory.open(WatsonListTypeAuditPersistence.class);
}