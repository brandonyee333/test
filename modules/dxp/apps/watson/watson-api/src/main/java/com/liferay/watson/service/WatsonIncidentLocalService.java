...
/**
 * Provides the local service interface for WatsonIncident. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Steven Smith
 * @see WatsonIncidentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface WatsonIncidentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.watson.service.impl.WatsonIncidentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the watson incident local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link WatsonIncidentLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect WatsonIncidentLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	...
	public WatsonIncident addWatsonIncident(WatsonIncident watsonIncident);
	...
	public WatsonIncident deleteWatsonIncident(long watsonIncidentId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public WatsonIncident deleteWatsonIncident(WatsonIncident watsonIncident);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonIncident fetchWatsonIncident(long watsonIncidentId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonIncident getWatsonIncident(long watsonIncidentId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonIncident> getWatsonIncidents(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public WatsonIncident updateWatsonIncident(WatsonIncident watsonIncident);
