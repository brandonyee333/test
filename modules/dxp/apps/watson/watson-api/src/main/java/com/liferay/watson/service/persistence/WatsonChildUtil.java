...
public class WatsonChildUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<WatsonChildPersistence, WatsonChildPersistence> serviceTracker =
			new ServiceTracker<WatsonChildPersistence, WatsonChildPersistence>(bundle.getBundleContext(),
				WatsonChildPersistence.class, null);
