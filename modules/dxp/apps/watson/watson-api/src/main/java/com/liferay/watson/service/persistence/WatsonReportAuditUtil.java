...
/**
 * The persistence utility for the watson report audit service. This utility wraps {@link com.liferay.watson.service.persistence.impl.WatsonReportAuditPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.liferay.watson.service.persistence.impl.WatsonReportAuditPersistenceImpl
 * @generated
 */
@ProviderType
public class WatsonReportAuditUtil {
	 ...
	 */
	public static WatsonReportAudit update(WatsonReportAudit watsonReportAudit) {
	...
	*/
	public static WatsonReportAudit fetchByPrimaryKey(long watsonReportAuditId) {
		return getPersistence().fetchByPrimaryKey(watsonReportAuditId);
	}

	public static java.util.Map<java.io.Serializable, WatsonReportAudit> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<WatsonReportAuditPersistence, WatsonReportAuditPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WatsonReportAuditPersistence.class);

		ServiceTracker<WatsonReportAuditPersistence, WatsonReportAuditPersistence> serviceTracker =
			new ServiceTracker<WatsonReportAuditPersistence, WatsonReportAuditPersistence>(bundle.getBundleContext(),
