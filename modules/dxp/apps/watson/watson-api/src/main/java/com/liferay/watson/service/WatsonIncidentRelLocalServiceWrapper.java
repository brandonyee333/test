...
public class WatsonIncidentRelLocalServiceWrapper
	implements WatsonIncidentRelLocalService,
		ServiceWrapper<WatsonIncidentRelLocalService> {
	...
	*/
	...
	public com.liferay.watson.model.WatsonIncidentRel addWatsonIncidentRel(
		...
		return _watsonIncidentRelLocalService.addWatsonIncidentRel(watsonIncidentRel);
	}
	...
	*/
	...
	public com.liferay.watson.model.WatsonIncidentRel createWatsonIncidentRel(
		...
		return _watsonIncidentRelLocalService.createWatsonIncidentRel(watsonIncidentRelId);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _watsonIncidentRelLocalService.dynamicQuery(dynamicQuery, start,
			end);
	}
