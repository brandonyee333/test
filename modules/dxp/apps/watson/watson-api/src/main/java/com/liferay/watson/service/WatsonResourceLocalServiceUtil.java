 ...
 * {@link com.liferay.watson.service.impl.WatsonResourceLocalServiceImpl} and is the
...
public class WatsonResourceLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonResourceLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<com.liferay.watson.model.WatsonResource> getWatsonResources(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<WatsonResourceLocalService, WatsonResourceLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WatsonResourceLocalService.class);

		ServiceTracker<WatsonResourceLocalService, WatsonResourceLocalService> serviceTracker =
			new ServiceTracker<WatsonResourceLocalService, WatsonResourceLocalService>(bundle.getBundleContext(),
