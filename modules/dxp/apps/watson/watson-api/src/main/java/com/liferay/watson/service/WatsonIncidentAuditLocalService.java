...
public interface WatsonIncidentAuditLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonIncidentAuditLocalServiceUtil} to access the watson incident audit local service. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonIncidentAuditLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WatsonIncidentAudit deleteWatsonIncidentAudit(
		long watsonIncidentAuditId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonIncidentAudit> getWatsonIncidentAudits(int start, int end);
