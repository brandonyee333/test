...
/**
 * The base model interface for the WatsonAddressAudit service. Represents a row in the &quot;WatsonAddressAudit&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.watson.model.impl.WatsonAddressAuditModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.watson.model.impl.WatsonAddressAuditImpl</code>.
 * </p>
 *
 * @author Steven Smith
 ...
 */
@ProviderType
public interface WatsonAddressAuditModel
	extends BaseModel<WatsonAddressAudit>, GroupedModel, LocalizedModel,
			ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a watson address audit model instance should use the {@link WatsonAddressAudit} interface instead.
	 */
