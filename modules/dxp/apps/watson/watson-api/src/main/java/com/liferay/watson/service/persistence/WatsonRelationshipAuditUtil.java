...
/**
 * The persistence utility for the watson relationship audit service. This utility wraps {@link com.liferay.watson.service.persistence.impl.WatsonRelationshipAuditPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class WatsonRelationshipAuditUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(watsonRelationshipAudit);
	}
	 ...
	 */
	public static List<WatsonRelationshipAudit> findWithDynamicQuery(
	 ...
	 */
	public static WatsonRelationshipAudit update(
		WatsonRelationshipAudit watsonRelationshipAudit) {
		return getPersistence().update(watsonRelationshipAudit);
	}
	...
	public static WatsonRelationshipAudit update(
		...
		return getPersistence().update(watsonRelationshipAudit, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		WatsonRelationshipAudit watsonRelationshipAudit) {
		getPersistence().cacheResult(watsonRelationshipAudit);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(watsonRelationshipAudits);
	}
	...
	*/
	public static WatsonRelationshipAudit create(long watsonRelationshipAuditId) {
		return getPersistence().create(watsonRelationshipAuditId);
	}
	...
	*/
	public static WatsonRelationshipAudit remove(long watsonRelationshipAuditId)
		throws com.liferay.watson.exception.NoSuchRelationshipAuditException {
		return getPersistence().remove(watsonRelationshipAuditId);
	}

	public static WatsonRelationshipAudit updateImpl(
		WatsonRelationshipAudit watsonRelationshipAudit) {
		return getPersistence().updateImpl(watsonRelationshipAudit);
	}
	...
	* @throws NoSuchRelationshipAuditException if a watson relationship audit with the primary key could not be found
	*/
	public static WatsonRelationshipAudit findByPrimaryKey(
		long watsonRelationshipAuditId)
		throws com.liferay.watson.exception.NoSuchRelationshipAuditException {
		return getPersistence().findByPrimaryKey(watsonRelationshipAuditId);
	}
	...
	*/
	public static WatsonRelationshipAudit fetchByPrimaryKey(
		long watsonRelationshipAuditId) {
		return getPersistence().fetchByPrimaryKey(watsonRelationshipAuditId);
	}

	public static java.util.Map<java.io.Serializable, WatsonRelationshipAudit> fetchByPrimaryKeys(
	...
	*/
	public static List<WatsonRelationshipAudit> findAll() {
	...
	*/
	public static List<WatsonRelationshipAudit> findAll(int start, int end) {
	...
	*/
	...
	public static WatsonRelationshipAuditPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<WatsonRelationshipAuditPersistence, WatsonRelationshipAuditPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WatsonRelationshipAuditPersistence.class);

		ServiceTracker<WatsonRelationshipAuditPersistence, WatsonRelationshipAuditPersistence> serviceTracker =
			new ServiceTracker<WatsonRelationshipAuditPersistence, WatsonRelationshipAuditPersistence>(bundle.getBundleContext(),
				WatsonRelationshipAuditPersistence.class, null);
