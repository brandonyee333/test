...
/**
 * The persistence utility for the watson person audit service. This utility wraps <code>com.liferay.watson.service.persistence.impl.WatsonPersonAuditPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WatsonPersonAuditUtil {
	 ...
	 */
	public static Map<Serializable, WatsonPersonAudit> fetchByPrimaryKeys(
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(WatsonPersonAuditPersistence.class);

		ServiceTracker<WatsonPersonAuditPersistence, WatsonPersonAuditPersistence> serviceTracker =
			new ServiceTracker<WatsonPersonAuditPersistence, WatsonPersonAuditPersistence>(bundle.getBundleContext(),
				WatsonPersonAuditPersistence.class, null);
