 ...
 * {@link com.liferay.watson.service.impl.WatsonHistoryLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class WatsonHistoryLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonHistoryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<com.liferay.watson.model.WatsonHistory> getWatsonHistories(
		int start, int end) {
	...
	*/
	public static int getWatsonHistoriesCount() {
		return getService().getWatsonHistoriesCount();
	}
	...
	*/
	...
	private static ServiceTracker<WatsonHistoryLocalService, WatsonHistoryLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WatsonHistoryLocalService.class);

		ServiceTracker<WatsonHistoryLocalService, WatsonHistoryLocalService> serviceTracker =
			new ServiceTracker<WatsonHistoryLocalService, WatsonHistoryLocalService>(bundle.getBundleContext(),
