 ...
 * {@link com.liferay.watson.service.impl.WatsonChildLocalServiceImpl} and is the
...
public class WatsonChildLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonChildLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<com.liferay.watson.model.WatsonChild> getWatsonChilds(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<WatsonChildLocalService, WatsonChildLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WatsonChildLocalService.class);

		ServiceTracker<WatsonChildLocalService, WatsonChildLocalService> serviceTracker =
			new ServiceTracker<WatsonChildLocalService, WatsonChildLocalService>(bundle.getBundleContext(),
