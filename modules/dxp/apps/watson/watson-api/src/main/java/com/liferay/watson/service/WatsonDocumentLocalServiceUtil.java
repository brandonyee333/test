...
public class WatsonDocumentLocalServiceUtil {
	 ...
	 */
	public static WatsonDocument addWatsonDocument(
	 ...
	 */
	public static WatsonDocument createWatsonDocument(long watsonDocumentId) {
	 ...
	 */
	public static WatsonDocument deleteWatsonDocument(long watsonDocumentId)
		throws PortalException {
	 ...
	 * @return the watson document that was removed
	 */
	public static WatsonDocument deleteWatsonDocument(
		WatsonDocument watsonDocument) {
	...
	public static WatsonDocument fetchWatsonDocument(long watsonDocumentId) {
	 ...
	 * @throws PortalException if a watson document with the primary key could not be found
	 */
	public static WatsonDocument getWatsonDocument(long watsonDocumentId)
		throws PortalException {
	 ...
	 */
	public static List<WatsonDocument> getWatsonDocuments(int start, int end) {
	 ...
	 */
	public static WatsonDocument updateWatsonDocument(
		WatsonDocument watsonDocument) {
	...
	private static volatile WatsonDocumentLocalService _service;
