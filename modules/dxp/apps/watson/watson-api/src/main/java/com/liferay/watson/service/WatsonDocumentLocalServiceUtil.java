 ...
 * {@link com.liferay.watson.service.impl.WatsonDocumentLocalServiceImpl} and is the
...
public class WatsonDocumentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonDocumentLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<com.liferay.watson.model.WatsonDocument> getWatsonDocuments(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<WatsonDocumentLocalService, WatsonDocumentLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WatsonDocumentLocalService.class);

		ServiceTracker<WatsonDocumentLocalService, WatsonDocumentLocalService> serviceTracker =
			new ServiceTracker<WatsonDocumentLocalService, WatsonDocumentLocalService>(bundle.getBundleContext(),
