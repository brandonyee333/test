...
public class WatsonChildSoap implements Serializable {
	...
	public static WatsonChildSoap[] toSoapModels(WatsonChild[] models) {
		WatsonChildSoap[] soapModels = new WatsonChildSoap[models.length];
	...
	public static WatsonChildSoap[][] toSoapModels(WatsonChild[][] models) {
		WatsonChildSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new WatsonChildSoap[models.length][models[0].length];
		}
		else {
			soapModels = new WatsonChildSoap[0][0];
		}
	...
	public static WatsonChildSoap[] toSoapModels(List<WatsonChild> models) {
		...
		return soapModels.toArray(new WatsonChildSoap[soapModels.size()]);
	}

	public WatsonChildSoap() {
	}
