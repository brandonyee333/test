 ...
 */
@ProviderType
public interface WatsonListTypeRelAuditPersistence extends BasePersistence<WatsonListTypeRelAudit> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, WatsonListTypeRelAudit> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<WatsonListTypeRelAudit> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<WatsonListTypeRelAudit> orderByComparator);
