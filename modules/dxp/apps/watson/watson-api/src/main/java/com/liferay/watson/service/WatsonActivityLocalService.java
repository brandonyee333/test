...
/**
 * Provides the local service interface for WatsonActivity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Steven Smith
 * @see WatsonActivityLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface WatsonActivityLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.watson.service.impl.WatsonActivityLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the watson activity local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link WatsonActivityLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public WatsonActivity addWatsonActivity(WatsonActivity watsonActivity);
	...
	public WatsonActivity deleteWatsonActivity(long watsonActivityId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public WatsonActivity deleteWatsonActivity(WatsonActivity watsonActivity);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonActivity fetchWatsonActivity(long watsonActivityId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonActivity> getWatsonActivities(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonActivity getWatsonActivity(long watsonActivityId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public WatsonActivity updateWatsonActivity(WatsonActivity watsonActivity);
