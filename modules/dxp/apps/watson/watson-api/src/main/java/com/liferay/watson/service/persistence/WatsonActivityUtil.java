...
public class WatsonActivityUtil {
	 ...
	 */
	public static WatsonActivity update(
		WatsonActivity watsonActivity, ServiceContext serviceContext) {
	...
	private static ServiceTracker
		<WatsonActivityPersistence, WatsonActivityPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			WatsonActivityPersistence.class);

		ServiceTracker<WatsonActivityPersistence, WatsonActivityPersistence>
			serviceTracker =
				new ServiceTracker
