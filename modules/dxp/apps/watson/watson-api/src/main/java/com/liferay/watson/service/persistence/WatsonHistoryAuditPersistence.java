 ...
 */
@ProviderType
public interface WatsonHistoryAuditPersistence extends BasePersistence<WatsonHistoryAudit> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<WatsonHistoryAudit> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<WatsonHistoryAudit> orderByComparator);
