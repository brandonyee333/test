...
/**
 * Provides the local service interface for WatsonListType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Steven Smith
 * @see WatsonListTypeLocalServiceUtil
...
public interface WatsonListTypeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonListTypeLocalServiceUtil} to access the watson list type local service. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonListTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WatsonListType addWatsonListType(WatsonListType watsonListType);
	...
	*/
	...
	public WatsonListType deleteWatsonListType(long watsonListTypeId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WatsonListType deleteWatsonListType(WatsonListType watsonListType);
	...
	*/
	...
	public WatsonListType fetchWatsonListType(long watsonListTypeId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonListType getWatsonListType(long watsonListTypeId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonListType> getWatsonListTypes(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WatsonListType updateWatsonListType(WatsonListType watsonListType);
}