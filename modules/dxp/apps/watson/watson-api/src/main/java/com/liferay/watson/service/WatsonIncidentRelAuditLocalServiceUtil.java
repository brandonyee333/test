 ...
 * {@link com.liferay.watson.service.impl.WatsonIncidentRelAuditLocalServiceImpl} and is the
 ...
 * @see com.liferay.watson.service.base.WatsonIncidentRelAuditLocalServiceBaseImpl
 * @see com.liferay.watson.service.impl.WatsonIncidentRelAuditLocalServiceImpl
 * @generated
 */
@ProviderType
public class WatsonIncidentRelAuditLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonIncidentRelAuditLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.watson.model.WatsonIncidentRelAudit addWatsonIncidentRelAudit(
	...
	*/
	public static com.liferay.watson.model.WatsonIncidentRelAudit createWatsonIncidentRelAudit(
		long watsonIncidentRelAuditId) {
		return getService()
				   .createWatsonIncidentRelAudit(watsonIncidentRelAuditId);
	}
	...
	*/
	public static com.liferay.watson.model.WatsonIncidentRelAudit deleteWatsonIncidentRelAudit(
		long watsonIncidentRelAuditId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .deleteWatsonIncidentRelAudit(watsonIncidentRelAuditId);
	}
	...
	*/
	public static com.liferay.watson.model.WatsonIncidentRelAudit deleteWatsonIncidentRelAudit(
		com.liferay.watson.model.WatsonIncidentRelAudit watsonIncidentRelAudit) {
		return getService().deleteWatsonIncidentRelAudit(watsonIncidentRelAudit);
	}
	...
	*/
	...
	public static com.liferay.watson.model.WatsonIncidentRelAudit fetchWatsonIncidentRelAudit(
		long watsonIncidentRelAuditId) {
		return getService().fetchWatsonIncidentRelAudit(watsonIncidentRelAuditId);
	}
	...
	* @throws PortalException if a watson incident rel audit with the primary key could not be found
	*/
	public static com.liferay.watson.model.WatsonIncidentRelAudit getWatsonIncidentRelAudit(
		long watsonIncidentRelAuditId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.watson.model.WatsonIncidentRelAudit> getWatsonIncidentRelAudits(
		int start, int end) {
	...
	*/
	public static com.liferay.watson.model.WatsonIncidentRelAudit updateWatsonIncidentRelAudit(
		com.liferay.watson.model.WatsonIncidentRelAudit watsonIncidentRelAudit) {
		return getService().updateWatsonIncidentRelAudit(watsonIncidentRelAudit);
	}
	...
	private static ServiceTracker<WatsonIncidentRelAuditLocalService, WatsonIncidentRelAuditLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WatsonIncidentRelAuditLocalService.class);

		ServiceTracker<WatsonIncidentRelAuditLocalService, WatsonIncidentRelAuditLocalService> serviceTracker =
			new ServiceTracker<WatsonIncidentRelAuditLocalService, WatsonIncidentRelAuditLocalService>(bundle.getBundleContext(),
