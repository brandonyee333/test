...
public class WatsonRelationshipLocalServiceUtil {
	 ...
	 */
	public static WatsonRelationship addWatsonRelationship(
	 ...
	 */
	public static WatsonRelationship createWatsonRelationship(
	 ...
	 */
	public static WatsonRelationship deleteWatsonRelationship(
			long watsonRelationshipId)
		throws PortalException {
	...
	public static WatsonRelationship fetchWatsonRelationship(
		long watsonRelationshipId) {
	 ...
	 * @throws PortalException if a watson relationship with the primary key could not be found
	 */
	public static WatsonRelationship getWatsonRelationship(
			long watsonRelationshipId)
		throws PortalException {
	 ...
	 */
	public static List<WatsonRelationship> getWatsonRelationships(
		int start, int end) {
	 ...
	 */
	public static WatsonRelationship updateWatsonRelationship(
		WatsonRelationship watsonRelationship) {
	...
	private static volatile WatsonRelationshipLocalService _service;
