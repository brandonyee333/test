...
/**
 * Provides the local service interface for WatsonHistory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Steven Smith
 * @see WatsonHistoryLocalServiceUtil
 * @see com.liferay.watson.service.base.WatsonHistoryLocalServiceBaseImpl
...
public interface WatsonHistoryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonHistoryLocalServiceUtil} to access the watson history local service. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonHistoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
