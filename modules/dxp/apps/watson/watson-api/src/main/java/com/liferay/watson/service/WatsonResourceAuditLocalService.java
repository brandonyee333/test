...
public interface WatsonResourceAuditLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonResourceAuditLocalServiceUtil} to access the watson resource audit local service. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonResourceAuditLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WatsonResourceAudit deleteWatsonResourceAudit(
		long watsonResourceAuditId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonResourceAudit> getWatsonResourceAudits(int start, int end);
