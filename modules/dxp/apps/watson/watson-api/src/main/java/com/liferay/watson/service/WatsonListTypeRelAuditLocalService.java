...
public interface WatsonListTypeRelAuditLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.watson.service.impl.WatsonListTypeRelAuditLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the watson list type rel audit local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link WatsonListTypeRelAuditLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonListTypeRelAudit> getWatsonListTypeRelAudits(
		int start, int end);
