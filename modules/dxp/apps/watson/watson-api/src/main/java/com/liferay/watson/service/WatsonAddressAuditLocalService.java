...
public interface WatsonAddressAuditLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.watson.service.impl.WatsonAddressAuditLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the watson address audit local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link WatsonAddressAuditLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect WatsonAddressAuditLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonAddressAudit fetchWatsonAddressAudit(
		long watsonAddressAuditId);
