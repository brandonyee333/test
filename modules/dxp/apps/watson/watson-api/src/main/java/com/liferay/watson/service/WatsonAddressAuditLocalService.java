...
/**
 * Provides the local service interface for WatsonAddressAudit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Steven Smith
 * @see WatsonAddressAuditLocalServiceUtil
...
public interface WatsonAddressAuditLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonAddressAuditLocalServiceUtil} to access the watson address audit local service. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonAddressAuditLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WatsonAddressAudit addWatsonAddressAudit(
	...
	*/
	...
	public WatsonAddressAudit deleteWatsonAddressAudit(
		long watsonAddressAuditId) throws PortalException;
	...
	*/
	...
	public WatsonAddressAudit fetchWatsonAddressAudit(long watsonAddressAuditId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonAddressAudit getWatsonAddressAudit(long watsonAddressAuditId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonAddressAudit> getWatsonAddressAudits(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WatsonAddressAudit updateWatsonAddressAudit(
		WatsonAddressAudit watsonAddressAudit);
}