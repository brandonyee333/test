...
/**
 * The persistence utility for the watson incident rel audit service. This utility wraps {@link com.liferay.watson.service.persistence.impl.WatsonIncidentRelAuditPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WatsonIncidentRelAuditUtil {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, WatsonIncidentRelAudit> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<WatsonIncidentRelAuditPersistence, WatsonIncidentRelAuditPersistence> _serviceTracker =
		ServiceTrackerFactory.open(WatsonIncidentRelAuditPersistence.class);
}