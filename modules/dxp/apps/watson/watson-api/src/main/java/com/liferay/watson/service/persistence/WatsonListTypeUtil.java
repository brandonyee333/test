...
/**
 * The persistence utility for the watson list type service. This utility wraps {@link com.liferay.watson.service.persistence.impl.WatsonListTypePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WatsonListTypeUtil {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, WatsonListType> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<WatsonListTypePersistence, WatsonListTypePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WatsonListTypePersistence.class);

		ServiceTracker<WatsonListTypePersistence, WatsonListTypePersistence> serviceTracker =
			new ServiceTracker<WatsonListTypePersistence, WatsonListTypePersistence>(bundle.getBundleContext(),
