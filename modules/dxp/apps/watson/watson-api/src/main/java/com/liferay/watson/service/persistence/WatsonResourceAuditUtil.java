...
/**
 * The persistence utility for the watson resource audit service. This utility wraps {@link com.liferay.watson.service.persistence.impl.WatsonResourceAuditPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WatsonResourceAuditUtil {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, WatsonResourceAudit> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<WatsonResourceAuditPersistence, WatsonResourceAuditPersistence> _serviceTracker =
		ServiceTrackerFactory.open(WatsonResourceAuditPersistence.class);
}