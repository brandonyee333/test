...
/**
 * Provides the local service interface for WatsonAddress. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Steven Smith
 * @see WatsonAddressLocalServiceUtil
 * @see com.liferay.watson.service.base.WatsonAddressLocalServiceBaseImpl
...
public interface WatsonAddressLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonAddressLocalServiceUtil} to access the watson address local service. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonAddressLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WatsonAddress addWatsonAddress(WatsonAddress watsonAddress);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WatsonAddress deleteWatsonAddress(WatsonAddress watsonAddress);
	...
	*/
	...
	public WatsonAddress fetchWatsonAddress(long watsonAddressId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonAddress> getWatsonAddresses(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WatsonAddress updateWatsonAddress(WatsonAddress watsonAddress);
}