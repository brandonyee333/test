...
public class WatsonDocumentLocalServiceWrapper
	implements WatsonDocumentLocalService,
		ServiceWrapper<WatsonDocumentLocalService> {
	...
	*/
	...
	public com.liferay.watson.model.WatsonDocument createWatsonDocument(
		...
		return _watsonDocumentLocalService.createWatsonDocument(watsonDocumentId);
	}
	...
	*/
	...
	public com.liferay.watson.model.WatsonDocument deleteWatsonDocument(
		long watsonDocumentId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _watsonDocumentLocalService.deleteWatsonDocument(watsonDocumentId);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _watsonDocumentLocalService.dynamicQuery(dynamicQuery, start, end);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _watsonDocumentLocalService.dynamicQuery(dynamicQuery, start,
	...
	*/
	...
	public com.liferay.watson.model.WatsonDocument fetchWatsonDocument(
		long watsonDocumentId) {
		return _watsonDocumentLocalService.fetchWatsonDocument(watsonDocumentId);
	}
	...
	*/
	@Override
	public java.util.List<com.liferay.watson.model.WatsonDocument> getWatsonDocuments(
		int start, int end) {
