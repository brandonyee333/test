...
/**
 * Provides the local service interface for WatsonListTypeRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Steven Smith
 * @see WatsonListTypeRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface WatsonListTypeRelLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonListTypeRelLocalServiceUtil} to access the watson list type rel local service. Add custom service methods to <code>com.liferay.watson.service.impl.WatsonListTypeRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WatsonListTypeRel addWatsonListTypeRel(
	...
	*/
	...
	public WatsonListTypeRel deleteWatsonListTypeRel(long watsonListTypeRelId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WatsonListTypeRel deleteWatsonListTypeRel(
		WatsonListTypeRel watsonListTypeRel);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonListTypeRel fetchWatsonListTypeRel(long watsonListTypeRelId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonListTypeRel getWatsonListTypeRel(long watsonListTypeRelId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonListTypeRel> getWatsonListTypeRels(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WatsonListTypeRel updateWatsonListTypeRel(
		WatsonListTypeRel watsonListTypeRel);
}