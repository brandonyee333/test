...
public interface WatsonListTypeRelLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.watson.service.impl.WatsonListTypeRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the watson list type rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link WatsonListTypeRelLocalServiceUtil} if injection and service tracking are not available.
	 */
