...
/**
 * Provides the local service interface for WatsonChild. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Steven Smith
 * @see WatsonChildLocalServiceUtil
 * @see com.liferay.watson.service.base.WatsonChildLocalServiceBaseImpl
 * @see com.liferay.watson.service.impl.WatsonChildLocalServiceImpl
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface WatsonChildLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WatsonChildLocalServiceUtil} to access the watson child local service. Add custom service methods to {@link com.liferay.watson.service.impl.WatsonChildLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WatsonChild addWatsonChild(WatsonChild watsonChild);
	...
	*/
	...
	public WatsonChild deleteWatsonChild(long watsonChildId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WatsonChild deleteWatsonChild(WatsonChild watsonChild);
	...
	*/
	...
	public WatsonChild fetchWatsonChild(long watsonChildId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WatsonChild getWatsonChild(long watsonChildId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WatsonChild> getWatsonChilds(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WatsonChild updateWatsonChild(WatsonChild watsonChild);
}