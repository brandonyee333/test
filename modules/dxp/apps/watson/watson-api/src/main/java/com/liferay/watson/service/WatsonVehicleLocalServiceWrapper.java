...
public class WatsonVehicleLocalServiceWrapper
	implements WatsonVehicleLocalService,
		ServiceWrapper<WatsonVehicleLocalService> {
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _watsonVehicleLocalService.dynamicQuery(dynamicQuery, start, end);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _watsonVehicleLocalService.dynamicQuery(dynamicQuery, start,
