...
public class WatsonHistoryLocalServiceWrapper
	implements WatsonHistoryLocalService,
		ServiceWrapper<WatsonHistoryLocalService> {
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _watsonHistoryLocalService.dynamicQuery(dynamicQuery, start, end);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _watsonHistoryLocalService.dynamicQuery(dynamicQuery, start,
