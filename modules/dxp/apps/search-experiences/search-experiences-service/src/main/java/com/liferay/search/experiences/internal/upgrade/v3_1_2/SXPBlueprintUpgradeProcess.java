...
public class SXPBlueprintUpgradeProcess extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		_upgradeSXPBlueprintClauseContributors();
	}

	private void _updateToUseDynamicStorage(SXPBlueprint sxpBlueprint) {
		_upgradeSXPBlueprintContributorStorageSchemaHelper.
			upgradeContributorStorageSchema(sxpBlueprint);
	}

	private void _upgradeSXPBlueprintClauseContributors() throws Exception {
		_companyLocalService.forEachCompanyId(
			companyId -> {
				...
				for (SXPBlueprint sxpBlueprint : sxpBlueprints) {
					_updateToUseDynamicStorage(sxpBlueprint);
				}
			});
	}
