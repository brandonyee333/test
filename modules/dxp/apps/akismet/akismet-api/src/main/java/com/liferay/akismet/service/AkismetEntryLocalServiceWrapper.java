 ...
 */
@ProviderType
public class AkismetEntryLocalServiceWrapper implements AkismetEntryLocalService,
	...
	*/
	@Override
	public java.util.List<com.liferay.akismet.model.AkismetEntry> getAkismetEntries(
		int start, int end) {
	...
	*/
	...
	public com.liferay.akismet.model.AkismetEntry updateAkismetEntry(
		...
		return _akismetEntryLocalService.updateAkismetEntry(className, classPK,
