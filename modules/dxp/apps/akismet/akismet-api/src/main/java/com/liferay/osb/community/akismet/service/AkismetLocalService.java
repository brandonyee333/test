...
/**
 * Provides the local service interface for Akismet. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jamie Sammons
 * @see AkismetLocalServiceUtil
 * @see com.liferay.osb.community.akismet.service.base.AkismetLocalServiceBaseImpl
 * @see com.liferay.osb.community.akismet.service.impl.AkismetLocalServiceImpl
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface AkismetLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AkismetLocalServiceUtil} to access the akismet local service. Add custom service methods to {@link com.liferay.osb.community.akismet.service.impl.AkismetLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Akismet addAkismet(Akismet akismet);
	...
	*/
	public Akismet createAkismet(long akismetId);
	...
	*/
	...
	public Akismet deleteAkismet(Akismet akismet);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Akismet deleteAkismet(long akismetId) throws PortalException;
	...
	*/
	...
	public Akismet fetchAkismet(long akismetId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Akismet fetchAkismetData(java.lang.String className, long classPK);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Akismet getAkismet(long akismetId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Akismet> getAkismets(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Akismet updateAkismet(Akismet akismet);

	public Akismet updateAkismetData(java.lang.String className, long classPK,
		java.lang.String type, java.lang.String permalink,
