				...
				prototype: {
					...
					toXML: function() {
						...
						if (!definitionDescription) {
							definitionDescription = instance.xmlDeserializer.get('definitionDescription');
						}

						var definitionName = metadata.definitionName;

						if (!definitionName) {
							definitionName = A.Escape.html(instance.xmlDeserializer.get('definitionName'));
						}

						var definitionVersion = metadata.definitionVersion;

						if (!definitionVersion) {
							definitionVersion = instance.xmlDeserializer.get('definitionVersion');
						}
