...
public class KaleoDraftDefinitionPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setKaleoDraftDefinitionUtilPersistence(this);
	}

	public void destroy() {
		_setKaleoDraftDefinitionUtilPersistence(null);
	...
	private void _setKaleoDraftDefinitionUtilPersistence(
		KaleoDraftDefinitionPersistence kaleoDraftDefinitionPersistence) {

		try {
			Field field = KaleoDraftDefinitionUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, kaleoDraftDefinitionPersistence);
		}
