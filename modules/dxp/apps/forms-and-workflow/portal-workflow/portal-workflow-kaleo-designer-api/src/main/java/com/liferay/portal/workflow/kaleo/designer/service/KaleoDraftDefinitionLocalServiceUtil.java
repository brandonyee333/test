...
public class KaleoDraftDefinitionLocalServiceUtil {
	...
	*/
	public static int getKaleoDraftDefinitionsCount(String name, int version,
		com.liferay.portal.kernel.service.ServiceContext serviceContext) {
		return getService()
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(KaleoDraftDefinitionLocalService.class);

		ServiceTracker<KaleoDraftDefinitionLocalService, KaleoDraftDefinitionLocalService> serviceTracker =
			new ServiceTracker<KaleoDraftDefinitionLocalService, KaleoDraftDefinitionLocalService>(bundle.getBundleContext(),
