...
public class KaleoDraftDefinitionUtil {
	...
	*/
	public static KaleoDraftDefinition fetchByC_N_V_D(long companyId,
		String name, int version, int draftVersion, boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByC_N_V_D(companyId, name, version, draftVersion,
			retrieveFromCache);
	}
	...
	* @return the number of matching kaleo draft definitions
	*/
	public static int countByC_N_V_D(long companyId, String name, int version,
		int draftVersion) {
		return getPersistence()
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(KaleoDraftDefinitionPersistence.class);

		ServiceTracker<KaleoDraftDefinitionPersistence, KaleoDraftDefinitionPersistence> serviceTracker =
			new ServiceTracker<KaleoDraftDefinitionPersistence, KaleoDraftDefinitionPersistence>(bundle.getBundleContext(),
