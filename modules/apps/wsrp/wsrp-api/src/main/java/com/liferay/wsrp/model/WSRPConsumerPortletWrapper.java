...
public class WSRPConsumerPortletWrapper
	...
	@Override
	public Object clone() {
		return new WSRPConsumerPortletWrapper(
			(WSRPConsumerPortlet)_wsrpConsumerPortlet.clone());
	}
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<WSRPConsumerPortlet>
		toCacheModel() {
	...
	public WSRPConsumerPortlet toEscapedModel() {
		return new WSRPConsumerPortletWrapper(
			_wsrpConsumerPortlet.toEscapedModel());
	}
	...
	public WSRPConsumerPortlet toUnescapedModel() {
		return new WSRPConsumerPortletWrapper(
			_wsrpConsumerPortlet.toUnescapedModel());
	}
