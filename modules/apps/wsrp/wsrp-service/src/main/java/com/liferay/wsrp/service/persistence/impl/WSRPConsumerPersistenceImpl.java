...
public class WSRPConsumerPersistenceImpl
	...
	public List<WSRPConsumer> findByUuid(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_WSRPCONSUMER_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(WSRPConsumerModelImpl.ORDER_BY_JPQL);
			}
	...
	public WSRPConsumer findByUuid_First(
		...
		throw new NoSuchConsumerException(sb.toString());
	}
	...
	protected WSRPConsumer getByUuid_PrevAndNext(
		...
		List<WSRPConsumer> list = query.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_WSRPCONSUMER_WHERE);
	...
	public void cacheResult(List<WSRPConsumer> wsrpConsumers) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (wsrpConsumers.size() > _valueObjectFinderCacheListThreshold))) {
	...
	public WSRPConsumer remove(Serializable primaryKey)
		...
		catch (NoSuchConsumerException noSuchEntityException) {
	...
	public Map<Serializable, WSRPConsumer> fetchByPrimaryKeys(
		...
		try {
			...
			for (WSRPConsumer wsrpConsumer : (List<WSRPConsumer>)query.list()) {
	...
	public List<WSRPConsumer> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_WSRPCONSUMER);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_WSRPCONSUMER);
