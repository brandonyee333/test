...
public class ProcessListMenuTag extends IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute(
			...
			String.valueOf(_backgroundTaskGroupId));
		request.setAttribute(
			"liferay-staging:process-list-menu:backgroundTaskId",
			String.valueOf(_backgroundTaskId));
		request.setAttribute(
			"liferay-staging:process-list-menu:deleteLabel",
			String.valueOf(_deleteLabel));
		request.setAttribute(
			"liferay-staging:process-list-menu:localPublishing",
			String.valueOf(_localPublishing));
	}
