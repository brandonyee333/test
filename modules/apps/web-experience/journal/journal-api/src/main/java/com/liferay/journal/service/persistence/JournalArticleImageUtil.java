...
/**
 * The persistence utility for the journal article image service. This utility wraps <code>com.liferay.journal.service.persistence.impl.JournalArticleImagePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class JournalArticleImageUtil {
	 ...
	 */
	public static Map<Serializable, JournalArticleImage> fetchByPrimaryKeys(
	 ...
	 */
	public static JournalArticleImage findByGroupId_First(
			long groupId,
			OrderByComparator<JournalArticleImage> orderByComparator)
	 ...
	 */
	public static JournalArticleImage fetchByGroupId_First(
		long groupId,
		OrderByComparator<JournalArticleImage> orderByComparator) {
	 ...
	 * @throws NoSuchArticleImageException if a matching journal article image could not be found
	 */
	public static JournalArticleImage findByGroupId_Last(
			long groupId,
			OrderByComparator<JournalArticleImage> orderByComparator)
		throws com.liferay.journal.exception.NoSuchArticleImageException {
	 ...
	 */
	public static JournalArticleImage fetchByGroupId_Last(
		long groupId,
		OrderByComparator<JournalArticleImage> orderByComparator) {
	...
	public static JournalArticleImage[] findByGroupId_PrevAndNext(
		...
		return getPersistence().findByGroupId_PrevAndNext(
			articleImageId, groupId, orderByComparator);
	}
	 ...
	 * @throws NoSuchArticleImageException if a matching journal article image could not be found
	 */
	public static JournalArticleImage findByTempImage_First(
			boolean tempImage,
			OrderByComparator<JournalArticleImage> orderByComparator)
		throws com.liferay.journal.exception.NoSuchArticleImageException {

		return getPersistence().findByTempImage_First(
	...
	public static JournalArticleImage fetchByTempImage_First(
		...
		return getPersistence().fetchByTempImage_First(
			tempImage, orderByComparator);
	}
	 ...
	 * @throws NoSuchArticleImageException if a matching journal article image could not be found
	 */
	public static JournalArticleImage findByTempImage_Last(
			boolean tempImage,
			OrderByComparator<JournalArticleImage> orderByComparator)
		throws com.liferay.journal.exception.NoSuchArticleImageException {

		return getPersistence().findByTempImage_Last(
			tempImage, orderByComparator);
	}
	 ...
	 * @return the last matching journal article image, or <code>null</code> if a matching journal article image could not be found
	 */
	public static JournalArticleImage fetchByTempImage_Last(
		boolean tempImage,
		OrderByComparator<JournalArticleImage> orderByComparator) {

		return getPersistence().fetchByTempImage_Last(
			tempImage, orderByComparator);
	}
	...
	public static JournalArticleImage[] findByTempImage_PrevAndNext(
		...
		return getPersistence().findByTempImage_PrevAndNext(
			articleImageId, tempImage, orderByComparator);
	}
	...
	public static List<JournalArticleImage> findByG_A_V(
		...
		return getPersistence().findByG_A_V(
			groupId, articleId, version, start, end);
	}
	 ...
	 * @throws NoSuchArticleImageException if a matching journal article image could not be found
	 */
	public static JournalArticleImage findByG_A_V_First(
			long groupId, String articleId, double version,
			OrderByComparator<JournalArticleImage> orderByComparator)
		throws com.liferay.journal.exception.NoSuchArticleImageException {

		return getPersistence().findByG_A_V_First(
	 ...
	 * @return the first matching journal article image, or <code>null</code> if a matching journal article image could not be found
	 */
	public static JournalArticleImage fetchByG_A_V_First(
		long groupId, String articleId, double version,
		OrderByComparator<JournalArticleImage> orderByComparator) {

		return getPersistence().fetchByG_A_V_First(
			groupId, articleId, version, orderByComparator);
	}
	 ...
	 * @throws NoSuchArticleImageException if a matching journal article image could not be found
	 */
	public static JournalArticleImage findByG_A_V_Last(
			long groupId, String articleId, double version,
			OrderByComparator<JournalArticleImage> orderByComparator)
		throws com.liferay.journal.exception.NoSuchArticleImageException {

		return getPersistence().findByG_A_V_Last(
			groupId, articleId, version, orderByComparator);
	}
	 ...
	 * @return the last matching journal article image, or <code>null</code> if a matching journal article image could not be found
	 */
	public static JournalArticleImage fetchByG_A_V_Last(
		long groupId, String articleId, double version,
		OrderByComparator<JournalArticleImage> orderByComparator) {

		return getPersistence().fetchByG_A_V_Last(
			groupId, articleId, version, orderByComparator);
	}
	...
	public static JournalArticleImage[] findByG_A_V_PrevAndNext(
		...
		return getPersistence().findByG_A_V_PrevAndNext(
			articleImageId, groupId, articleId, version, orderByComparator);
	}
	 ...
	 * @param version the version
	 */
	public static void removeByG_A_V(
		long groupId, String articleId, double version) {
	 ...
	 */
	public static JournalArticleImage removeByG_A_V_E_E_L(
			long groupId, String articleId, double version, String elInstanceId,
			String elName, String languageId)
		throws com.liferay.journal.exception.NoSuchArticleImageException {

		return getPersistence().removeByG_A_V_E_E_L(
			groupId, articleId, version, elInstanceId, elName, languageId);
	}
	 ...
	 * @return the number of matching journal article images
	 */
	public static int countByG_A_V_E_E_L(
		long groupId, String articleId, double version, String elInstanceId,
		String elName, String languageId) {

		return getPersistence().countByG_A_V_E_E_L(
			groupId, articleId, version, elInstanceId, elName, languageId);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			JournalArticleImagePersistence.class);
