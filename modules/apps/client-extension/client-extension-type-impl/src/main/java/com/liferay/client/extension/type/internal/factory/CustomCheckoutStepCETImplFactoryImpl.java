...
public class CustomCheckoutStepCETImplFactoryImpl
	implements CETImplFactory<CustomCheckoutStepCET> {

	@Override
	public CustomCheckoutStepCET create(ClientExtensionEntry clientExtensionEntry)
		throws PortalException {

		return new CustomCheckoutStepCETImpl(clientExtensionEntry);
	}

	@Override
	public CustomCheckoutStepCET create(PortletRequest portletRequest)
		throws PortalException {

		return new CustomCheckoutStepCETImpl(portletRequest);
	}
