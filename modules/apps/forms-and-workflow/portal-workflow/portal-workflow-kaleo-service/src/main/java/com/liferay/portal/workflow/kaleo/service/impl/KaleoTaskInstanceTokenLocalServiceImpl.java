...
public class KaleoTaskInstanceTokenLocalServiceImpl
	...
	public void deleteKaleoDefinitionKaleoTaskInstanceTokens(
		...
		for (KaleoTaskInstanceToken kaleoTaskInstanceToken :
				kaleoTaskInstanceTokenPersistence.findByKaleoDefinitionId(
					kaleoDefinitionId)) {
	...
	public List<KaleoTaskInstanceToken> search(
		...
		return search(
			null, taskName, assetTypes, assetPrimaryKeys, dueDateGT, dueDateLT,
	...
	protected SearchContext buildSearchContext(
		...
		searchContext.setAttribute(
			"kaleoTaskInstanceTokenQuery",
			(Serializable)kaleoTaskInstanceTokenQuery);
