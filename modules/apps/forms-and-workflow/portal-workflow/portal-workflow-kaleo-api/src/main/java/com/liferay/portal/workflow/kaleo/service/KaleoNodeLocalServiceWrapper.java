...
public class KaleoNodeLocalServiceWrapper
	...
	public void deleteKaleoDefinitionKaleoNodes(long kaleoDefinitionId) {
		_kaleoNodeLocalService.deleteKaleoDefinitionKaleoNodes(
			kaleoDefinitionId);
	}
	...
	public java.util.List<com.liferay.portal.workflow.kaleo.model.KaleoNode>
		getKaleoDefinitionKaleoNodes(long kaleoDefinitionId) {

		return _kaleoNodeLocalService.getKaleoDefinitionKaleoNodes(
			kaleoDefinitionId);
	}
