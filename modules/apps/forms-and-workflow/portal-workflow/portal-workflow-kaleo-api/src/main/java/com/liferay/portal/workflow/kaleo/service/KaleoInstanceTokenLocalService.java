...
public interface KaleoInstanceTokenLocalService extends BaseLocalService,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Hits search(java.lang.Long userId, java.lang.String assetClassName,
		...
		int start, int end, Sort[] sorts, ServiceContext serviceContext);
	...
	*/
	...
	public KaleoInstanceToken addKaleoInstanceToken(long currentKaleoNodeId,
		long kaleoDefinitionId, long kaleoInstanceId,
