...
<clay:management-toolbar
	managementToolbarDisplayContext="<%= new AnnouncementsAdminViewManagementToolbarDisplayContext(request, liferayPortletRequest, liferayPortletResponse, announcementsAdminViewDisplayContext) %>"
