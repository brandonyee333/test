...
<%
DLMimeTypeDisplayContext dlMimeTypeDisplayContext = (DLMimeTypeDisplayContext)request.getAttribute(KBAttachmentItemSelectorView.DL_MIME_TYPE_DISPLAY_CONTEXT);
