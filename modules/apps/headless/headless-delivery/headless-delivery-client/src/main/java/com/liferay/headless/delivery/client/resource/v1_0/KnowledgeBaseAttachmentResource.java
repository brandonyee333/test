...
public interface KnowledgeBaseAttachmentResource {
	...
	public HttpInvoker.HttpResponse
			getKnowledgeBaseAttachmentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putKnowledgeBaseAttachmentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode,
				KnowledgeBaseAttachment knowledgeBaseAttachment,
				Map<String, File> multipartFiles)
		throws Exception;
	...
	public static class KnowledgeBaseAttachmentResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-delivery/v1.0/knowledge-base-attachments/by-external-reference-code/{externalReferenceCode}");
