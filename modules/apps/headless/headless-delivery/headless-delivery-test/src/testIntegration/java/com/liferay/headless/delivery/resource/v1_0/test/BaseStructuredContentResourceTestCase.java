...
public abstract class BaseStructuredContentResourceTestCase {
	...
	protected void assertValid(StructuredContent structuredContent) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("relatedAssets", additionalAssertFieldName)) {
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("relatedAssets", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						structuredContent1.getRelatedAssets(),
						structuredContent2.getRelatedAssets())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("relatedAssets")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
