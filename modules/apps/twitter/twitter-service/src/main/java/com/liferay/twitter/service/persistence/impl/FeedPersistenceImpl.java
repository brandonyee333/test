...
public class FeedPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setFeedUtilPersistence(this);
	}

	public void destroy() {
		_setFeedUtilPersistence(null);
	...
	private void _setFeedUtilPersistence(FeedPersistence feedPersistence) {
		try {
			Field field = FeedUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, feedPersistence);
		}
