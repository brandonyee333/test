...
public class ReleaseManagerHelper {
	...
	public void closeServiceTrackerMap() {
	...
	public ServiceTrackerMap<String, List<UpgradeInfo>>
		openMultiValueMapServiceTrackerMap(BundleContext bundleContext) {

		return _serviceTrackerMap = ServiceTrackerMapFactory.openMultiValueMap(
