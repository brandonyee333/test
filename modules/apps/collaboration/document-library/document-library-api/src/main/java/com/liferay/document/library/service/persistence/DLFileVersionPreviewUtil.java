 ...
 * @see com.liferay.document.library.service.persistence.impl.DLFileVersionPreviewPersistenceImpl
 * @generated
 */
@ProviderType
public class DLFileVersionPreviewUtil {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, DLFileVersionPreview> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<DLFileVersionPreviewPersistence, DLFileVersionPreviewPersistence> _serviceTracker =
		ServiceTrackerFactory.open(DLFileVersionPreviewPersistence.class);
}