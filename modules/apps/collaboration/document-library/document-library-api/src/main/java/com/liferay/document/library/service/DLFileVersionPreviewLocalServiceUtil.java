 ...
 * {@link com.liferay.document.library.service.impl.DLFileVersionPreviewLocalServiceImpl} and is the
 ...
 * @see com.liferay.document.library.service.base.DLFileVersionPreviewLocalServiceBaseImpl
...
public class DLFileVersionPreviewLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.document.library.service.impl.DLFileVersionPreviewLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static boolean hasDLFileVersionPreview(long fileEntryId,
		long fileVersionId, int previewStatus) {
		return getService()
				   .hasDLFileVersionPreview(fileEntryId, fileVersionId,
			previewStatus);
	}
	...
	*/
	public static com.liferay.document.library.model.DLFileVersionPreview addDLFileVersionPreview(
	...
	*/
	public static com.liferay.document.library.model.DLFileVersionPreview createDLFileVersionPreview(
	...
	*/
	public static com.liferay.document.library.model.DLFileVersionPreview deleteDLFileVersionPreview(
		com.liferay.document.library.model.DLFileVersionPreview dlFileVersionPreview) {
	...
	*/
	...
	public static com.liferay.document.library.model.DLFileVersionPreview fetchDLFileVersionPreview(
		long dlFileVersionPreviewId) {
	...
	public static com.liferay.document.library.model.DLFileVersionPreview fetchDLFileVersionPreview(
		...
		return getService().fetchDLFileVersionPreview(fileEntryId, fileVersionId);
	}

	public static com.liferay.document.library.model.DLFileVersionPreview fetchDLFileVersionPreview(
		long fileEntryId, long fileVersionId, int previewStatus) {
		return getService()
				   .fetchDLFileVersionPreview(fileEntryId, fileVersionId,
			previewStatus);
	}
	...
	* @throws PortalException if a dl file version preview with the primary key could not be found
	*/
	public static com.liferay.document.library.model.DLFileVersionPreview getDLFileVersionPreview(
		long dlFileVersionPreviewId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.liferay.document.library.model.DLFileVersionPreview getDLFileVersionPreview(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getDLFileVersionPreview(fileEntryId, fileVersionId,
			previewStatus);
	}
	...
	*/
	public static com.liferay.document.library.model.DLFileVersionPreview updateDLFileVersionPreview(
		com.liferay.document.library.model.DLFileVersionPreview dlFileVersionPreview) {
	...
	*/
	public static java.util.List<com.liferay.document.library.model.DLFileVersionPreview> getDLFileVersionPreviews(
		int start, int end) {
		return getService().getDLFileVersionPreviews(start, end);
	}

	public static java.util.List<com.liferay.document.library.model.DLFileVersionPreview> getFileEntryDLFileVersionPreviews(
		long fileEntryId) {
	...
	*/
	...
	public static void addDLFileVersionPreview(long fileEntryId,
		long fileVersionId, int previewStatus)
		throws com.liferay.portal.kernel.exception.PortalException {
		getService()
			.addDLFileVersionPreview(fileEntryId, fileVersionId, previewStatus);
	}
	...
	public static void updateDLFileVersionPreview(long dlFileVersionPreviewId,
		int previewStatus)
		throws com.liferay.portal.kernel.exception.PortalException {
		getService()
			.updateDLFileVersionPreview(dlFileVersionPreviewId, previewStatus);
	}
	...
	private static ServiceTracker<DLFileVersionPreviewLocalService, DLFileVersionPreviewLocalService> _serviceTracker =
		ServiceTrackerFactory.open(DLFileVersionPreviewLocalService.class);
}