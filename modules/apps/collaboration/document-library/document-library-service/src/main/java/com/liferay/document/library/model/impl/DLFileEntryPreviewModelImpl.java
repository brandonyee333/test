...
public class DLFileEntryPreviewModelImpl
	...
	private static Function<InvocationHandler, DLFileEntryPreview>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			DLFileEntryPreview.class.getClassLoader(), DLFileEntryPreview.class,
			ModelWrapper.class);

		try {
			Constructor<DLFileEntryPreview> constructor =
				(Constructor<DLFileEntryPreview>)proxyClass.getConstructor(
	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<DLFileEntryPreview, Object>() {
				...
				public void accept(
					...
					Object fileEntryPreviewIdObject) {

					dlFileEntryPreview.setFileEntryPreviewId(
						(Long)fileEntryPreviewIdObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<DLFileEntryPreview, Object>() {
				...
				public void accept(
					...
					dlFileEntryPreview.setGroupId((Long)groupIdObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<DLFileEntryPreview, Object>() {
				...
				public void accept(
					...
					dlFileEntryPreview.setFileEntryId((Long)fileEntryIdObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<DLFileEntryPreview, Object>() {
				...
				public void accept(
					...
					dlFileEntryPreview.setFileVersionId(
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<DLFileEntryPreview, Object>() {
				...
				public void accept(
					DLFileEntryPreview dlFileEntryPreview,
					Object previewTypeObject) {

					dlFileEntryPreview.setPreviewType(
						(Integer)previewTypeObject);
				}
	...
	public DLFileEntryPreview toEscapedModel() {
		if (_escapedModel == null) {
			Function<InvocationHandler, DLFileEntryPreview>
	...
	private static class EscapedModelProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, DLFileEntryPreview>
