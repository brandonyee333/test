 ...
 * @see com.liferay.document.library.service.persistence.DLFileVersionPreviewUtil
 * @generated
 */
@ProviderType
public class DLFileVersionPreviewPersistenceImpl extends BasePersistenceImpl<DLFileVersionPreview>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link DLFileVersionPreviewUtil} to access the dl file version preview persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(DLFileVersionPreviewModelImpl.ENTITY_CACHE_ENABLED,
			DLFileVersionPreviewModelImpl.FINDER_CACHE_ENABLED,
			DLFileVersionPreviewImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(DLFileVersionPreviewModelImpl.ENTITY_CACHE_ENABLED,
			DLFileVersionPreviewModelImpl.FINDER_CACHE_ENABLED,
			DLFileVersionPreviewImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(DLFileVersionPreviewModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_FILEENTRYID =
		new FinderPath(DLFileVersionPreviewModelImpl.ENTITY_CACHE_ENABLED,
			DLFileVersionPreviewModelImpl.FINDER_CACHE_ENABLED,
			DLFileVersionPreviewImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_FILEENTRYID = new FinderPath(DLFileVersionPreviewModelImpl.ENTITY_CACHE_ENABLED,
			DLFileVersionPreviewModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	protected DLFileVersionPreview getByFileEntryId_PrevAndNext(
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(dlFileVersionPreview);
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_FILEVERSIONID = new FinderPath(DLFileVersionPreviewModelImpl.ENTITY_CACHE_ENABLED,
			DLFileVersionPreviewModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_F_F = new FinderPath(DLFileVersionPreviewModelImpl.ENTITY_CACHE_ENABLED,
			DLFileVersionPreviewModelImpl.FINDER_CACHE_ENABLED,
			...
			DLFileVersionPreviewModelImpl.FILEENTRYID_COLUMN_BITMASK |
			DLFileVersionPreviewModelImpl.FILEVERSIONID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_F = new FinderPath(DLFileVersionPreviewModelImpl.ENTITY_CACHE_ENABLED,
			DLFileVersionPreviewModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_F",
			new String[] { Long.class.getName(), Long.class.getName() });

	/**
	 * Returns the dl file version preview where fileEntryId = &#63; and fileVersionId = &#63; or throws a {@link NoSuchFileVersionPreviewException} if it could not be found.
	 *
	 * @param fileEntryId the file entry ID
	 * @param fileVersionId the file version ID
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((dlFileVersionPreview.getFileEntryId() != fileEntryId) ||
							(dlFileVersionPreview.getFileVersionId() != fileVersionId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_F_F,
							finderArgs, dlFileVersionPreview);
					}
				}
			}
			catch (Exception e) {
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_F_F_P = new FinderPath(DLFileVersionPreviewModelImpl.ENTITY_CACHE_ENABLED,
			DLFileVersionPreviewModelImpl.FINDER_CACHE_ENABLED,
			DLFileVersionPreviewImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByF_F_P",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_F_F_P = new FinderPath(DLFileVersionPreviewModelImpl.ENTITY_CACHE_ENABLED,
			DLFileVersionPreviewModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	/**
	 * Returns the dl file version preview where fileEntryId = &#63; and fileVersionId = &#63; and previewStatus = &#63; or throws a {@link NoSuchFileVersionPreviewException} if it could not be found.
	 *
	 * @param fileEntryId the file entry ID
	 * @param fileVersionId the file version ID
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((dlFileVersionPreview.getFileEntryId() != fileEntryId) ||
							(dlFileVersionPreview.getFileVersionId() != fileVersionId) ||
							(dlFileVersionPreview.getPreviewStatus() != previewStatus)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_F_F_P,
							finderArgs, dlFileVersionPreview);
					}
				}
	...
	protected DLFileVersionPreview removeImpl(
		...
		dlFileVersionPreview = toUnwrappedModel(dlFileVersionPreview);
	...
	protected DLFileVersionPreview toUnwrappedModel(
		DLFileVersionPreview dlFileVersionPreview) {
		if (dlFileVersionPreview instanceof DLFileVersionPreviewImpl) {
			return dlFileVersionPreview;
		}

		DLFileVersionPreviewImpl dlFileVersionPreviewImpl = new DLFileVersionPreviewImpl();

		dlFileVersionPreviewImpl.setNew(dlFileVersionPreview.isNew());
		dlFileVersionPreviewImpl.setPrimaryKey(dlFileVersionPreview.getPrimaryKey());

		dlFileVersionPreviewImpl.setDlFileVersionPreviewId(dlFileVersionPreview.getDlFileVersionPreviewId());
		dlFileVersionPreviewImpl.setGroupId(dlFileVersionPreview.getGroupId());
		dlFileVersionPreviewImpl.setFileEntryId(dlFileVersionPreview.getFileEntryId());
		dlFileVersionPreviewImpl.setFileVersionId(dlFileVersionPreview.getFileVersionId());
		dlFileVersionPreviewImpl.setPreviewStatus(dlFileVersionPreview.getPreviewStatus());

		return dlFileVersionPreviewImpl;
	}

	/**
	 * Returns the dl file version preview with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the dl file version preview
	...
	/**
	 * Returns the dl file version preview with the primary key or throws a {@link NoSuchFileVersionPreviewException} if it could not be found.
	 *
	 * @param dlFileVersionPreviewId the primary key of the dl file version preview
	 * @return the dl file version preview
	 * @throws NoSuchFileVersionPreviewException if a dl file version preview with the primary key could not be found
	...
	public DLFileVersionPreview fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(DLFileVersionPreviewModelImpl.ENTITY_CACHE_ENABLED,
		...
		DLFileVersionPreview dlFileVersionPreview = (DLFileVersionPreview)serializable;
	...
	public Map<Serializable, DLFileVersionPreview> fetchByPrimaryKeys(
		...
		Map<Serializable, DLFileVersionPreview> map = new HashMap<Serializable, DLFileVersionPreview>();
		...
		try {
			...
			for (DLFileVersionPreview dlFileVersionPreview : (List<DLFileVersionPreview>)q.list()) {
				map.put(dlFileVersionPreview.getPrimaryKeyObj(),
					dlFileVersionPreview);

				cacheResult(dlFileVersionPreview);

				uncachedPrimaryKeys.remove(dlFileVersionPreview.getPrimaryKeyObj());
			}
	...
	private static final String _SQL_SELECT_DLFILEVERSIONPREVIEW_WHERE_PKS_IN = "SELECT dlFileVersionPreview FROM DLFileVersionPreview dlFileVersionPreview WHERE dlFileVersionPreviewId IN (";
