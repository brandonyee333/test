...
public class ShoppingItemFieldPersistenceTest {
	...
	public void testRemove() throws Exception {
		...
		ShoppingItemField existingShoppingItemField =
			_persistence.fetchByPrimaryKey(
				newShoppingItemField.getPrimaryKey());
	...
	public void testUpdateExisting() throws Exception {
		...
		ShoppingItemField existingShoppingItemField =
			_persistence.findByPrimaryKey(newShoppingItemField.getPrimaryKey());

		Assert.assertEquals(
			existingShoppingItemField.getItemFieldId(),
			newShoppingItemField.getItemFieldId());
		Assert.assertEquals(
			existingShoppingItemField.getCompanyId(),
			newShoppingItemField.getCompanyId());
		Assert.assertEquals(
			existingShoppingItemField.getItemId(),
			newShoppingItemField.getItemId());
		Assert.assertEquals(
			existingShoppingItemField.getName(),
			newShoppingItemField.getName());
		Assert.assertEquals(
			existingShoppingItemField.getValues(),
			newShoppingItemField.getValues());
		Assert.assertEquals(
			existingShoppingItemField.getDescription(),
	...
	protected OrderByComparator<ShoppingItemField> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"ShoppingItemField", "itemFieldId", true, "companyId", true,
			"itemId", true, "name", true, "values", true, "description", true);
	}
	...
	public void testFetchByPrimaryKeyMissing() throws Exception {
		...
		ShoppingItemField missingShoppingItemField =
	...
	public void testActionableDynamicQuery() throws Exception {
		...
		ActionableDynamicQuery actionableDynamicQuery =
			ShoppingItemFieldLocalServiceUtil.getActionableDynamicQuery();
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		DynamicQuery dynamicQuery = DynamicQueryFactoryUtil.forClass(
			ShoppingItemField.class, _dynamicQueryClassLoader);

		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"itemFieldId", newShoppingItemField.getItemFieldId()));

		List<ShoppingItemField> result = _persistence.findWithDynamicQuery(
			dynamicQuery);
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"itemFieldId", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(
			ProjectionFactoryUtil.property("itemFieldId"));

		Object newItemFieldId = newShoppingItemField.getItemFieldId();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"itemFieldId", new Object[] {newItemFieldId}));
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"itemFieldId", new Object[] {RandomTestUtil.nextLong()}));
	...
	protected ShoppingItemField addShoppingItemField() throws Exception {
		long pk = RandomTestUtil.nextLong();
	...
	private List<ShoppingItemField> _shoppingItemFields =
