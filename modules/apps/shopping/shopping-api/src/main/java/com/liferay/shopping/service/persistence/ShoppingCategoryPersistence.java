...
public interface ShoppingCategoryPersistence
	 ...
	 */
	public java.util.List<ShoppingCategory> filterFindByGroupId(
		long groupId, int start, int end);
	 ...
	 * @return the matching shopping categories that the user has permission to view
	 */
	public java.util.List<ShoppingCategory> filterFindByG_P(
		long groupId, long parentCategoryId);
	...
	public void cacheResult(
		java.util.List<ShoppingCategory> shoppingCategories);
