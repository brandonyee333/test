...
public class ShoppingItemPriceWrapper
	implements ModelWrapper<ShoppingItemPrice>, ShoppingItemPrice {
	...
	@Override
	public Object clone() {
		return new ShoppingItemPriceWrapper(
			(ShoppingItemPrice)_shoppingItemPrice.clone());
	}
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<ShoppingItemPrice>
		toCacheModel() {
	...
	public ShoppingItemPrice toEscapedModel() {
		return new ShoppingItemPriceWrapper(
			_shoppingItemPrice.toEscapedModel());
	}
	...
	public ShoppingItemPrice toUnescapedModel() {
		return new ShoppingItemPriceWrapper(
			_shoppingItemPrice.toUnescapedModel());
	}
