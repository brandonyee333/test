...
/**
 * The persistence utility for the shopping item field service. This utility wraps <code>com.liferay.shopping.service.persistence.impl.ShoppingItemFieldPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ShoppingItemFieldUtil {
	 ...
	 */
	public static Map<Serializable, ShoppingItemField> fetchByPrimaryKeys(
	 ...
	 */
	public static ShoppingItemField findByItemId_First(
	 ...
	 */
	public static ShoppingItemField fetchByItemId_First(
		long itemId, OrderByComparator<ShoppingItemField> orderByComparator) {
	 ...
	 * @throws NoSuchItemFieldException if a matching shopping item field could not be found
	 */
	public static ShoppingItemField findByItemId_Last(
			long itemId, OrderByComparator<ShoppingItemField> orderByComparator)
		throws com.liferay.shopping.exception.NoSuchItemFieldException {
	 ...
	 */
	public static ShoppingItemField fetchByItemId_Last(
		long itemId, OrderByComparator<ShoppingItemField> orderByComparator) {
	...
	public static ShoppingItemField[] findByItemId_PrevAndNext(
		...
		return getPersistence().findByItemId_PrevAndNext(
			itemFieldId, itemId, orderByComparator);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ShoppingItemFieldPersistence.class);
