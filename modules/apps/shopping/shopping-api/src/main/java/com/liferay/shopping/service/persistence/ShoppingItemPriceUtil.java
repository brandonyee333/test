...
/**
 * The persistence utility for the shopping item price service. This utility wraps <code>com.liferay.shopping.service.persistence.impl.ShoppingItemPricePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ShoppingItemPriceUtil {
	 ...
	 */
	public static Map<Serializable, ShoppingItemPrice> fetchByPrimaryKeys(
	 ...
	 */
	public static List<ShoppingItemPrice> findByItemId(
	 ...
	 */
	public static ShoppingItemPrice findByItemId_First(
	 ...
	 */
	public static ShoppingItemPrice fetchByItemId_First(
		long itemId, OrderByComparator<ShoppingItemPrice> orderByComparator) {
	 ...
	 * @throws NoSuchItemPriceException if a matching shopping item price could not be found
	 */
	public static ShoppingItemPrice findByItemId_Last(
			long itemId, OrderByComparator<ShoppingItemPrice> orderByComparator)
		throws com.liferay.shopping.exception.NoSuchItemPriceException {
	 ...
	 */
	public static ShoppingItemPrice fetchByItemId_Last(
		long itemId, OrderByComparator<ShoppingItemPrice> orderByComparator) {
	...
	public static ShoppingItemPrice[] findByItemId_PrevAndNext(
		...
		return getPersistence().findByItemId_PrevAndNext(
			itemPriceId, itemId, orderByComparator);
	}
	...
	public static void setPersistence(
		ShoppingItemPricePersistence persistence) {

		_persistence = persistence;
	}

	private static volatile ShoppingItemPricePersistence _persistence;
