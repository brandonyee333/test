...
/**
 * The persistence utility for the shopping item service. This utility wraps <code>com.liferay.shopping.service.persistence.impl.ShoppingItemPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ShoppingItemUtil {
	 ...
	 */
	public static Map<Serializable, ShoppingItem> fetchByPrimaryKeys(
	 ...
	 */
	public static ShoppingItem update(
		ShoppingItem shoppingItem, ServiceContext serviceContext) {
	 ...
	 * @throws NoSuchItemException if a matching shopping item could not be found
	 */
	public static ShoppingItem findByG_C_First(
	 ...
	 */
	public static ShoppingItem fetchByG_C_First(
		long groupId, long categoryId,
		OrderByComparator<ShoppingItem> orderByComparator) {
	 ...
	 * @throws NoSuchItemException if a matching shopping item could not be found
	 */
	public static ShoppingItem findByG_C_Last(
			long groupId, long categoryId,
			OrderByComparator<ShoppingItem> orderByComparator)
		throws com.liferay.shopping.exception.NoSuchItemException {
	 ...
	 */
	public static ShoppingItem fetchByG_C_Last(
		long groupId, long categoryId,
		OrderByComparator<ShoppingItem> orderByComparator) {
	 ...
	 */
	public static ShoppingItem[] findByG_C_PrevAndNext(
	 ...
	 */
	public static List<ShoppingItem> filterFindByG_C(
		long groupId, long categoryId) {
	 ...
	 * @throws NoSuchItemException if a shopping item with the primary key could not be found
	 */
	public static ShoppingItem[] filterFindByG_C_PrevAndNext(
			long itemId, long groupId, long categoryId,
			OrderByComparator<ShoppingItem> orderByComparator)
		throws com.liferay.shopping.exception.NoSuchItemException {
	...
	private static ServiceTracker
		<ShoppingItemPersistence, ShoppingItemPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ShoppingItemPersistence.class);

		ServiceTracker<ShoppingItemPersistence, ShoppingItemPersistence>
			serviceTracker =
				new ServiceTracker
