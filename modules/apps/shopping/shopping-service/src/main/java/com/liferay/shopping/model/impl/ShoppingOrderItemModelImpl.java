...
public class ShoppingOrderItemModelImpl extends BaseModelImpl<ShoppingOrderItem>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("itemId", Types.VARCHAR);
	...
	public static final String TABLE_SQL_CREATE = "create table ShoppingOrderItem (orderItemId LONG not null primary key,companyId LONG,orderId LONG,itemId VARCHAR(75) null,sku VARCHAR(75) null,name VARCHAR(75) null,description VARCHAR(75) null,properties VARCHAR(75) null,price DOUBLE,quantity INTEGER,shippedDate DATE null)";
