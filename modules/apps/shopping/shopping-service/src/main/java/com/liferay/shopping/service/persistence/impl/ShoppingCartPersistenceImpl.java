...
public class ShoppingCartPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_setShoppingCartUtilPersistence(this);
	}

	public void destroy() {
		_setShoppingCartUtilPersistence(null);
	...
	private void _setShoppingCartUtilPersistence(
		ShoppingCartPersistence shoppingCartPersistence) {

		try {
			Field field = ShoppingCartUtil.class.getDeclaredField(
				"_persistence");
