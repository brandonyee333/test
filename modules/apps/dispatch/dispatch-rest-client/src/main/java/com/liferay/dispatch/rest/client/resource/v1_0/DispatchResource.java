...
import com.liferay.dispatch.rest.client.pagination.Pagination;
...
public interface DispatchResource {
	...
	public HttpInvoker.HttpResponse getCompanyDispatchesHttpResponse(
	...
	public void postCreateDispatchTaskExecutorType(
	...
	public static class Builder {
		...
		public DispatchResource build() {
			return new DispatchResourceImpl(this);
		}
	...
	public static class DispatchResourceImpl implements DispatchResource {

		public String getCompanyDispatches(
				Long companyId, Pagination pagination)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getCompanyDispatchesHttpResponse(companyId, pagination);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/dispatch-rest/v1.0/company/{companyId}/dispatches");
		...
		private DispatchResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DispatchResource.class.getName());
