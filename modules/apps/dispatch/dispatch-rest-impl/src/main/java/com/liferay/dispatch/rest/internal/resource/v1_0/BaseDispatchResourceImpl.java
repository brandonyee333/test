...
public abstract class BaseDispatchResourceImpl implements DispatchResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/dispatch-rest/v1.0/company/{companyId}/dispatches'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/company/{companyId}/dispatches")
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseDispatchResourceImpl.class);
