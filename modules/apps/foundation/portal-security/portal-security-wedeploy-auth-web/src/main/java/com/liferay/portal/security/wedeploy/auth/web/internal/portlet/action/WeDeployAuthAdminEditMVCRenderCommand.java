...
@Component(
	...
	property = {
		...
		"mvc.command.name=/wedeploy_auth_admin/edit"
	},
	service = MVCRenderCommand.class
)
public class WeDeployAuthAdminEditMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		return "/wedeploy_auth_admin/edit.jsp";
	}
