...
<aui:fieldset>
	...
	<c:if test="<%= portletName.equals(myAccountPortletId) %>">
		<aui:input label="current-password" name="password0" size="30" type="password" />
	</c:if>

	<aui:input autocomplete="new-password" label="new-password" name="password1" size="30" type="password" />

	<aui:input autocomplete="new-password" label="enter-again" name="password2" size="30" type="password">
