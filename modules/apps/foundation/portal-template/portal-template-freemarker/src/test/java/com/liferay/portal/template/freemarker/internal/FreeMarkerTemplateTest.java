...
public class FreeMarkerTemplateTest {
	...
	public void setUp() throws Exception {
		...
		TemplateCache templateCache = new LiferayTemplateCache(
			...
			_freeMarkerTemplateResourceLoader, null);
	...
	public void testGet() throws Exception {
		Template template = new FreeMarkerTemplate(
			...
			_configuration, _templateContextHelper, false, false,
	...
	public void testProcessTemplate3() throws Exception {
		Template template = new FreeMarkerTemplate(
			...
			null, null, _configuration, _templateContextHelper, false, false,
			(BeansWrapper)_configuration.getObjectWrapper(), null,
			_templateResourceCache);
	...
	public void testProcessTemplate5() throws Exception {
		Template template = new FreeMarkerTemplate(
			...
			_templateContextHelper, false, false,
			(BeansWrapper)_configuration.getObjectWrapper(), null,
			_templateResourceCache);
	...
	public void testProcessTemplate7() throws Exception {
		Template template = new FreeMarkerTemplate(
			...
			null, _configuration, _templateContextHelper, false, false,
			(BeansWrapper)_configuration.getObjectWrapper(), null,
			_templateResourceCache);
