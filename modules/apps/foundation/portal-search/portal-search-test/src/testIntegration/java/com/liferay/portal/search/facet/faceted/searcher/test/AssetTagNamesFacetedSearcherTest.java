...
public class AssetTagNamesFacetedSearcherTest
	...
	public void testSearchQuoted() throws Exception {
		...
		String[] assetTagNames =
			new String[] {"Tag Name", "Nametag", "NA-META-G", "Names of Tags"};
		...
		assertTags("tag", expected);
		assertTags("tags names", expected);
		assertTags("name", expected);
		assertTags("Names of tags", expected);
		assertTags("nameTAG", expected);
		assertTags("of", expected);
