...
<aui:form action="<%= configurationActionURL %>" method="post" name="fm">
	...
	<div class="portlet-configuration-body-content">
		<div class="container-fluid-1280">
			...
			<aui:input label="show-asset-count" name="<%= PortletPreferencesJspUtil.getInputName(TagFacetPortletPreferences.PREFERENCE_KEY_FREQUENCIES_VISIBLE) %>" type="checkbox" value="<%= tagFacetPortletPreferences.isFrequenciesVisible() %>" />
		</div>
	</div>
