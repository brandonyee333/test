...
page import="com.liferay.portal.search.web.internal.tag.facet.constants.TagFacetWebKeys" %>
...
<%
AssetTagsSearchFacetDisplayContext assetTagsSearchFacetDisplayContext = (AssetTagsSearchFacetDisplayContext)java.util.Objects.requireNonNull(request.getAttribute(TagFacetWebKeys.DISPLAY_CONTEXT));
%>
