 ...
 * {@link com.liferay.analytics.message.storage.service.impl.AnalyticsMessageLocalServiceImpl} and is the
 ...
 * @see com.liferay.analytics.message.storage.service.base.AnalyticsMessageLocalServiceBaseImpl
...
public class AnalyticsMessageLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.analytics.message.storage.service.impl.AnalyticsMessageLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.analytics.message.storage.model.AnalyticsMessage addAnalyticsMessage(
	...
	*/
	public static com.liferay.analytics.message.storage.model.AnalyticsMessage createAnalyticsMessage(
	...
	*/
	public static com.liferay.analytics.message.storage.model.AnalyticsMessage deleteAnalyticsMessage(
		com.liferay.analytics.message.storage.model.AnalyticsMessage analyticsMessage) {
	...
	*/
	...
	public static com.liferay.analytics.message.storage.model.AnalyticsMessage fetchAnalyticsMessage(
		long analyticsMessageId) {
	...
	* @throws PortalException if a analytics message with the primary key could not be found
	*/
	public static com.liferay.analytics.message.storage.model.AnalyticsMessage getAnalyticsMessage(
		long analyticsMessageId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.liferay.analytics.message.storage.model.AnalyticsMessage updateAnalyticsMessage(
		com.liferay.analytics.message.storage.model.AnalyticsMessage analyticsMessage) {
		return getService().updateAnalyticsMessage(analyticsMessage);
	}

	public static com.liferay.analytics.message.storage.model.AnalyticsMessageBodyBlobModel getBodyBlobModel(
	...
	*/
	public static java.util.List<com.liferay.analytics.message.storage.model.AnalyticsMessage> getAnalyticsMessages(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<AnalyticsMessageLocalService, AnalyticsMessageLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AnalyticsMessageLocalService.class);
}