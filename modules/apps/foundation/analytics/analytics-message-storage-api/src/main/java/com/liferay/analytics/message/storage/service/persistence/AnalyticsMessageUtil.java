 ...
 * @see com.liferay.analytics.message.storage.service.persistence.impl.AnalyticsMessagePersistenceImpl
 * @generated
 */
@ProviderType
public class AnalyticsMessageUtil {
	...
	*/
	public static AnalyticsMessage findByCompanyId_First(long companyId,
		OrderByComparator<AnalyticsMessage> orderByComparator)
		throws com.liferay.analytics.message.storage.exception.NoSuchMessageException {
		return getPersistence()
	...
	*/
	public static AnalyticsMessage fetchByCompanyId_First(long companyId,
		OrderByComparator<AnalyticsMessage> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchMessageException if a matching analytics message could not be found
	*/
	public static AnalyticsMessage findByCompanyId_Last(long companyId,
		OrderByComparator<AnalyticsMessage> orderByComparator)
		throws com.liferay.analytics.message.storage.exception.NoSuchMessageException {
		return getPersistence()
	...
	*/
	public static AnalyticsMessage fetchByCompanyId_Last(long companyId,
		OrderByComparator<AnalyticsMessage> orderByComparator) {
		return getPersistence()
	...
	*/
	public static AnalyticsMessage[] findByCompanyId_PrevAndNext(
		...
		throws com.liferay.analytics.message.storage.exception.NoSuchMessageException {
		return getPersistence()
				   .findByCompanyId_PrevAndNext(analyticsMessageId, companyId,
			orderByComparator);
	}
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, AnalyticsMessage> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<AnalyticsMessagePersistence, AnalyticsMessagePersistence> _serviceTracker =
		ServiceTrackerFactory.open(AnalyticsMessagePersistence.class);
}