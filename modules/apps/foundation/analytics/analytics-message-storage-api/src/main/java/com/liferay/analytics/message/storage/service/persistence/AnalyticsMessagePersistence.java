...
public interface AnalyticsMessagePersistence extends BasePersistence<AnalyticsMessage> {
	...
	*/
	public java.util.List<AnalyticsMessage> findByCompanyId(long companyId,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AnalyticsMessage> orderByComparator);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, AnalyticsMessage> fetchByPrimaryKeys(
