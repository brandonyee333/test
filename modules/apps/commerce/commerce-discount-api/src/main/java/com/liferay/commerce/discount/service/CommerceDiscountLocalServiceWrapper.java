...
public class CommerceDiscountLocalServiceWrapper
	...
	public com.liferay.commerce.discount.model.CommerceDiscount
			addOrUpdateCommerceDiscount(
				String externalReferenceCode, long userId,
				long commerceDiscountId, String commerceCurrencyCode,
		...
		return _commerceDiscountLocalService.addOrUpdateCommerceDiscount(
			externalReferenceCode, userId, commerceDiscountId,
			commerceCurrencyCode, title, target, useCouponCode, couponCode,
	...
	public com.liferay.commerce.discount.model.CommerceDiscount
		...
		return _commerceDiscountLocalService.updateExternalReferenceCode(
