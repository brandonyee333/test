...
boolean hasEditAddressesPermission = baseAddressCheckoutStepDisplayContext.hasPermission(permissionChecker, commerceAccount, CommerceAccountActionKeys.MANAGE_ADDRESSES);
%>
...
<div class="address-fields">
	...
	<div class="form-group-autofit">
		...
		<aui:select disabled="<%= (commerceAddressId > 0) || !hasEditAddressesPermission %>" label="" name="commerceCountryId" placeholder="country" title="country" wrapperCssClass="form-group-item">
	...
	<div class="form-group-autofit">
		...
		<aui:select disabled="<%= (commerceAddressId > 0) || !hasEditAddressesPermission %>" label="" name="commerceRegionId" placeholder="region" title="region" wrapperCssClass="form-group-item" />

		<aui:input disabled="<%= (commerceAddressId > 0) || !hasEditAddressesPermission %>" id="commerceRegionIdInput" label="" name="commerceRegionId" placeholder="regionId" title="region" wrapperCssClass="d-none form-group-item" />

		<aui:input disabled="<%= (commerceAddressId > 0) || !hasEditAddressesPermission %>" id="commerceRegionIdName" label="" name="commerceRegionId" placeholder="regionName" title="region" wrapperCssClass="d-none form-group-item" />
	</div>
