...
public class PlacedOrderResourceImpl extends BasePlacedOrderResourceImpl {
	...
	public Page<PlacedOrder> getChannelAccountPlacedOrdersPage(
		...
		return Page.of(
			_toPlacedOrders(commerceOrders), pagination,
	...
	public PlacedOrder getPlacedOrder(Long placedOrderId) throws Exception {
		...
		return _toPlacedOrder(commerceOrder);
	}
	...
	private PlacedOrder _toPlacedOrder(CommerceOrder commerceOrder)
		throws Exception {
	...
	private List<PlacedOrder> _toPlacedOrders(
			List<CommerceOrder> commerceOrders)
		throws Exception {
		...
		for (CommerceOrder commerceOrder : commerceOrders) {
			orders.add(_toPlacedOrder(commerceOrder));
		}
