...
public class PlacedOrderCommentResourceImpl
	...
	public PlacedOrderComment getPlacedOrderComment(Long placedOrderCommentId)
		...
		return _toOrderComment(placedOrderCommentId);
	}
	...
	private PlacedOrderComment _toOrderComment(Long commerceOrderNoteId)
		throws Exception {
	...
	private List<PlacedOrderComment> _toOrderComments(
			List<CommerceOrderNote> commerceOrderNotes)
		throws Exception {

		List<PlacedOrderComment> orders = new ArrayList<>();
