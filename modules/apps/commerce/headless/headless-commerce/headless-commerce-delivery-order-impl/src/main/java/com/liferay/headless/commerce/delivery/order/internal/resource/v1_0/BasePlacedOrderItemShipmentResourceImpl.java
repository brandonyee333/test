...
public abstract class BasePlacedOrderItemShipmentResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-order/v1.0/placed-order-items/{placedOrderItemId}/shipments'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/placed-order-items/{placedOrderItemId}/shipments")
