...
public abstract class BasePlacedOrderAddressResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-order/v1.0/placed-orders/{placedOrderId}/billing-address'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrive placed order billing address."
	)
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/placed-orders/{placedOrderId}/billing-address")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-order/v1.0/placed-orders/{placedOrderId}/shipping-address'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrive placed order billing address."
	)
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/placed-orders/{placedOrderId}/shipping-address")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
