...
public class Query {
	 ...
	 */
	@GraphQLField(
		description = "Retrive information of the given Placed Order."
	)
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {placedOrderBillingAddres(placedOrderId: ___){city, country, countryISOCode, description, id, latitude, longitude, name, phoneNumber, region, regionISOCode, street1, street2, street3, type, typeId, vatNumber, zip}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(description = "Retrive placed order billing address.")
	public PlacedOrderAddress placedOrderBillingAddres(
			@GraphQLName("placedOrderId") Long placedOrderId)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			...
			placedOrderAddressResource ->
				placedOrderAddressResource.getPlacedOrderBillingAddres(
					placedOrderId));
	}
	...
	public PlacedOrderAddress placedOrderShippingAddres(
		...
		return _applyComponentServiceObjects(
			...
			this::_populateResourceContext,
			placedOrderAddressResource ->
				placedOrderAddressResource.getPlacedOrderShippingAddres(
					placedOrderId));
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {placedOrderItems(page: ___, pageSize: ___, placedOrderId: ___, skuId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(description = "Retrive order items of a Placed Order.")
	public PlacedOrderItemPage placedOrderItems(
			@GraphQLName("placedOrderId") Long placedOrderId,
	...
	@GraphQLTypeExtension(PlacedOrder.class)
	public class GetPlacedOrderShippingAddresTypeExtension {

		public GetPlacedOrderShippingAddresTypeExtension(
			PlacedOrder placedOrder) {
		...
		@GraphQLField(description = "Retrive placed order billing address.")
		public PlacedOrderAddress shippingAddres() throws Exception {
			return _applyComponentServiceObjects(
				_placedOrderAddressResourceComponentServiceObjects,
				Query.this::_populateResourceContext,
				placedOrderAddressResource ->
	...
	@GraphQLTypeExtension(PlacedOrder.class)
	public class GetPlacedOrderBillingAddresTypeExtension {

		public GetPlacedOrderBillingAddresTypeExtension(
			PlacedOrder placedOrder) {
		...
		@GraphQLField(description = "Retrive placed order billing address.")
		public PlacedOrderAddress billingAddres() throws Exception {
			return _applyComponentServiceObjects(
				_placedOrderAddressResourceComponentServiceObjects,
				Query.this::_populateResourceContext,
				placedOrderAddressResource ->
	...
	@GraphQLTypeExtension(PlacedOrder.class)
	public class GetPlacedOrderItemsPageTypeExtension {

		public GetPlacedOrderItemsPageTypeExtension(PlacedOrder placedOrder) {
			_placedOrder = placedOrder;
		}

		@GraphQLField(description = "Retrive order items of a Placed Order.")
		public PlacedOrderItemPage items(
				@GraphQLName("skuId") Long skuId,
				@GraphQLName("pageSize") int pageSize,
				@GraphQLName("page") int page)
			throws Exception {
