...
public interface PlacedOrderItemShipmentResource {
	...
	public Page<PlacedOrderItemShipment> getPlacedOrderItemShipmentsPage(
			Long placedOrderItemId)
		throws Exception;

	public HttpInvoker.HttpResponse getPlacedOrderItemShipmentsPageHttpResponse(
			Long placedOrderItemId)
		throws Exception;
	...
	public static class PlacedOrderItemShipmentResourceImpl
		...
		public Page<PlacedOrderItemShipment> getPlacedOrderItemShipmentsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getPlacedOrderItemShipmentsPageHttpResponse(placedOrderItemId);
		...
		public HttpInvoker.HttpResponse
				getPlacedOrderItemShipmentsPageHttpResponse(
					Long placedOrderItemId)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/placed-order-items/{placedOrderItemId}/shipments");
