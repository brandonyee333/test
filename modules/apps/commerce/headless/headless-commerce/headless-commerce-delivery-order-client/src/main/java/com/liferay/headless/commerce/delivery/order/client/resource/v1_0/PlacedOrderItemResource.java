...
public interface PlacedOrderItemResource {
	...
	public HttpInvoker.HttpResponse getPlacedOrderItemsPageHttpResponse(
			Long placedOrderId, Long skuId, Pagination pagination)
		throws Exception;
	...
	public static class PlacedOrderItemResourceImpl
		...
		public Page<PlacedOrderItem> getPlacedOrderItemsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getPlacedOrderItemsPageHttpResponse(
		...
		public HttpInvoker.HttpResponse getPlacedOrderItemsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/placed-orders/{placedOrderId}/items");
