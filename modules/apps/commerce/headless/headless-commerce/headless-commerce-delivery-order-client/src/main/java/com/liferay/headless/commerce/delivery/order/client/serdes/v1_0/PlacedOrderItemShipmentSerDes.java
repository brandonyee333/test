...
public class PlacedOrderItemShipmentSerDes {
	...
	public static String toJSON(
		...
		if (placedOrderItemShipment.getUserName() != null) {
			...
			sb.append(_escape(placedOrderItemShipment.getUserName()));
	...
	public static Map<String, String> toMap(
		...
		if (placedOrderItemShipment.getUserName() == null) {
			...
			map.put(
				"userName",
				String.valueOf(placedOrderItemShipment.getUserName()));
		}
	...
	public static class PlacedOrderItemShipmentJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "accountId")) {
				...
				if (jsonParserFieldValue != null) {
					placedOrderItemShipment.setExpectedDate(
						toDate((String)jsonParserFieldValue));
				}
			}
				...
				if (jsonParserFieldValue != null) {
					placedOrderItemShipment.setShippingDate(
						toDate((String)jsonParserFieldValue));
				}
			}
				...
				if (jsonParserFieldValue != null) {
					placedOrderItemShipment.setUserName(
						(String)jsonParserFieldValue);
				}
			}
		}
