...
public abstract class BasePlacedOrderAddressResourceTestCase {
	...
	@Test
	public void testGraphQLGetPlacedOrderBillingAddres() throws Exception {
		PlacedOrderAddress placedOrderAddress =
			testGraphQLGetPlacedOrderBillingAddres_addPlacedOrderAddress();
			...
			equals(
				...
				PlacedOrderAddressSerDes.toDTO(
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								"placedOrderBillingAddres",
								new HashMap<String, Object>() {
									{
										put(
											"placedOrderId",
											testGraphQLGetPlacedOrderBillingAddres_getPlacedOrderId());
									}
								},
								getGraphQLFields())),
						"JSONObject/data",
						"Object/placedOrderBillingAddres"))));
	}

	protected Long testGraphQLGetPlacedOrderBillingAddres_getPlacedOrderId()
		throws Exception {
	...
	@Test
	public void testGraphQLGetPlacedOrderBillingAddresNotFound()
		throws Exception {
	...
	@Test
	public void testGetPlacedOrderShippingAddres() throws Exception {
		PlacedOrderAddress postPlacedOrderAddress =
			testGetPlacedOrderShippingAddres_addPlacedOrderAddress();

		PlacedOrderAddress getPlacedOrderAddress =
			placedOrderAddressResource.getPlacedOrderShippingAddres(
				testGetPlacedOrderShippingAddres_getPlacedOrderId());

		assertEquals(postPlacedOrderAddress, getPlacedOrderAddress);
		assertValid(getPlacedOrderAddress);
	}

	protected Long testGetPlacedOrderShippingAddres_getPlacedOrderId()
		throws Exception {
	...
	@Test
	public void testGraphQLGetPlacedOrderShippingAddres() throws Exception {
		PlacedOrderAddress placedOrderAddress =
			testGraphQLGetPlacedOrderShippingAddres_addPlacedOrderAddress();
			...
			equals(
				...
				PlacedOrderAddressSerDes.toDTO(
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								"placedOrderShippingAddres",
								new HashMap<String, Object>() {
									{
										put(
											"placedOrderId",
											testGraphQLGetPlacedOrderShippingAddres_getPlacedOrderId());
									}
								},
								getGraphQLFields())),
						"JSONObject/data",
						"Object/placedOrderShippingAddres"))));
	}

	protected Long testGraphQLGetPlacedOrderShippingAddres_getPlacedOrderId()
		throws Exception {
	...
	@Test
	public void testGraphQLGetPlacedOrderShippingAddresNotFound()
		throws Exception {
