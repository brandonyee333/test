...
public class WallEntryPersistenceImpl
	...
	public Map<Serializable, WallEntry> fetchByPrimaryKeys(
		...
		sb.append(_SQL_SELECT_WALLENTRY_WHERE_PKS_IN);
		...
		try {
			...
			for (WallEntry wallEntry : (List<WallEntry>)query.list()) {
	...
	public void afterPropertiesSet() {
		...
		WallEntryUtil.setPersistence(this);
	}

	public void destroy() {
		WallEntryUtil.setPersistence(null);
