...
<aui:input cssClass="lfr-search-keywords" inlineField="<%= true %>" label="" name='<%= namespace + "keywords" %>' onBlur="<%= taglibOnBlur %>" onFocus="<%= taglibOnFocus %>" size="30" title="search-web-content" type="text" value="<%= HtmlUtil.escape(keywords) %>" />
