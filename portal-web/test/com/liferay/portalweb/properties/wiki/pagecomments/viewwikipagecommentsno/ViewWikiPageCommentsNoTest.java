...
public class ViewWikiPageCommentsNoTest extends BaseTestCase {
	public void testViewWikiPageCommentsNo() throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"Your Rating\n Rate this 1 stars out of 5. Rate this 2 stars out of 5. Rate this 3 stars out of 5. Rate this 4 stars out of 5. Rate this 5 stars out of 5. \n \n Average (0 Votes)"),
			selenium.getText("//div[8]/div"));
		assertFalse(selenium.isElementPresent("Be the frist"));
