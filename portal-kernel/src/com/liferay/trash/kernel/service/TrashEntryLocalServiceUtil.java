 ...
 * <code>com.liferay.portlet.trash.service.impl.TrashEntryLocalServiceImpl</code> and
...
public class TrashEntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portlet.trash.service.impl.TrashEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static java.util.List<com.liferay.trash.kernel.model.TrashEntry>
		getEntries(long groupId, int start, int end) {
	...
	public static TrashEntryLocalService getService() {
		if (_service == null) {
			_service = (TrashEntryLocalService)PortalBeanLocatorUtil.locate(
				TrashEntryLocalService.class.getName());
		}
