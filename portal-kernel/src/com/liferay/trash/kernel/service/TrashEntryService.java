...
public interface TrashEntryService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portlet.trash.service.impl.TrashEntryServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the trash entry remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TrashEntryServiceUtil} if injection and service tracking are not available.
	 */
