...
public class OrganizationUtil {
	...
	* @return the matching organizations
	*/
	public static List<Organization> findByC_LikeN(long companyId,
	...
	* @throws NoSuchOrganizationException if a matching organization could not be found
	*/
	public static Organization findByC_LikeN_First(long companyId,
		java.lang.String name, OrderByComparator<Organization> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchOrganizationException {
		return getPersistence()
	...
	* @throws NoSuchOrganizationException if a matching organization could not be found
	*/
	public static Organization findByC_LikeN_Last(long companyId,
		java.lang.String name, OrderByComparator<Organization> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchOrganizationException {
		return getPersistence()
	...
	* @return the last matching organization, or <code>null</code> if a matching organization could not be found
	*/
	public static Organization fetchByC_LikeN_Last(long companyId,
		java.lang.String name, OrderByComparator<Organization> orderByComparator) {
		return getPersistence()
	...
	*/
	public static Organization[] findByC_LikeN_PrevAndNext(
		long organizationId, long companyId, java.lang.String name,
		OrderByComparator<Organization> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchOrganizationException {
		return getPersistence()
	...
	* @return the number of matching organizations that the user has permission to view
	*/
	public static int filterCountByC_LikeN(long companyId, java.lang.String name) {
	...
	*/
	public static List<Organization> findByC_P_LikeN(long companyId,
		long parentOrganizationId, java.lang.String name, int start, int end) {
		return getPersistence()
				   .findByC_P_LikeN(companyId, parentOrganizationId, name,
			start, end);
	}
