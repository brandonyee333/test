...
public class LayoutRevisionPersistenceImpl extends BasePersistenceImpl<LayoutRevision>
	 ...
	 */
	@Override
	public List<LayoutRevision> findByL_H_P(long layoutSetBranchId,
		boolean head, long plid) {
		return findByL_H_P(layoutSetBranchId, head, plid, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<LayoutRevision> findByL_H_P(long layoutSetBranchId,
		...
		return findByL_H_P(layoutSetBranchId, head, plid, start, end, null);
	}
	...
	public List<LayoutRevision> findByL_H_P(long layoutSetBranchId,
		boolean head, long plid, int start, int end,
		OrderByComparator<LayoutRevision> orderByComparator) {
		return findByL_H_P(layoutSetBranchId, head, plid, start, end,
			orderByComparator, true);
	}
	 ...
	 */
	@Override
	public LayoutRevision[] findByL_H_P_PrevAndNext(long layoutRevisionId,
		...
		try {
			...
			array[0] = getByL_H_P_PrevAndNext(session, layoutRevision,
					layoutSetBranchId, head, plid, orderByComparator, true);

			array[1] = layoutRevision;

			array[2] = getByL_H_P_PrevAndNext(session, layoutRevision,
	...
	protected LayoutRevision getByL_H_P_PrevAndNext(Session session,
		LayoutRevision layoutRevision, long layoutSetBranchId, boolean head,
		long plid, OrderByComparator<LayoutRevision> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public LayoutRevision updateImpl(LayoutRevision layoutRevision) {
		...
		if (!LayoutRevisionModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_L_H_P,
				args);
			...
			if ((layoutRevisionModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_L_H_P.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						layoutRevisionModelImpl.getOriginalLayoutSetBranchId(),
						layoutRevisionModelImpl.getOriginalHead(),
						layoutRevisionModelImpl.getOriginalPlid()
