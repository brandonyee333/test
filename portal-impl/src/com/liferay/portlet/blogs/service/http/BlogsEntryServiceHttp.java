...
public class BlogsEntryServiceHttp {
	...
	public static java.util.List<com.liferay.blogs.kernel.model.BlogsEntry>
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCompanyEntriesParameterTypes3);
			...
			return (java.util.List<com.liferay.blogs.kernel.model.BlogsEntry>)
				returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException
					systemException) {
	...
	public static String getCompanyEntriesRSS(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCompanyEntriesRSSParameterTypes4);
	...
	public static com.liferay.blogs.kernel.model.BlogsEntry[]
			getEntriesPrevAndNext(HttpPrincipal httpPrincipal, long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static String getGroupEntriesRSS(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getGroupEntriesRSSParameterTypes15);
	...
	public static java.util.List<com.liferay.blogs.kernel.model.BlogsEntry>
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getGroupsEntriesParameterTypes16);
	...
	public static java.util.List<com.liferay.blogs.kernel.model.BlogsEntry>
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getGroupUserEntriesParameterTypes17);
	...
	public static com.liferay.blogs.kernel.model.BlogsEntry moveEntryToTrash(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_moveEntryToTrashParameterTypes23);
	...
	private static final Class<?>[] _getCompanyEntriesParameterTypes3 =
		new Class[] {long.class, java.util.Date.class, int.class, int.class};
	private static final Class<?>[] _getCompanyEntriesRSSParameterTypes4 =
		new Class[] {
	...
	private static final Class<?>[] _getEntriesPrevAndNextParameterTypes5 =
	...
	private static final Class<?>[] _getGroupEntriesRSSParameterTypes15 =
		new Class[] {
			long.class, java.util.Date.class, int.class, int.class,
			String.class, double.class, String.class, String.class,
			String.class, com.liferay.portal.kernel.theme.ThemeDisplay.class
		};
	private static final Class<?>[] _getGroupsEntriesParameterTypes16 =
		new Class[] {
			long.class, long.class, java.util.Date.class, int.class, int.class
		};
	private static final Class<?>[] _getGroupUserEntriesParameterTypes17 =
		new Class[] {
	...
	private static final Class<?>[] _getGroupUserEntriesCountParameterTypes19 =
		new Class[] {long.class, long.class, int.class};
	private static final Class<?>[] _getGroupUserEntriesCountParameterTypes20 =
		new Class[] {long.class, long.class, int[].class};
	private static final Class<?>[] _getOrganizationEntriesParameterTypes21 =
		new Class[] {long.class, java.util.Date.class, int.class, int.class};
	private static final Class<?>[] _getOrganizationEntriesRSSParameterTypes22 =
		new Class[] {
			long.class, java.util.Date.class, int.class, int.class,
			String.class, double.class, String.class, String.class,
			String.class, com.liferay.portal.kernel.theme.ThemeDisplay.class
		};
	private static final Class<?>[] _moveEntryToTrashParameterTypes23 =
		new Class[] {long.class};
	private static final Class<?>[] _restoreEntryFromTrashParameterTypes24 =
		new Class[] {long.class};
