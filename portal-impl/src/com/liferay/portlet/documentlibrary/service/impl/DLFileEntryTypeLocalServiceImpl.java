        ...
        try {
            if (ddmStructure == null) {
                ...
                try {
                    ...
                    Element structureElementRootElement = document.getRootElement();
                    ...
                    xsd = DDMXMLUtil.updateXMLDefaultLocale(
                            xsd, ddmStructureDefaultLocale, defaultLocale);
                } catch (Exception e) {
                    _log.warn("Unable to update xml default locale for structure key: " + ddmStructureKey);
                }
